...
//      case ObjectClass.phantasm_12mm_machinegun => ConstructorData(DetailedWeaponData.codec, "weapon")
  ...
  def selectDataCodec(objClass : Int) : Codec[ConstructorData] =
    (objClass : @switch) match {
      //ammunition
      case ObjectClass.bullet_105mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_12mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_150mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_15mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_20mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_25mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_35mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_75mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_9mm => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_9mm_AP => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ancient_ammo_combo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ancient_ammo_vehicle => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.anniversary_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_immolation_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_laser_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_plasma_rocket_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_ppa_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_starfire_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.armor_canister => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.armor_siphon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bolt => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.burster_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_100mm_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_burster_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_chaingun_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_cluster_bomb_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_tank_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.comet_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.dualcycler_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.energy_cell => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.energy_gun_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.falcon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.firebird_missile => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.flamethrower_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.flux_cannon_thresher_battery => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.fluxpod_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.frag_cartridge => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.frag_grenade_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.gauss_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.grenade => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.health_canister => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.heavy_grenade_mortar => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.heavy_rail_beam_battery => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.hellfire_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.hunter_seeker_missile => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.jammer_cartridge => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.jammer_grenade_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.lancer_cartridge => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.liberator_bomb => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.maelstrom_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.melee_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.mine => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.mine_sweeper_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ntu_siphon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.oicw_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pellet_gun_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_dual_machine_gun_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_mechhammer_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_particle_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_rocket_pod_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_sparrow_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.phalanx_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.phoenix_missile => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.plasma_cartridge => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.plasma_grenade_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pounder_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pulse_battery => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.quasar_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.reaver_rocket => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.rocket => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.scattercannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.shotgun_shell => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.shotgun_shell_AP => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.six_shooter_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.skyguard_flak_cannon_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.sparrow_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.spitfire_aa_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.spitfire_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.starfire_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.striker_missile_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.trek_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.upgrade_canister => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.wasp_gun_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.wasp_rocket_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.winchester_ammo => ConstructorData(CommonFieldData2.codec, "ammo box")
      //weapons
      ...
      //medkits
      case ObjectClass.medkit => ConstructorData(CommonFieldData2.codec, "medkit")
      case ObjectClass.super_armorkit => ConstructorData(CommonFieldData2.codec, "repair kit")
      case ObjectClass.super_medkit => ConstructorData(CommonFieldData2.codec, "super medkit")
      case ObjectClass.super_staminakit => ConstructorData(CommonFieldData2.codec, "stamina kit")
      //tools
      ...
      //other
      case ObjectClass.ams_order_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.ams_respawn_tube => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.avatar => ConstructorData(PlayerData.codec(false), "avatar")
      case ObjectClass.bfr_rearm_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.implant_terminal_interface => ConstructorData(CommonFieldData2.codec, "implant terminal")
      case ObjectClass.lodestar_repair_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.matrix_terminala => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.matrix_terminalb => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.matrix_terminalc => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.multivehicle_rearm_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminala => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminalb => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.targeting_laser_dispenser => ConstructorData(CommonFieldData2.codec, "terminal")
      case ObjectClass.teleportpad_terminal => ConstructorData(CommonFieldData2.codec, "terminal")
      //failure case
      case _ => defaultFailureCodec(objClass)
    }
  ...
  def selectDataDroppedCodec(objClass : Int) : Codec[ConstructorData] =
    (objClass : @switch) match {
      //ammunition
      case ObjectClass.bullet_105mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_12mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_150mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_15mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_20mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_25mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_35mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_75mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_9mm => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bullet_9mm_AP => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ancient_ammo_combo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ancient_ammo_vehicle => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.anniversary_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_immolation_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_laser_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_plasma_rocket_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_ppa_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.aphelion_starfire_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.armor_canister => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.armor_siphon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.bolt => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.burster_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_100mm_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_burster_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_chaingun_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_cluster_bomb_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.colossus_tank_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.comet_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.dualcycler_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.energy_cell => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.energy_gun_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.falcon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.firebird_missile => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.flamethrower_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.flux_cannon_thresher_battery => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.fluxpod_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.frag_cartridge => DroppedItemData(CommonFieldData2.codec, "ammo box")
//      case ObjectClass.frag_grenade_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.gauss_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.grenade => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.health_canister => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.heavy_grenade_mortar => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.heavy_rail_beam_battery => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.hellfire_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.hunter_seeker_missile => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.jammer_cartridge => DroppedItemData(CommonFieldData2.codec, "ammo box")
//      case ObjectClass.jammer_grenade_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.lancer_cartridge => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.liberator_bomb => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.maelstrom_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.melee_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.mine => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.mine_sweeper_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.ntu_siphon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.oicw_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pellet_gun_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_dual_machine_gun_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_mechhammer_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_particle_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_rocket_pod_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.peregrine_sparrow_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.phalanx_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.phoenix_missile => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.plasma_cartridge => DroppedItemData(CommonFieldData2.codec, "ammo box")
//      case ObjectClass.plasma_grenade_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pounder_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.pulse_battery => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.quasar_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.reaver_rocket => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.rocket => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.scattercannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.shotgun_shell => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.shotgun_shell_AP => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.six_shooter_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.skyguard_flak_cannon_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.sparrow_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.spitfire_aa_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.spitfire_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.starfire_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.striker_missile_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
//      case ObjectClass.trek_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.upgrade_canister => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.wasp_gun_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.wasp_rocket_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      case ObjectClass.winchester_ammo => DroppedItemData(CommonFieldData2.codec, "ammo box")
      //weapons
...
//      case ObjectClass.spitfire_weapon => DroppedItemData(WeaponData.codec, "weapon")
      ...
      //medkits
      case ObjectClass.medkit => DroppedItemData(CommonFieldData2.codec, "medkit")
      case ObjectClass.super_armorkit => DroppedItemData(CommonFieldData2.codec, "repair kit")
      case ObjectClass.super_medkit => DroppedItemData(CommonFieldData2.codec, "super medkit")
      case ObjectClass.super_staminakit => DroppedItemData(CommonFieldData2.codec, "stamina kit")
      //tools
      ...
      case ObjectClass.boomer => ConstructorData(CommonFieldData2WithPlacement.codec, "ace deployable")
      case ObjectClass.he_mine => ConstructorData(CommonFieldData2WithPlacement.codec, "ace deployable")
      case ObjectClass.jammer_mine => ConstructorData(CommonFieldData2WithPlacement.codec, "ace deployable")
      case ObjectClass.motionalarmsensor => ConstructorData(CommonFieldData2WithPlacement.codec, "ace deployable")
      case ObjectClass.sensor_shield => ConstructorData(CommonFieldData2WithPlacement.codec, "ace deployable")
      ...
      //other
      case ObjectClass.ams_respawn_tube => DroppedItemData(CommonFieldData2.codec, "terminal")
      ...
      case ObjectClass.matrix_terminala => DroppedItemData(CommonFieldData2.codec, "terminal")
      case ObjectClass.matrix_terminalb => DroppedItemData(CommonFieldData2.codec, "terminal")
      case ObjectClass.matrix_terminalc => DroppedItemData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminal => DroppedItemData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminala => DroppedItemData(CommonFieldData2.codec, "terminal")
      case ObjectClass.order_terminalb => DroppedItemData(CommonFieldData2.codec, "terminal")
      //failure case
      case _ => defaultFailureCodec(objClass)
    }
