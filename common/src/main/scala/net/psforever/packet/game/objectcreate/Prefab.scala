...
object Prefab {
  object Vehicle {
    def ams(loc : PlacementData, faction : PlanetSideEmpire.Value, health : Int, driveState : DriveState.Value, matrix_guid : PlanetSideGUID, respawn_guid : PlanetSideGUID, term_a_guid : PlanetSideGUID, term_b_guid : PlanetSideGUID) : VehicleData = {
      VehicleData(loc, CommonFieldData(faction, 0), health, driveState, false, UtilityVehicleData(0),
        Some(InventoryData(List(
          InternalSlot(ObjectClass.matrix_terminalc, matrix_guid, 1, CommonFieldData2(faction)),
          InternalSlot(ObjectClass.ams_respawn_tube, respawn_guid, 2, CommonFieldData2(faction)),
          InternalSlot(ObjectClass.order_terminala, term_a_guid, 3, CommonFieldData2(faction)),
          InternalSlot(ObjectClass.order_terminalb, term_b_guid, 4, CommonFieldData2(faction))
        )))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.apc_weapon_systemc_nc, weapon1_guid, 11,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_20mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.apc_weapon_systemb, weapon2_guid, 12,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_75mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_weapon_systema, weapon3_guid, 13,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_75mm, ammo3_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_weapon_systemd_nc, weapon4_guid, 14,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_20mm, ammo4_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_ballgun_r, weapon5_guid, 15,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_12mm, ammo5_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_ballgun_l, weapon6_guid, 16,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_12mm, ammo6_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.apc_weapon_systemc_tr, weapon1_guid, 11,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_15mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.apc_weapon_systemb, weapon2_guid, 12,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_75mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            ...
            InventoryItemData(ObjectClass.apc_weapon_systemd_tr, weapon4_guid, 14,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_15mm, ammo4_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_ballgun_r, weapon5_guid, 15,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_12mm, ammo5_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.apc_weapon_systemc_vs, weapon1_guid, 11,
            WeaponData(0x6, 0x8, 0, ObjectClass.flux_cannon_thresher_battery, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.apc_weapon_systemb, weapon2_guid, 12,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_75mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            ...
            InventoryItemData(ObjectClass.apc_weapon_systemd_vs, weapon4_guid, 14,
              WeaponData(0x6, 0x8, 0, ObjectClass.flux_cannon_thresher_battery, ammo4_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.apc_ballgun_r, weapon5_guid, 15,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_12mm, ammo5_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
      ...
      //VehicleData(loc, CommonFieldData(faction, 0), 0, health, false, false, DriveState.State7, true, false, false, None,
        VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
          ...
          InventoryItemData(ObjectClass.aurora_weapon_systema, weapon1_guid, 5,
            WeaponData(0x6, 0x8, 0, ObjectClass.fluxpod_ammo, ammo11_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.aurora_weapon_systemb, weapon2_guid, 6,
              WeaponData(0x6, 0x8, 0, ObjectClass.fluxpod_ammo, ammo21_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
        ...
        Some(InventoryData(
          InventoryItemData(ObjectClass.battlewagon_weapon_systema, weapon1_guid, 5,
            ...
            InventoryItemData(ObjectClass.battlewagon_weapon_systemb, weapon2_guid, 6,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_15mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.battlewagon_weapon_systemc, weapon3_guid, 7,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_15mm, ammo3_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
        ...
        Some(InventoryData(
          InventoryItemData(ObjectClass.cannon_dropship_20mm, weapon1_guid, 12,
            ...
            InventoryItemData(ObjectClass.cannon_dropship_20mm, weapon2_guid, 13,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_20mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.dropship_rear_turret, weapon3_guid, 14,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_20mm, ammo3_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.Mobile, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.flail_weapon, weapon_guid, 1,
            WeaponData(0x6, 0x8, 0, ObjectClass.ancient_ammo_vehicle, ammo_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.targeting_laser_dispenser, terminal_guid, 2, CommonFieldData2(faction, 2)) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.fury_weapon_systema, weapon_guid, 1,
            WeaponData(0x4, 0x8, ObjectClass.hellfire_ammo, ammo_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.galaxy_gunship_cannon, weapon1_guid, 6,
            WeaponData(0x6, 0x8, 0, ObjectClass.heavy_grenade_mortar, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.galaxy_gunship_cannon, weapon2_guid, 7,
              WeaponData(0x6, 0x8, 0, ObjectClass.heavy_grenade_mortar, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.galaxy_gunship_tailgun, weapon3_guid, 8,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_35mm, ammo3_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.galaxy_gunship_gun, weapon4_guid, 9,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_35mm, ammo4_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.galaxy_gunship_gun, weapon5_guid, 10,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_35mm, ammo5_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.liberator_weapon_system, weapon1_guid, 3,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_35mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.liberator_bomb_bay, weapon2_guid, 4,
              WeaponData(0x6, 0x8, 0, ObjectClass.liberator_bomb, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.liberator_bomb, ammo3_guid, 1, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.liberator_25mm_cannon, weapon3_guid, 5,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_25mm, ammo4_guid, 0 ,CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.Mobile, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.lightgunship_weapon_system, weapon_guid, 1,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_20mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.reaver_rocket, ammo2_guid,1, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.lightning_weapon_system, weapon_guid, 1,
            WeaponData(0x4, 0x8, 0, ObjectClass.bullet_75mm, ammo1_guid, 0, CommonFieldData2(), ObjectClass.bullet_12mm, ammo2_guid, 1, CommonFieldData2())
          ) :: Nil)
        )
      )
    }
    ...
    def lodestar(loc : PlacementData, faction : PlanetSideEmpire.Value, health : Int, repair1_guid : PlanetSideGUID, repair2_guid : PlanetSideGUID, veh_rearm1_guid : PlanetSideGUID, veh_rearm2_guid : PlanetSideGUID, bfr_rearm1_guid : PlanetSideGUID, bfr_rearm2_guid : PlanetSideGUID) : VehicleData = {
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false, VariantVehicleData(0),
        Some(InventoryData(List(
          InternalSlot(ObjectClass.lodestar_repair_terminal, repair1_guid, 2, CommonFieldData2(faction, 2)),
          InternalSlot(ObjectClass.lodestar_repair_terminal, repair2_guid, 3, CommonFieldData2(faction, 2)),
          InternalSlot(ObjectClass.multivehicle_rearm_terminal, veh_rearm1_guid, 4, CommonFieldData2(faction, 2)),
          InternalSlot(ObjectClass.multivehicle_rearm_terminal, veh_rearm2_guid, 5, CommonFieldData2(faction, 2)),
          InternalSlot(ObjectClass.bfr_rearm_terminal, bfr_rearm1_guid, 6, CommonFieldData2(faction, 2)),
          InternalSlot(ObjectClass.bfr_rearm_terminal, bfr_rearm2_guid, 7, CommonFieldData2(faction, 2))
        )))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.particle_beam_magrider, weapon1_guid, 2,
            WeaponData(0x6, 0x8, 0, ObjectClass.pulse_battery, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.heavy_rail_beam_magrider, weapon2_guid, 3,
              WeaponData(0x6, 0x8, 0, ObjectClass.heavy_rail_beam_battery, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.mediumtransport_weapon_systemA, weapon1_guid, 5,
            WeaponData(0x6, 0x8, ObjectClass.bullet_20mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.mediumtransport_weapon_systemB, weapon2_guid, 6,
              WeaponData(0x6, 0x8, ObjectClass.bullet_20mm, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.rotarychaingun_mosquito, weapon_guid, 1,
            WeaponData(0x6, 0x8, ObjectClass.bullet_12mm, ammo_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.prowler_weapon_systemA, weapon1_guid, 3,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_105mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
    ...
    def router(loc : PlacementData, faction : PlanetSideEmpire.Value, health : Int, terminal_guid : PlanetSideGUID) : VehicleData = {
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.Mobile, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.teleportpad_terminal, terminal_guid, 1, CommonFieldData2(faction, 2)) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.skyguard_weapon_system, weapon_guid, 2,
            WeaponData(0x6, 0x8, 0, ObjectClass.skyguard_flak_cannon_ammo, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.bullet_12mm, ammo2_guid, 1, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.scythe, weapon_guid, 1,
            WeaponData(0x6, 0x8, 0, ObjectClass.ancient_ammo_vehicle, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.ancient_ammo_vehicle, ammo2_guid, 1, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.chaingun_p, weapon1_guid, 3,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_12mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.thunderer_weapon_systema, weapon1_guid, 5,
            WeaponData(0x6, 0x8, 0, ObjectClass.gauss_cannon_ammo, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) ::
            InventoryItemData(ObjectClass.thunderer_weapon_systemb, weapon2_guid, 6,
              WeaponData(0x6, 0x8, 0, ObjectClass.gauss_cannon_ammo, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.advanced_missile_launcher_t, weapon_guid, 2,
            WeaponData(0x6, 0x8, 0, ObjectClass.firebird_missile, ammo_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.flux_cannon_thresher, weapon_guid, 2,
            WeaponData(0x6, 0x8, 0, ObjectClass.flux_cannon_thresher_battery, ammo_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 2), health, DriveState.State7, false,
        Some(InventoryData(
          InventoryItemData(ObjectClass.vanguard_weapon_system, weapon_guid, 2,
            WeaponData(0x6, 0x8, 0, ObjectClass.bullet_150mm, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.bullet_20mm, ammo2_guid, 1, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
        ...
        Some(InventoryData(
          InventoryItemData(ObjectClass.vulture_nose_weapon_system, weapon1_guid, 3,
            ...
            InventoryItemData(ObjectClass.vulture_bomb_bay, weapon2_guid, 4,
              WeaponData(0x6, 0x8, 0, ObjectClass.liberator_bomb, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) ::
            InventoryItemData(ObjectClass.vulture_tail_cannon, weapon3_guid, 5,
              WeaponData(0x6, 0x8, 0, ObjectClass.bullet_25mm, ammo3_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
            ) :: Nil
        ))
      )
    }
      ...
      VehicleData(loc, CommonFieldData(faction, 0), health, DriveState.Mobile, false, VariantVehicleData(0),
        Some(InventoryData(
          InventoryItemData(ObjectClass.wasp_weapon_system, weapon_guid, 1,
            WeaponData(0x6, 0x8, 0, ObjectClass.wasp_gun_ammo, ammo1_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2), ObjectClass.wasp_rocket_ammo, ammo2_guid, 0, CommonFieldData2(PlanetSideEmpire.NEUTRAL, 2))
          ) :: Nil
        ))
      )
    }
