...
# this tag only needs to provide JDK 21 + an sbt launcher (which fetches sbt 1.12.14 /
# Scala 2.13.18 per the project). No published sbtscala tag bundles 1.12.14_2.13.18, so we
