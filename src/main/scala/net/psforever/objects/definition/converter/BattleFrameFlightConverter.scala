...
object BattleFrameFlightConverter extends ObjectCreateConverter[Vehicle] {
    ...
    if(health > 0) { //active
      Success(
        BattleFrameRoboticsData(
          ...
          CommonFieldData(obj.Faction, bops = false, alternate = false, v1 = true, v2 = None, jammered = false, v5 = None, GetOwner(obj)),
          health,
