...
//                PlacementData(
//                  Vector3(2900.8125f,4818.8516f,58.78125f),
//                  Vector3(0.0f,0.0f,174.375f)
//                ),
//                BasicCharacterData("FateJH",PlanetSideEmpire.VS,CharacterGender.Male,23,2),
//                1,
//                false,
//                false,
//                ExoSuitType.Agile,
...
//                false,
//                false,
//                RibbonBars(MeritCommendation.EventVSSoldier,MeritCommendation.CombatMedic7,MeritCommendation.None,MeritCommendation.OneYearTR)
//              ),
//              2286230, //BR23, 1xp from BR24
//              100, 100,
//              100,
//              1,7,7,
//              100,100,
//              48,4,
//              BattleRankFieldData(12,16,24,52,56,104,108,Some(112),Some(164),Some(168),Some(3),Some(1),Some(193),Some(48),Some(0),Some(0),None),
//              List("xpe_battle_rank_8"),
//              List(),
//              Some(
//                InventoryData(List(
//                  InternalSlot(32,PlanetSideGUID(363),0,DetailedACEData(8)),
//                  InternalSlot(728,PlanetSideGUID(364),1,DetailedREKData(8)),
//                  InternalSlot(706,PlanetSideGUID(365),2,DetailedWeaponData(4,8,List(InternalSlot(28,PlanetSideGUID(366),0,DetailedAmmoBoxData(8,30)), InternalSlot(413,PlanetSideGUID(367),1,DetailedAmmoBoxData(8,1))))(2)),
//                  InternalSlot(324,PlanetSideGUID(368),4,DetailedWeaponData(4,8,List(InternalSlot(540,PlanetSideGUID(369),0,DetailedAmmoBoxData(8,1)))))
//                ))
//              ),
//              DrawnSlot.None
//            )
