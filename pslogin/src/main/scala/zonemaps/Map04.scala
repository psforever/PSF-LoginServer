...
object Map04 {
  ...
  val ZoneMap = new ZoneMap("map04") {
    ...
    def Building8(): Unit = { // Name: Enkidu Type: amp_station GUID: 1, MapID: 8
      ...
      LocalObject(1885, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3301.713f, 3491.774f, 35.13554f), Vector3(0, 0, 46)), owning_building_guid = 1, terminal_guid = 3069)
    ...
    def Building15(): Unit = { // Name: Neti Type: comm_station GUID: 18, MapID: 15
      ...
      LocalObject(1887, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4056.803f, 2507.361f, 78.67047f), Vector3(0, 0, -40)), owning_building_guid = 18, terminal_guid = 3071)
    ...
    def Building11(): Unit = { // Name: Irkalla Type: comm_station GUID: 21, MapID: 11
      ...
      LocalObject(1892, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4834.85f, 5185.569f, 64.50593f), Vector3(0, 0, 47)), owning_building_guid = 21, terminal_guid = 3074)
    ...
    def Building5(): Unit = { // Name: Akkan Type: comm_station_dsp GUID: 24, MapID: 5
      ...
      LocalObject(282, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(2762.328f, 4448.856f, 39.32722f), Vector3(0, 0, 90)), owning_building_guid = 24, terminal_guid = 283)
      ...
      LocalObject(1881, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2711.786f, 4418.411f, 37.92823f), Vector3(0, 0, 180)), owning_building_guid = 24, terminal_guid = 3067)
    ...
    def Building7(): Unit = { // Name: Dagon Type: cryo_facility GUID: 27, MapID: 7
      ...
      LocalObject(1880, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1762.234f, 5802.075f, 37.88553f), Vector3(0, 0, 92)), owning_building_guid = 27, terminal_guid = 3066)
    ...
    def Building10(): Unit = { // Name: Hanish Type: cryo_facility GUID: 30, MapID: 10
      ...
      LocalObject(1886, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3674.315f, 5459.119f, 86.77422f), Vector3(0, 0, 1)), owning_building_guid = 30, terminal_guid = 3070)
    ...
    def Building16(): Unit = { // Name: Zaqar Type: cryo_facility GUID: 33, MapID: 16
      ...
      LocalObject(1891, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4762.881f, 2064.315f, 72.69127f), Vector3(0, 0, -89)), owning_building_guid = 33, terminal_guid = 3073)
    ...
    def Building13(): Unit = { // Name: Lahar Type: cryo_facility GUID: 36, MapID: 13
      ...
      LocalObject(1896, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(7070.699f, 5376.181f, 36.00278f), Vector3(0, 0, 134)), owning_building_guid = 36, terminal_guid = 3076)
    ...
    def Building6(): Unit = { // Name: Baal Type: tech_plant GUID: 42, MapID: 6
      ...
      LocalObject(1877, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(924.1434f, 5472.034f, 84.932f), Vector3(0, 0, 135)), owning_building_guid = 42, terminal_guid = 172)
      LocalObject(173, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 42)
      LocalObject(1878, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(939.0054f, 5486.896f, 84.932f), Vector3(0, 0, 135)), owning_building_guid = 42, terminal_guid = 173)
      ...
      LocalObject(1879, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(955.0065f, 5538.954f, 49.891f), Vector3(0, 0, 135)), owning_building_guid = 42, terminal_guid = 3065)
    ...
    def Building14(): Unit = { // Name: Marduk Type: tech_plant GUID: 45, MapID: 14
      ...
      LocalObject(1883, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3131.468f, 2212.988f, 83.09319f), Vector3(0, 0, 91)), owning_building_guid = 45, terminal_guid = 174)
      LocalObject(175, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 45)
      LocalObject(1884, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3131.834f, 2234.003f, 83.09319f), Vector3(0, 0, 91)), owning_building_guid = 45, terminal_guid = 175)
      ...
      LocalObject(1882, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3107.182f, 2282.565f, 48.05219f), Vector3(0, 0, 91)), owning_building_guid = 45, terminal_guid = 3068)
    ...
    def Building9(): Unit = { // Name: Girru Type: tech_plant GUID: 48, MapID: 9
      ...
      LocalObject(1889, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4385.925f, 5927.835f, 90.10956f), Vector3(0, 0, 2)), owning_building_guid = 48, terminal_guid = 176)
      LocalObject(177, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 48)
      LocalObject(1890, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4406.93f, 5927.102f, 90.10956f), Vector3(0, 0, 2)), owning_building_guid = 48, terminal_guid = 177)
      ...
      LocalObject(1888, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4336.939f, 5904.034f, 55.06856f), Vector3(0, 0, 2)), owning_building_guid = 48, terminal_guid = 3072)
    ...
    def Building12(): Unit = { // Name: Kusag Type: tech_plant GUID: 51, MapID: 12
      ...
      LocalObject(1893, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6546.232f, 4590.508f, 58.17188f), Vector3(0, 0, 219)), owning_building_guid = 51, terminal_guid = 178)
      LocalObject(179, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 51)
      LocalObject(1894, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6562.567f, 4577.281f, 58.17188f), Vector3(0, 0, 219)), owning_building_guid = 51, terminal_guid = 179)
      ...
      LocalObject(1895, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6616.012f, 4566.809f, 23.13088f), Vector3(0, 0, 219)), owning_building_guid = 51, terminal_guid = 3075)
