...
object Map06 {
  ...
  val ZoneMap = new ZoneMap("map06") {
    ...
    def Building1(): Unit = { // Name: Akna Type: amp_station GUID: 1, MapID: 1
      ...
      LocalObject(1480, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4425.146f, 3819.608f, 216.8529f), Vector3(0, 0, 228)), owning_building_guid = 1, terminal_guid = 2420)
    ...
    def Building4(): Unit = { // Name: Keelut Type: comm_station GUID: 17, MapID: 4
      ...
      LocalObject(1477, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3753.934f, 1916.22f, 263.8428f), Vector3(0, 0, 1)), owning_building_guid = 17, terminal_guid = 2417)
    ...
    def Building2(): Unit = { // Name: Anguta Type: comm_station_dsp GUID: 20, MapID: 2
      ...
      LocalObject(223, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(4012.328f, 4364.856f, 266.4719f), Vector3(0, 0, 90)), owning_building_guid = 20, terminal_guid = 224)
      ...
      LocalObject(1479, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3961.786f, 4334.411f, 265.0728f), Vector3(0, 0, 180)), owning_building_guid = 20, terminal_guid = 2419)
    ...
    def Building8(): Unit = { // Name: Tarqaq Type: cryo_facility GUID: 23, MapID: 8
      ...
      LocalObject(1470, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2922.14f, 2263.093f, 235.3643f), Vector3(0, 0, 52)), owning_building_guid = 23, terminal_guid = 2414)
    ...
    def Building7(): Unit = { // Name: Sedna Type: cryo_facility GUID: 26, MapID: 7
      ...
      LocalObject(1478, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3959.119f, 5287.685f, 230.3755f), Vector3(0, 0, 91)), owning_building_guid = 26, terminal_guid = 2418)
    ...
    def Building9(): Unit = { // Name: Tootega Type: cryo_facility GUID: 29, MapID: 9
      ...
      LocalObject(1481, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5043.152f, 3272.91f, 215.2079f), Vector3(0, 0, -1)), owning_building_guid = 29, terminal_guid = 2421)
    ...
    def Building3(): Unit = { // Name: Igaluk Type: tech_plant GUID: 36, MapID: 3
      ...
      LocalObject(1472, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3315.468f, 5734.988f, 247.0087f), Vector3(0, 0, 91)), owning_building_guid = 36, terminal_guid = 140)
      LocalObject(141, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 36)
      LocalObject(1473, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3315.834f, 5756.003f, 247.0087f), Vector3(0, 0, 91)), owning_building_guid = 36, terminal_guid = 141)
      ...
      LocalObject(1471, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3291.182f, 5804.565f, 211.9677f), Vector3(0, 0, 91)), owning_building_guid = 36, terminal_guid = 2415)
    ...
    def Building5(): Unit = { // Name: Nerrivik Type: tech_plant GUID: 39, MapID: 5
      ...
      LocalObject(1474, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3623.737f, 3698.664f, 235.0033f), Vector3(0, 0, 137)), owning_building_guid = 39, terminal_guid = 142)
      LocalObject(143, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 39)
      LocalObject(1475, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3639.108f, 3712.998f, 235.0033f), Vector3(0, 0, 137)), owning_building_guid = 39, terminal_guid = 143)
      ...
      LocalObject(1476, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3656.917f, 3764.466f, 199.9623f), Vector3(0, 0, 137)), owning_building_guid = 39, terminal_guid = 2416)
    ...
    def Building6(): Unit = { // Name: Pinga Type: tech_plant GUID: 42, MapID: 6
      ...
      LocalObject(1482, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5864.165f, 3444.07f, 108.9877f), Vector3(0, 0, -90)), owning_building_guid = 42, terminal_guid = 144)
      LocalObject(145, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 42)
      LocalObject(1483, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5864.165f, 3465.088f, 108.9877f), Vector3(0, 0, -90)), owning_building_guid = 42, terminal_guid = 145)
      ...
      LocalObject(1484, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5889.661f, 3395.945f, 73.94666f), Vector3(0, 0, -90)), owning_building_guid = 42, terminal_guid = 2422)
