...
object Map99 {
  ...
  val ZoneMap = new ZoneMap("map99") {
    ...
    def Building7(): Unit = { // Name: Blue_Base Type: amp_station GUID: 1, MapID: 7
      ...
      LocalObject(494, VehicleSpawnPad.Constructor(Vector3(2764.84f, 2773.572f, 86.48452f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 778)
    ...
    def Building8(): Unit = { // Name: Indigo_Base Type: comm_station GUID: 15, MapID: 8
      ...
      LocalObject(493, VehicleSpawnPad.Constructor(Vector3(1449.956f, 1287.172f, 87.26411f), Vector3(0f, 0f, 0f)), owning_building_guid = 15, terminal_guid = 777)
    ...
    def Building18(): Unit = { // Name: Red_Base Type: cryo_facility GUID: 18, MapID: 18
      ...
      LocalObject(492, VehicleSpawnPad.Constructor(Vector3(1310.6f, 2464.909f, 86.13828f), Vector3(0f, 0f, 0f)), owning_building_guid = 18, terminal_guid = 776)
