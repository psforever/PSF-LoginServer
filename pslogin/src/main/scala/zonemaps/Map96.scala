...
object Map96 {
  ...
  val ZoneMap = new ZoneMap("map96") {
    ...
    def Building1(): Unit = { // Name: Nexus_Base Type: comm_station_dsp GUID: 1, MapID: 1
      ...
      LocalObject(24, VehicleSpawnPad.Constructor(Vector3(1990.328f, 2064.856f, 35.74076f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 25)
      ...
      LocalObject(200, VehicleSpawnPad.Constructor(Vector3(1939.786f, 2034.411f, 34.34176f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 318)
