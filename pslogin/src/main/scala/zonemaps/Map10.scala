...
object Map10 {
  ...
  val ZoneMap = new ZoneMap("map10") {
    ...
    def Building13(): Unit = { // Name: Sungrey Type: amp_station GUID: 1, MapID: 13
      ...
      LocalObject(1632, VehicleSpawnPad.Constructor(Vector3(4616.341f, 5499.374f, 70.00238f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 2651)
    ...
    def Building49(): Unit = { // Name: Verica Type: amp_station GUID: 4, MapID: 49
      ...
      LocalObject(1634, VehicleSpawnPad.Constructor(Vector3(4970.835f, 3581.835f, 45.21432f), Vector3(0f, 0f, 0f)), owning_building_guid = 4, terminal_guid = 2653)
    ...
    def Building6(): Unit = { // Name: Cetan Type: comm_station GUID: 18, MapID: 6
      ...
      LocalObject(1625, VehicleSpawnPad.Constructor(Vector3(3496.973f, 2610.949f, 46.69231f), Vector3(0f, 0f, 0f)), owning_building_guid = 18, terminal_guid = 2648)
    ...
    def Building12(): Unit = { // Name: Qumu Type: comm_station GUID: 21, MapID: 12
      ...
      LocalObject(1626, VehicleSpawnPad.Constructor(Vector3(3893.992f, 5238.266f, 45.06975f), Vector3(0f, 0f, 0f)), owning_building_guid = 21, terminal_guid = 2649)
    ...
    def Building5(): Unit = { // Name: Azeban Type: comm_station_dsp GUID: 24, MapID: 5
      ...
      LocalObject(255, VehicleSpawnPad.Constructor(Vector3(6328.328f, 5358.856f, 61.91016f), Vector3(0f, 0f, 0f)), owning_building_guid = 24, terminal_guid = 256)
      ...
      LocalObject(1639, VehicleSpawnPad.Constructor(Vector3(6277.786f, 5328.411f, 60.51116f), Vector3(0f, 0f, 0f)), owning_building_guid = 24, terminal_guid = 2656)
    ...
    def Building8(): Unit = { // Name: Ikanam Type: cryo_facility GUID: 27, MapID: 8
      ...
      LocalObject(1623, VehicleSpawnPad.Constructor(Vector3(2717.989f, 2288.724f, 55.24944f), Vector3(0f, 0f, 0f)), owning_building_guid = 27, terminal_guid = 2646)
    ...
    def Building11(): Unit = { // Name: Onatha Type: cryo_facility GUID: 30, MapID: 11
      ...
      LocalObject(1624, VehicleSpawnPad.Constructor(Vector3(3373.989f, 5668.724f, 46.05167f), Vector3(0f, 0f, 0f)), owning_building_guid = 30, terminal_guid = 2647)
    ...
    def Building9(): Unit = { // Name: Kyoi Type: cryo_facility GUID: 33, MapID: 9
      ...
      LocalObject(1635, VehicleSpawnPad.Constructor(Vector3(5620.075f, 2253.766f, 60.46901f), Vector3(0f, 0f, 0f)), owning_building_guid = 33, terminal_guid = 2654)
    ...
    def Building15(): Unit = { // Name: Xelas Type: cryo_facility GUID: 36, MapID: 15
      ...
      LocalObject(1640, VehicleSpawnPad.Constructor(Vector3(6711.131f, 4393.475f, 54.45771f), Vector3(0f, 0f, 0f)), owning_building_guid = 36, terminal_guid = 2657)
    ...
    def Building7(): Unit = { // Name: Heyoka Type: tech_plant GUID: 43, MapID: 7
      ...
      LocalObject(1628, VehicleSpawnPad.Constructor(Vector3(4298.07f, 2399.835f, 60.07214f), Vector3(0f, 0f, 0f)), owning_building_guid = 43, terminal_guid = 145)
      LocalObject(146, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 43)
      LocalObject(1629, VehicleSpawnPad.Constructor(Vector3(4319.088f, 2399.835f, 60.07214f), Vector3(0f, 0f, 0f)), owning_building_guid = 43, terminal_guid = 146)
      ...
      LocalObject(1627, VehicleSpawnPad.Constructor(Vector3(4249.945f, 2374.339f, 25.03114f), Vector3(0f, 0f, 0f)), owning_building_guid = 43, terminal_guid = 2650)
    ...
    def Building14(): Unit = { // Name: Tumas Type: tech_plant GUID: 46, MapID: 14
      ...
      LocalObject(1630, VehicleSpawnPad.Constructor(Vector3(4614.166f, 6291.997f, 82.00605f), Vector3(0f, 0f, 0f)), owning_building_guid = 46, terminal_guid = 147)
      LocalObject(148, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 46)
      LocalObject(1631, VehicleSpawnPad.Constructor(Vector3(4614.532f, 6313.012f, 82.00605f), Vector3(0f, 0f, 0f)), owning_building_guid = 46, terminal_guid = 148)
      ...
      LocalObject(1633, VehicleSpawnPad.Constructor(Vector3(4638.818f, 6243.435f, 46.96505f), Vector3(0f, 0f, 0f)), owning_building_guid = 46, terminal_guid = 2652)
    ...
    def Building10(): Unit = { // Name: Mekala Type: tech_plant GUID: 49, MapID: 10
      ...
      LocalObject(1637, VehicleSpawnPad.Constructor(Vector3(5986.07f, 2997.835f, 71.41052f), Vector3(0f, 0f, 0f)), owning_building_guid = 49, terminal_guid = 149)
      LocalObject(150, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 49)
      LocalObject(1638, VehicleSpawnPad.Constructor(Vector3(6007.088f, 2997.835f, 71.41052f), Vector3(0f, 0f, 0f)), owning_building_guid = 49, terminal_guid = 150)
      ...
      LocalObject(1636, VehicleSpawnPad.Constructor(Vector3(5937.945f, 2972.339f, 36.36952f), Vector3(0f, 0f, 0f)), owning_building_guid = 49, terminal_guid = 2655)
