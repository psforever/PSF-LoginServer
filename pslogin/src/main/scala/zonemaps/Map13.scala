...
object Map13 {
  ...
  val ZoneMap = new ZoneMap("map13") {
    ...
    def Building22(): Unit = { // Name: Hart_Ishundar Type: orbital_building_vs GUID: 1, MapID: 22
      ...
      LocalObject(168, Terminal.Constructor(Vector3(2910.617f, 4842.381f, 68.58539f), cert_terminal), owning_building_guid = 1)
      LocalObject(169, Terminal.Constructor(Vector3(2910.617f, 4846.259f, 68.58539f), cert_terminal), owning_building_guid = 1)
      LocalObject(170, Terminal.Constructor(Vector3(2910.617f, 4850.131f, 68.58539f), cert_terminal), owning_building_guid = 1)
      LocalObject(171, Terminal.Constructor(Vector3(2910.629f, 4818.056f, 68.58539f), cert_terminal), owning_building_guid = 1)
      LocalObject(172, Terminal.Constructor(Vector3(2910.629f, 4821.959f, 68.58539f), cert_terminal), owning_building_guid = 1)
      LocalObject(173, Terminal.Constructor(Vector3(2910.629f, 4825.797f, 68.58539f), cert_terminal), owning_building_guid = 1)
      ...
      LocalObject(810, Terminal.Constructor(Vector3(3035.515f, 4837.817f, 69.88239f), order_terminal), owning_building_guid = 1)
      LocalObject(811, Terminal.Constructor(Vector3(3035.515f, 4840.738f, 69.88239f), order_terminal), owning_building_guid = 1)
      LocalObject(812, Terminal.Constructor(Vector3(3035.522f, 4827.265f, 69.88239f), order_terminal), owning_building_guid = 1)
      LocalObject(813, Terminal.Constructor(Vector3(3035.522f, 4830.166f, 69.88239f), order_terminal), owning_building_guid = 1)
      ...
      LocalObject(774, ProximityTerminal.Constructor(Vector3(2907.307f, 4856.855f, 58.57639f), medical_terminal), owning_building_guid = 1)
      LocalObject(775, ProximityTerminal.Constructor(Vector3(2907.369f, 4811.151f, 58.57639f), medical_terminal), owning_building_guid = 1)
    ...
    def Building4(): Unit = { // Name: Hart_Esamir Type: orbital_building_vs GUID: 2, MapID: 4
      ...
      LocalObject(192, Terminal.Constructor(Vector3(3620.617f, 2816.381f, 103.3531f), cert_terminal), owning_building_guid = 2)
      LocalObject(193, Terminal.Constructor(Vector3(3620.617f, 2820.259f, 103.3531f), cert_terminal), owning_building_guid = 2)
      LocalObject(194, Terminal.Constructor(Vector3(3620.617f, 2824.131f, 103.3531f), cert_terminal), owning_building_guid = 2)
      LocalObject(195, Terminal.Constructor(Vector3(3620.629f, 2792.056f, 103.3531f), cert_terminal), owning_building_guid = 2)
      LocalObject(196, Terminal.Constructor(Vector3(3620.629f, 2795.959f, 103.3531f), cert_terminal), owning_building_guid = 2)
      LocalObject(197, Terminal.Constructor(Vector3(3620.629f, 2799.797f, 103.3531f), cert_terminal), owning_building_guid = 2)
      ...
      LocalObject(863, Terminal.Constructor(Vector3(3745.515f, 2811.817f, 104.6501f), order_terminal), owning_building_guid = 2)
      LocalObject(864, Terminal.Constructor(Vector3(3745.515f, 2814.738f, 104.6501f), order_terminal), owning_building_guid = 2)
      LocalObject(865, Terminal.Constructor(Vector3(3745.522f, 2801.265f, 104.6501f), order_terminal), owning_building_guid = 2)
      LocalObject(866, Terminal.Constructor(Vector3(3745.522f, 2804.166f, 104.6501f), order_terminal), owning_building_guid = 2)
    ...
    def Building40(): Unit = { // Name: Hart_Hossin Type: orbital_building_vs GUID: 3, MapID: 40
      ...
      LocalObject(216, Terminal.Constructor(Vector3(5542.617f, 4246.381f, 115.7289f), cert_terminal), owning_building_guid = 3)
      LocalObject(217, Terminal.Constructor(Vector3(5542.617f, 4250.259f, 115.7289f), cert_terminal), owning_building_guid = 3)
      LocalObject(218, Terminal.Constructor(Vector3(5542.617f, 4254.131f, 115.7289f), cert_terminal), owning_building_guid = 3)
      LocalObject(219, Terminal.Constructor(Vector3(5542.629f, 4222.056f, 115.7289f), cert_terminal), owning_building_guid = 3)
      LocalObject(220, Terminal.Constructor(Vector3(5542.629f, 4225.959f, 115.7289f), cert_terminal), owning_building_guid = 3)
      LocalObject(221, Terminal.Constructor(Vector3(5542.629f, 4229.797f, 115.7289f), cert_terminal), owning_building_guid = 3)
      ...
      LocalObject(916, Terminal.Constructor(Vector3(5667.515f, 4241.817f, 117.0259f), order_terminal), owning_building_guid = 3)
      LocalObject(917, Terminal.Constructor(Vector3(5667.515f, 4244.738f, 117.0259f), order_terminal), owning_building_guid = 3)
      LocalObject(918, Terminal.Constructor(Vector3(5667.522f, 4231.265f, 117.0259f), order_terminal), owning_building_guid = 3)
      LocalObject(919, Terminal.Constructor(Vector3(5667.522f, 4234.166f, 117.0259f), order_terminal), owning_building_guid = 3)
      ...
      LocalObject(782, ProximityTerminal.Constructor(Vector3(5539.307f, 4260.855f, 105.7199f), medical_terminal), owning_building_guid = 3)
      LocalObject(783, ProximityTerminal.Constructor(Vector3(5539.369f, 4215.151f, 105.7199f), medical_terminal), owning_building_guid = 3)
    ...
    def Building34(): Unit = { // Name: VT_building_vs Type: VT_building_vs GUID: 40, MapID: 34
      ...
      LocalObject(826, Terminal.Constructor(Vector3(3143.942f, 4884.338f, 57.44539f), order_terminal), owning_building_guid = 40)
      LocalObject(827, Terminal.Constructor(Vector3(3143.989f, 4865.301f, 57.44539f), order_terminal), owning_building_guid = 40)
    ...
    def Building49(): Unit = { // Name: VT_building_vs Type: VT_building_vs GUID: 45, MapID: 49
      ...
      LocalObject(894, Terminal.Constructor(Vector3(5493.942f, 4348.338f, 104.592f), order_terminal), owning_building_guid = 45)
      LocalObject(895, Terminal.Constructor(Vector3(5493.989f, 4329.301f, 104.592f), order_terminal), owning_building_guid = 45)
