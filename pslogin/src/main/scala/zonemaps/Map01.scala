...
object Map01 {
  ...
  val ZoneMap = new ZoneMap("map01") {
    ...
    def Building10(): Unit = { // Name: Mont Type: amp_station GUID: 1, MapID: 10
      ...
      LocalObject(1338, Terminal.Constructor(Vector3(3369.105f, 4319.66f, 84.27689f), order_terminal), owning_building_guid = 1)
      LocalObject(1339, Terminal.Constructor(Vector3(3380.51f, 4310.106f, 77.03789f), order_terminal), owning_building_guid = 1)
      LocalObject(1340, Terminal.Constructor(Vector3(3382.319f, 4306.843f, 77.03789f), order_terminal), owning_building_guid = 1)
      LocalObject(1341, Terminal.Constructor(Vector3(3384.156f, 4303.529f, 77.03789f), order_terminal), owning_building_guid = 1)
      LocalObject(1342, Terminal.Constructor(Vector3(3390.899f, 4280.342f, 84.27689f), order_terminal), owning_building_guid = 1)
      LocalObject(1343, Terminal.Constructor(Vector3(3399.648f, 4310.896f, 84.27689f), order_terminal), owning_building_guid = 1)
      LocalObject(1906, Terminal.Constructor(Vector3(3382.632f, 4306.604f, 89.47588f), spawn_terminal), owning_building_guid = 1)
      LocalObject(1907, Terminal.Constructor(Vector3(3390.458f, 4320.383f, 77.58189f), spawn_terminal), owning_building_guid = 1)
      LocalObject(1908, Terminal.Constructor(Vector3(3393.997f, 4314.007f, 77.58189f), spawn_terminal), owning_building_guid = 1)
      LocalObject(1909, Terminal.Constructor(Vector3(3397.528f, 4307.631f, 77.58189f), spawn_terminal), owning_building_guid = 1)
      LocalObject(1910, Terminal.Constructor(Vector3(3408.411f, 4298.13f, 69.50488f), spawn_terminal), owning_building_guid = 1)
      ...
      LocalObject(1299, ProximityTerminal.Constructor(Vector3(3375.339f, 4290.991f, 67.94788f), medical_terminal), owning_building_guid = 1)
      LocalObject(1300, ProximityTerminal.Constructor(Vector3(3399.281f, 4310.694f, 87.94788f), medical_terminal), owning_building_guid = 1)
      LocalObject(1480, ProximityTerminal.Constructor(Vector3(3327.2f, 4293.409f, 91.25288f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(1481, Terminal.Constructor(Vector3(3327.2f, 4293.409f, 91.25288f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1483, ProximityTerminal.Constructor(Vector3(3337.111f, 4360.257f, 91.27589f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(1484, Terminal.Constructor(Vector3(3337.111f, 4360.257f, 91.27589f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1486, ProximityTerminal.Constructor(Vector3(3384.572f, 4236.892f, 93.41389f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(1487, Terminal.Constructor(Vector3(3384.572f, 4236.892f, 93.41389f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1489, ProximityTerminal.Constructor(Vector3(3439.656f, 4310.462f, 91.25288f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(1490, Terminal.Constructor(Vector3(3439.656f, 4310.462f, 91.25288f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1737, ProximityTerminal.Constructor(Vector3(3325.68f, 4269.44f, 82.14789f), repair_silo), owning_building_guid = 1)
      LocalObject(1738, Terminal.Constructor(Vector3(3325.68f, 4269.44f, 82.14789f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1741, ProximityTerminal.Constructor(Vector3(3441.406f, 4333.806f, 82.14789f), repair_silo), owning_building_guid = 1)
      LocalObject(1742, Terminal.Constructor(Vector3(3441.406f, 4333.806f, 82.14789f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1219, FacilityTurret.Constructor(Vector3(3269.344f, 4349.394f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1219, 5000)
      LocalObject(1220, FacilityTurret.Constructor(Vector3(3334.443f, 4227.359f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1220, 5001)
      LocalObject(1221, FacilityTurret.Constructor(Vector3(3350.346f, 4396.83f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1221, 5002)
      LocalObject(1222, FacilityTurret.Constructor(Vector3(3367.111f, 4172.999f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1222, 5003)
      LocalObject(1223, FacilityTurret.Constructor(Vector3(3403.542f, 4423.77f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1223, 5004)
      LocalObject(1224, FacilityTurret.Constructor(Vector3(3501.342f, 4247.393f, 91.45589f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(1224, 5005)
      LocalObject(1616, Painbox.Constructor(Vector3(3429.009f, 4335.035f, 72.81889f), painbox), owning_building_guid = 1)
      LocalObject(1625, Painbox.Constructor(Vector3(3390.156f, 4307.246f, 80.39629f), painbox_continuous), owning_building_guid = 1)
      LocalObject(1634, Painbox.Constructor(Vector3(3417.756f, 4326.366f, 69.40689f), painbox_door_radius), owning_building_guid = 1)
    ...
    def Building6(): Unit = { // Name: Bastet Type: amp_station GUID: 4, MapID: 6
      ...
      LocalObject(1404, Terminal.Constructor(Vector3(5323.533f, 5517.996f, 57.96383f), order_terminal), owning_building_guid = 4)
      LocalObject(1405, Terminal.Constructor(Vector3(5340.654f, 5509.408f, 50.72483f), order_terminal), owning_building_guid = 4)
      LocalObject(1406, Terminal.Constructor(Vector3(5340.654f, 5513.139f, 50.72483f), order_terminal), owning_building_guid = 4)
      LocalObject(1407, Terminal.Constructor(Vector3(5340.654f, 5516.928f, 50.72483f), order_terminal), owning_building_guid = 4)
      LocalObject(1408, Terminal.Constructor(Vector3(5345.998f, 5495.523f, 57.96383f), order_terminal), owning_building_guid = 4)
      LocalObject(1409, Terminal.Constructor(Vector3(5345.998f, 5540.477f, 57.96383f), order_terminal), owning_building_guid = 4)
      LocalObject(1953, Terminal.Constructor(Vector3(5298.058f, 5557.409f, 50.69183f), spawn_terminal), owning_building_guid = 4)
      LocalObject(1954, Terminal.Constructor(Vector3(5322.058f, 5533.409f, 43.19183f), spawn_terminal), owning_building_guid = 4)
      LocalObject(1955, Terminal.Constructor(Vector3(5326.967f, 5512.535f, 51.26883f), spawn_terminal), owning_building_guid = 4)
      LocalObject(1956, Terminal.Constructor(Vector3(5326.971f, 5505.243f, 51.26883f), spawn_terminal), owning_building_guid = 4)
      LocalObject(1957, Terminal.Constructor(Vector3(5326.97f, 5519.823f, 51.26883f), spawn_terminal), owning_building_guid = 4)
      ...
      LocalObject(1310, ProximityTerminal.Constructor(Vector3(5323.952f, 5517.994f, 61.63483f), medical_terminal), owning_building_guid = 4)
      LocalObject(1311, ProximityTerminal.Constructor(Vector3(5354.444f, 5523.62f, 41.63483f), medical_terminal), owning_building_guid = 4)
      LocalObject(1567, ProximityTerminal.Constructor(Vector3(5288.752f, 5537.771f, 64.93983f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(1568, Terminal.Constructor(Vector3(5288.752f, 5537.771f, 64.93983f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1570, ProximityTerminal.Constructor(Vector3(5354.298f, 5444.505f, 64.96283f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(1571, Terminal.Constructor(Vector3(5354.298f, 5444.505f, 64.96283f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1573, ProximityTerminal.Constructor(Vector3(5372.597f, 5575.412f, 67.10083f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(1574, Terminal.Constructor(Vector3(5372.597f, 5575.412f, 67.10083f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1576, ProximityTerminal.Constructor(Vector3(5395.375f, 5498.167f, 64.93983f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(1577, Terminal.Constructor(Vector3(5395.375f, 5498.167f, 64.93983f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1793, ProximityTerminal.Constructor(Vector3(5275.903f, 5518.204f, 55.83483f), repair_silo), owning_building_guid = 4)
      LocalObject(1794, Terminal.Constructor(Vector3(5275.903f, 5518.204f, 55.83483f), ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(1797, ProximityTerminal.Constructor(Vector3(5408.325f, 5518.393f, 55.83483f), repair_silo), owning_building_guid = 4)
      LocalObject(1798, Terminal.Constructor(Vector3(5408.325f, 5518.393f, 55.83483f), ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(1272, FacilityTurret.Constructor(Vector3(5265.376f, 5622.839f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1272, 5006)
      LocalObject(1273, FacilityTurret.Constructor(Vector3(5265.405f, 5421.162f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1273, 5007)
      LocalObject(1274, FacilityTurret.Constructor(Vector3(5324.992f, 5418.934f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1274, 5008)
      LocalObject(1275, FacilityTurret.Constructor(Vector3(5418.835f, 5421.152f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1275, 5009)
      LocalObject(1276, FacilityTurret.Constructor(Vector3(5418.844f, 5622.829f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1276, 5010)
      LocalObject(1277, FacilityTurret.Constructor(Vector3(5421.062f, 5559.447f, 65.14282f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(1277, 5011)
      LocalObject(1623, Painbox.Constructor(Vector3(5286.151f, 5511.117f, 46.50583f), painbox), owning_building_guid = 4)
      LocalObject(1632, Painbox.Constructor(Vector3(5333.604f, 5516.586f, 54.08323f), painbox_continuous), owning_building_guid = 4)
      LocalObject(1641, Painbox.Constructor(Vector3(5300.195f, 5513.244f, 43.09383f), painbox_door_radius), owning_building_guid = 4)
    ...
    def Building8(): Unit = { // Name: Hapi Type: comm_station GUID: 16, MapID: 8
      ...
      LocalObject(1367, Terminal.Constructor(Vector3(4251.19f, 4508.786f, 65.74149f), order_terminal), owning_building_guid = 16)
      LocalObject(1368, Terminal.Constructor(Vector3(4268.877f, 4505.196f, 73.13649f), order_terminal), owning_building_guid = 16)
      LocalObject(1369, Terminal.Constructor(Vector3(4269.583f, 4508.208f, 73.13649f), order_terminal), owning_building_guid = 16)
      LocalObject(1370, Terminal.Constructor(Vector3(4272.684f, 4507.393f, 73.13649f), order_terminal), owning_building_guid = 16)
      LocalObject(1374, Terminal.Constructor(Vector3(4314.671f, 4475.836f, 50.97149f), order_terminal), owning_building_guid = 16)
      LocalObject(1375, Terminal.Constructor(Vector3(4317.902f, 4477.702f, 50.97149f), order_terminal), owning_building_guid = 16)
      LocalObject(1376, Terminal.Constructor(Vector3(4321.183f, 4479.596f, 50.97149f), order_terminal), owning_building_guid = 16)
      LocalObject(1926, Terminal.Constructor(Vector3(4254.443f, 4501.275f, 65.99849f), spawn_terminal), owning_building_guid = 16)
      LocalObject(1927, Terminal.Constructor(Vector3(4275.412f, 4530.201f, 43.43849f), spawn_terminal), owning_building_guid = 16)
      LocalObject(1928, Terminal.Constructor(Vector3(4304.222f, 4485.604f, 51.51549f), spawn_terminal), owning_building_guid = 16)
      LocalObject(1929, Terminal.Constructor(Vector3(4310.295f, 4532.483f, 53.43849f), spawn_terminal), owning_building_guid = 16)
      LocalObject(1930, Terminal.Constructor(Vector3(4310.535f, 4489.253f, 51.51549f), spawn_terminal), owning_building_guid = 16)
      ...
      LocalObject(1303, ProximityTerminal.Constructor(Vector3(4251.337f, 4496.763f, 59.38149f), medical_terminal), owning_building_guid = 16)
      LocalObject(1304, ProximityTerminal.Constructor(Vector3(4333.874f, 4471f, 41.88149f), medical_terminal), owning_building_guid = 16)
      LocalObject(1516, ProximityTerminal.Constructor(Vector3(4314.369f, 4555.914f, 67.62249f), pad_landing_frame), owning_building_guid = 16)
      LocalObject(1517, Terminal.Constructor(Vector3(4314.369f, 4555.914f, 67.62249f), air_rearm_terminal), owning_building_guid = 16)
      LocalObject(1761, ProximityTerminal.Constructor(Vector3(4265.53f, 4576.494f, 58.93149f), repair_silo), owning_building_guid = 16)
      LocalObject(1762, Terminal.Constructor(Vector3(4265.53f, 4576.494f, 58.93149f), ground_rearm_terminal), owning_building_guid = 16)
      LocalObject(1765, ProximityTerminal.Constructor(Vector3(4285.75f, 4446.452f, 58.93149f), repair_silo), owning_building_guid = 16)
      LocalObject(1766, Terminal.Constructor(Vector3(4285.75f, 4446.452f, 58.93149f), ground_rearm_terminal), owning_building_guid = 16)
      LocalObject(1243, FacilityTurret.Constructor(Vector3(4170.118f, 4534.522f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1243, 5012)
      LocalObject(1244, FacilityTurret.Constructor(Vector3(4220.754f, 4444.464f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1244, 5013)
      LocalObject(1245, FacilityTurret.Constructor(Vector3(4272.686f, 4595.045f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1245, 5014)
      LocalObject(1246, FacilityTurret.Constructor(Vector3(4279.664f, 4428.656f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1246, 5015)
      LocalObject(1249, FacilityTurret.Constructor(Vector3(4331.572f, 4579.246f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1249, 5016)
      LocalObject(1253, FacilityTurret.Constructor(Vector3(4382.079f, 4489.135f, 67.8895f), manned_turret), owning_building_guid = 16)
      TurretToWeapon(1253, 5017)
      LocalObject(1619, Painbox.Constructor(Vector3(4297.323f, 4547.246f, 46.78349f), painbox), owning_building_guid = 16)
      LocalObject(1628, Painbox.Constructor(Vector3(4321.771f, 4485.062f, 53.82629f), painbox_continuous), owning_building_guid = 16)
      LocalObject(1637, Painbox.Constructor(Vector3(4284.368f, 4539.652f, 44.64019f), painbox_door_radius), owning_building_guid = 16)
    ...
    def Building13(): Unit = { // Name: Sobek Type: comm_station_dsp GUID: 19, MapID: 13
      ...
      LocalObject(201, Terminal.Constructor(Vector3(3103.879f, 3188.918f, 80.2302f), dropship_vehicle_terminal), owning_building_guid = 19)
      LocalObject(200, VehicleSpawnPad.Constructor(Vector3(3112.328f, 3210.856f, 74.5542f), dropship_pad_doors, Vector3(0, 0, 90)), owning_building_guid = 19, terminal_guid = 201)
      LocalObject(1318, Terminal.Constructor(Vector3(3034.378f, 3062.897f, 80.9862f), order_terminal), owning_building_guid = 19)
      LocalObject(1319, Terminal.Constructor(Vector3(3044.075f, 3078.547f, 88.3812f), order_terminal), owning_building_guid = 19)
      LocalObject(1320, Terminal.Constructor(Vector3(3046.331f, 3076.43f, 88.3812f), order_terminal), owning_building_guid = 19)
      LocalObject(1321, Terminal.Constructor(Vector3(3046.332f, 3080.825f, 88.3812f), order_terminal), owning_building_guid = 19)
      LocalObject(1322, Terminal.Constructor(Vector3(3048.592f, 3078.59f, 88.3812f), order_terminal), owning_building_guid = 19)
      LocalObject(1323, Terminal.Constructor(Vector3(3094.654f, 3101.408f, 66.2162f), order_terminal), owning_building_guid = 19)
      LocalObject(1324, Terminal.Constructor(Vector3(3094.654f, 3105.139f, 66.2162f), order_terminal), owning_building_guid = 19)
      LocalObject(1325, Terminal.Constructor(Vector3(3094.654f, 3108.928f, 66.2162f), order_terminal), owning_building_guid = 19)
      LocalObject(1897, Terminal.Constructor(Vector3(3042.509f, 3061.959f, 81.2432f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1898, Terminal.Constructor(Vector3(3080.967f, 3104.535f, 66.7602f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1899, Terminal.Constructor(Vector3(3080.971f, 3097.243f, 66.7602f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1900, Terminal.Constructor(Vector3(3080.97f, 3111.823f, 66.7602f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1901, Terminal.Constructor(Vector3(3099.103f, 3180.906f, 81.1742f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1902, Terminal.Constructor(Vector3(3108.058f, 3085.409f, 58.6542f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1903, Terminal.Constructor(Vector3(3115.409f, 3141.942f, 58.6542f), spawn_terminal), owning_building_guid = 19)
      LocalObject(1904, Terminal.Constructor(Vector3(3124.058f, 3093.409f, 66.1832f), spawn_terminal), owning_building_guid = 19)
      ...
      LocalObject(1297, ProximityTerminal.Constructor(Vector3(3044.863f, 3057.013f, 74.6262f), medical_terminal), owning_building_guid = 19)
      LocalObject(1298, ProximityTerminal.Constructor(Vector3(3108.444f, 3115.62f, 57.1262f), medical_terminal), owning_building_guid = 19)
      LocalObject(1468, ProximityTerminal.Constructor(Vector3(3025.153f, 3179.398f, 82.9362f), pad_landing_frame), owning_building_guid = 19)
      LocalObject(1469, Terminal.Constructor(Vector3(3025.153f, 3179.398f, 82.9362f), air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1471, ProximityTerminal.Constructor(Vector3(3041.514f, 3133.467f, 80.2202f), pad_landing_frame), owning_building_guid = 19)
      LocalObject(1472, Terminal.Constructor(Vector3(3041.514f, 3133.467f, 80.2202f), air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1474, ProximityTerminal.Constructor(Vector3(3093.804f, 3097.901f, 87.4022f), pad_landing_frame), owning_building_guid = 19)
      LocalObject(1475, Terminal.Constructor(Vector3(3093.804f, 3097.901f, 87.4022f), air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1477, ProximityTerminal.Constructor(Vector3(3129.071f, 3114.159f, 82.9492f), pad_landing_frame), owning_building_guid = 19)
      LocalObject(1478, Terminal.Constructor(Vector3(3129.071f, 3114.159f, 82.9492f), air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1729, ProximityTerminal.Constructor(Vector3(2982.642f, 3124.24f, 74.2762f), repair_silo), owning_building_guid = 19)
      LocalObject(1730, Terminal.Constructor(Vector3(2982.642f, 3124.24f, 74.2762f), ground_rearm_terminal), owning_building_guid = 19)
      LocalObject(1733, ProximityTerminal.Constructor(Vector3(3152.57f, 3127.152f, 74.2762f), repair_silo), owning_building_guid = 19)
      LocalObject(1734, Terminal.Constructor(Vector3(3152.57f, 3127.152f, 74.2762f), ground_rearm_terminal), owning_building_guid = 19)
      LocalObject(1205, FacilityTurret.Constructor(Vector3(2970.401f, 3159.113f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1205, 5018)
      LocalObject(1206, FacilityTurret.Constructor(Vector3(2971.554f, 3005.565f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1206, 5019)
      LocalObject(1207, FacilityTurret.Constructor(Vector3(3015.445f, 3205.667f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1207, 5020)
      LocalObject(1208, FacilityTurret.Constructor(Vector3(3074.428f, 3004.396f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1208, 5021)
      LocalObject(1209, FacilityTurret.Constructor(Vector3(3075.449f, 3264.154f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1209, 5022)
      LocalObject(1211, FacilityTurret.Constructor(Vector3(3116.537f, 3045.011f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1211, 5023)
      LocalObject(1215, FacilityTurret.Constructor(Vector3(3163.619f, 3262.985f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1215, 5024)
      LocalObject(1216, FacilityTurret.Constructor(Vector3(3164.773f, 3094.733f, 83.1342f), manned_turret), owning_building_guid = 19)
      TurretToWeapon(1216, 5025)
      LocalObject(1615, Painbox.Constructor(Vector3(3072.428f, 3146.057f, 61.0205f), painbox), owning_building_guid = 19)
      LocalObject(1624, Painbox.Constructor(Vector3(3089.857f, 3106.408f, 68.6537f), painbox_continuous), owning_building_guid = 19)
      LocalObject(1633, Painbox.Constructor(Vector3(3086.203f, 3144.915f, 60.2584f), painbox_door_radius), owning_building_guid = 19)
    ...
    def Building12(): Unit = { // Name: Horus Type: cryo_facility GUID: 22, MapID: 12
      ...
      LocalObject(161, Terminal.Constructor(Vector3(3735.192f, 2137.559f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(162, Terminal.Constructor(Vector3(3736.299f, 2150.211f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(163, Terminal.Constructor(Vector3(3736.509f, 2135.991f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(164, Terminal.Constructor(Vector3(3737.868f, 2151.527f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(165, Terminal.Constructor(Vector3(3743.806f, 2135.352f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(166, Terminal.Constructor(Vector3(3745.165f, 2150.889f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(167, Terminal.Constructor(Vector3(3745.375f, 2136.669f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(168, Terminal.Constructor(Vector3(3746.481f, 2149.32f, 62.88651f), cert_terminal), owning_building_guid = 22)
      LocalObject(1347, Terminal.Constructor(Vector3(3695.754f, 2138.771f, 64.48651f), order_terminal), owning_building_guid = 22)
      LocalObject(1348, Terminal.Constructor(Vector3(3699.471f, 2138.446f, 64.48651f), order_terminal), owning_building_guid = 22)
      LocalObject(1349, Terminal.Constructor(Vector3(3700.364f, 2167.16f, 74.19151f), order_terminal), owning_building_guid = 22)
      LocalObject(1350, Terminal.Constructor(Vector3(3703.245f, 2138.116f, 64.48651f), order_terminal), owning_building_guid = 22)
      LocalObject(1912, Terminal.Constructor(Vector3(3635.028f, 2178.961f, 67.00951f), spawn_terminal), owning_building_guid = 22)
      LocalObject(1913, Terminal.Constructor(Vector3(3676.245f, 2157.291f, 74.47552f), spawn_terminal), owning_building_guid = 22)
      LocalObject(1914, Terminal.Constructor(Vector3(3692.797f, 2152.765f, 65.03052f), spawn_terminal), owning_building_guid = 22)
      LocalObject(1915, Terminal.Constructor(Vector3(3692.896f, 2197.899f, 64.50951f), spawn_terminal), owning_building_guid = 22)
      LocalObject(1916, Terminal.Constructor(Vector3(3700.062f, 2152.134f, 65.03052f), spawn_terminal), owning_building_guid = 22)
      LocalObject(1917, Terminal.Constructor(Vector3(3707.322f, 2151.496f, 65.03052f), spawn_terminal), owning_building_guid = 22)
      ...
      LocalObject(114, ProximityTerminal.Constructor(Vector3(3682.746f, 2156.644f, 72.70651f), adv_med_terminal), owning_building_guid = 22)
      LocalObject(1301, ProximityTerminal.Constructor(Vector3(3691.528f, 2130.119f, 62.89651f), medical_terminal), owning_building_guid = 22)
      LocalObject(1492, ProximityTerminal.Constructor(Vector3(3621.198f, 2165.828f, 81.24851f), pad_landing_frame), owning_building_guid = 22)
      LocalObject(1493, Terminal.Constructor(Vector3(3621.198f, 2165.828f, 81.24851f), air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1495, ProximityTerminal.Constructor(Vector3(3629.876f, 2181.446f, 83.18951f), pad_landing_frame), owning_building_guid = 22)
      LocalObject(1496, Terminal.Constructor(Vector3(3629.876f, 2181.446f, 83.18951f), air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1498, ProximityTerminal.Constructor(Vector3(3734.966f, 2152.738f, 83.22852f), pad_landing_frame), owning_building_guid = 22)
      LocalObject(1499, Terminal.Constructor(Vector3(3734.966f, 2152.738f, 83.22852f), air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1501, ProximityTerminal.Constructor(Vector3(3744.745f, 2168.166f, 81.23852f), pad_landing_frame), owning_building_guid = 22)
      LocalObject(1502, Terminal.Constructor(Vector3(3744.745f, 2168.166f, 81.23852f), air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1745, ProximityTerminal.Constructor(Vector3(3608.569f, 2200.735f, 72.64651f), repair_silo), owning_building_guid = 22)
      LocalObject(1746, Terminal.Constructor(Vector3(3608.569f, 2200.735f, 72.64651f), ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(1749, ProximityTerminal.Constructor(Vector3(3701.222f, 2104.288f, 72.64651f), repair_silo), owning_building_guid = 22)
      LocalObject(1750, Terminal.Constructor(Vector3(3701.222f, 2104.288f, 72.64651f), ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(1226, FacilityTurret.Constructor(Vector3(3588.193f, 2103.038f, 81.29852f), manned_turret), owning_building_guid = 22)
      TurretToWeapon(1226, 5026)
      LocalObject(1228, FacilityTurret.Constructor(Vector3(3599.987f, 2237.749f, 81.29852f), manned_turret), owning_building_guid = 22)
      TurretToWeapon(1228, 5027)
      LocalObject(1229, FacilityTurret.Constructor(Vector3(3722.701f, 2090.078f, 81.29852f), manned_turret), owning_building_guid = 22)
      TurretToWeapon(1229, 5028)
      LocalObject(1232, FacilityTurret.Constructor(Vector3(3769.406f, 2129.305f, 81.29852f), manned_turret), owning_building_guid = 22)
      ...
      LocalObject(1626, Painbox.Constructor(Vector3(3696.397f, 2142.631f, 66.96642f), painbox_continuous), owning_building_guid = 22)
      LocalObject(1635, Painbox.Constructor(Vector3(3684.453f, 2154.287f, 87.13042f), painbox_door_radius), owning_building_guid = 22)
    ...
    def Building7(): Unit = { // Name: Aton Type: cryo_facility GUID: 25, MapID: 7
      ...
      LocalObject(169, Terminal.Constructor(Vector3(3772.977f, 5421.724f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(170, Terminal.Constructor(Vector3(3772.977f, 5434.424f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(171, Terminal.Constructor(Vector3(3774.425f, 5420.276f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(172, Terminal.Constructor(Vector3(3774.425f, 5435.872f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(173, Terminal.Constructor(Vector3(3781.75f, 5420.276f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(174, Terminal.Constructor(Vector3(3781.75f, 5435.872f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(175, Terminal.Constructor(Vector3(3783.198f, 5421.724f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(176, Terminal.Constructor(Vector3(3783.198f, 5434.424f, 44.13594f), cert_terminal), owning_building_guid = 25)
      LocalObject(1354, Terminal.Constructor(Vector3(3815.072f, 5436.654f, 45.73594f), order_terminal), owning_building_guid = 25)
      LocalObject(1355, Terminal.Constructor(Vector3(3818.861f, 5436.654f, 45.73594f), order_terminal), owning_building_guid = 25)
      LocalObject(1356, Terminal.Constructor(Vector3(3820.474f, 5407.972f, 55.44094f), order_terminal), owning_building_guid = 25)
      LocalObject(1357, Terminal.Constructor(Vector3(3822.592f, 5436.654f, 45.73594f), order_terminal), owning_building_guid = 25)
      LocalObject(1919, Terminal.Constructor(Vector3(3766f, 5417.407f, 45.75894f), spawn_terminal), owning_building_guid = 25)
      LocalObject(1920, Terminal.Constructor(Vector3(3812.177f, 5422.97f, 46.27994f), spawn_terminal), owning_building_guid = 25)
      LocalObject(1921, Terminal.Constructor(Vector3(3819.465f, 5422.967f, 46.27994f), spawn_terminal), owning_building_guid = 25)
      LocalObject(1922, Terminal.Constructor(Vector3(3826.757f, 5422.971f, 46.27994f), spawn_terminal), owning_building_guid = 25)
      LocalObject(1923, Terminal.Constructor(Vector3(3830.593f, 5378f, 45.75894f), spawn_terminal), owning_building_guid = 25)
      LocalObject(1924, Terminal.Constructor(Vector3(3843.641f, 5419.905f, 55.72494f), spawn_terminal), owning_building_guid = 25)
      ...
      LocalObject(115, ProximityTerminal.Constructor(Vector3(3837.108f, 5419.983f, 53.95594f), adv_med_terminal), owning_building_guid = 25)
      LocalObject(1302, ProximityTerminal.Constructor(Vector3(3826.048f, 5445.642f, 44.14594f), medical_terminal), owning_building_guid = 25)
      LocalObject(1504, ProximityTerminal.Constructor(Vector3(3776.349f, 5403.101f, 62.48794f), pad_landing_frame), owning_building_guid = 25)
      LocalObject(1505, Terminal.Constructor(Vector3(3776.349f, 5403.101f, 62.48794f), air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1507, ProximityTerminal.Constructor(Vector3(3784.747f, 5419.323f, 64.47794f), pad_landing_frame), owning_building_guid = 25)
      LocalObject(1508, Terminal.Constructor(Vector3(3784.747f, 5419.323f, 64.47794f), air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1510, ProximityTerminal.Constructor(Vector3(3891.939f, 5399.883f, 64.43894f), pad_landing_frame), owning_building_guid = 25)
      LocalObject(1511, Terminal.Constructor(Vector3(3891.939f, 5399.883f, 64.43894f), air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1513, ProximityTerminal.Constructor(Vector3(3899.223f, 5416.198f, 62.49794f), pad_landing_frame), owning_building_guid = 25)
      LocalObject(1514, Terminal.Constructor(Vector3(3899.223f, 5416.198f, 62.49794f), air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1753, ProximityTerminal.Constructor(Vector3(3814.139f, 5470.53f, 53.89594f), repair_silo), owning_building_guid = 25)
      LocalObject(1754, Terminal.Constructor(Vector3(3814.139f, 5470.53f, 53.89594f), ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(1757, ProximityTerminal.Constructor(Vector3(3914.846f, 5382.524f, 53.89594f), repair_silo), owning_building_guid = 25)
      LocalObject(1758, Terminal.Constructor(Vector3(3914.846f, 5382.524f, 53.89594f), ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(1230, FacilityTurret.Constructor(Vector3(3748.395f, 5439.665f, 62.54794f), manned_turret), owning_building_guid = 25)
      TurretToWeapon(1230, 5031)
      LocalObject(1231, FacilityTurret.Constructor(Vector3(3749.528f, 5346.392f, 62.54794f), manned_turret), owning_building_guid = 25)
      TurretToWeapon(1231, 5032)
      LocalObject(1234, FacilityTurret.Constructor(Vector3(3791.504f, 5482.813f, 62.54794f), manned_turret), owning_building_guid = 25)
      TurretToWeapon(1234, 5033)
      LocalObject(1237, FacilityTurret.Constructor(Vector3(3926.621f, 5346.4f, 62.54794f), manned_turret), owning_building_guid = 25)
      ...
      LocalObject(1627, Painbox.Constructor(Vector3(3822.288f, 5432.753f, 48.21584f), painbox_continuous), owning_building_guid = 25)
      LocalObject(1636, Painbox.Constructor(Vector3(3835.202f, 5422.182f, 68.37984f), painbox_door_radius), owning_building_guid = 25)
    ...
    def Building9(): Unit = { // Name: Thoth Type: cryo_facility GUID: 28, MapID: 9
      ...
      LocalObject(177, Terminal.Constructor(Vector3(4578.454f, 3380.768f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(178, Terminal.Constructor(Vector3(4579.154f, 3378.843f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(179, Terminal.Constructor(Vector3(4581.55f, 3387.406f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(180, Terminal.Constructor(Vector3(4583.474f, 3388.106f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(181, Terminal.Constructor(Vector3(4590.665f, 3373.476f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(182, Terminal.Constructor(Vector3(4592.589f, 3374.176f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(183, Terminal.Constructor(Vector3(4594.984f, 3382.739f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(184, Terminal.Constructor(Vector3(4595.685f, 3380.815f, 43.18376f), cert_terminal), owning_building_guid = 28)
      LocalObject(1394, Terminal.Constructor(Vector3(4550.938f, 3350.872f, 54.48876f), order_terminal), owning_building_guid = 28)
      LocalObject(1395, Terminal.Constructor(Vector3(4576.037f, 3336.83f, 44.78376f), order_terminal), owning_building_guid = 28)
      LocalObject(1396, Terminal.Constructor(Vector3(4577.614f, 3340.212f, 44.78376f), order_terminal), owning_building_guid = 28)
      LocalObject(1397, Terminal.Constructor(Vector3(4579.215f, 3343.646f, 44.78376f), order_terminal), owning_building_guid = 28)
      LocalObject(1940, Terminal.Constructor(Vector3(4517.501f, 3293.512f, 47.30676f), spawn_terminal), owning_building_guid = 28)
      LocalObject(1942, Terminal.Constructor(Vector3(4519.497f, 3354.367f, 44.80676f), spawn_terminal), owning_building_guid = 28)
      LocalObject(1947, Terminal.Constructor(Vector3(4551.961f, 3324.832f, 54.77276f), spawn_terminal), owning_building_guid = 28)
      LocalObject(1948, Terminal.Constructor(Vector3(4561.876f, 3338.838f, 45.32776f), spawn_terminal), owning_building_guid = 28)
      LocalObject(1949, Terminal.Constructor(Vector3(4564.954f, 3345.449f, 45.32776f), spawn_terminal), owning_building_guid = 28)
      LocalObject(1951, Terminal.Constructor(Vector3(4568.037f, 3352.053f, 45.32776f), spawn_terminal), owning_building_guid = 28)
      ...
      LocalObject(116, ProximityTerminal.Constructor(Vector3(4554.793f, 3330.72f, 53.00377f), adv_med_terminal), owning_building_guid = 28)
      LocalObject(1309, ProximityTerminal.Constructor(Vector3(4582.722f, 3329.9f, 43.19376f), medical_terminal), owning_building_guid = 28)
      LocalObject(1543, ProximityTerminal.Constructor(Vector3(4513.404f, 3289.521f, 63.48676f), pad_landing_frame), owning_building_guid = 28)
      LocalObject(1544, Terminal.Constructor(Vector3(4513.404f, 3289.521f, 63.48676f), air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1549, ProximityTerminal.Constructor(Vector3(4525.112f, 3276.024f, 61.54576f), pad_landing_frame), owning_building_guid = 28)
      LocalObject(1550, Terminal.Constructor(Vector3(4525.112f, 3276.024f, 61.54576f), air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1561, ProximityTerminal.Constructor(Vector3(4565.171f, 3392.921f, 61.53576f), pad_landing_frame), owning_building_guid = 28)
      LocalObject(1562, Terminal.Constructor(Vector3(4565.171f, 3392.921f, 61.53576f), air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1564, ProximityTerminal.Constructor(Vector3(4576.324f, 3378.454f, 63.52576f), pad_landing_frame), owning_building_guid = 28)
      LocalObject(1565, Terminal.Constructor(Vector3(4576.324f, 3378.454f, 63.52576f), air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1781, ProximityTerminal.Constructor(Vector3(4487.991f, 3276.096f, 52.94376f), repair_silo), owning_building_guid = 28)
      LocalObject(1782, Terminal.Constructor(Vector3(4487.991f, 3276.096f, 52.94376f), ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(1789, ProximityTerminal.Constructor(Vector3(4610.312f, 3330.175f, 52.94376f), repair_silo), owning_building_guid = 28)
      LocalObject(1790, Terminal.Constructor(Vector3(4610.312f, 3330.175f, 52.94376f), ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(1255, FacilityTurret.Constructor(Vector3(4450.274f, 3280.691f, 61.59576f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(1255, 5036)
      LocalObject(1261, FacilityTurret.Constructor(Vector3(4525.11f, 3441.195f, 61.59576f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(1261, 5037)
      LocalObject(1262, FacilityTurret.Constructor(Vector3(4572.828f, 3223.535f, 61.59576f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(1262, 5038)
      LocalObject(1264, FacilityTurret.Constructor(Vector3(4610.123f, 3402.803f, 61.59576f), manned_turret), owning_building_guid = 28)
      ...
      LocalObject(1631, Painbox.Constructor(Vector3(4572.629f, 3338.754f, 47.26366f), painbox_continuous), owning_building_guid = 28)
      LocalObject(1640, Painbox.Constructor(Vector3(4557.592f, 3331.518f, 67.42767f), painbox_door_radius), owning_building_guid = 28)
    ...
    def Building11(): Unit = { // Name: Amun Type: tech_plant GUID: 35, MapID: 11
      ...
      LocalObject(117, Terminal.Constructor(Vector3(4411.832f, 2245.145f, 84.0492f), air_vehicle_terminal), owning_building_guid = 35)
      LocalObject(1289, VehicleSpawnPad.Constructor(Vector3(4406.988f, 2224.532f, 80.9242f), mb_pad_creation, Vector3(0, 0, 181)), owning_building_guid = 35, terminal_guid = 117)
      LocalObject(118, Terminal.Constructor(Vector3(4423.762f, 2244.937f, 84.0492f), air_vehicle_terminal), owning_building_guid = 35)
      LocalObject(1290, VehicleSpawnPad.Constructor(Vector3(4428.003f, 2224.166f, 80.9242f), mb_pad_creation, Vector3(0, 0, 181)), owning_building_guid = 35, terminal_guid = 118)
      LocalObject(1377, Terminal.Constructor(Vector3(4401.927f, 2253.532f, 62.5362f), order_terminal), owning_building_guid = 35)
      LocalObject(1378, Terminal.Constructor(Vector3(4401.993f, 2257.321f, 62.5362f), order_terminal), owning_building_guid = 35)
      LocalObject(1379, Terminal.Constructor(Vector3(4402.059f, 2261.051f, 62.5362f), order_terminal), owning_building_guid = 35)
      LocalObject(1380, Terminal.Constructor(Vector3(4425.405f, 2246.563f, 74.7762f), order_terminal), owning_building_guid = 35)
      LocalObject(1932, Terminal.Constructor(Vector3(4391.119f, 2241.008f, 75.0282f), spawn_terminal), owning_building_guid = 35)
      LocalObject(1933, Terminal.Constructor(Vector3(4413.414f, 2217.039f, 80.3692f), spawn_terminal), owning_building_guid = 35)
      LocalObject(1934, Terminal.Constructor(Vector3(4415.559f, 2250.399f, 63.0802f), spawn_terminal), owning_building_guid = 35)
      LocalObject(1935, Terminal.Constructor(Vector3(4415.689f, 2257.686f, 63.0802f), spawn_terminal), owning_building_guid = 35)
      LocalObject(1936, Terminal.Constructor(Vector3(4415.812f, 2264.977f, 63.0802f), spawn_terminal), owning_building_guid = 35)
      LocalObject(1937, Terminal.Constructor(Vector3(4420.887f, 2267.54f, 55.0032f), spawn_terminal), owning_building_guid = 35)
      ...
      LocalObject(1305, ProximityTerminal.Constructor(Vector3(4388.022f, 2247.082f, 53.4462f), medical_terminal), owning_building_guid = 35)
      LocalObject(1306, ProximityTerminal.Constructor(Vector3(4425.589f, 2257.147f, 73.4432f), medical_terminal), owning_building_guid = 35)
      LocalObject(1519, ProximityTerminal.Constructor(Vector3(4360.183f, 2247.086f, 76.5542f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1520, Terminal.Constructor(Vector3(4360.183f, 2247.086f, 76.5542f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1522, ProximityTerminal.Constructor(Vector3(4366.758f, 2263.22f, 78.9982f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1523, Terminal.Constructor(Vector3(4366.758f, 2263.22f, 78.9982f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1525, ProximityTerminal.Constructor(Vector3(4403.89f, 2301.805f, 76.5542f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1526, Terminal.Constructor(Vector3(4403.89f, 2301.805f, 76.5542f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1528, ProximityTerminal.Constructor(Vector3(4419.749f, 2284.68f, 83.7932f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1529, Terminal.Constructor(Vector3(4419.749f, 2284.68f, 83.7932f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1531, ProximityTerminal.Constructor(Vector3(4469.156f, 2227.45f, 78.8962f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1532, Terminal.Constructor(Vector3(4469.156f, 2227.45f, 78.8962f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1537, ProximityTerminal.Constructor(Vector3(4489.711f, 2243.266f, 76.5412f), pad_landing_frame), owning_building_guid = 35)
      LocalObject(1538, Terminal.Constructor(Vector3(4489.711f, 2243.266f, 76.5412f), air_rearm_terminal), owning_building_guid = 35)
      LocalObject(1769, ProximityTerminal.Constructor(Vector3(4370.992f, 2313.802f, 68.0962f), repair_silo), owning_building_guid = 35)
      LocalObject(1770, Terminal.Constructor(Vector3(4370.992f, 2313.802f, 68.0962f), ground_rearm_terminal), owning_building_guid = 35)
      LocalObject(1773, ProximityTerminal.Constructor(Vector3(4426.965f, 2178.375f, 68.0747f), repair_silo), owning_building_guid = 35)
      LocalObject(1774, Terminal.Constructor(Vector3(4426.965f, 2178.375f, 68.0747f), ground_rearm_terminal), owning_building_guid = 35)
      LocalObject(1250, FacilityTurret.Constructor(Vector3(4334.737f, 2256.21f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1250, 5041)
      LocalObject(1251, FacilityTurret.Constructor(Vector3(4341.189f, 2183.111f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1251, 5042)
      LocalObject(1252, FacilityTurret.Constructor(Vector3(4343.593f, 2320.832f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1252, 5043)
      LocalObject(1254, FacilityTurret.Constructor(Vector3(4420.675f, 2121.258f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1254, 5044)
      LocalObject(1258, FacilityTurret.Constructor(Vector3(4508.309f, 2317.948f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1258, 5045)
      LocalObject(1259, FacilityTurret.Constructor(Vector3(4510.356f, 2119.692f, 76.8452f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(1259, 5046)
      LocalObject(1620, Painbox.Constructor(Vector3(4402.333f, 2224.242f, 56.9195f), painbox), owning_building_guid = 35)
      LocalObject(1629, Painbox.Constructor(Vector3(4407.813f, 2257.146f, 65.2161f), painbox_continuous), owning_building_guid = 35)
      LocalObject(1638, Painbox.Constructor(Vector3(4400.628f, 2239.009f, 56.6056f), painbox_door_radius), owning_building_guid = 35)
    ...
    def Building5(): Unit = { // Name: Seth Type: tech_plant GUID: 38, MapID: 5
      ...
      LocalObject(119, Terminal.Constructor(Vector3(4539.789f, 6101.625f, 73.50201f), air_vehicle_terminal), owning_building_guid = 38)
      LocalObject(1294, VehicleSpawnPad.Constructor(Vector3(4560.013f, 6095.355f, 70.37701f), mb_pad_creation, Vector3(0, 0, 95)), owning_building_guid = 38, terminal_guid = 119)
      LocalObject(120, Terminal.Constructor(Vector3(4540.828f, 6113.511f, 73.50201f), air_vehicle_terminal), owning_building_guid = 38)
      LocalObject(1295, VehicleSpawnPad.Constructor(Vector3(4561.845f, 6116.293f, 70.37701f), mb_pad_creation, Vector3(0, 0, 95)), owning_building_guid = 38, terminal_guid = 120)
      LocalObject(1390, Terminal.Constructor(Vector3(4523.239f, 6092.985f, 51.989f), order_terminal), owning_building_guid = 38)
      LocalObject(1391, Terminal.Constructor(Vector3(4526.956f, 6092.66f, 51.989f), order_terminal), owning_building_guid = 38)
      LocalObject(1392, Terminal.Constructor(Vector3(4530.731f, 6092.33f, 51.989f), order_terminal), owning_building_guid = 38)
      LocalObject(1393, Terminal.Constructor(Vector3(4539.32f, 6115.265f, 64.229f), order_terminal), owning_building_guid = 38)
      LocalObject(1939, Terminal.Constructor(Vector3(4473.051f, 6148.282f, 51.95601f), spawn_terminal), owning_building_guid = 38)
      LocalObject(1941, Terminal.Constructor(Vector3(4518.079f, 6112.22f, 44.456f), spawn_terminal), owning_building_guid = 38)
      LocalObject(1943, Terminal.Constructor(Vector3(4520.283f, 6106.979f, 52.533f), spawn_terminal), owning_building_guid = 38)
      LocalObject(1944, Terminal.Constructor(Vector3(4527.547f, 6106.348f, 52.533f), spawn_terminal), owning_building_guid = 38)
      LocalObject(1945, Terminal.Constructor(Vector3(4534.808f, 6105.709f, 52.533f), spawn_terminal), owning_building_guid = 38)
      LocalObject(1946, Terminal.Constructor(Vector3(4542.471f, 6080.674f, 64.481f), spawn_terminal), owning_building_guid = 38)
      ...
      LocalObject(1307, ProximityTerminal.Constructor(Vector3(4528.775f, 6116.186f, 62.896f), medical_terminal), owning_building_guid = 38)
      LocalObject(1308, ProximityTerminal.Constructor(Vector3(4536.195f, 6078.009f, 42.899f), medical_terminal), owning_building_guid = 38)
      LocalObject(1534, ProximityTerminal.Constructor(Vector3(4482.712f, 6097.655f, 66.007f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1535, Terminal.Constructor(Vector3(4482.712f, 6097.655f, 66.007f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1540, ProximityTerminal.Constructor(Vector3(4500.902f, 6112.28f, 73.246f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1541, Terminal.Constructor(Vector3(4500.902f, 6112.28f, 73.246f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1546, ProximityTerminal.Constructor(Vector3(4518.613f, 6057.922f, 68.451f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1547, Terminal.Constructor(Vector3(4518.613f, 6057.922f, 68.451f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1552, ProximityTerminal.Constructor(Vector3(4534.25f, 6050.237f, 66.007f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1553, Terminal.Constructor(Vector3(4534.25f, 6050.237f, 66.007f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1555, ProximityTerminal.Constructor(Vector3(4547.096f, 6179.184f, 65.994f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1556, Terminal.Constructor(Vector3(4547.096f, 6179.184f, 65.994f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1558, ProximityTerminal.Constructor(Vector3(4561.439f, 6157.576f, 68.34901f), pad_landing_frame), owning_building_guid = 38)
      LocalObject(1559, Terminal.Constructor(Vector3(4561.439f, 6157.576f, 68.34901f), air_rearm_terminal), owning_building_guid = 38)
      LocalObject(1777, ProximityTerminal.Constructor(Vector3(4468.45f, 6065.674f, 57.549f), repair_silo), owning_building_guid = 38)
      LocalObject(1778, Terminal.Constructor(Vector3(4468.45f, 6065.674f, 57.549f), ground_rearm_terminal), owning_building_guid = 38)
      LocalObject(1785, ProximityTerminal.Constructor(Vector3(4607.451f, 6112.063f, 57.5275f), repair_silo), owning_building_guid = 38)
      LocalObject(1786, Terminal.Constructor(Vector3(4607.451f, 6112.063f, 57.5275f), ground_rearm_terminal), owning_building_guid = 38)
      LocalObject(1256, FacilityTurret.Constructor(Vector3(4459.526f, 6038.832f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1256, 5047)
      LocalObject(1257, FacilityTurret.Constructor(Vector3(4473.892f, 6202.946f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1257, 5048)
      LocalObject(1260, FacilityTurret.Constructor(Vector3(4523.372f, 6025.49f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1260, 5049)
      LocalObject(1263, FacilityTurret.Constructor(Vector3(4596.743f, 6026.827f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1263, 5050)
      LocalObject(1266, FacilityTurret.Constructor(Vector3(4663.991f, 6101.805f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1266, 5051)
      LocalObject(1267, FacilityTurret.Constructor(Vector3(4671.808f, 6191.158f, 66.298f), manned_turret), owning_building_guid = 38)
      TurretToWeapon(1267, 5052)
      LocalObject(1622, Painbox.Constructor(Vector3(4559.978f, 6090.691f, 46.3723f), painbox), owning_building_guid = 38)
      LocalObject(1630, Painbox.Constructor(Vector3(4527.537f, 6098.453f, 54.6689f), painbox_continuous), owning_building_guid = 38)
      LocalObject(1639, Painbox.Constructor(Vector3(4545.127f, 6090.021f, 46.0584f), painbox_door_radius), owning_building_guid = 38)
    ...
    def Building20(): Unit = { // Name: W_Sobek_Tower Type: tower_a GUID: 41, MapID: 20
      ...
      LocalObject(1312, Terminal.Constructor(Vector3(2585.234f, 3161.58f, 64.81447f), order_terminal), owning_building_guid = 41)
      LocalObject(1313, Terminal.Constructor(Vector3(2590.788f, 3160.195f, 64.81447f), order_terminal), owning_building_guid = 41)
      LocalObject(1314, Terminal.Constructor(Vector3(2596.009f, 3158.894f, 64.81447f), order_terminal), owning_building_guid = 41)
      LocalObject(1810, SpawnTube.Constructor(Vector3(2585.516f, 3172.577f, 62.96447f), respawn_tube_tower, Vector3(0, 0, 104)), owning_building_guid = 41)
      LocalObject(1811, SpawnTube.Constructor(Vector3(2601.439f, 3168.608f, 62.96447f), respawn_tube_tower, Vector3(0, 0, 104)), owning_building_guid = 41)
      LocalObject(1201, FacilityTurret.Constructor(Vector3(2590.74f, 3195.377f, 92.42447f), manned_turret), owning_building_guid = 41)
      TurretToWeapon(1201, 5053)
      LocalObject(1202, FacilityTurret.Constructor(Vector3(2606.851f, 3154.952f, 92.42447f), manned_turret), owning_building_guid = 41)
      TurretToWeapon(1202, 5054)
      LocalObject(1669, Painbox.Constructor(Vector3(2586.406f, 3165.895f, 63.58247f), painbox_radius_continuous), owning_building_guid = 41)
      LocalObject(1670, Painbox.Constructor(Vector3(2592.721f, 3176.42f, 64.98157f), painbox_radius_continuous), owning_building_guid = 41)
      LocalObject(1671, Painbox.Constructor(Vector3(2597.938f, 3163.108f, 63.58247f), painbox_radius_continuous), owning_building_guid = 41)
    }
    ...
    def Building21(): Unit = { // Name: S_Mont_Tower Type: tower_a GUID: 42, MapID: 21
      ...
      LocalObject(1326, Terminal.Constructor(Vector3(3145.256f, 3787.098f, 89.22318f), order_terminal), owning_building_guid = 42)
      LocalObject(1327, Terminal.Constructor(Vector3(3145.725f, 3781.738f, 89.22318f), order_terminal), owning_building_guid = 42)
      LocalObject(1328, Terminal.Constructor(Vector3(3146.224f, 3776.036f, 89.22318f), order_terminal), owning_building_guid = 42)
      LocalObject(1817, SpawnTube.Constructor(Vector3(3134.303f, 3789.069f, 87.37318f), respawn_tube_tower, Vector3(0, 0, 355)), owning_building_guid = 42)
      LocalObject(1818, SpawnTube.Constructor(Vector3(3135.734f, 3772.722f, 87.37318f), respawn_tube_tower, Vector3(0, 0, 355)), owning_building_guid = 42)
      LocalObject(1210, FacilityTurret.Constructor(Vector3(3112.476f, 3770.238f, 116.8332f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(1210, 5055)
      LocalObject(1213, FacilityTurret.Constructor(Vector3(3145.453f, 3798.633f, 116.8332f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(1213, 5056)
      LocalObject(1675, Painbox.Constructor(Vector3(3129.755f, 3778.283f, 89.39027f), painbox_radius_continuous), owning_building_guid = 42)
      LocalObject(1676, Painbox.Constructor(Vector3(3140.643f, 3787.55f, 87.99117f), painbox_radius_continuous), owning_building_guid = 42)
      LocalObject(1677, Painbox.Constructor(Vector3(3141.763f, 3775.739f, 87.99117f), painbox_radius_continuous), owning_building_guid = 42)
    }
    ...
    def Building14(): Unit = { // Name: NE_Amerish_Warpgate_Tower Type: tower_a GUID: 43, MapID: 14
      ...
      LocalObject(1329, Terminal.Constructor(Vector3(3165.089f, 1411.015f, 48.0415f), order_terminal), owning_building_guid = 43)
      LocalObject(1330, Terminal.Constructor(Vector3(3168.098f, 1406.554f, 48.0415f), order_terminal), owning_building_guid = 43)
      LocalObject(1331, Terminal.Constructor(Vector3(3171.299f, 1401.808f, 48.0415f), order_terminal), owning_building_guid = 43)
      LocalObject(1819, SpawnTube.Constructor(Vector3(3154.554f, 1407.429f, 46.1915f), respawn_tube_tower, Vector3(0, 0, 326)), owning_building_guid = 43)
      LocalObject(1820, SpawnTube.Constructor(Vector3(3163.73f, 1393.824f, 46.1915f), respawn_tube_tower, Vector3(0, 0, 326)), owning_building_guid = 43)
      LocalObject(1212, FacilityTurret.Constructor(Vector3(3144.592f, 1380.376f, 75.6515f), manned_turret), owning_building_guid = 43)
      TurretToWeapon(1212, 5057)
      LocalObject(1214, FacilityTurret.Constructor(Vector3(3159.669f, 1421.199f, 75.6515f), manned_turret), owning_building_guid = 43)
      TurretToWeapon(1214, 5058)
      LocalObject(1678, Painbox.Constructor(Vector3(3155.805f, 1395.79f, 48.2086f), painbox_radius_continuous), owning_building_guid = 43)
      LocalObject(1679, Painbox.Constructor(Vector3(3160.835f, 1409.174f, 46.80949f), painbox_radius_continuous), owning_building_guid = 43)
      LocalObject(1680, Painbox.Constructor(Vector3(3167.541f, 1399.386f, 46.80949f), painbox_radius_continuous), owning_building_guid = 43)
    }
    ...
    def Building32(): Unit = { // Name: SW__Aton_Tower Type: tower_a GUID: 44, MapID: 32
      ...
      LocalObject(1344, Terminal.Constructor(Vector3(3593.445f, 4876.129f, 59.36691f), order_terminal), owning_building_guid = 44)
      LocalObject(1345, Terminal.Constructor(Vector3(3593.445f, 4881.853f, 59.36691f), order_terminal), owning_building_guid = 44)
      LocalObject(1346, Terminal.Constructor(Vector3(3593.445f, 4887.234f, 59.36691f), order_terminal), owning_building_guid = 44)
      LocalObject(1828, SpawnTube.Constructor(Vector3(3582.706f, 4873.742f, 57.51691f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 44)
      LocalObject(1829, SpawnTube.Constructor(Vector3(3582.706f, 4890.152f, 57.51691f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 44)
      LocalObject(1225, FacilityTurret.Constructor(Vector3(3559.32f, 4873.295f, 86.97691f), manned_turret), owning_building_guid = 44)
      TurretToWeapon(1225, 5059)
      LocalObject(1227, FacilityTurret.Constructor(Vector3(3594.647f, 4898.707f, 86.97691f), manned_turret), owning_building_guid = 44)
      TurretToWeapon(1227, 5060)
      LocalObject(1687, Painbox.Constructor(Vector3(3577.235f, 4879.803f, 59.53401f), painbox_radius_continuous), owning_building_guid = 44)
      LocalObject(1688, Painbox.Constructor(Vector3(3588.889f, 4888.086f, 58.13491f), painbox_radius_continuous), owning_building_guid = 44)
      LocalObject(1689, Painbox.Constructor(Vector3(3588.975f, 4876.223f, 58.13491f), painbox_radius_continuous), owning_building_guid = 44)
    }
    ...
    def Building38(): Unit = { // Name: NE_Horus_Tower Type: tower_a GUID: 45, MapID: 38
      ...
      LocalObject(1358, Terminal.Constructor(Vector3(3883.445f, 2316.129f, 63.39536f), order_terminal), owning_building_guid = 45)
      LocalObject(1359, Terminal.Constructor(Vector3(3883.445f, 2321.853f, 63.39536f), order_terminal), owning_building_guid = 45)
      LocalObject(1360, Terminal.Constructor(Vector3(3883.445f, 2327.234f, 63.39536f), order_terminal), owning_building_guid = 45)
      LocalObject(1838, SpawnTube.Constructor(Vector3(3872.706f, 2313.742f, 61.54536f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 45)
      LocalObject(1839, SpawnTube.Constructor(Vector3(3872.706f, 2330.152f, 61.54536f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 45)
      LocalObject(1235, FacilityTurret.Constructor(Vector3(3849.32f, 2313.295f, 91.00536f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(1235, 5061)
      LocalObject(1236, FacilityTurret.Constructor(Vector3(3884.647f, 2338.707f, 91.00536f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(1236, 5062)
      LocalObject(1693, Painbox.Constructor(Vector3(3867.235f, 2319.803f, 63.56245f), painbox_radius_continuous), owning_building_guid = 45)
      LocalObject(1694, Painbox.Constructor(Vector3(3878.889f, 2328.086f, 62.16335f), painbox_radius_continuous), owning_building_guid = 45)
      LocalObject(1695, Painbox.Constructor(Vector3(3878.975f, 2316.223f, 62.16335f), painbox_radius_continuous), owning_building_guid = 45)
    }
    ...
    def Building17(): Unit = { // Name: W_Thoth_Tower Type: tower_a GUID: 46, MapID: 17
      ...
      LocalObject(1371, Terminal.Constructor(Vector3(4308.914f, 3338.181f, 58.64362f), order_terminal), owning_building_guid = 46)
      LocalObject(1372, Terminal.Constructor(Vector3(4311.188f, 3333.305f, 58.64362f), order_terminal), owning_building_guid = 46)
      LocalObject(1373, Terminal.Constructor(Vector3(4313.607f, 3328.117f, 58.64362f), order_terminal), owning_building_guid = 46)
      LocalObject(1844, SpawnTube.Constructor(Vector3(4297.948f, 3336.288f, 56.79362f), respawn_tube_tower, Vector3(0, 0, 335)), owning_building_guid = 46)
      LocalObject(1845, SpawnTube.Constructor(Vector3(4304.883f, 3321.415f, 56.79362f), respawn_tube_tower, Vector3(0, 0, 335)), owning_building_guid = 46)
      LocalObject(1247, FacilityTurret.Constructor(Vector3(4283.877f, 3311.126f, 86.25362f), manned_turret), owning_building_guid = 46)
      ...
      LocalObject(1702, Painbox.Constructor(Vector3(4297.363f, 3324.596f, 58.81072f), painbox_radius_continuous), owning_building_guid = 46)
      LocalObject(1703, Painbox.Constructor(Vector3(4304.425f, 3337.028f, 57.41162f), painbox_radius_continuous), owning_building_guid = 46)
      LocalObject(1704, Painbox.Constructor(Vector3(4309.517f, 3326.313f, 57.41162f), painbox_radius_continuous), owning_building_guid = 46)
    }
    ...
    def Building36(): Unit = { // Name: E_Tower_Seth Type: tower_a GUID: 47, MapID: 36
      ...
      LocalObject(1398, Terminal.Constructor(Vector3(4845.313f, 6204.715f, 59.11628f), order_terminal), owning_building_guid = 47)
      LocalObject(1399, Terminal.Constructor(Vector3(4848.244f, 6200.202f, 59.11628f), order_terminal), owning_building_guid = 47)
      LocalObject(1400, Terminal.Constructor(Vector3(4851.361f, 6195.401f, 59.11628f), order_terminal), owning_building_guid = 47)
      LocalObject(1864, SpawnTube.Constructor(Vector3(4834.717f, 6201.313f, 57.26628f), respawn_tube_tower, Vector3(0, 0, 327)), owning_building_guid = 47)
      LocalObject(1865, SpawnTube.Constructor(Vector3(4843.655f, 6187.55f, 57.26628f), respawn_tube_tower, Vector3(0, 0, 327)), owning_building_guid = 47)
      LocalObject(1268, FacilityTurret.Constructor(Vector3(4824.285f, 6174.438f, 86.72628f), manned_turret), owning_building_guid = 47)
      TurretToWeapon(1268, 5065)
      LocalObject(1269, FacilityTurret.Constructor(Vector3(4840.073f, 6214.991f, 86.72628f), manned_turret), owning_building_guid = 47)
      TurretToWeapon(1269, 5066)
      LocalObject(1714, Painbox.Constructor(Vector3(4835.766f, 6189.654f, 59.28338f), painbox_radius_continuous), owning_building_guid = 47)
      LocalObject(1715, Painbox.Constructor(Vector3(4841.028f, 6202.948f, 57.88428f), painbox_radius_continuous), owning_building_guid = 47)
      LocalObject(1716, Painbox.Constructor(Vector3(4847.562f, 6193.045f, 57.88428f), painbox_radius_continuous), owning_building_guid = 47)
    }
    ...
    def Building24(): Unit = { // Name: E_Bastet_Tower Type: tower_a GUID: 48, MapID: 24
      ...
      LocalObject(1413, Terminal.Constructor(Vector3(5538.301f, 5417.217f, 65.35464f), order_terminal), owning_building_guid = 48)
      LocalObject(1414, Terminal.Constructor(Vector3(5540.988f, 5422.271f, 65.35464f), order_terminal), owning_building_guid = 48)
      LocalObject(1415, Terminal.Constructor(Vector3(5543.514f, 5427.022f, 65.35464f), order_terminal), owning_building_guid = 48)
      LocalObject(1873, SpawnTube.Constructor(Vector3(5527.698f, 5420.151f, 63.50465f), respawn_tube_tower, Vector3(0, 0, 28)), owning_building_guid = 48)
      LocalObject(1874, SpawnTube.Constructor(Vector3(5535.402f, 5434.64f, 63.50465f), respawn_tube_tower, Vector3(0, 0, 28)), owning_building_guid = 48)
      LocalObject(1279, FacilityTurret.Constructor(Vector3(5506.839f, 5430.735f, 92.96465f), manned_turret), owning_building_guid = 48)
      TurretToWeapon(1279, 5067)
      LocalObject(1281, FacilityTurret.Constructor(Vector3(5549.962f, 5436.587f, 92.96465f), manned_turret), owning_building_guid = 48)
      TurretToWeapon(1281, 5068)
      LocalObject(1721, Painbox.Constructor(Vector3(5525.713f, 5428.071f, 65.52174f), painbox_radius_continuous), owning_building_guid = 48)
      LocalObject(1724, Painbox.Constructor(Vector3(5534.398f, 5419.398f, 64.12264f), painbox_radius_continuous), owning_building_guid = 48)
      LocalObject(1725, Painbox.Constructor(Vector3(5539.892f, 5429.913f, 64.12264f), painbox_radius_continuous), owning_building_guid = 48)
    }
    ...
    def Building25(): Unit = { // Name: NW_Cyssor_Warpgate_Tower Type: tower_a GUID: 49, MapID: 25
      ...
      LocalObject(1416, Terminal.Constructor(Vector3(5653.345f, 3605.985f, 154.1086f), order_terminal), owning_building_guid = 49)
      LocalObject(1417, Terminal.Constructor(Vector3(5655.114f, 3611.429f, 154.1086f), order_terminal), owning_building_guid = 49)
      LocalObject(1418, Terminal.Constructor(Vector3(5656.777f, 3616.547f, 154.1086f), order_terminal), owning_building_guid = 49)
      LocalObject(1875, SpawnTube.Constructor(Vector3(5642.394f, 3607.034f, 152.2586f), respawn_tube_tower, Vector3(0, 0, 18)), owning_building_guid = 49)
      LocalObject(1876, SpawnTube.Constructor(Vector3(5647.465f, 3622.64f, 152.2586f), respawn_tube_tower, Vector3(0, 0, 18)), owning_building_guid = 49)
      LocalObject(1282, FacilityTurret.Constructor(Vector3(5620.015f, 3613.835f, 181.7186f), manned_turret), owning_building_guid = 49)
      TurretToWeapon(1282, 5069)
      LocalObject(1283, FacilityTurret.Constructor(Vector3(5661.465f, 3627.087f, 181.7186f), manned_turret), owning_building_guid = 49)
      TurretToWeapon(1283, 5070)
      LocalObject(1726, Painbox.Constructor(Vector3(5639.064f, 3614.489f, 154.2757f), painbox_radius_continuous), owning_building_guid = 49)
      LocalObject(1727, Painbox.Constructor(Vector3(5649.123f, 3607.456f, 152.8766f), painbox_radius_continuous), owning_building_guid = 49)
      LocalObject(1728, Painbox.Constructor(Vector3(5652.707f, 3618.765f, 152.8766f), painbox_radius_continuous), owning_building_guid = 49)
    }
    ...
    def Building22(): Unit = { // Name: S_Sobek_Tower Type: tower_b GUID: 50, MapID: 22
      ...
      LocalObject(1332, Terminal.Constructor(Vector3(3174.537f, 2873.443f, 61.42691f), order_terminal), owning_building_guid = 50)
      LocalObject(1333, Terminal.Constructor(Vector3(3178.719f, 2870.057f, 61.42691f), order_terminal), owning_building_guid = 50)
      LocalObject(1334, Terminal.Constructor(Vector3(3183.168f, 2866.455f, 61.42691f), order_terminal), owning_building_guid = 50)
      LocalObject(1821, SpawnTube.Constructor(Vector3(3165.511f, 2866.933f, 59.57691f), respawn_tube_tower, Vector3(0, 0, 309)), owning_building_guid = 50)
      LocalObject(1822, SpawnTube.Constructor(Vector3(3178.264f, 2856.606f, 59.57691f), respawn_tube_tower, Vector3(0, 0, 309)), owning_building_guid = 50)
      LocalObject(1681, Painbox.Constructor(Vector3(3171.014f, 2855.769f, 61.38431f), painbox_radius_continuous), owning_building_guid = 50)
      LocalObject(1682, Painbox.Constructor(Vector3(3171.224f, 2870.739f, 60.19491f), painbox_radius_continuous), owning_building_guid = 50)
      LocalObject(1683, Painbox.Constructor(Vector3(3180.489f, 2863.066f, 60.19491f), painbox_radius_continuous), owning_building_guid = 50)
    }
    ...
    def Building37(): Unit = { // Name: N_Aton_Tower Type: tower_b GUID: 51, MapID: 37
      ...
      LocalObject(1351, Terminal.Constructor(Vector3(3710.994f, 5632.582f, 72.67908f), order_terminal), owning_building_guid = 51)
      LocalObject(1352, Terminal.Constructor(Vector3(3715.848f, 5635.615f, 72.67908f), order_terminal), owning_building_guid = 51)
      LocalObject(1353, Terminal.Constructor(Vector3(3720.411f, 5638.467f, 72.67908f), order_terminal), owning_building_guid = 51)
      LocalObject(1832, SpawnTube.Constructor(Vector3(3703.278f, 5640.425f, 70.82909f), respawn_tube_tower, Vector3(0, 0, 58)), owning_building_guid = 51)
      LocalObject(1834, SpawnTube.Constructor(Vector3(3717.194f, 5649.121f, 70.82909f), respawn_tube_tower, Vector3(0, 0, 58)), owning_building_guid = 51)
      LocalObject(1690, Painbox.Constructor(Vector3(3704.846f, 5647.552f, 72.63648f), painbox_radius_continuous), owning_building_guid = 51)
      LocalObject(1691, Painbox.Constructor(Vector3(3708.662f, 5636.217f, 71.44708f), painbox_radius_continuous), owning_building_guid = 51)
      LocalObject(1692, Painbox.Constructor(Vector3(3718.933f, 5642.479f, 71.44708f), painbox_radius_continuous), owning_building_guid = 51)
    }
    ...
    def Building41(): Unit = { // Name: E_Hossin_Warpgate_Tower Type: tower_b GUID: 52, MapID: 41
      ...
      LocalObject(1381, Terminal.Constructor(Vector3(4499.884f, 7276.534f, 53.09536f), order_terminal), owning_building_guid = 52)
      LocalObject(1382, Terminal.Constructor(Vector3(4502.121f, 7281.803f, 53.09536f), order_terminal), owning_building_guid = 52)
      LocalObject(1383, Terminal.Constructor(Vector3(4504.223f, 7286.756f, 53.09536f), order_terminal), owning_building_guid = 52)
      LocalObject(1852, SpawnTube.Constructor(Vector3(4489.065f, 7278.533f, 51.24536f), respawn_tube_tower, Vector3(0, 0, 23)), owning_building_guid = 52)
      LocalObject(1853, SpawnTube.Constructor(Vector3(4495.477f, 7293.639f, 51.24536f), respawn_tube_tower, Vector3(0, 0, 23)), owning_building_guid = 52)
      LocalObject(1705, Painbox.Constructor(Vector3(4486.262f, 7285.271f, 53.05276f), painbox_radius_continuous), owning_building_guid = 52)
      LocalObject(1706, Painbox.Constructor(Vector3(4495.889f, 7278.175f, 51.86336f), painbox_radius_continuous), owning_building_guid = 52)
      LocalObject(1708, Painbox.Constructor(Vector3(4500.71f, 7289.195f, 51.86336f), painbox_radius_continuous), owning_building_guid = 52)
    }
    ...
    def Building18(): Unit = { // Name: N_Hapi_Tower Type: tower_b GUID: 53, MapID: 18
      ...
      LocalObject(1384, Terminal.Constructor(Vector3(4515.257f, 4887.099f, 66.023f), order_terminal), owning_building_guid = 53)
      LocalObject(1385, Terminal.Constructor(Vector3(4515.726f, 4881.738f, 66.023f), order_terminal), owning_building_guid = 53)
      LocalObject(1386, Terminal.Constructor(Vector3(4516.225f, 4876.036f, 66.023f), order_terminal), owning_building_guid = 53)
      LocalObject(1854, SpawnTube.Constructor(Vector3(4504.303f, 4889.069f, 64.173f), respawn_tube_tower, Vector3(0, 0, 355)), owning_building_guid = 53)
      LocalObject(1855, SpawnTube.Constructor(Vector3(4505.733f, 4872.722f, 64.173f), respawn_tube_tower, Vector3(0, 0, 355)), owning_building_guid = 53)
      LocalObject(1707, Painbox.Constructor(Vector3(4500.095f, 4877.355f, 65.9804f), painbox_radius_continuous), owning_building_guid = 53)
      LocalObject(1710, Painbox.Constructor(Vector3(4511.01f, 4887.603f, 64.791f), painbox_radius_continuous), owning_building_guid = 53)
      LocalObject(1711, Painbox.Constructor(Vector3(4511.927f, 4875.608f, 64.791f), painbox_radius_continuous), owning_building_guid = 53)
    }
    ...
    def Building15(): Unit = { // Name: S_Amun_Tower Type: tower_b GUID: 54, MapID: 15
      ...
      LocalObject(1387, Terminal.Constructor(Vector3(4520.721f, 1917.666f, 67.80833f), order_terminal), owning_building_guid = 54)
      LocalObject(1388, Terminal.Constructor(Vector3(4521.839f, 1912.402f, 67.80833f), order_terminal), owning_building_guid = 54)
      LocalObject(1389, Terminal.Constructor(Vector3(4523.03f, 1906.804f, 67.80833f), order_terminal), owning_building_guid = 54)
      LocalObject(1856, SpawnTube.Constructor(Vector3(4509.609f, 1918.287f, 65.95834f), respawn_tube_tower, Vector3(0, 0, 348)), owning_building_guid = 54)
      LocalObject(1857, SpawnTube.Constructor(Vector3(4513.021f, 1902.236f, 65.95834f), respawn_tube_tower, Vector3(0, 0, 348)), owning_building_guid = 54)
      LocalObject(1709, Painbox.Constructor(Vector3(4506.859f, 1906.147f, 67.76573f), painbox_radius_continuous), owning_building_guid = 54)
      LocalObject(1712, Painbox.Constructor(Vector3(4516.444f, 1917.649f, 66.57633f), painbox_radius_continuous), owning_building_guid = 54)
      LocalObject(1713, Painbox.Constructor(Vector3(4518.816f, 1905.856f, 66.57633f), painbox_radius_continuous), owning_building_guid = 54)
    }
    ...
    def Building39(): Unit = { // Name: E_Forseral_Warpgate_Tower Type: tower_c GUID: 55, MapID: 39
      ...
      LocalObject(1315, Terminal.Constructor(Vector3(2844.42f, 5315.234f, 166.4411f), order_terminal), owning_building_guid = 55)
      LocalObject(1316, Terminal.Constructor(Vector3(2845.805f, 5320.788f, 166.4411f), order_terminal), owning_building_guid = 55)
      LocalObject(1317, Terminal.Constructor(Vector3(2847.106f, 5326.009f, 166.4411f), order_terminal), owning_building_guid = 55)
      LocalObject(1812, SpawnTube.Constructor(Vector3(2833.423f, 5315.516f, 164.5911f), respawn_tube_tower, Vector3(0, 0, 14)), owning_building_guid = 55)
      LocalObject(1813, SpawnTube.Constructor(Vector3(2837.392f, 5331.438f, 164.5911f), respawn_tube_tower, Vector3(0, 0, 14)), owning_building_guid = 55)
      LocalObject(1579, ProximityTerminal.Constructor(Vector3(2823.663f, 5325.146f, 202.6791f), pad_landing_tower_frame), owning_building_guid = 55)
      LocalObject(1580, Terminal.Constructor(Vector3(2823.663f, 5325.146f, 202.6791f), air_rearm_terminal), owning_building_guid = 55)
      LocalObject(1582, ProximityTerminal.Constructor(Vector3(2826.19f, 5335.281f, 202.6791f), pad_landing_tower_frame), owning_building_guid = 55)
      LocalObject(1583, Terminal.Constructor(Vector3(2826.19f, 5335.281f, 202.6791f), air_rearm_terminal), owning_building_guid = 55)
      LocalObject(1203, FacilityTurret.Constructor(Vector3(2807.896f, 5319.101f, 194.0511f), manned_turret), owning_building_guid = 55)
      TurretToWeapon(1203, 5071)
      LocalObject(1204, FacilityTurret.Constructor(Vector3(2852.417f, 5338.828f, 194.0511f), manned_turret), owning_building_guid = 55)
      TurretToWeapon(1204, 5072)
      LocalObject(1672, Painbox.Constructor(Vector3(2828.592f, 5321.984f, 167.1286f), painbox_radius_continuous), owning_building_guid = 55)
      LocalObject(1673, Painbox.Constructor(Vector3(2839.89f, 5315.756f, 165.2091f), painbox_radius_continuous), owning_building_guid = 55)
      LocalObject(1674, Painbox.Constructor(Vector3(2843.094f, 5327.822f, 165.2091f), painbox_radius_continuous), owning_building_guid = 55)
    }
    ...
    def Building23(): Unit = { // Name: NW_Mont_Tower Type: tower_c GUID: 56, MapID: 23
      ...
      LocalObject(1335, Terminal.Constructor(Vector3(3201.186f, 4391.211f, 96.92299f), order_terminal), owning_building_guid = 56)
      LocalObject(1336, Terminal.Constructor(Vector3(3204.631f, 4395.782f, 96.92299f), order_terminal), owning_building_guid = 56)
      LocalObject(1337, Terminal.Constructor(Vector3(3207.869f, 4400.08f, 96.92299f), order_terminal), owning_building_guid = 56)
      LocalObject(1823, SpawnTube.Constructor(Vector3(3191.173f, 4395.767f, 95.07299f), respawn_tube_tower, Vector3(0, 0, 37)), owning_building_guid = 56)
      LocalObject(1824, SpawnTube.Constructor(Vector3(3201.049f, 4408.873f, 95.07299f), respawn_tube_tower, Vector3(0, 0, 37)), owning_building_guid = 56)
      LocalObject(1585, ProximityTerminal.Constructor(Vector3(3185.953f, 4408.445f, 133.161f), pad_landing_tower_frame), owning_building_guid = 56)
      LocalObject(1586, Terminal.Constructor(Vector3(3185.953f, 4408.445f, 133.161f), air_rearm_terminal), owning_building_guid = 56)
      LocalObject(1588, ProximityTerminal.Constructor(Vector3(3192.239f, 4416.787f, 133.161f), pad_landing_tower_frame), owning_building_guid = 56)
      LocalObject(1589, Terminal.Constructor(Vector3(3192.239f, 4416.787f, 133.161f), air_rearm_terminal), owning_building_guid = 56)
      LocalObject(1217, FacilityTurret.Constructor(Vector3(3169.076f, 4409.042f, 124.533f), manned_turret), owning_building_guid = 56)
      TurretToWeapon(1217, 5073)
      LocalObject(1218, FacilityTurret.Constructor(Vector3(3217.767f, 4409.804f, 124.533f), manned_turret), owning_building_guid = 56)
      TurretToWeapon(1218, 5074)
      LocalObject(1684, Painbox.Constructor(Vector3(3189.254f, 4403.608f, 97.61049f), painbox_radius_continuous), owning_building_guid = 56)
      LocalObject(1685, Painbox.Constructor(Vector3(3197.22f, 4393.461f, 95.69099f), painbox_radius_continuous), owning_building_guid = 56)
      LocalObject(1686, Painbox.Constructor(Vector3(3204.884f, 4403.316f, 95.69099f), painbox_radius_continuous), owning_building_guid = 56)
    }
    ...
    def Building42(): Unit = { // Name: E_Amerish_Warpgate_Tower Type: tower_c GUID: 57, MapID: 42
      ...
      LocalObject(1361, Terminal.Constructor(Vector3(4076.355f, 1273.157f, 59.54087f), order_terminal), owning_building_guid = 57)
      LocalObject(1362, Terminal.Constructor(Vector3(4078.882f, 1268.406f, 59.54087f), order_terminal), owning_building_guid = 57)
      LocalObject(1363, Terminal.Constructor(Vector3(4081.569f, 1263.352f, 59.54087f), order_terminal), owning_building_guid = 57)
      LocalObject(1840, SpawnTube.Constructor(Vector3(4065.504f, 1270.692f, 57.69087f), respawn_tube_tower, Vector3(0, 0, 332)), owning_building_guid = 57)
      LocalObject(1841, SpawnTube.Constructor(Vector3(4073.208f, 1256.203f, 57.69087f), respawn_tube_tower, Vector3(0, 0, 332)), owning_building_guid = 57)
      LocalObject(1591, ProximityTerminal.Constructor(Vector3(4054.608f, 1266.052f, 95.77887f), pad_landing_tower_frame), owning_building_guid = 57)
      LocalObject(1592, Terminal.Constructor(Vector3(4054.608f, 1266.052f, 95.77887f), air_rearm_terminal), owning_building_guid = 57)
      LocalObject(1594, ProximityTerminal.Constructor(Vector3(4059.511f, 1256.829f, 95.77887f), pad_landing_tower_frame), owning_building_guid = 57)
      LocalObject(1595, Terminal.Constructor(Vector3(4059.511f, 1256.829f, 95.77887f), air_rearm_terminal), owning_building_guid = 57)
      LocalObject(1239, FacilityTurret.Constructor(Vector3(4051.839f, 1241.786f, 87.15087f), manned_turret), owning_building_guid = 57)
      TurretToWeapon(1239, 5075)
      LocalObject(1240, FacilityTurret.Constructor(Vector3(4071.725f, 1286.237f, 87.15087f), manned_turret), owning_building_guid = 57)
      TurretToWeapon(1240, 5076)
      LocalObject(1696, Painbox.Constructor(Vector3(4065.29f, 1257.777f, 60.22837f), painbox_radius_continuous), owning_building_guid = 57)
      LocalObject(1697, Painbox.Constructor(Vector3(4072.16f, 1271.819f, 58.30887f), painbox_radius_continuous), owning_building_guid = 57)
      LocalObject(1698, Painbox.Constructor(Vector3(4077.853f, 1260.709f, 58.30887f), painbox_radius_continuous), owning_building_guid = 57)
    }
    ...
    def Building19(): Unit = { // Name: NW_Seth_Tower Type: tower_c GUID: 58, MapID: 19
      ...
      LocalObject(1364, Terminal.Constructor(Vector3(4165.747f, 6236.103f, 84.54469f), order_terminal), owning_building_guid = 58)
      LocalObject(1365, Terminal.Constructor(Vector3(4168.518f, 6231.49f, 84.54469f), order_terminal), owning_building_guid = 58)
      LocalObject(1366, Terminal.Constructor(Vector3(4171.466f, 6226.584f, 84.54469f), order_terminal), owning_building_guid = 58)
      LocalObject(1842, SpawnTube.Constructor(Vector3(4155.039f, 6233.073f, 82.69469f), respawn_tube_tower, Vector3(0, 0, 329)), owning_building_guid = 58)
      LocalObject(1843, SpawnTube.Constructor(Vector3(4163.49f, 6219.007f, 82.69469f), respawn_tube_tower, Vector3(0, 0, 329)), owning_building_guid = 58)
      LocalObject(1597, ProximityTerminal.Constructor(Vector3(4144.4f, 6227.869f, 120.7827f), pad_landing_tower_frame), owning_building_guid = 58)
      LocalObject(1598, Terminal.Constructor(Vector3(4144.4f, 6227.869f, 120.7827f), air_rearm_terminal), owning_building_guid = 58)
      LocalObject(1600, ProximityTerminal.Constructor(Vector3(4149.78f, 6218.916f, 120.7827f), pad_landing_tower_frame), owning_building_guid = 58)
      LocalObject(1601, Terminal.Constructor(Vector3(4149.78f, 6218.916f, 120.7827f), air_rearm_terminal), owning_building_guid = 58)
      LocalObject(1241, FacilityTurret.Constructor(Vector3(4142.905f, 6203.492f, 112.1547f), manned_turret), owning_building_guid = 58)
      TurretToWeapon(1241, 5077)
      LocalObject(1242, FacilityTurret.Constructor(Vector3(4160.438f, 6248.922f, 112.1547f), manned_turret), owning_building_guid = 58)
      TurretToWeapon(1242, 5078)
      LocalObject(1699, Painbox.Constructor(Vector3(4155.501f, 6220.165f, 85.23219f), painbox_radius_continuous), owning_building_guid = 58)
      LocalObject(1700, Painbox.Constructor(Vector3(4161.627f, 6234.547f, 83.31268f), painbox_radius_continuous), owning_building_guid = 58)
      LocalObject(1701, Painbox.Constructor(Vector3(4167.894f, 6223.75f, 83.31268f), painbox_radius_continuous), owning_building_guid = 58)
    }
    ...
    def Building16(): Unit = { // Name: E_Amun_Tower Type: tower_c GUID: 59, MapID: 16
      ...
      LocalObject(1401, Terminal.Constructor(Vector3(5096.859f, 1809.311f, 68.04638f), order_terminal), owning_building_guid = 59)
      LocalObject(1402, Terminal.Constructor(Vector3(5099.945f, 1804.903f, 68.04638f), order_terminal), owning_building_guid = 59)
      LocalObject(1403, Terminal.Constructor(Vector3(5103.229f, 1800.214f, 68.04638f), order_terminal), owning_building_guid = 59)
      LocalObject(1866, SpawnTube.Constructor(Vector3(5086.388f, 1805.542f, 66.19638f), respawn_tube_tower, Vector3(0, 0, 325)), owning_building_guid = 59)
      LocalObject(1867, SpawnTube.Constructor(Vector3(5095.801f, 1792.099f, 66.19638f), respawn_tube_tower, Vector3(0, 0, 325)), owning_building_guid = 59)
      LocalObject(1603, ProximityTerminal.Constructor(Vector3(5076.139f, 1799.608f, 104.2844f), pad_landing_tower_frame), owning_building_guid = 59)
      LocalObject(1604, Terminal.Constructor(Vector3(5076.139f, 1799.608f, 104.2844f), air_rearm_terminal), owning_building_guid = 59)
      LocalObject(1606, ProximityTerminal.Constructor(Vector3(5082.13f, 1791.052f, 104.2844f), pad_landing_tower_frame), owning_building_guid = 59)
      LocalObject(1607, Terminal.Constructor(Vector3(5082.13f, 1791.052f, 104.2844f), air_rearm_terminal), owning_building_guid = 59)
      LocalObject(1270, FacilityTurret.Constructor(Vector3(5076.348f, 1775.186f, 95.65638f), manned_turret), owning_building_guid = 59)
      TurretToWeapon(1270, 5079)
      LocalObject(1271, FacilityTurret.Constructor(Vector3(5090.668f, 1821.729f, 95.65638f), manned_turret), owning_building_guid = 59)
      TurretToWeapon(1271, 5080)
      LocalObject(1717, Painbox.Constructor(Vector3(5087.75f, 1792.697f, 68.73388f), painbox_radius_continuous), owning_building_guid = 59)
      LocalObject(1718, Painbox.Constructor(Vector3(5092.858f, 1807.472f, 66.81438f), painbox_radius_continuous), owning_building_guid = 59)
      LocalObject(1719, Painbox.Constructor(Vector3(5099.862f, 1797.138f, 66.81438f), painbox_radius_continuous), owning_building_guid = 59)
    }
    ...
    def Building40(): Unit = { // Name: N_Bastet_Tower Type: tower_c GUID: 60, MapID: 40
      ...
      LocalObject(1410, Terminal.Constructor(Vector3(5534.082f, 5951.589f, 44.25739f), order_terminal), owning_building_guid = 60)
      LocalObject(1411, Terminal.Constructor(Vector3(5534.78f, 5957.271f, 44.25739f), order_terminal), owning_building_guid = 60)
      LocalObject(1412, Terminal.Constructor(Vector3(5535.436f, 5962.611f, 44.25739f), order_terminal), owning_building_guid = 60)
      LocalObject(1871, SpawnTube.Constructor(Vector3(5523.132f, 5950.529f, 42.40739f), respawn_tube_tower, Vector3(0, 0, 7)), owning_building_guid = 60)
      LocalObject(1872, SpawnTube.Constructor(Vector3(5525.132f, 5966.816f, 42.40739f), respawn_tube_tower, Vector3(0, 0, 7)), owning_building_guid = 60)
      LocalObject(1609, ProximityTerminal.Constructor(Vector3(5512.272f, 5958.897f, 80.49538f), pad_landing_tower_frame), owning_building_guid = 60)
      LocalObject(1610, Terminal.Constructor(Vector3(5512.272f, 5958.897f, 80.49538f), air_rearm_terminal), owning_building_guid = 60)
      LocalObject(1612, ProximityTerminal.Constructor(Vector3(5513.545f, 5969.265f, 80.49538f), pad_landing_tower_frame), owning_building_guid = 60)
      LocalObject(1613, Terminal.Constructor(Vector3(5513.545f, 5969.265f, 80.49538f), air_rearm_terminal), owning_building_guid = 60)
      LocalObject(1278, FacilityTurret.Constructor(Vector3(5497.359f, 5950.976f, 71.86739f), manned_turret), owning_building_guid = 60)
      TurretToWeapon(1278, 5081)
      LocalObject(1280, FacilityTurret.Constructor(Vector3(5539.145f, 5975.982f, 71.86739f), manned_turret), owning_building_guid = 60)
      TurretToWeapon(1280, 5082)
      LocalObject(1720, Painbox.Constructor(Vector3(5517.549f, 5956.359f, 44.94489f), painbox_radius_continuous), owning_building_guid = 60)
      LocalObject(1722, Painbox.Constructor(Vector3(5529.522f, 5951.555f, 43.02538f), painbox_radius_continuous), owning_building_guid = 60)
      LocalObject(1723, Painbox.Constructor(Vector3(5531.231f, 5963.921f, 43.02538f), painbox_radius_continuous), owning_building_guid = 60)
    }
