...
object Map09 {
  ...
  val ZoneMap = new ZoneMap("map09") {
    ...
    def Building14(): Unit = { // Name: Rehua Type: amp_station GUID: 1, MapID: 14
      ...
      LocalObject(1881, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1882, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1883, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1884, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1885, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1886, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(2656, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2657, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2658, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2659, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2660, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2661, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2911, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 1)
      LocalObject(1801, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3724.629f, 2243.049f, 57.71703f), Vector3(0, 0, 207)), owning_building_guid = 1, terminal_guid = 2911)
      ...
      LocalObject(1820, ProximityTerminal.Constructor(medical_terminal, Vector3(3716.352f, 2170.004f, 64.97202f)), owning_building_guid = 1)
      LocalObject(1821, ProximityTerminal.Constructor(medical_terminal, Vector3(3746.075f, 2161.174f, 44.97203f)), owning_building_guid = 1)
      LocalObject(2078, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3693.968f, 2203.606f, 68.27702f)), owning_building_guid = 1)
      LocalObject(2079, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2081, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3710.028f, 2090.748f, 68.30003f)), owning_building_guid = 1)
      LocalObject(2082, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2090, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3770.99f, 2119.913f, 68.27702f)), owning_building_guid = 1)
      LocalObject(2091, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2093, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3785.763f, 2199.08f, 70.43803f)), owning_building_guid = 1)
      LocalObject(2094, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2425, ProximityTerminal.Constructor(repair_silo, Vector3(3673.636f, 2192.004f, 59.17203f)), owning_building_guid = 1)
      LocalObject(2426, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(2437, ProximityTerminal.Constructor(repair_silo, Vector3(3791.71f, 2132.056f, 59.17203f)), owning_building_guid = 1)
      LocalObject(2438, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1702, FacilityTurret.Constructor(manned_turret, Vector3(3620.226f, 2110.306f, 68.48003f)), owning_building_guid = 1)
      TurretToWeapon(1702, 5000)
      LocalObject(1706, FacilityTurret.Constructor(manned_turret, Vector3(3672.307f, 2081.269f, 68.48003f)), owning_building_guid = 1)
      TurretToWeapon(1706, 5001)
      LocalObject(1708, FacilityTurret.Constructor(manned_turret, Vector3(3711.759f, 2290.015f, 68.48003f)), owning_building_guid = 1)
      TurretToWeapon(1708, 5002)
      LocalObject(1710, FacilityTurret.Constructor(manned_turret, Vector3(3756.928f, 2040.641f, 68.48003f)), owning_building_guid = 1)
      TurretToWeapon(1710, 5003)
      LocalObject(1713, FacilityTurret.Constructor(manned_turret, Vector3(3821.697f, 2162.852f, 68.48003f)), owning_building_guid = 1)
      TurretToWeapon(1713, 5004)
      LocalObject(1716, FacilityTurret.Constructor(manned_turret, Vector3(3848.496f, 2220.333f, 68.48003f)), owning_building_guid = 1)
    ...
    def Building13(): Unit = { // Name: Pele Type: amp_station GUID: 4, MapID: 13
      ...
      LocalObject(1908, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1909, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1910, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1911, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1912, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1913, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(2682, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2683, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2684, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2685, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2686, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2687, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2914, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 4)
      LocalObject(1808, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4437.373f, 3771.783f, 205.947f), Vector3(0, 0, 213)), owning_building_guid = 4, terminal_guid = 2914)
      ...
      LocalObject(1827, ProximityTerminal.Constructor(medical_terminal, Vector3(4421.506f, 3700.003f, 213.202f)), owning_building_guid = 4)
      LocalObject(1828, ProximityTerminal.Constructor(medical_terminal, Vector3(4450.143f, 3688.115f, 193.202f)), owning_building_guid = 4)
      LocalObject(2132, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4402.756f, 3735.761f, 216.507f)), owning_building_guid = 4)
      LocalObject(2133, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2135, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4406.931f, 3621.843f, 216.53f)), owning_building_guid = 4)
      LocalObject(2136, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2138, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4470.607f, 3644.475f, 216.507f)), owning_building_guid = 4)
      LocalObject(2139, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2141, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4493.575f, 3721.664f, 218.668f)), owning_building_guid = 4)
      LocalObject(2142, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2453, ProximityTerminal.Constructor(repair_silo, Vector3(4381.323f, 3726.348f, 207.4019f)), owning_building_guid = 4)
      LocalObject(2454, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(2457, ProximityTerminal.Constructor(repair_silo, Vector3(4492.484f, 3654.385f, 207.4019f)), owning_building_guid = 4)
      LocalObject(2458, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(1729, FacilityTurret.Constructor(manned_turret, Vector3(4319.666f, 3650.68f, 216.71f)), owning_building_guid = 4)
      TurretToWeapon(1729, 5006)
      LocalObject(1731, FacilityTurret.Constructor(manned_turret, Vector3(4368.426f, 3616.358f, 216.71f)), owning_building_guid = 4)
      TurretToWeapon(1731, 5007)
      LocalObject(1733, FacilityTurret.Constructor(manned_turret, Vector3(4429.482f, 3819.836f, 216.71f)), owning_building_guid = 4)
      TurretToWeapon(1733, 5008)
      LocalObject(1734, FacilityTurret.Constructor(manned_turret, Vector3(4448.337f, 3567.108f, 216.71f)), owning_building_guid = 4)
      TurretToWeapon(1734, 5009)
      LocalObject(1737, FacilityTurret.Constructor(manned_turret, Vector3(4525.526f, 3681.879f, 216.71f)), owning_building_guid = 4)
      TurretToWeapon(1737, 5010)
      LocalObject(1739, FacilityTurret.Constructor(manned_turret, Vector3(4558.186f, 3736.243f, 216.71f)), owning_building_guid = 4)
    ...
    def Building10(): Unit = { // Name: Matagi Type: amp_station GUID: 7, MapID: 10
      ...
      LocalObject(1944, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1945, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1947, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1948, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1949, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1951, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(2707, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2709, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2711, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2712, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2713, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2715, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2918, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 7)
      LocalObject(1812, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5198.674f, 5051.121f, 237.0499f), Vector3(0, 0, 159)), owning_building_guid = 7, terminal_guid = 2918)
      ...
      LocalObject(1834, ProximityTerminal.Constructor(medical_terminal, Vector3(5247.418f, 4996.093f, 244.3049f)), owning_building_guid = 7)
      LocalObject(1835, ProximityTerminal.Constructor(medical_terminal, Vector3(5273.869f, 5012.273f, 224.3049f)), owning_building_guid = 7)
      LocalObject(2162, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5207.469f, 5001.942f, 247.6099f)), owning_building_guid = 7)
      LocalObject(2163, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2171, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5272.256f, 5067.13f, 249.7709f)), owning_building_guid = 7)
      LocalObject(2172, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2174, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5302.085f, 4938.36f, 247.6329f)), owning_building_guid = 7)
      LocalObject(2175, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2180, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5321.203f, 5003.179f, 247.6099f)), owning_building_guid = 7)
      LocalObject(2181, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2485, ProximityTerminal.Constructor(repair_silo, Vector3(5202.486f, 4979.07f, 238.5049f)), owning_building_guid = 7)
      LocalObject(2486, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(2497, ProximityTerminal.Constructor(repair_silo, Vector3(5326.044f, 5026.702f, 238.5049f)), owning_building_guid = 7)
      LocalObject(2498, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(1760, FacilityTurret.Constructor(manned_turret, Vector3(5155.16f, 5072.982f, 247.8129f)), owning_building_guid = 7)
      TurretToWeapon(1760, 5012)
      LocalObject(1763, FacilityTurret.Constructor(manned_turret, Vector3(5227.462f, 4884.711f, 247.8129f)), owning_building_guid = 7)
      TurretToWeapon(1763, 5013)
      LocalObject(1765, FacilityTurret.Constructor(manned_turret, Vector3(5283.89f, 4903.985f, 247.8129f)), owning_building_guid = 7)
      TurretToWeapon(1765, 5014)
      LocalObject(1768, FacilityTurret.Constructor(manned_turret, Vector3(5298.438f, 5127.971f, 247.8129f)), owning_building_guid = 7)
      TurretToWeapon(1768, 5015)
      LocalObject(1770, FacilityTurret.Constructor(manned_turret, Vector3(5323.223f, 5069.594f, 247.8129f)), owning_building_guid = 7)
      TurretToWeapon(1770, 5016)
      LocalObject(1771, FacilityTurret.Constructor(manned_turret, Vector3(5370.705f, 4939.687f, 247.8129f)), owning_building_guid = 7)
    ...
    def Building17(): Unit = { // Name: Wakea Type: comm_station GUID: 23, MapID: 17
      ...
      LocalObject(1850, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1851, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1852, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1853, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1856, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1857, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(1858, Terminal.Constructor(order_terminal), owning_building_guid = 23)
      LocalObject(2649, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2650, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2651, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2652, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2653, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2654, Terminal.Constructor(spawn_terminal), owning_building_guid = 23)
      LocalObject(2909, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 23)
      LocalObject(1799, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1776.833f, 5368.62f, 61.72378f), Vector3(0, 0, -90)), owning_building_guid = 23, terminal_guid = 2909)
      ...
      LocalObject(1818, ProximityTerminal.Constructor(medical_terminal, Vector3(1738.864f, 5285.023f, 63.19478f)), owning_building_guid = 23)
      LocalObject(1819, ProximityTerminal.Constructor(medical_terminal, Vector3(1802.444f, 5343.62f, 45.69478f)), owning_building_guid = 23)
      LocalObject(2069, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1719.154f, 5369.185f, 71.43578f)), owning_building_guid = 23)
      LocalObject(2070, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 23)
      LocalObject(2413, ProximityTerminal.Constructor(repair_silo, Vector3(1676.912f, 5337.18f, 62.74478f)), owning_building_guid = 23)
      LocalObject(2414, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 23)
      LocalObject(2417, ProximityTerminal.Constructor(repair_silo, Vector3(1799.641f, 5289.67f, 62.74478f)), owning_building_guid = 23)
      LocalObject(2418, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 23)
      LocalObject(1686, FacilityTurret.Constructor(manned_turret, Vector3(1664.424f, 5352.652f, 71.70278f)), owning_building_guid = 23)
      TurretToWeapon(1686, 5018)
      LocalObject(1687, FacilityTurret.Constructor(manned_turret, Vector3(1665.554f, 5233.565f, 71.70278f)), owning_building_guid = 23)
      TurretToWeapon(1687, 5019)
      LocalObject(1688, FacilityTurret.Constructor(manned_turret, Vector3(1707.549f, 5395.75f, 71.70278f)), owning_building_guid = 23)
      TurretToWeapon(1688, 5020)
      LocalObject(1689, FacilityTurret.Constructor(manned_turret, Vector3(1768.865f, 5232.388f, 71.70278f)), owning_building_guid = 23)
      TurretToWeapon(1689, 5021)
      LocalObject(1692, FacilityTurret.Constructor(manned_turret, Vector3(1810.841f, 5394.435f, 71.70278f)), owning_building_guid = 23)
      TurretToWeapon(1692, 5022)
      LocalObject(1693, FacilityTurret.Constructor(manned_turret, Vector3(1812.01f, 5275.501f, 71.70278f)), owning_building_guid = 23)
    ...
    def Building9(): Unit = { // Name: Laka Type: comm_station GUID: 26, MapID: 9
      ...
      LocalObject(1918, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1919, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1920, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1921, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1922, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1923, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(1924, Terminal.Constructor(order_terminal), owning_building_guid = 26)
      LocalObject(2695, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2696, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2697, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2698, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2699, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2700, Terminal.Constructor(spawn_terminal), owning_building_guid = 26)
      LocalObject(2915, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 26)
      LocalObject(1810, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4597.897f, 6761.692f, 47.68718f), Vector3(0, 0, 204)), owning_building_guid = 26, terminal_guid = 2915)
      ...
      LocalObject(1830, ProximityTerminal.Constructor(medical_terminal, Vector3(4631.152f, 6774.92f, 31.65818f)), owning_building_guid = 26)
      LocalObject(1831, ProximityTerminal.Constructor(medical_terminal, Vector3(4658.823f, 6693.003f, 49.15818f)), owning_building_guid = 26)
      LocalObject(2156, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4573.92f, 6709.229f, 57.39918f)), owning_building_guid = 26)
      LocalObject(2157, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 26)
      LocalObject(2465, ProximityTerminal.Constructor(repair_silo, Vector3(4585.978f, 6657.621f, 48.70818f)), owning_building_guid = 26)
      LocalObject(2466, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 26)
      LocalObject(2473, ProximityTerminal.Constructor(repair_silo, Vector3(4679.298f, 6750.416f, 48.70818f)), owning_building_guid = 26)
      LocalObject(2474, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 26)
      LocalObject(1738, FacilityTurret.Constructor(manned_turret, Vector3(4544.932f, 6709.432f, 57.66618f)), owning_building_guid = 26)
      TurretToWeapon(1738, 5024)
      LocalObject(1740, FacilityTurret.Constructor(manned_turret, Vector3(4566.764f, 6652.506f, 57.66618f)), owning_building_guid = 26)
      TurretToWeapon(1740, 5025)
      LocalObject(1741, FacilityTurret.Constructor(manned_turret, Vector3(4588.146f, 6803.259f, 57.66618f)), owning_building_guid = 26)
      TurretToWeapon(1741, 5026)
      LocalObject(1746, FacilityTurret.Constructor(manned_turret, Vector3(4676.015f, 6605.102f, 57.66618f)), owning_building_guid = 26)
      TurretToWeapon(1746, 5027)
      LocalObject(1747, FacilityTurret.Constructor(manned_turret, Vector3(4697.273f, 6755.953f, 57.66618f)), owning_building_guid = 26)
      TurretToWeapon(1747, 5028)
      LocalObject(1749, FacilityTurret.Constructor(manned_turret, Vector3(4719.11f, 6699.002f, 57.66618f)), owning_building_guid = 26)
    ...
    def Building12(): Unit = { // Name: Oro Type: comm_station GUID: 29, MapID: 12
      ...
      LocalObject(1934, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1938, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1939, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1940, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1941, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1942, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(1943, Terminal.Constructor(order_terminal), owning_building_guid = 29)
      LocalObject(2701, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2702, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2703, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2704, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2705, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2706, Terminal.Constructor(spawn_terminal), owning_building_guid = 29)
      LocalObject(2917, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 29)
      LocalObject(1811, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4961.914f, 4525.889f, 206.731f), Vector3(0, 0, -25)), owning_building_guid = 29, terminal_guid = 2917)
      ...
      LocalObject(1832, ProximityTerminal.Constructor(medical_terminal, Vector3(4870.103f, 4524.971f, 208.202f)), owning_building_guid = 29)
      LocalObject(1833, ProximityTerminal.Constructor(medical_terminal, Vector3(4950.08f, 4492.112f, 190.702f)), owning_building_guid = 29)
      LocalObject(2159, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4938.05f, 4578.402f, 216.4429f)), owning_building_guid = 29)
      LocalObject(2160, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 29)
      LocalObject(2477, ProximityTerminal.Constructor(repair_silo, Vector3(4891.191f, 4603.161f, 207.752f)), owning_building_guid = 29)
      LocalObject(2478, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 29)
      LocalObject(2481, ProximityTerminal.Constructor(repair_silo, Vector3(4900f, 4471.852f, 207.752f)), owning_building_guid = 29)
      LocalObject(2482, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 29)
      LocalObject(1752, FacilityTurret.Constructor(manned_turret, Vector3(4792.484f, 4569.665f, 216.71f)), owning_building_guid = 29)
      TurretToWeapon(1752, 5030)
      LocalObject(1753, FacilityTurret.Constructor(manned_turret, Vector3(4835.079f, 4475.536f, 216.71f)), owning_building_guid = 29)
      TurretToWeapon(1753, 5031)
      LocalObject(1756, FacilityTurret.Constructor(manned_turret, Vector3(4892.386f, 4454.654f, 216.71f)), owning_building_guid = 29)
      TurretToWeapon(1756, 5032)
      LocalObject(1757, FacilityTurret.Constructor(manned_turret, Vector3(4899.936f, 4621.018f, 216.71f)), owning_building_guid = 29)
      TurretToWeapon(1757, 5033)
      LocalObject(1758, FacilityTurret.Constructor(manned_turret, Vector3(4957.222f, 4600.147f, 216.71f)), owning_building_guid = 29)
      TurretToWeapon(1758, 5034)
      LocalObject(1759, FacilityTurret.Constructor(manned_turret, Vector3(4999.683f, 4505.977f, 216.71f)), owning_building_guid = 29)
    ...
    def Building15(): Unit = { // Name: Sina Type: comm_station_dsp GUID: 32, MapID: 15
      ...
      LocalObject(279, Terminal.Constructor(dropship_vehicle_terminal), owning_building_guid = 32)
      LocalObject(278, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(5812.526f, 2338.031f, 90.98689f), Vector3(0, 0, 51)), owning_building_guid = 32, terminal_guid = 279)
      LocalObject(1960, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1961, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1962, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1963, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1964, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1965, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1966, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(1967, Terminal.Constructor(order_terminal), owning_building_guid = 32)
      LocalObject(2720, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2721, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2722, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2723, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2724, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2725, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2726, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2727, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2728, Terminal.Constructor(spawn_terminal), owning_building_guid = 32)
      LocalObject(2920, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 32)
      LocalObject(1814, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5792.408f, 2282.564f, 89.58789f), Vector3(0, 0, 141)), owning_building_guid = 32, terminal_guid = 2920)
      ...
      LocalObject(1837, ProximityTerminal.Constructor(medical_terminal, Vector3(5856.913f, 2176.016f, 91.05889f)), owning_building_guid = 32)
      LocalObject(1838, ProximityTerminal.Constructor(medical_terminal, Vector3(5869.442f, 2261.575f, 73.55889f)), owning_building_guid = 32)
      LocalObject(2186, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5764.576f, 2258.723f, 99.3689f)), owning_building_guid = 32)
      LocalObject(2187, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 32)
      LocalObject(2189, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5806.196f, 2233.324f, 96.65289f)), owning_building_guid = 32)
      LocalObject(2190, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 32)
      LocalObject(2192, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5869.215f, 2238.592f, 103.8349f)), owning_building_guid = 32)
      LocalObject(2193, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 32)
      LocalObject(2195, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5886.392f, 2273.421f, 99.3819f)), owning_building_guid = 32)
      LocalObject(2196, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 32)
      LocalObject(2501, ProximityTerminal.Constructor(repair_silo, Vector3(5766.25f, 2189.105f, 90.70889f)), owning_building_guid = 32)
      LocalObject(2502, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 32)
      LocalObject(2505, ProximityTerminal.Constructor(repair_silo, Vector3(5896.477f, 2298.306f, 90.70889f)), owning_building_guid = 32)
      LocalObject(2506, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 32)
      LocalObject(1775, FacilityTurret.Constructor(manned_turret, Vector3(5734.792f, 2208.502f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1775, 5036)
      LocalObject(1776, FacilityTurret.Constructor(manned_turret, Vector3(5740.5f, 2273.029f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1776, 5037)
      LocalObject(1777, FacilityTurret.Constructor(manned_turret, Vector3(5750.325f, 2356.243f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1777, 5038)
      LocalObject(1778, FacilityTurret.Constructor(manned_turret, Vector3(5819.581f, 2410.822f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1778, 5039)
      LocalObject(1779, FacilityTurret.Constructor(manned_turret, Vector3(5832.318f, 2089.898f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1779, 5040)
      LocalObject(1780, FacilityTurret.Constructor(manned_turret, Vector3(5913.002f, 2153.731f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1780, 5041)
      LocalObject(1781, FacilityTurret.Constructor(manned_turret, Vector3(5920.167f, 2211.795f, 99.56689f)), owning_building_guid = 32)
      TurretToWeapon(1781, 5042)
      LocalObject(1782, FacilityTurret.Constructor(manned_turret, Vector3(5926.362f, 2280.792f, 99.56689f)), owning_building_guid = 32)
    ...
    def Building5(): Unit = { // Name: Drakulu Type: cryo_facility GUID: 35, MapID: 5
      ...
      LocalObject(225, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(226, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(227, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(228, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(229, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(230, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(231, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(232, Terminal.Constructor(cert_terminal), owning_building_guid = 35)
      LocalObject(1887, Terminal.Constructor(order_terminal), owning_building_guid = 35)
      LocalObject(1888, Terminal.Constructor(order_terminal), owning_building_guid = 35)
      LocalObject(1889, Terminal.Constructor(order_terminal), owning_building_guid = 35)
      LocalObject(1890, Terminal.Constructor(order_terminal), owning_building_guid = 35)
      LocalObject(2655, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2662, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2663, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2664, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2665, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2666, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2674, Terminal.Constructor(spawn_terminal), owning_building_guid = 35)
      LocalObject(2910, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 35)
      LocalObject(1800, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3681.205f, 2682.483f, 149.2136f), Vector3(0, 0, 4)), owning_building_guid = 35, terminal_guid = 2910)
      ...
      LocalObject(153, ProximityTerminal.Constructor(adv_med_terminal, Vector3(3738.771f, 2700.518f, 150.8766f)), owning_building_guid = 35)
      LocalObject(1822, ProximityTerminal.Constructor(medical_terminal, Vector3(3748.014f, 2674.15f, 141.0666f)), owning_building_guid = 35)
      LocalObject(2072, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3677.071f, 2708.626f, 159.4186f)), owning_building_guid = 35)
      LocalObject(2073, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 35)
      LocalObject(2075, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3685.476f, 2724.394f, 161.3596f)), owning_building_guid = 35)
      LocalObject(2076, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 35)
      LocalObject(2096, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3791.051f, 2697.523f, 161.3986f)), owning_building_guid = 35)
      LocalObject(2097, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 35)
      LocalObject(2102, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3800.56f, 2713.12f, 159.4086f)), owning_building_guid = 35)
      LocalObject(2103, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 35)
      LocalObject(2421, ProximityTerminal.Constructor(repair_silo, Vector3(3663.835f, 2743.308f, 150.8166f)), owning_building_guid = 35)
      LocalObject(2422, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 35)
      LocalObject(2433, ProximityTerminal.Constructor(repair_silo, Vector3(3758.158f, 2648.492f, 150.8166f)), owning_building_guid = 35)
      LocalObject(2434, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 35)
      LocalObject(1704, FacilityTurret.Constructor(manned_turret, Vector3(3645.168f, 2645.27f, 159.4686f)), owning_building_guid = 35)
      TurretToWeapon(1704, 5044)
      LocalObject(1705, FacilityTurret.Constructor(manned_turret, Vector3(3654.609f, 2780.166f, 159.4686f)), owning_building_guid = 35)
      TurretToWeapon(1705, 5045)
      LocalObject(1711, FacilityTurret.Constructor(manned_turret, Vector3(3779.881f, 2634.659f, 159.4686f)), owning_building_guid = 35)
      TurretToWeapon(1711, 5046)
      LocalObject(1714, FacilityTurret.Constructor(manned_turret, Vector3(3825.895f, 2674.695f, 159.4686f)), owning_building_guid = 35)
      TurretToWeapon(1714, 5047)
      LocalObject(1715, FacilityTurret.Constructor(manned_turret, Vector3(3831.271f, 2767.82f, 159.4686f)), owning_building_guid = 35)
      TurretToWeapon(1715, 5048)
      LocalObject(967, ImplantTerminalMech.Constructor, owning_building_guid = 35)
      LocalObject(959, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 35)
      TerminalToInterface(967, 959)
      LocalObject(968, ImplantTerminalMech.Constructor, owning_building_guid = 35)
      LocalObject(960, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 35)
    ...
    def Building6(): Unit = { // Name: Hiro Type: cryo_facility GUID: 38, MapID: 6
      ...
      LocalObject(233, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(234, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(235, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(236, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(237, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(238, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(239, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(240, Terminal.Constructor(cert_terminal), owning_building_guid = 38)
      LocalObject(1914, Terminal.Constructor(order_terminal), owning_building_guid = 38)
      LocalObject(1915, Terminal.Constructor(order_terminal), owning_building_guid = 38)
      LocalObject(1916, Terminal.Constructor(order_terminal), owning_building_guid = 38)
      LocalObject(1917, Terminal.Constructor(order_terminal), owning_building_guid = 38)
      LocalObject(2688, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2689, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2690, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2691, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2692, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2693, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2694, Terminal.Constructor(spawn_terminal), owning_building_guid = 38)
      LocalObject(2916, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 38)
      LocalObject(1809, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4593.989f, 5632.724f, 188.2224f), Vector3(0, 0, -90)), owning_building_guid = 38, terminal_guid = 2916)
      ...
      LocalObject(154, ProximityTerminal.Constructor(adv_med_terminal, Vector3(4571.983f, 5688.892f, 189.8854f)), owning_building_guid = 38)
      LocalObject(1829, ProximityTerminal.Constructor(medical_terminal, Vector3(4597.642f, 5699.952f, 180.0754f)), owning_building_guid = 38)
      LocalObject(2144, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4551.883f, 5634.061f, 200.3684f)), owning_building_guid = 38)
      LocalObject(2145, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 38)
      LocalObject(2147, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4555.101f, 5749.651f, 198.4174f)), owning_building_guid = 38)
      LocalObject(2148, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 38)
      LocalObject(2150, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4568.198f, 5626.777f, 198.4274f)), owning_building_guid = 38)
      LocalObject(2151, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 38)
      LocalObject(2153, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4571.323f, 5741.253f, 200.4074f)), owning_building_guid = 38)
      LocalObject(2154, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 38)
      LocalObject(2461, ProximityTerminal.Constructor(repair_silo, Vector3(4534.524f, 5611.154f, 189.8254f)), owning_building_guid = 38)
      LocalObject(2462, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 38)
      LocalObject(2469, ProximityTerminal.Constructor(repair_silo, Vector3(4622.53f, 5711.861f, 189.8254f)), owning_building_guid = 38)
      LocalObject(2470, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 38)
      LocalObject(1735, FacilityTurret.Constructor(manned_turret, Vector3(4498.392f, 5776.472f, 198.4774f)), owning_building_guid = 38)
      TurretToWeapon(1735, 5049)
      LocalObject(1736, FacilityTurret.Constructor(manned_turret, Vector3(4498.4f, 5599.379f, 198.4774f)), owning_building_guid = 38)
      TurretToWeapon(1736, 5050)
      LocalObject(1742, FacilityTurret.Constructor(manned_turret, Vector3(4591.665f, 5777.605f, 198.4774f)), owning_building_guid = 38)
      TurretToWeapon(1742, 5051)
      LocalObject(1743, FacilityTurret.Constructor(manned_turret, Vector3(4633.626f, 5599.371f, 198.4774f)), owning_building_guid = 38)
      TurretToWeapon(1743, 5052)
      LocalObject(1744, FacilityTurret.Constructor(manned_turret, Vector3(4634.813f, 5734.496f, 198.4774f)), owning_building_guid = 38)
      TurretToWeapon(1744, 5053)
      LocalObject(969, ImplantTerminalMech.Constructor, owning_building_guid = 38)
      LocalObject(961, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 38)
      TerminalToInterface(969, 961)
      LocalObject(970, ImplantTerminalMech.Constructor, owning_building_guid = 38)
      LocalObject(962, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 38)
    ...
    def Building4(): Unit = { // Name: Akua Type: cryo_facility GUID: 41, MapID: 4
      ...
      LocalObject(241, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(242, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(243, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(244, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(245, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(246, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(247, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(248, Terminal.Constructor(cert_terminal), owning_building_guid = 41)
      LocalObject(1946, Terminal.Constructor(order_terminal), owning_building_guid = 41)
      LocalObject(1950, Terminal.Constructor(order_terminal), owning_building_guid = 41)
      LocalObject(1952, Terminal.Constructor(order_terminal), owning_building_guid = 41)
      LocalObject(1953, Terminal.Constructor(order_terminal), owning_building_guid = 41)
      LocalObject(2708, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2710, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2714, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2716, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2717, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2718, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2719, Terminal.Constructor(spawn_terminal), owning_building_guid = 41)
      LocalObject(2919, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 41)
      LocalObject(1813, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5337.892f, 3935.704f, 344.2742f), Vector3(0, 0, 220)), owning_building_guid = 41, terminal_guid = 2919)
      ...
      LocalObject(155, ProximityTerminal.Constructor(adv_med_terminal, Vector3(5280.72f, 3954.95f, 345.9372f)), owning_building_guid = 41)
      LocalObject(1836, ProximityTerminal.Constructor(medical_terminal, Vector3(5288.741f, 3981.715f, 336.1272f)), owning_building_guid = 41)
      LocalObject(2165, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5223.324f, 3981.073f, 354.4692f)), owning_building_guid = 41)
      LocalObject(2166, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 41)
      LocalObject(2168, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5240.185f, 3988.102f, 356.4592f)), owning_building_guid = 41)
      LocalObject(2169, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 41)
      LocalObject(2177, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5309.803f, 3904.308f, 356.4202f)), owning_building_guid = 41)
      LocalObject(2178, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 41)
      LocalObject(2183, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5325.87f, 3912.124f, 354.4792f)), owning_building_guid = 41)
      LocalObject(2184, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 41)
      LocalObject(2489, ProximityTerminal.Constructor(repair_silo, Vector3(5295.615f, 4008.436f, 345.8772f)), owning_building_guid = 41)
      LocalObject(2490, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 41)
      LocalObject(2493, ProximityTerminal.Constructor(repair_silo, Vector3(5316.193f, 3876.286f, 345.8772f)), owning_building_guid = 41)
      LocalObject(2494, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 41)
      LocalObject(1761, FacilityTurret.Constructor(manned_turret, Vector3(5166.326f, 3954.872f, 354.5292f)), owning_building_guid = 41)
      TurretToWeapon(1761, 5054)
      LocalObject(1762, FacilityTurret.Constructor(manned_turret, Vector3(5225.413f, 4027.051f, 354.5292f)), owning_building_guid = 41)
      TurretToWeapon(1762, 5055)
      LocalObject(1766, FacilityTurret.Constructor(manned_turret, Vector3(5286.171f, 4032.394f, 354.5292f)), owning_building_guid = 41)
      TurretToWeapon(1766, 5056)
      LocalObject(1769, FacilityTurret.Constructor(manned_turret, Vector3(5301.992f, 3841.044f, 354.5292f)), owning_building_guid = 41)
      TurretToWeapon(1769, 5057)
      LocalObject(1773, FacilityTurret.Constructor(manned_turret, Vector3(5388.92f, 3944.628f, 354.5292f)), owning_building_guid = 41)
      TurretToWeapon(1773, 5058)
      LocalObject(971, ImplantTerminalMech.Constructor, owning_building_guid = 41)
      LocalObject(963, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 41)
      TerminalToInterface(971, 963)
      LocalObject(972, ImplantTerminalMech.Constructor, owning_building_guid = 41)
      LocalObject(964, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 41)
    ...
    def Building7(): Unit = { // Name: Iva Type: cryo_facility GUID: 44, MapID: 7
      ...
      LocalObject(249, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(250, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(251, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(252, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(253, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(254, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(255, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(256, Terminal.Constructor(cert_terminal), owning_building_guid = 44)
      LocalObject(1971, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1972, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1973, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1974, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(2729, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2730, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2731, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2732, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2733, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2734, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2735, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2921, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 44)
      LocalObject(1815, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6514.848f, 5175.09f, 53.45417f), Vector3(0, 0, 179)), owning_building_guid = 44, terminal_guid = 2921)
      ...
      LocalObject(156, ProximityTerminal.Constructor(adv_med_terminal, Vector3(6459.072f, 5152.107f, 55.11717f)), owning_building_guid = 44)
      LocalObject(1839, ProximityTerminal.Constructor(medical_terminal, Vector3(6447.566f, 5177.569f, 45.30717f)), owning_building_guid = 44)
      LocalObject(2198, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6398.617f, 5134.167f, 63.64917f)), owning_building_guid = 44)
      LocalObject(2199, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(2201, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6406.731f, 5150.533f, 65.63917f)), owning_building_guid = 44)
      LocalObject(2202, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(2204, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6514.246f, 5132.967f, 65.60017f)), owning_building_guid = 44)
      LocalObject(2205, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(2207, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6521.244f, 5149.406f, 63.65917f)), owning_building_guid = 44)
      LocalObject(2208, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(2509, ProximityTerminal.Constructor(repair_silo, Vector3(6435.225f, 5202.245f, 55.05717f)), owning_building_guid = 44)
      LocalObject(2510, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 44)
      LocalObject(2513, ProximityTerminal.Constructor(repair_silo, Vector3(6537.452f, 5116.011f, 55.05717f)), owning_building_guid = 44)
      LocalObject(2514, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 44)
      LocalObject(1785, FacilityTurret.Constructor(manned_turret, Vector3(6370.029f, 5170.237f, 63.70917f)), owning_building_guid = 44)
      TurretToWeapon(1785, 5059)
      LocalObject(1786, FacilityTurret.Constructor(manned_turret, Vector3(6372.79f, 5076.999f, 63.70917f)), owning_building_guid = 44)
      TurretToWeapon(1786, 5060)
      LocalObject(1787, FacilityTurret.Constructor(manned_turret, Vector3(6412.379f, 5214.131f, 63.70917f)), owning_building_guid = 44)
      TurretToWeapon(1787, 5061)
      LocalObject(1790, FacilityTurret.Constructor(manned_turret, Vector3(6547.504f, 5215.303f, 63.70917f)), owning_building_guid = 44)
      TurretToWeapon(1790, 5062)
      LocalObject(1791, FacilityTurret.Constructor(manned_turret, Vector3(6549.856f, 5080.097f, 63.70917f)), owning_building_guid = 44)
      TurretToWeapon(1791, 5063)
      LocalObject(973, ImplantTerminalMech.Constructor, owning_building_guid = 44)
      LocalObject(965, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 44)
      TerminalToInterface(973, 965)
      LocalObject(974, ImplantTerminalMech.Constructor, owning_building_guid = 44)
      LocalObject(966, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 44)
    ...
    def Building16(): Unit = { // Name: Tara Type: tech_plant GUID: 50, MapID: 16
      ...
      LocalObject(157, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1796, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1151.355f, 4145.987f, 72.55145f), Vector3(0, 0, 185)), owning_building_guid = 50, terminal_guid = 157)
      LocalObject(158, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1797, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1172.293f, 4144.155f, 72.55145f), Vector3(0, 0, 185)), owning_building_guid = 50, terminal_guid = 158)
      LocalObject(1840, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1841, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1842, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1846, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(2642, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2643, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2644, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2645, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2646, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2647, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2648, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2908, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1798, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1222.457f, 4165.36f, 37.51045f), Vector3(0, 0, 185)), owning_building_guid = 50, terminal_guid = 2908)
      ...
      LocalObject(1816, ProximityTerminal.Constructor(medical_terminal, Vector3(1134.009f, 4169.805f, 45.07345f)), owning_building_guid = 50)
      LocalObject(1817, ProximityTerminal.Constructor(medical_terminal, Vector3(1172.186f, 4177.225f, 65.07045f)), owning_building_guid = 50)
      LocalObject(2051, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1106.237f, 4171.75f, 68.18145f)), owning_building_guid = 50)
      LocalObject(2052, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2054, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1113.922f, 4187.387f, 70.62545f)), owning_building_guid = 50)
      LocalObject(2055, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2057, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1153.655f, 4223.288f, 68.18145f)), owning_building_guid = 50)
      LocalObject(2058, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2060, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1168.281f, 4205.098f, 75.42045f)), owning_building_guid = 50)
      LocalObject(2061, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2063, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1213.576f, 4144.561f, 70.52345f)), owning_building_guid = 50)
      LocalObject(2064, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2066, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1235.184f, 4158.904f, 68.16845f)), owning_building_guid = 50)
      LocalObject(2067, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2405, ProximityTerminal.Constructor(repair_silo, Vector3(1121.674f, 4237.55f, 59.72345f)), owning_building_guid = 50)
      LocalObject(2406, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 50)
      LocalObject(2409, ProximityTerminal.Constructor(repair_silo, Vector3(1168.064f, 4098.549f, 59.70195f)), owning_building_guid = 50)
      LocalObject(2410, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 50)
      LocalObject(1678, FacilityTurret.Constructor(manned_turret, Vector3(1081.49f, 4182.628f, 68.47245f)), owning_building_guid = 50)
      TurretToWeapon(1678, 5064)
      LocalObject(1679, FacilityTurret.Constructor(manned_turret, Vector3(1082.827f, 4109.257f, 68.47245f)), owning_building_guid = 50)
      TurretToWeapon(1679, 5065)
      LocalObject(1680, FacilityTurret.Constructor(manned_turret, Vector3(1094.832f, 4246.474f, 68.47245f)), owning_building_guid = 50)
      TurretToWeapon(1680, 5066)
      LocalObject(1683, FacilityTurret.Constructor(manned_turret, Vector3(1157.805f, 4042.009f, 68.47245f)), owning_building_guid = 50)
      TurretToWeapon(1683, 5067)
      LocalObject(1684, FacilityTurret.Constructor(manned_turret, Vector3(1247.158f, 4034.192f, 68.47245f)), owning_building_guid = 50)
      TurretToWeapon(1684, 5068)
      LocalObject(1685, FacilityTurret.Constructor(manned_turret, Vector3(1258.946f, 4232.108f, 68.47245f)), owning_building_guid = 50)
    ...
    def Building8(): Unit = { // Name: Karihi Type: tech_plant GUID: 53, MapID: 8
      ...
      LocalObject(159, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1803, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3758.205f, 5588.466f, 248.6783f), Vector3(0, 0, -31)), owning_building_guid = 53, terminal_guid = 159)
      LocalObject(160, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1804, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3776.221f, 5599.291f, 248.6783f), Vector3(0, 0, -31)), owning_building_guid = 53, terminal_guid = 160)
      LocalObject(1891, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1892, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1893, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1894, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(2667, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2668, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2669, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2670, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2671, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2672, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2673, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2912, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1802, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3730.085f, 5541.825f, 213.6373f), Vector3(0, 0, -31)), owning_building_guid = 53, terminal_guid = 2912)
      ...
      LocalObject(1823, ProximityTerminal.Constructor(medical_terminal, Vector3(3777.729f, 5561.775f, 241.1973f)), owning_building_guid = 53)
      LocalObject(1824, ProximityTerminal.Constructor(medical_terminal, Vector3(3804.254f, 5590.218f, 221.2003f)), owning_building_guid = 53)
      LocalObject(2084, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3715.995f, 5539.568f, 244.2953f)), owning_building_guid = 53)
      LocalObject(2085, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2087, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3725.045f, 5563.873f, 246.6503f)), owning_building_guid = 53)
      LocalObject(2088, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2099, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3797.273f, 5541.521f, 251.5473f)), owning_building_guid = 53)
      LocalObject(2100, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2105, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3819.797f, 5535.401f, 244.3083f)), owning_building_guid = 53)
      LocalObject(2106, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2108, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3827.866f, 5604.968f, 244.3083f)), owning_building_guid = 53)
      LocalObject(2109, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2111, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3830.84f, 5587.8f, 246.7523f)), owning_building_guid = 53)
      LocalObject(2112, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2429, ProximityTerminal.Constructor(repair_silo, Vector3(3734.82f, 5627.849f, 235.8288f)), owning_building_guid = 53)
      LocalObject(2430, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 53)
      LocalObject(2441, ProximityTerminal.Constructor(repair_silo, Vector3(3854.053f, 5542.662f, 235.8503f)), owning_building_guid = 53)
      LocalObject(2442, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 53)
      LocalObject(1703, FacilityTurret.Constructor(manned_turret, Vector3(3633.003f, 5633.424f, 244.5993f)), owning_building_guid = 53)
      TurretToWeapon(1703, 5070)
      LocalObject(1707, FacilityTurret.Constructor(manned_turret, Vector3(3709.887f, 5679.62f, 244.5993f)), owning_building_guid = 53)
      TurretToWeapon(1707, 5071)
      LocalObject(1709, FacilityTurret.Constructor(manned_turret, Vector3(3739.799f, 5466.378f, 244.5993f)), owning_building_guid = 53)
      TurretToWeapon(1709, 5072)
      LocalObject(1712, FacilityTurret.Constructor(manned_turret, Vector3(3810.072f, 5669.286f, 244.5993f)), owning_building_guid = 53)
      TurretToWeapon(1712, 5073)
      LocalObject(1717, FacilityTurret.Constructor(manned_turret, Vector3(3854.28f, 5610.714f, 244.5993f)), owning_building_guid = 53)
      TurretToWeapon(1717, 5074)
      LocalObject(1718, FacilityTurret.Constructor(manned_turret, Vector3(3881.014f, 5551.219f, 244.5993f)), owning_building_guid = 53)
    ...
    def Building11(): Unit = { // Name: Ngaru Type: tech_plant GUID: 56, MapID: 11
      ...
      LocalObject(161, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 56)
      LocalObject(1806, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4096.807f, 4197.325f, 217.5754f), Vector3(0, 0, 51)), owning_building_guid = 56, terminal_guid = 161)
      LocalObject(162, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 56)
      LocalObject(1807, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4110.034f, 4180.99f, 217.5754f), Vector3(0, 0, 51)), owning_building_guid = 56, terminal_guid = 162)
      LocalObject(1898, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1899, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1900, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1901, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(2675, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2676, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2677, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2678, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2679, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2680, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2681, Terminal.Constructor(spawn_terminal), owning_building_guid = 56)
      LocalObject(2913, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 56)
      LocalObject(1805, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4046.707f, 4218.68f, 182.5344f), Vector3(0, 0, 51)), owning_building_guid = 56, terminal_guid = 2913)
      ...
      LocalObject(1825, ProximityTerminal.Constructor(medical_terminal, Vector3(4073.094f, 4174.275f, 210.0944f)), owning_building_guid = 56)
      LocalObject(1826, ProximityTerminal.Constructor(medical_terminal, Vector3(4104.951f, 4151.968f, 190.0974f)), owning_building_guid = 56)
      LocalObject(2114, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4042.51f, 4232.319f, 213.1924f)), owning_building_guid = 56)
      LocalObject(2115, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2117, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4052.831f, 4128.947f, 213.2054f)), owning_building_guid = 56)
      LocalObject(2118, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2120, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4055.756f, 4152.104f, 220.4444f)), owning_building_guid = 56)
      LocalObject(2121, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2123, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4067.838f, 4226.739f, 215.5474f)), owning_building_guid = 56)
      LocalObject(2124, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2126, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4106.257f, 4125.304f, 215.6494f)), owning_building_guid = 56)
      LocalObject(2127, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2129, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4122.843f, 4130.638f, 213.2054f)), owning_building_guid = 56)
      LocalObject(2130, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 56)
      LocalObject(2445, ProximityTerminal.Constructor(repair_silo, Vector3(4064.788f, 4096.035f, 204.7474f)), owning_building_guid = 56)
      LocalObject(2446, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 56)
      LocalObject(2449, ProximityTerminal.Constructor(repair_silo, Vector3(4132.552f, 4225.963f, 204.7259f)), owning_building_guid = 56)
      LocalObject(2450, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 56)
      LocalObject(1719, FacilityTurret.Constructor(manned_turret, Vector3(3973.346f, 4198.56f, 213.4964f)), owning_building_guid = 56)
      TurretToWeapon(1719, 5076)
      LocalObject(1722, FacilityTurret.Constructor(manned_turret, Vector3(4077.014f, 4070.527f, 213.4964f)), owning_building_guid = 56)
      TurretToWeapon(1722, 5077)
      LocalObject(1723, FacilityTurret.Constructor(manned_turret, Vector3(4123.903f, 4327.565f, 213.4964f)), owning_building_guid = 56)
      TurretToWeapon(1723, 5078)
      LocalObject(1724, FacilityTurret.Constructor(manned_turret, Vector3(4132.21f, 4105.281f, 213.4964f)), owning_building_guid = 56)
      TurretToWeapon(1724, 5079)
      LocalObject(1725, FacilityTurret.Constructor(manned_turret, Vector3(4180.35f, 4257.859f, 213.4964f)), owning_building_guid = 56)
      TurretToWeapon(1725, 5080)
      LocalObject(1726, FacilityTurret.Constructor(manned_turret, Vector3(4184.059f, 4157.21f, 213.4964f)), owning_building_guid = 56)
    ...
    def Building47(): Unit = { // Name: N_Tara_Tower Type: tower_a GUID: 59, MapID: 47
      ...
      LocalObject(1843, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1844, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1845, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(2531, SpawnTube.Constructor(respawn_tube_tower, Vector3(1144.706f, 4487.742f, 50.32828f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(2532, SpawnTube.Constructor(respawn_tube_tower, Vector3(1144.706f, 4504.152f, 50.32828f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(1681, FacilityTurret.Constructor(manned_turret, Vector3(1121.32f, 4487.295f, 79.78828f)), owning_building_guid = 59)
      TurretToWeapon(1681, 5082)
      LocalObject(1682, FacilityTurret.Constructor(manned_turret, Vector3(1156.647f, 4512.707f, 79.78828f)), owning_building_guid = 59)
    ...
    def Building20(): Unit = { // Name: SE_Wakea_Tower Type: tower_a GUID: 60, MapID: 20
      ...
      LocalObject(1860, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1861, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1862, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(2543, SpawnTube.Constructor(respawn_tube_tower, Vector3(1944.706f, 5175.742f, 44.39445f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(2544, SpawnTube.Constructor(respawn_tube_tower, Vector3(1944.706f, 5192.152f, 44.39445f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(1694, FacilityTurret.Constructor(manned_turret, Vector3(1921.32f, 5175.295f, 73.85445f)), owning_building_guid = 60)
      TurretToWeapon(1694, 5084)
      LocalObject(1695, FacilityTurret.Constructor(manned_turret, Vector3(1956.647f, 5200.707f, 73.85445f)), owning_building_guid = 60)
    ...
    def Building18(): Unit = { // Name: E_Esamir_Warpgate_Tower Type: tower_a GUID: 61, MapID: 18
      ...
      LocalObject(1866, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1867, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1868, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(2547, SpawnTube.Constructor(respawn_tube_tower, Vector3(2554.706f, 1449.742f, 43.34564f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(2548, SpawnTube.Constructor(respawn_tube_tower, Vector3(2554.706f, 1466.152f, 43.34564f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(1696, FacilityTurret.Constructor(manned_turret, Vector3(2531.32f, 1449.295f, 72.80564f)), owning_building_guid = 61)
      TurretToWeapon(1696, 5086)
      LocalObject(1697, FacilityTurret.Constructor(manned_turret, Vector3(2566.647f, 1474.707f, 72.80564f)), owning_building_guid = 61)
    ...
    def Building26(): Unit = { // Name: W_Ngaru_Tower Type: tower_a GUID: 62, MapID: 26
      ...
      LocalObject(1875, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1876, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1877, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(2553, SpawnTube.Constructor(respawn_tube_tower, Vector3(3408.706f, 4087.742f, 347.426f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(2554, SpawnTube.Constructor(respawn_tube_tower, Vector3(3408.706f, 4104.152f, 347.426f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(1698, FacilityTurret.Constructor(manned_turret, Vector3(3385.32f, 4087.295f, 376.886f)), owning_building_guid = 62)
      TurretToWeapon(1698, 5088)
      LocalObject(1699, FacilityTurret.Constructor(manned_turret, Vector3(3420.647f, 4112.707f, 376.886f)), owning_building_guid = 62)
    ...
    def Building46(): Unit = { // Name: NW_Karihi_Tower Type: tower_a GUID: 63, MapID: 46
      ...
      LocalObject(1878, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1879, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1880, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(2555, SpawnTube.Constructor(respawn_tube_tower, Vector3(3588.706f, 5805.742f, 204.497f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(2556, SpawnTube.Constructor(respawn_tube_tower, Vector3(3588.706f, 5822.152f, 204.497f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(1700, FacilityTurret.Constructor(manned_turret, Vector3(3565.32f, 5805.295f, 233.957f)), owning_building_guid = 63)
      TurretToWeapon(1700, 5090)
      LocalObject(1701, FacilityTurret.Constructor(manned_turret, Vector3(3600.647f, 5830.707f, 233.957f)), owning_building_guid = 63)
    ...
    def Building48(): Unit = { // Name: E_Drakulu_Tower Type: tower_a GUID: 64, MapID: 48
      ...
      LocalObject(1895, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1896, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1897, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(2566, SpawnTube.Constructor(respawn_tube_tower, Vector3(4001.147f, 2640.942f, 147.4473f), Vector3(0, 0, 344)), owning_building_guid = 64)
      LocalObject(2567, SpawnTube.Constructor(respawn_tube_tower, Vector3(4005.67f, 2625.168f, 147.4473f), Vector3(0, 0, 344)), owning_building_guid = 64)
      LocalObject(1720, FacilityTurret.Constructor(manned_turret, Vector3(3983.313f, 2618.292f, 176.9073f)), owning_building_guid = 64)
      TurretToWeapon(1720, 5092)
      LocalObject(1721, FacilityTurret.Constructor(manned_turret, Vector3(4010.267f, 2652.457f, 176.9073f)), owning_building_guid = 64)
    ...
    def Building51(): Unit = { // Name: N_Ngaru_Tower Type: tower_a GUID: 65, MapID: 51
      ...
      LocalObject(1902, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1903, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1904, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(2571, SpawnTube.Constructor(respawn_tube_tower, Vector3(4222.706f, 4833.742f, 209.5021f), Vector3(0, 0, 0)), owning_building_guid = 65)
      LocalObject(2572, SpawnTube.Constructor(respawn_tube_tower, Vector3(4222.706f, 4850.152f, 209.5021f), Vector3(0, 0, 0)), owning_building_guid = 65)
      LocalObject(1727, FacilityTurret.Constructor(manned_turret, Vector3(4199.32f, 4833.295f, 238.9621f)), owning_building_guid = 65)
      TurretToWeapon(1727, 5094)
      LocalObject(1728, FacilityTurret.Constructor(manned_turret, Vector3(4234.647f, 4858.707f, 238.9621f)), owning_building_guid = 65)
    ...
    def Building44(): Unit = { // Name: S_Laka_Tower Type: tower_a GUID: 66, MapID: 44
      ...
      LocalObject(1905, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1906, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1907, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(2573, SpawnTube.Constructor(respawn_tube_tower, Vector3(4358.376f, 6200.134f, 42.98057f), Vector3(0, 0, 54)), owning_building_guid = 66)
      LocalObject(2574, SpawnTube.Constructor(respawn_tube_tower, Vector3(4371.652f, 6209.779f, 42.98057f), Vector3(0, 0, 54)), owning_building_guid = 66)
      LocalObject(1730, FacilityTurret.Constructor(manned_turret, Vector3(4344.269f, 6218.791f, 72.44057f)), owning_building_guid = 66)
      TurretToWeapon(1730, 5096)
      LocalObject(1732, FacilityTurret.Constructor(manned_turret, Vector3(4385.592f, 6205.147f, 72.44057f)), owning_building_guid = 66)
    ...
    def Building52(): Unit = { // Name: NW_Oro_Tower Type: tower_a GUID: 67, MapID: 52
      ...
      LocalObject(1928, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1929, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1930, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(2586, SpawnTube.Constructor(respawn_tube_tower, Vector3(4754.706f, 4681.742f, 200.5724f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(2587, SpawnTube.Constructor(respawn_tube_tower, Vector3(4754.706f, 4698.152f, 200.5724f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(1750, FacilityTurret.Constructor(manned_turret, Vector3(4731.32f, 4681.295f, 230.0324f)), owning_building_guid = 67)
      TurretToWeapon(1750, 5098)
      LocalObject(1751, FacilityTurret.Constructor(manned_turret, Vector3(4766.647f, 4706.707f, 230.0324f)), owning_building_guid = 67)
    ...
    def Building45(): Unit = { // Name: E_Hiro_Tower Type: tower_a GUID: 68, MapID: 45
      ...
      LocalObject(1936, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(1937, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(2590, SpawnTube.Constructor(respawn_tube_tower, Vector3(4862.706f, 5687.742f, 167.344f), Vector3(0, 0, 0)), owning_building_guid = 68)
      LocalObject(2591, SpawnTube.Constructor(respawn_tube_tower, Vector3(4862.706f, 5704.152f, 167.344f), Vector3(0, 0, 0)), owning_building_guid = 68)
      LocalObject(1754, FacilityTurret.Constructor(manned_turret, Vector3(4839.32f, 5687.295f, 196.804f)), owning_building_guid = 68)
      TurretToWeapon(1754, 5100)
      LocalObject(1755, FacilityTurret.Constructor(manned_turret, Vector3(4874.647f, 5712.707f, 196.804f)), owning_building_guid = 68)
    ...
    def Building19(): Unit = { // Name: NE_Iva_Tower Type: tower_a GUID: 69, MapID: 19
      ...
      LocalObject(1981, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1982, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1983, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(2617, SpawnTube.Constructor(respawn_tube_tower, Vector3(7014.706f, 5821.742f, 33.30811f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(2618, SpawnTube.Constructor(respawn_tube_tower, Vector3(7014.706f, 5838.152f, 33.30811f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(1794, FacilityTurret.Constructor(manned_turret, Vector3(6991.32f, 5821.295f, 62.7681f)), owning_building_guid = 69)
      TurretToWeapon(1794, 5102)
      LocalObject(1795, FacilityTurret.Constructor(manned_turret, Vector3(7026.647f, 5846.707f, 62.7681f)), owning_building_guid = 69)
    ...
    def Building53(): Unit = { // Name: S_Ishundar_Warpgate_Tower Type: tower_b GUID: 70, MapID: 53
      ...
      LocalObject(1847, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1848, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1849, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(2536, SpawnTube.Constructor(respawn_tube_tower, Vector3(1268.303f, 6337.069f, 31.38935f), Vector3(0, 0, 355)), owning_building_guid = 70)
      LocalObject(2537, SpawnTube.Constructor(respawn_tube_tower, Vector3(1269.734f, 6320.722f, 31.38935f), Vector3(0, 0, 355)), owning_building_guid = 70)
    ...
    def Building28(): Unit = { // Name: NE_Esamir_Warpgate_Tower Type: tower_b GUID: 71, MapID: 28
      ...
      LocalObject(1863, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1864, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1865, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(2545, SpawnTube.Constructor(respawn_tube_tower, Vector3(2316.249f, 2556.289f, 37.43726f), Vector3(0, 0, 26)), owning_building_guid = 71)
      LocalObject(2546, SpawnTube.Constructor(respawn_tube_tower, Vector3(2323.443f, 2571.039f, 37.43726f), Vector3(0, 0, 26)), owning_building_guid = 71)
    ...
    def Building24(): Unit = { // Name: E_Ishundar_Warpgate_Tower Type: tower_b GUID: 72, MapID: 24
      ...
      LocalObject(1869, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1870, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1871, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(2549, SpawnTube.Constructor(respawn_tube_tower, Vector3(2562.706f, 6903.742f, 41.52341f), Vector3(0, 0, 0)), owning_building_guid = 72)
      LocalObject(2550, SpawnTube.Constructor(respawn_tube_tower, Vector3(2562.706f, 6920.152f, 41.52341f), Vector3(0, 0, 0)), owning_building_guid = 72)
    ...
    def Building49(): Unit = { // Name: W_Rehua_Tower Type: tower_b GUID: 73, MapID: 49
      ...
      LocalObject(1872, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1873, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1874, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(2551, SpawnTube.Constructor(respawn_tube_tower, Vector3(3364.706f, 1943.742f, 44.37846f), Vector3(0, 0, 0)), owning_building_guid = 73)
      LocalObject(2552, SpawnTube.Constructor(respawn_tube_tower, Vector3(3364.706f, 1960.152f, 44.37846f), Vector3(0, 0, 0)), owning_building_guid = 73)
    ...
    def Building22(): Unit = { // Name: W_Sina_Tower Type: tower_b GUID: 74, MapID: 22
      ...
      LocalObject(1931, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1932, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1933, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(2588, SpawnTube.Constructor(respawn_tube_tower, Vector3(4843.147f, 1892.942f, 46.09841f), Vector3(0, 0, 344)), owning_building_guid = 74)
      LocalObject(2589, SpawnTube.Constructor(respawn_tube_tower, Vector3(4847.67f, 1877.168f, 46.09841f), Vector3(0, 0, 344)), owning_building_guid = 74)
    ...
    def Building23(): Unit = { // Name: SE_Tara_Tower Type: tower_c GUID: 75, MapID: 23
      ...
      LocalObject(1854, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(1855, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(1859, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(2541, SpawnTube.Constructor(respawn_tube_tower, Vector3(1774.74f, 3755.151f, 33.00597f), Vector3(0, 0, 305)), owning_building_guid = 75)
      LocalObject(2542, SpawnTube.Constructor(respawn_tube_tower, Vector3(1788.182f, 3745.739f, 33.00597f), Vector3(0, 0, 305)), owning_building_guid = 75)
      LocalObject(2210, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(1767.138f, 3746.07f, 71.09397f)), owning_building_guid = 75)
      LocalObject(2211, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2213, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(1775.694f, 3740.079f, 71.09397f)), owning_building_guid = 75)
      LocalObject(2214, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 75)
      LocalObject(1690, FacilityTurret.Constructor(manned_turret, Vector3(1773.225f, 3771.827f, 62.46597f)), owning_building_guid = 75)
      TurretToWeapon(1690, 5104)
      LocalObject(1691, FacilityTurret.Constructor(manned_turret, Vector3(1775.687f, 3723.192f, 62.46597f)), owning_building_guid = 75)
    ...
    def Building21(): Unit = { // Name: NE_Pele_Tower Type: tower_c GUID: 76, MapID: 21
      ...
      LocalObject(1925, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(1926, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(1927, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(2584, SpawnTube.Constructor(respawn_tube_tower, Vector3(4696.706f, 3945.742f, 182.8882f), Vector3(0, 0, 0)), owning_building_guid = 76)
      LocalObject(2585, SpawnTube.Constructor(respawn_tube_tower, Vector3(4696.706f, 3962.152f, 182.8882f), Vector3(0, 0, 0)), owning_building_guid = 76)
      LocalObject(2216, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4684.907f, 3952.725f, 220.9762f)), owning_building_guid = 76)
      LocalObject(2217, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 76)
      LocalObject(2219, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4684.907f, 3963.17f, 220.9762f)), owning_building_guid = 76)
      LocalObject(2220, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 76)
      LocalObject(1745, FacilityTurret.Constructor(manned_turret, Vector3(4671.07f, 3943.045f, 212.3482f)), owning_building_guid = 76)
      TurretToWeapon(1745, 5106)
      LocalObject(1748, FacilityTurret.Constructor(manned_turret, Vector3(4709.497f, 3972.957f, 212.3482f)), owning_building_guid = 76)
    ...
    def Building25(): Unit = { // Name: SE_Laka_Tower Type: tower_c GUID: 77, MapID: 25
      ...
      LocalObject(1954, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(1955, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(1956, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(2601, SpawnTube.Constructor(respawn_tube_tower, Vector3(5277.717f, 6378.119f, 37.72261f), Vector3(0, 0, 349)), owning_building_guid = 77)
      LocalObject(2602, SpawnTube.Constructor(respawn_tube_tower, Vector3(5280.848f, 6362.01f, 37.72261f), Vector3(0, 0, 349)), owning_building_guid = 77)
      LocalObject(2222, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5265.94f, 6376.867f, 75.81061f)), owning_building_guid = 77)
      LocalObject(2223, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 77)
      LocalObject(2225, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5267.934f, 6366.613f, 75.81061f)), owning_building_guid = 77)
      LocalObject(2226, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 77)
      LocalObject(1764, FacilityTurret.Constructor(manned_turret, Vector3(5256.198f, 6354.471f, 67.18261f)), owning_building_guid = 77)
      TurretToWeapon(1764, 5108)
      LocalObject(1767, FacilityTurret.Constructor(manned_turret, Vector3(5288.211f, 6391.166f, 67.18261f)), owning_building_guid = 77)
    ...
    def Building29(): Unit = { // Name: NE_Matagi_Tower Type: tower_c GUID: 78, MapID: 29
      ...
      LocalObject(1957, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(1958, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(1959, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(2603, SpawnTube.Constructor(respawn_tube_tower, Vector3(5386.717f, 5225.313f, 226.1866f), Vector3(0, 0, 327)), owning_building_guid = 78)
      LocalObject(2604, SpawnTube.Constructor(respawn_tube_tower, Vector3(5395.655f, 5211.55f, 226.1866f), Vector3(0, 0, 327)), owning_building_guid = 78)
      LocalObject(2228, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5376.268f, 5219.741f, 264.2746f)), owning_building_guid = 78)
      LocalObject(2229, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 78)
      LocalObject(2231, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5381.957f, 5210.981f, 264.2746f)), owning_building_guid = 78)
      LocalObject(2232, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 78)
      LocalObject(1772, FacilityTurret.Constructor(manned_turret, Vector3(5375.624f, 5195.326f, 255.6466f)), owning_building_guid = 78)
      TurretToWeapon(1772, 5110)
      LocalObject(1774, FacilityTurret.Constructor(manned_turret, Vector3(5391.56f, 5241.341f, 255.6466f)), owning_building_guid = 78)
    ...
    def Building37(): Unit = { // Name: NE_Sina_Tower Type: tower_c GUID: 79, MapID: 37
      ...
      LocalObject(1968, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(1969, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(1970, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(2608, SpawnTube.Constructor(respawn_tube_tower, Vector3(6195.676f, 2427.004f, 39.45148f), Vector3(0, 0, 64)), owning_building_guid = 79)
      LocalObject(2609, SpawnTube.Constructor(respawn_tube_tower, Vector3(6210.425f, 2434.198f, 39.45148f), Vector3(0, 0, 64)), owning_building_guid = 79)
      LocalObject(2234, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6196.78f, 2440.67f, 77.53948f)), owning_building_guid = 79)
      LocalObject(2235, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 79)
      LocalObject(2237, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6206.167f, 2445.249f, 77.53948f)), owning_building_guid = 79)
      LocalObject(2238, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 79)
      LocalObject(1783, FacilityTurret.Constructor(manned_turret, Vector3(6182.014f, 2448.863f, 68.91148f)), owning_building_guid = 79)
      TurretToWeapon(1783, 5112)
      LocalObject(1784, FacilityTurret.Constructor(manned_turret, Vector3(6225.744f, 2427.438f, 68.91148f)), owning_building_guid = 79)
    ...
    def Building27(): Unit = { // Name: S_Iva_Tower Type: tower_c GUID: 80, MapID: 27
      ...
      LocalObject(1975, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(1976, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(1977, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(2611, SpawnTube.Constructor(respawn_tube_tower, Vector3(6439.456f, 4941.79f, 53.19855f), Vector3(0, 0, 36)), owning_building_guid = 80)
      LocalObject(2614, SpawnTube.Constructor(respawn_tube_tower, Vector3(6449.102f, 4955.066f, 53.19855f), Vector3(0, 0, 36)), owning_building_guid = 80)
      LocalObject(2240, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6434.015f, 4954.375f, 91.28654f)), owning_building_guid = 80)
      LocalObject(2241, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 80)
      LocalObject(2243, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6440.155f, 4962.825f, 91.28654f)), owning_building_guid = 80)
      LocalObject(2244, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 80)
      LocalObject(1788, FacilityTurret.Constructor(manned_turret, Vector3(6417.131f, 4954.677f, 82.65855f)), owning_building_guid = 80)
      TurretToWeapon(1788, 5114)
      LocalObject(1789, FacilityTurret.Constructor(manned_turret, Vector3(6465.801f, 4956.289f, 82.65855f)), owning_building_guid = 80)
    ...
    def Building50(): Unit = { // Name: W_Cyssor_Warpgate_Tower Type: tower_c GUID: 81, MapID: 50
      ...
      LocalObject(1978, Terminal.Constructor(order_terminal), owning_building_guid = 81)
      LocalObject(1979, Terminal.Constructor(order_terminal), owning_building_guid = 81)
      LocalObject(1980, Terminal.Constructor(order_terminal), owning_building_guid = 81)
      LocalObject(2615, SpawnTube.Constructor(respawn_tube_tower, Vector3(6639.267f, 3194.781f, 40.98681f), Vector3(0, 0, 345)), owning_building_guid = 81)
      LocalObject(2616, SpawnTube.Constructor(respawn_tube_tower, Vector3(6643.514f, 3178.931f, 40.98681f), Vector3(0, 0, 345)), owning_building_guid = 81)
      LocalObject(2246, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6627.606f, 3192.711f, 79.07481f)), owning_building_guid = 81)
      LocalObject(2247, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 81)
      LocalObject(2249, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6630.31f, 3182.622f, 79.07481f)), owning_building_guid = 81)
      LocalObject(2250, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 81)
      LocalObject(1792, FacilityTurret.Constructor(manned_turret, Vector3(6619.449f, 3169.69f, 70.44681f)), owning_building_guid = 81)
