...
object Map98 {
  ...
  val ZoneMap = new ZoneMap("map98") {
    ...
    def Building39(): Unit = { // Name: Base_Charlie Type: amp_station GUID: 1, MapID: 39
      ...
      LocalObject(577, VehicleSpawnPad.Constructor(Vector3(2610.91f, 2354.151f, 88.5923f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 918)
    ...
    def Building7(): Unit = { // Name: Base_Alpha Type: comm_station GUID: 28, MapID: 7
      ...
      LocalObject(575, VehicleSpawnPad.Constructor(Vector3(1770.413f, 2685.167f, 89.3763f), Vector3(0f, 0f, 0f)), owning_building_guid = 28, terminal_guid = 916)
    ...
    def Building8(): Unit = { // Name: Base_Bravo Type: cryo_facility GUID: 31, MapID: 8
      ...
      LocalObject(576, VehicleSpawnPad.Constructor(Vector3(1802.133f, 1715.656f, 88.7943f), Vector3(0f, 0f, 0f)), owning_building_guid = 31, terminal_guid = 917)
