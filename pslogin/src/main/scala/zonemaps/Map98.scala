...
object Map98 { // Ascension
  val ZoneMap = new ZoneMap("map98") {
    ...
    def Building39(): Unit = { // Name: Base_Charlie Type: amp_station GUID: 1, MapID: 39
      ...
      LocalObject(78, CaptureTerminal.Constructor(Vector3(2646.689f, 2280.41f, 102.1553f), capture_terminal), owning_building_guid = 1)
      ...
      LocalObject(624, Terminal.Constructor(Vector3(2627.7f, 2282.734f, 92.1763f), order_terminal), owning_building_guid = 1)
      LocalObject(625, Terminal.Constructor(Vector3(2643.647f, 2272.124f, 84.9373f), order_terminal), owning_building_guid = 1)
      LocalObject(626, Terminal.Constructor(Vector3(2644.102f, 2275.827f, 84.9373f), order_terminal), owning_building_guid = 1)
      LocalObject(627, Terminal.Constructor(Vector3(2644.563f, 2279.587f, 84.9373f), order_terminal), owning_building_guid = 1)
      LocalObject(628, Terminal.Constructor(Vector3(2647.259f, 2257.691f, 92.1763f), order_terminal), owning_building_guid = 1)
      LocalObject(629, Terminal.Constructor(Vector3(2652.737f, 2302.31f, 92.1763f), order_terminal), owning_building_guid = 1)
      LocalObject(859, Terminal.Constructor(Vector3(2607.218f, 2324.958f, 84.9043f), spawn_terminal), owning_building_guid = 1)
      LocalObject(860, Terminal.Constructor(Vector3(2628.114f, 2298.212f, 77.4043f), spawn_terminal), owning_building_guid = 1)
      LocalObject(861, Terminal.Constructor(Vector3(2629.558f, 2269.657f, 85.4813f), spawn_terminal), owning_building_guid = 1)
      LocalObject(862, Terminal.Constructor(Vector3(2630.443f, 2276.895f, 85.4813f), spawn_terminal), owning_building_guid = 1)
      LocalObject(863, Terminal.Constructor(Vector3(2631.334f, 2284.128f, 85.4813f), spawn_terminal), owning_building_guid = 1)
      LocalObject(864, Terminal.Constructor(Vector3(2643.989f, 2276.204f, 97.3753f), spawn_terminal), owning_building_guid = 1)
      LocalObject(918, Terminal.Constructor(Vector3(2612.483f, 2367.699f, 92.7493f), vehicle_terminal_combined), owning_building_guid = 1)
      LocalObject(577, VehicleSpawnPad.Constructor(Vector3(2610.91f, 2354.151f, 88.5923f), mb_pad_creation, Vector3(0, 0, 187)), owning_building_guid = 1, terminal_guid = 918)
      ...
      LocalObject(581, ProximityTerminal.Constructor(Vector3(2628.116f, 2282.681f, 95.8473f), medical_terminal), owning_building_guid = 1)
      LocalObject(582, ProximityTerminal.Constructor(Vector3(2659.066f, 2284.549f, 75.8473f), medical_terminal), owning_building_guid = 1)
      LocalObject(672, ProximityTerminal.Constructor(Vector3(2595.588f, 2306.601f, 99.1523f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(673, Terminal.Constructor(Vector3(2595.588f, 2306.601f, 99.1523f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(675, ProximityTerminal.Constructor(Vector3(2649.279f, 2206.042f, 99.1753f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(676, Terminal.Constructor(Vector3(2649.279f, 2206.042f, 99.1753f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(678, ProximityTerminal.Constructor(Vector3(2683.396f, 2333.743f, 101.3133f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(679, Terminal.Constructor(Vector3(2683.396f, 2333.743f, 101.3133f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(681, ProximityTerminal.Constructor(Vector3(2696.59f, 2254.297f, 99.1523f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(682, Terminal.Constructor(Vector3(2696.59f, 2254.297f, 99.1523f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(790, ProximityTerminal.Constructor(Vector3(2580.451f, 2288.745f, 90.0473f), repair_silo), owning_building_guid = 1)
      LocalObject(791, Terminal.Constructor(Vector3(2580.451f, 2288.745f, 90.0473f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(794, ProximityTerminal.Constructor(Vector3(2711.908f, 2272.795f, 90.0473f), repair_silo), owning_building_guid = 1)
      LocalObject(795, Terminal.Constructor(Vector3(2711.908f, 2272.795f, 90.0473f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(567, FacilityTurret.Constructor(Vector3(2558.204f, 2193.706f, 99.3553f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(567, 5000)
      LocalObject(568, FacilityTurret.Constructor(Vector3(2582.754f, 2393.883f, 99.3553f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(568, 5001)
      LocalObject(569, FacilityTurret.Constructor(Vector3(2617.075f, 2184.233f, 99.3553f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(569, 5002)
      LocalObject(570, FacilityTurret.Constructor(Vector3(2710.489f, 2174.998f, 99.3553f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(570, 5003)
      LocalObject(571, FacilityTurret.Constructor(Vector3(2729.554f, 2311.99f, 99.3553f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(571, 5004)
      LocalObject(572, FacilityTurret.Constructor(Vector3(2735.076f, 2375.17f, 99.3553f), manned_turret), owning_building_guid = 1)
    ...
    def Building7(): Unit = { // Name: Base_Alpha Type: comm_station GUID: 28, MapID: 7
      ...
      LocalObject(77, CaptureTerminal.Constructor(Vector3(1747.729f, 2683.728f, 73.34731f), capture_terminal), owning_building_guid = 28)
      ...
      LocalObject(599, Terminal.Constructor(Vector3(1797.264f, 2705.737f, 82.4373f), order_terminal), owning_building_guid = 28)
      LocalObject(600, Terminal.Constructor(Vector3(1800.887f, 2706.845f, 82.4373f), order_terminal), owning_building_guid = 28)
      LocalObject(601, Terminal.Constructor(Vector3(1804.455f, 2707.936f, 82.4373f), order_terminal), owning_building_guid = 28)
      LocalObject(602, Terminal.Constructor(Vector3(1838.267f, 2667.743f, 104.6023f), order_terminal), owning_building_guid = 28)
      LocalObject(603, Terminal.Constructor(Vector3(1841.105f, 2666.251f, 104.6023f), order_terminal), owning_building_guid = 28)
      LocalObject(604, Terminal.Constructor(Vector3(1842.47f, 2669.027f, 104.6023f), order_terminal), owning_building_guid = 28)
      LocalObject(605, Terminal.Constructor(Vector3(1858.897f, 2661.551f, 97.2073f), order_terminal), owning_building_guid = 28)
      LocalObject(853, Terminal.Constructor(Vector3(1795.976f, 2651.757f, 84.9043f), spawn_terminal), owning_building_guid = 28)
      LocalObject(854, Terminal.Constructor(Vector3(1798.496f, 2691.805f, 82.9813f), spawn_terminal), owning_building_guid = 28)
      LocalObject(855, Terminal.Constructor(Vector3(1805.467f, 2693.933f, 82.9813f), spawn_terminal), owning_building_guid = 28)
      LocalObject(856, Terminal.Constructor(Vector3(1812.439f, 2696.068f, 82.9813f), spawn_terminal), owning_building_guid = 28)
      LocalObject(857, Terminal.Constructor(Vector3(1830.479f, 2646.133f, 74.9043f), spawn_terminal), owning_building_guid = 28)
      LocalObject(858, Terminal.Constructor(Vector3(1857.417f, 2669.601f, 97.4643f), spawn_terminal), owning_building_guid = 28)
      LocalObject(916, Terminal.Constructor(Vector3(1766.282f, 2698.151f, 93.5343f), vehicle_terminal_combined), owning_building_guid = 28)
      LocalObject(575, VehicleSpawnPad.Constructor(Vector3(1770.413f, 2685.167f, 89.3763f), mb_pad_creation, Vector3(0, 0, 163)), owning_building_guid = 28, terminal_guid = 916)
      ...
      LocalObject(579, ProximityTerminal.Constructor(Vector3(1786.833f, 2716.968f, 73.34731f), medical_terminal), owning_building_guid = 28)
      LocalObject(580, ProximityTerminal.Constructor(Vector3(1861.458f, 2673.298f, 90.8473f), medical_terminal), owning_building_guid = 28)
      LocalObject(666, ProximityTerminal.Constructor(Vector3(1786.736f, 2629.843f, 99.0883f), pad_landing_frame), owning_building_guid = 28)
      LocalObject(667, Terminal.Constructor(Vector3(1786.736f, 2629.843f, 99.0883f), air_rearm_terminal), owning_building_guid = 28)
      LocalObject(782, ProximityTerminal.Constructor(Vector3(1829.694f, 2598.804f, 90.3973f), repair_silo), owning_building_guid = 28)
      LocalObject(783, Terminal.Constructor(Vector3(1829.694f, 2598.804f, 90.3973f), ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(786, ProximityTerminal.Constructor(Vector3(1839.245f, 2730.061f, 90.3973f), repair_silo), owning_building_guid = 28)
      LocalObject(787, Terminal.Constructor(Vector3(1839.245f, 2730.061f, 90.3973f), ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(548, FacilityTurret.Constructor(Vector3(1735.783f, 2710.141f, 99.3553f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(548, 5006)
      LocalObject(550, FacilityTurret.Constructor(Vector3(1764.725f, 2610.978f, 99.3553f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(550, 5007)
      LocalObject(552, FacilityTurret.Constructor(Vector3(1818.548f, 2582.338f, 99.3553f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(552, 5008)
      LocalObject(553, FacilityTurret.Constructor(Vector3(1849.178f, 2746.032f, 99.3553f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(553, 5009)
      LocalObject(556, FacilityTurret.Constructor(Vector3(1903.022f, 2717.377f, 99.3553f), manned_turret), owning_building_guid = 28)
      TurretToWeapon(556, 5010)
      LocalObject(558, FacilityTurret.Constructor(Vector3(1932.102f, 2618.236f, 99.3553f), manned_turret), owning_building_guid = 28)
    ...
    def Building8(): Unit = { // Name: Base_Bravo Type: cryo_facility GUID: 31, MapID: 8
      ...
      LocalObject(76, CaptureTerminal.Constructor(Vector3(1670.997f, 1738.721f, 80.6473f), capture_terminal), owning_building_guid = 31)
      ...
      LocalObject(79, Terminal.Constructor(Vector3(1690.205f, 1764.18f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(80, Terminal.Constructor(Vector3(1690.63f, 1762.177f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(81, Terminal.Constructor(Vector3(1696.774f, 1758.188f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(82, Terminal.Constructor(Vector3(1697.122f, 1774.831f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(83, Terminal.Constructor(Vector3(1698.777f, 1758.613f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(84, Terminal.Constructor(Vector3(1699.125f, 1775.257f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(85, Terminal.Constructor(Vector3(1705.268f, 1771.268f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(86, Terminal.Constructor(Vector3(1705.694f, 1769.265f, 80.6373f), cert_terminal), owning_building_guid = 31)
      LocalObject(595, Terminal.Constructor(Vector3(1722.549f, 1726.778f, 91.9423f), order_terminal), owning_building_guid = 31)
      LocalObject(596, Terminal.Constructor(Vector3(1733.64f, 1753.775f, 82.2373f), order_terminal), owning_building_guid = 31)
      LocalObject(597, Terminal.Constructor(Vector3(1736.818f, 1751.711f, 82.2373f), order_terminal), owning_building_guid = 31)
      LocalObject(598, Terminal.Constructor(Vector3(1739.947f, 1749.679f, 82.2373f), order_terminal), owning_building_guid = 31)
      LocalObject(846, Terminal.Constructor(Vector3(1682.002f, 1764.36f, 82.2603f), spawn_terminal), owning_building_guid = 31)
      LocalObject(847, Terminal.Constructor(Vector3(1714.712f, 1696.13f, 82.2603f), spawn_terminal), owning_building_guid = 31)
      LocalObject(848, Terminal.Constructor(Vector3(1723.759f, 1743.875f, 82.7813f), spawn_terminal), owning_building_guid = 31)
      LocalObject(849, Terminal.Constructor(Vector3(1729.87f, 1739.903f, 82.7813f), spawn_terminal), owning_building_guid = 31)
      LocalObject(850, Terminal.Constructor(Vector3(1735.988f, 1735.935f, 82.7813f), spawn_terminal), owning_building_guid = 31)
      LocalObject(851, Terminal.Constructor(Vector3(1748.478f, 1724.168f, 92.2263f), spawn_terminal), owning_building_guid = 31)
      LocalObject(852, Terminal.Constructor(Vector3(1774.697f, 1685.685f, 84.7603f), spawn_terminal), owning_building_guid = 31)
      LocalObject(917, Terminal.Constructor(Vector3(1809.486f, 1727.144f, 92.9523f), vehicle_terminal_combined), owning_building_guid = 31)
      LocalObject(576, VehicleSpawnPad.Constructor(Vector3(1802.133f, 1715.656f, 88.7943f), mb_pad_creation, Vector3(0, 0, 213)), owning_building_guid = 31, terminal_guid = 917)
      ...
      LocalObject(70, ProximityTerminal.Constructor(Vector3(1743.041f, 1727.792f, 90.4573f), adv_med_terminal), owning_building_guid = 31)
      LocalObject(578, ProximityTerminal.Constructor(Vector3(1747.74f, 1755.335f, 80.6473f), medical_terminal), owning_building_guid = 31)
      LocalObject(657, ProximityTerminal.Constructor(Vector3(1682.89f, 1746.725f, 98.9893f), pad_landing_frame), owning_building_guid = 31)
      LocalObject(658, Terminal.Constructor(Vector3(1682.89f, 1746.725f, 98.9893f), air_rearm_terminal), owning_building_guid = 31)
      LocalObject(660, ProximityTerminal.Constructor(Vector3(1698.768f, 1755.756f, 100.9793f), pad_landing_frame), owning_building_guid = 31)
      LocalObject(661, Terminal.Constructor(Vector3(1698.768f, 1755.756f, 100.9793f), air_rearm_terminal), owning_building_guid = 31)
      LocalObject(663, ProximityTerminal.Constructor(Vector3(1778.079f, 1681.071f, 100.9403f), pad_landing_frame), owning_building_guid = 31)
      LocalObject(664, Terminal.Constructor(Vector3(1778.079f, 1681.071f, 100.9403f), air_rearm_terminal), owning_building_guid = 31)
      LocalObject(669, ProximityTerminal.Constructor(Vector3(1793.074f, 1690.787f, 98.9993f), pad_landing_frame), owning_building_guid = 31)
      LocalObject(670, Terminal.Constructor(Vector3(1793.074f, 1690.787f, 98.9993f), air_rearm_terminal), owning_building_guid = 31)
      LocalObject(774, ProximityTerminal.Constructor(Vector3(1751.308f, 1782.694f, 90.3973f), repair_silo), owning_building_guid = 31)
      LocalObject(775, Terminal.Constructor(Vector3(1751.308f, 1782.694f, 90.3973f), ground_rearm_terminal), owning_building_guid = 31)
      LocalObject(778, ProximityTerminal.Constructor(Vector3(1787.837f, 1654.037f, 90.3973f), repair_silo), owning_building_guid = 31)
      LocalObject(779, Terminal.Constructor(Vector3(1787.837f, 1654.037f, 90.3973f), ground_rearm_terminal), owning_building_guid = 31)
      LocalObject(546, FacilityTurret.Constructor(Vector3(1629.51f, 1713.773f, 99.0493f), manned_turret), owning_building_guid = 31)
      TurretToWeapon(546, 5012)
      LocalObject(547, FacilityTurret.Constructor(Vector3(1679.36f, 1792.615f, 99.0493f), manned_turret), owning_building_guid = 31)
      TurretToWeapon(547, 5013)
      LocalObject(549, FacilityTurret.Constructor(Vector3(1739.014f, 1805.323f, 99.0493f), manned_turret), owning_building_guid = 31)
      TurretToWeapon(549, 5014)
      LocalObject(551, FacilityTurret.Constructor(Vector3(1778.037f, 1617.328f, 99.0493f), manned_turret), owning_building_guid = 31)
    ...
    def Building6(): Unit = { // Name: Bravo_Middle Type: tower_a GUID: 34, MapID: 6
      ...
      LocalObject(835, CaptureTerminal.Constructor(Vector3(1299.12f, 1597.855f, 80.50896f), secondary_capture), owning_building_guid = 34)
      ...
      LocalObject(584, Terminal.Constructor(Vector3(1300.645f, 1602.657f, 61.84196f), order_terminal), owning_building_guid = 34)
      LocalObject(586, Terminal.Constructor(Vector3(1305.158f, 1599.727f, 61.84196f), order_terminal), owning_building_guid = 34)
      LocalObject(588, Terminal.Constructor(Vector3(1309.958f, 1596.609f, 61.84196f), order_terminal), owning_building_guid = 34)
      LocalObject(802, SpawnTube.Constructor(Vector3(1292.349f, 1595.24f, 59.99197f), respawn_tube_tower, Vector3(0, 0, 303)), owning_building_guid = 34)
      LocalObject(804, SpawnTube.Constructor(Vector3(1306.111f, 1586.303f, 59.99197f), respawn_tube_tower, Vector3(0, 0, 303)), owning_building_guid = 34)
      LocalObject(541, FacilityTurret.Constructor(Vector3(1291.677f, 1609.914f, 89.45197f), manned_turret), owning_building_guid = 34)
      TurretToWeapon(541, 5017)
      LocalObject(542, FacilityTurret.Constructor(Vector3(1293.749f, 1566.446f, 89.45197f), manned_turret), owning_building_guid = 34)
    ...
    def Building4(): Unit = { // Name: Alpha_Middle Type: tower_a GUID: 35, MapID: 4
      ...
      LocalObject(836, CaptureTerminal.Constructor(Vector3(1422.399f, 2678.493f, 83.83914f), secondary_capture), owning_building_guid = 35)
      ...
      LocalObject(590, Terminal.Constructor(Vector3(1426.988f, 2680.573f, 65.17214f), order_terminal), owning_building_guid = 35)
      LocalObject(591, Terminal.Constructor(Vector3(1427.83f, 2675.259f, 65.17214f), order_terminal), owning_building_guid = 35)
      LocalObject(592, Terminal.Constructor(Vector3(1428.725f, 2669.605f, 65.17214f), order_terminal), owning_building_guid = 35)
      LocalObject(806, SpawnTube.Constructor(Vector3(1415.925f, 2681.776f, 63.32214f), respawn_tube_tower, Vector3(0, 0, 351)), owning_building_guid = 35)
      LocalObject(807, SpawnTube.Constructor(Vector3(1418.492f, 2665.568f, 63.32214f), respawn_tube_tower, Vector3(0, 0, 351)), owning_building_guid = 35)
      LocalObject(544, FacilityTurret.Constructor(Vector3(1395.464f, 2661.468f, 92.78214f), manned_turret), owning_building_guid = 35)
      TurretToWeapon(544, 5019)
      LocalObject(545, FacilityTurret.Constructor(Vector3(1426.38f, 2692.093f, 92.78214f), manned_turret), owning_building_guid = 35)
    ...
    def Building1(): Unit = { // Name: Charlie_Middle Type: tower_a GUID: 36, MapID: 1
      ...
      LocalObject(843, CaptureTerminal.Constructor(Vector3(2495.343f, 1611.467f, 80.50896f), secondary_capture), owning_building_guid = 36)
      ...
      LocalObject(621, Terminal.Constructor(Vector3(2486.036f, 1605.776f, 61.84196f), order_terminal), owning_building_guid = 36)
      LocalObject(622, Terminal.Constructor(Vector3(2491.738f, 1606.275f, 61.84196f), order_terminal), owning_building_guid = 36)
      LocalObject(623, Terminal.Constructor(Vector3(2497.098f, 1606.744f, 61.84196f), order_terminal), owning_building_guid = 36)
      LocalObject(825, SpawnTube.Constructor(Vector3(2482.722f, 1616.266f, 59.99197f), respawn_tube_tower, Vector3(0, 0, 85)), owning_building_guid = 36)
      LocalObject(826, SpawnTube.Constructor(Vector3(2499.069f, 1617.697f, 59.99197f), respawn_tube_tower, Vector3(0, 0, 85)), owning_building_guid = 36)
      LocalObject(565, FacilityTurret.Constructor(Vector3(2480.238f, 1639.524f, 89.45197f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(565, 5021)
      LocalObject(566, FacilityTurret.Constructor(Vector3(2508.632f, 1606.547f, 89.45197f), manned_turret), owning_building_guid = 36)
    ...
    def Building13(): Unit = { // Name: Alpha_Gate_Tower Type: tower_b GUID: 37, MapID: 13
      ...
      LocalObject(837, CaptureTerminal.Constructor(Vector3(1422.826f, 1183.439f, 32.08433f), secondary_capture), owning_building_guid = 37)
      ...
      LocalObject(589, Terminal.Constructor(Vector3(1426.548f, 1186.836f, 3.41733f), order_terminal), owning_building_guid = 37)
      LocalObject(593, Terminal.Constructor(Vector3(1428.991f, 1182.041f, 3.41733f), order_terminal), owning_building_guid = 37)
      LocalObject(594, Terminal.Constructor(Vector3(1431.59f, 1176.941f, 3.41733f), order_terminal), owning_building_guid = 37)
      LocalObject(805, SpawnTube.Constructor(Vector3(1415.654f, 1184.56f, 1.56733f), respawn_tube_tower, Vector3(0, 0, 333)), owning_building_guid = 37)
      LocalObject(808, SpawnTube.Constructor(Vector3(1423.104f, 1169.938f, 1.56733f), respawn_tube_tower, Vector3(0, 0, 333)), owning_building_guid = 37)
    ...
    def Building10(): Unit = { // Name: Charlie_Gate_Tower Type: tower_b GUID: 38, MapID: 10
      ...
      LocalObject(842, CaptureTerminal.Constructor(Vector3(2324.402f, 2770.472f, 32.08433f), secondary_capture), owning_building_guid = 38)
      ...
      LocalObject(618, Terminal.Constructor(Vector3(2313.613f, 2772.094f, 3.41733f), order_terminal), owning_building_guid = 38)
      LocalObject(619, Terminal.Constructor(Vector3(2318.302f, 2768.811f, 3.41733f), order_terminal), owning_building_guid = 38)
      LocalObject(620, Terminal.Constructor(Vector3(2322.71f, 2765.725f, 3.41733f), order_terminal), owning_building_guid = 38)
      LocalObject(823, SpawnTube.Constructor(Vector3(2317.818f, 2782.261f, 1.56733f), respawn_tube_tower, Vector3(0, 0, 125)), owning_building_guid = 38)
      LocalObject(824, SpawnTube.Constructor(Vector3(2331.26f, 2772.849f, 1.56733f), respawn_tube_tower, Vector3(0, 0, 125)), owning_building_guid = 38)
    ...
    def Building11(): Unit = { // Name: Bravo_Gate_Tower Type: tower_b GUID: 39, MapID: 11
      ...
      LocalObject(845, CaptureTerminal.Constructor(Vector3(2860.57f, 1423.646f, 34.09611f), secondary_capture), owning_building_guid = 39)
      ...
      LocalObject(633, Terminal.Constructor(Vector3(2856.688f, 1426.86f, 5.42911f), order_terminal), owning_building_guid = 39)
      LocalObject(634, Terminal.Constructor(Vector3(2861.096f, 1429.946f, 5.42911f), order_terminal), owning_building_guid = 39)
      LocalObject(635, Terminal.Constructor(Vector3(2865.785f, 1433.229f, 5.42911f), order_terminal), owning_building_guid = 39)
      LocalObject(832, SpawnTube.Constructor(Vector3(2860.458f, 1416.388f, 3.57911f), respawn_tube_tower, Vector3(0, 0, 235)), owning_building_guid = 39)
      LocalObject(833, SpawnTube.Constructor(Vector3(2873.9f, 1425.801f, 3.57911f), respawn_tube_tower, Vector3(0, 0, 235)), owning_building_guid = 39)
    ...
    def Building14(): Unit = { // Name: Alpha_Bottom Type: tower_c GUID: 40, MapID: 14
      ...
      LocalObject(834, CaptureTerminal.Constructor(Vector3(1298.132f, 2096.458f, 44.21391f), secondary_capture), owning_building_guid = 40)
      ...
      LocalObject(583, Terminal.Constructor(Vector3(1299.318f, 2101.354f, 25.54691f), order_terminal), owning_building_guid = 40)
      LocalObject(585, Terminal.Constructor(Vector3(1304.024f, 2098.746f, 25.54691f), order_terminal), owning_building_guid = 40)
      LocalObject(587, Terminal.Constructor(Vector3(1309.03f, 2095.971f, 25.54691f), order_terminal), owning_building_guid = 40)
      LocalObject(801, SpawnTube.Constructor(Vector3(1291.559f, 2093.376f, 23.69691f), respawn_tube_tower, Vector3(0, 0, 299)), owning_building_guid = 40)
      LocalObject(803, SpawnTube.Constructor(Vector3(1305.911f, 2085.421f, 23.69691f), respawn_tube_tower, Vector3(0, 0, 299)), owning_building_guid = 40)
      LocalObject(684, ProximityTerminal.Constructor(Vector3(1284.948f, 2083.551f, 61.78491f), pad_landing_tower_frame), owning_building_guid = 40)
      LocalObject(685, Terminal.Constructor(Vector3(1284.948f, 2083.551f, 61.78491f), air_rearm_terminal), owning_building_guid = 40)
      LocalObject(687, ProximityTerminal.Constructor(Vector3(1294.084f, 2078.487f, 61.78491f), pad_landing_tower_frame), owning_building_guid = 40)
      LocalObject(688, Terminal.Constructor(Vector3(1294.084f, 2078.487f, 61.78491f), air_rearm_terminal), owning_building_guid = 40)
      LocalObject(540, FacilityTurret.Constructor(Vector3(1288.31f, 2109.802f, 53.15691f), manned_turret), owning_building_guid = 40)
      TurretToWeapon(540, 5023)
      LocalObject(543, FacilityTurret.Constructor(Vector3(1295.842f, 2061.692f, 53.15691f), manned_turret), owning_building_guid = 40)
    ...
    def Building5(): Unit = { // Name: Bravo_Top Type: tower_c GUID: 41, MapID: 5
      ...
      LocalObject(838, CaptureTerminal.Constructor(Vector3(1895.054f, 2035.446f, 120.9838f), secondary_capture), owning_building_guid = 41)
      ...
      LocalObject(606, Terminal.Constructor(Vector3(1885.649f, 2029.919f, 102.3168f), order_terminal), owning_building_guid = 41)
      LocalObject(607, Terminal.Constructor(Vector3(1891.359f, 2030.318f, 102.3168f), order_terminal), owning_building_guid = 41)
      LocalObject(608, Terminal.Constructor(Vector3(1896.727f, 2030.693f, 102.3168f), order_terminal), owning_building_guid = 41)
      LocalObject(815, SpawnTube.Constructor(Vector3(1882.519f, 2040.465f, 100.4668f), respawn_tube_tower, Vector3(0, 0, 86)), owning_building_guid = 41)
      LocalObject(816, SpawnTube.Constructor(Vector3(1898.889f, 2041.61f, 100.4668f), respawn_tube_tower, Vector3(0, 0, 86)), owning_building_guid = 41)
      LocalObject(690, ProximityTerminal.Constructor(Vector3(1888.662f, 2052.722f, 138.5548f), pad_landing_tower_frame), owning_building_guid = 41)
      LocalObject(691, Terminal.Constructor(Vector3(1888.662f, 2052.722f, 138.5548f), air_rearm_terminal), owning_building_guid = 41)
      LocalObject(693, ProximityTerminal.Constructor(Vector3(1899.081f, 2053.451f, 138.5548f), pad_landing_tower_frame), owning_building_guid = 41)
      LocalObject(694, Terminal.Constructor(Vector3(1899.081f, 2053.451f, 138.5548f), air_rearm_terminal), owning_building_guid = 41)
      LocalObject(555, FacilityTurret.Constructor(Vector3(1878.04f, 2065.851f, 129.9268f), manned_turret), owning_building_guid = 41)
      TurretToWeapon(555, 5025)
      LocalObject(557, FacilityTurret.Constructor(Vector3(1910.56f, 2029.604f, 129.9268f), manned_turret), owning_building_guid = 41)
    ...
    def Building3(): Unit = { // Name: Alpha_Top Type: tower_c GUID: 42, MapID: 3
      ...
      LocalObject(839, CaptureTerminal.Constructor(Vector3(2049.076f, 2338.917f, 124.5582f), secondary_capture), owning_building_guid = 42)
      ...
      LocalObject(609, Terminal.Constructor(Vector3(2052.914f, 2342.181f, 105.8912f), order_terminal), owning_building_guid = 42)
      LocalObject(610, Terminal.Constructor(Vector3(2055.188f, 2337.305f, 105.8912f), order_terminal), owning_building_guid = 42)
      LocalObject(611, Terminal.Constructor(Vector3(2057.607f, 2332.117f, 105.8912f), order_terminal), owning_building_guid = 42)
      LocalObject(817, SpawnTube.Constructor(Vector3(2041.948f, 2340.288f, 104.0412f), respawn_tube_tower, Vector3(0, 0, 335)), owning_building_guid = 42)
      LocalObject(818, SpawnTube.Constructor(Vector3(2048.883f, 2325.415f, 104.0412f), respawn_tube_tower, Vector3(0, 0, 335)), owning_building_guid = 42)
      LocalObject(696, ProximityTerminal.Constructor(Vector3(2030.824f, 2336.224f, 142.1292f), pad_landing_tower_frame), owning_building_guid = 42)
      LocalObject(697, Terminal.Constructor(Vector3(2030.824f, 2336.224f, 142.1292f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(699, ProximityTerminal.Constructor(Vector3(2035.239f, 2326.757f, 142.1292f), pad_landing_tower_frame), owning_building_guid = 42)
      LocalObject(700, Terminal.Constructor(Vector3(2035.239f, 2326.757f, 142.1292f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(559, FacilityTurret.Constructor(Vector3(2026.789f, 2312.136f, 133.5012f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(559, 5027)
      LocalObject(560, FacilityTurret.Constructor(Vector3(2048.974f, 2355.486f, 133.5012f), manned_turret), owning_building_guid = 42)
    ...
    def Building12(): Unit = { // Name: Bravo_Bottom Type: tower_c GUID: 43, MapID: 12
      ...
      LocalObject(840, CaptureTerminal.Constructor(Vector3(2105.524f, 1572.081f, 22.08921f), secondary_capture), owning_building_guid = 43)
      ...
      LocalObject(612, Terminal.Constructor(Vector3(2099.512f, 1581.184f, 3.422213f), order_terminal), owning_building_guid = 43)
      LocalObject(613, Terminal.Constructor(Vector3(2100.209f, 1575.503f, 3.422213f), order_terminal), owning_building_guid = 43)
      LocalObject(614, Terminal.Constructor(Vector3(2100.865f, 1570.162f, 3.422213f), order_terminal), owning_building_guid = 43)
      LocalObject(819, SpawnTube.Constructor(Vector3(2109.88f, 1584.862f, 1.572213f), respawn_tube_tower, Vector3(0, 0, 173)), owning_building_guid = 43)
      LocalObject(820, SpawnTube.Constructor(Vector3(2111.88f, 1568.574f, 1.572213f), respawn_tube_tower, Vector3(0, 0, 173)), owning_building_guid = 43)
      LocalObject(702, ProximityTerminal.Constructor(Vector3(2122.442f, 1579.369f, 39.66021f), pad_landing_tower_frame), owning_building_guid = 43)
      LocalObject(703, Terminal.Constructor(Vector3(2122.442f, 1579.369f, 39.66021f), air_rearm_terminal), owning_building_guid = 43)
      LocalObject(705, ProximityTerminal.Constructor(Vector3(2123.715f, 1569.002f, 39.66021f), pad_landing_tower_frame), owning_building_guid = 43)
      LocalObject(706, Terminal.Constructor(Vector3(2123.715f, 1569.002f, 39.66021f), air_rearm_terminal), owning_building_guid = 43)
      LocalObject(561, FacilityTurret.Constructor(Vector3(2100.501f, 1556.291f, 31.03221f), manned_turret), owning_building_guid = 43)
      TurretToWeapon(561, 5029)
      LocalObject(562, FacilityTurret.Constructor(Vector3(2134.996f, 1590.663f, 31.03221f), manned_turret), owning_building_guid = 43)
    ...
    def Building2(): Unit = { // Name: Charlie_Top Type: tower_c GUID: 44, MapID: 2
      ...
      LocalObject(841, CaptureTerminal.Constructor(Vector3(2245.123f, 2121.988f, 120.7885f), secondary_capture), owning_building_guid = 44)
      ...
      LocalObject(615, Terminal.Constructor(Vector3(2234.265f, 2123.044f, 102.1215f), order_terminal), owning_building_guid = 44)
      LocalObject(616, Terminal.Constructor(Vector3(2239.119f, 2120.011f, 102.1215f), order_terminal), owning_building_guid = 44)
      LocalObject(617, Terminal.Constructor(Vector3(2243.682f, 2117.16f, 102.1215f), order_terminal), owning_building_guid = 44)
      LocalObject(821, SpawnTube.Constructor(Vector3(2237.931f, 2133.417f, 100.2715f), respawn_tube_tower, Vector3(0, 0, 122)), owning_building_guid = 44)
      LocalObject(822, SpawnTube.Constructor(Vector3(2251.848f, 2124.721f, 100.2715f), respawn_tube_tower, Vector3(0, 0, 122)), owning_building_guid = 44)
      LocalObject(708, ProximityTerminal.Constructor(Vector3(2250.106f, 2139.722f, 138.3595f), pad_landing_tower_frame), owning_building_guid = 44)
      LocalObject(709, Terminal.Constructor(Vector3(2250.106f, 2139.722f, 138.3595f), air_rearm_terminal), owning_building_guid = 44)
      LocalObject(711, ProximityTerminal.Constructor(Vector3(2258.964f, 2134.187f, 138.3595f), pad_landing_tower_frame), owning_building_guid = 44)
      LocalObject(712, Terminal.Constructor(Vector3(2258.964f, 2134.187f, 138.3595f), air_rearm_terminal), owning_building_guid = 44)
      LocalObject(563, FacilityTurret.Constructor(Vector3(2249.229f, 2156.586f, 129.7315f), manned_turret), owning_building_guid = 44)
      TurretToWeapon(563, 5031)
      LocalObject(564, FacilityTurret.Constructor(Vector3(2254.233f, 2108.147f, 129.7315f), manned_turret), owning_building_guid = 44)
    ...
    def Building9(): Unit = { // Name: Charlie_Bottom Type: tower_c GUID: 45, MapID: 9
      ...
      LocalObject(844, CaptureTerminal.Constructor(Vector3(2789.633f, 2562.697f, 21.30794f), secondary_capture), owning_building_guid = 45)
      ...
      LocalObject(630, Terminal.Constructor(Vector3(2784.626f, 2562.136f, 2.640939f), order_terminal), owning_building_guid = 45)
      LocalObject(631, Terminal.Constructor(Vector3(2785.468f, 2567.451f, 2.640939f), order_terminal), owning_building_guid = 45)
      LocalObject(632, Terminal.Constructor(Vector3(2786.363f, 2573.104f, 2.640939f), order_terminal), owning_building_guid = 45)
      LocalObject(830, SpawnTube.Constructor(Vector3(2794.776f, 2557.574f, 0.7909393f), respawn_tube_tower, Vector3(0, 0, 189)), owning_building_guid = 45)
      LocalObject(831, SpawnTube.Constructor(Vector3(2797.343f, 2573.782f, 0.7909393f), respawn_tube_tower, Vector3(0, 0, 189)), owning_building_guid = 45)
      LocalObject(714, ProximityTerminal.Constructor(Vector3(2806.271f, 2554.723f, 38.87894f), pad_landing_tower_frame), owning_building_guid = 45)
      LocalObject(715, Terminal.Constructor(Vector3(2806.271f, 2554.723f, 38.87894f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(717, ProximityTerminal.Constructor(Vector3(2807.905f, 2565.039f, 38.87894f), pad_landing_tower_frame), owning_building_guid = 45)
      LocalObject(718, Terminal.Constructor(Vector3(2807.905f, 2565.039f, 38.87894f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(573, FacilityTurret.Constructor(Vector3(2780.453f, 2548.903f, 30.25094f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(573, 5033)
      LocalObject(574, FacilityTurret.Constructor(Vector3(2823.086f, 2572.435f, 30.25094f), manned_turret), owning_building_guid = 45)
