...
object Map97 {
  ...
  val ZoneMap = new ZoneMap("map97") {
    ...
    def Building1(): Unit = { // Name: Red_Base_97 Type: tech_plant GUID: 4, MapID: 1
      ...
      LocalObject(395, VehicleSpawnPad.Constructor(Vector3(1522.493f, 2235.115f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 4, terminal_guid = 42)
      LocalObject(43, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 4)
      LocalObject(396, VehicleSpawnPad.Constructor(Vector3(1534.548f, 2252.332f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 4, terminal_guid = 43)
      ...
      LocalObject(397, VehicleSpawnPad.Constructor(Vector3(1541.266f, 2306.377f, 7.759481f), Vector3(0f, 0f, 0f)), owning_building_guid = 4, terminal_guid = 697)
    ...
    def Building3(): Unit = { // Name: Indigo_Base_97 Type: tech_plant GUID: 7, MapID: 3
      ...
      LocalObject(399, VehicleSpawnPad.Constructor(Vector3(2448.619f, 1542.761f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 7, terminal_guid = 44)
      LocalObject(45, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 7)
      LocalObject(400, VehicleSpawnPad.Constructor(Vector3(2465.182f, 1555.701f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 7, terminal_guid = 45)
      ...
      LocalObject(398, VehicleSpawnPad.Constructor(Vector3(2426.393f, 1493.041f, 7.759481f), Vector3(0f, 0f, 0f)), owning_building_guid = 7, terminal_guid = 698)
    ...
    def Building2(): Unit = { // Name: Blue_Base_97 Type: tech_plant GUID: 10, MapID: 2
      ...
      LocalObject(401, VehicleSpawnPad.Constructor(Vector3(2517.115f, 2441.507f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 10, terminal_guid = 46)
      LocalObject(47, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 10)
      LocalObject(402, VehicleSpawnPad.Constructor(Vector3(2534.332f, 2429.452f, 42.80048f), Vector3(0f, 0f, 0f)), owning_building_guid = 10, terminal_guid = 47)
      ...
      LocalObject(403, VehicleSpawnPad.Constructor(Vector3(2588.377f, 2422.734f, 7.759481f), Vector3(0f, 0f, 0f)), owning_building_guid = 10, terminal_guid = 699)
