...
object Map03 {
  ...
  val ZoneMap = new ZoneMap("map03") {
    ...
    def Building1(): Unit = { // Name: Aja Type: amp_station GUID: 1, MapID: 1
      ...
      LocalObject(2306, VehicleSpawnPad.Constructor(Vector3(641.5068f, 5390.323f, 46.35651f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 3718)
    ...
    def Building12(): Unit = { // Name: Nzame Type: amp_station GUID: 4, MapID: 12
      ...
      LocalObject(2308, VehicleSpawnPad.Constructor(Vector3(1568.298f, 2771.823f, 43.04647f), Vector3(0f, 0f, 0f)), owning_building_guid = 4, terminal_guid = 3720)
    ...
    def Building5(): Unit = { // Name: Ekera Type: amp_station GUID: 7, MapID: 5
      ...
      LocalObject(2320, VehicleSpawnPad.Constructor(Vector3(5700.404f, 6675.652f, 48.90542f), Vector3(0f, 0f, 0f)), owning_building_guid = 7, terminal_guid = 3728)
    ...
    def Building20(): Unit = { // Name: Kaang Type: amp_station GUID: 10, MapID: 20
      ...
      LocalObject(2321, VehicleSpawnPad.Constructor(Vector3(5918.444f, 3913.83f, 60.26929f), Vector3(0f, 0f, 0f)), owning_building_guid = 10, terminal_guid = 3729)
    ...
    def Building15(): Unit = { // Name: Pamba Type: amp_station GUID: 13, MapID: 15
      ...
      LocalObject(2326, VehicleSpawnPad.Constructor(Vector3(7290.01f, 3159.406f, 60.88772f), Vector3(0f, 0f, 0f)), owning_building_guid = 13, terminal_guid = 3732)
    ...
    def Building2(): Unit = { // Name: Bomazi Type: comm_station GUID: 33, MapID: 2
      ...
      LocalObject(2307, VehicleSpawnPad.Constructor(Vector3(1254.444f, 4602.945f, 56.5573f), Vector3(0f, 0f, 0f)), owning_building_guid = 33, terminal_guid = 3719)
    ...
    def Building11(): Unit = { // Name: Tore Type: comm_station GUID: 36, MapID: 11
      ...
      LocalObject(2312, VehicleSpawnPad.Constructor(Vector3(2996.833f, 2382.62f, 57.01752f), Vector3(0f, 0f, 0f)), owning_building_guid = 36, terminal_guid = 3722)
    ...
    def Building18(): Unit = { // Name: Gunuku Type: comm_station_dsp GUID: 39, MapID: 18
      ...
      LocalObject(358, VehicleSpawnPad.Constructor(Vector3(5004.328f, 4468.856f, 53.94444f), Vector3(0f, 0f, 0f)), owning_building_guid = 39, terminal_guid = 359)
      ...
      LocalObject(2315, VehicleSpawnPad.Constructor(Vector3(4953.786f, 4438.411f, 52.54544f), Vector3(0f, 0f, 0f)), owning_building_guid = 39, terminal_guid = 3725)
    ...
    def Building21(): Unit = { // Name: Mukuru Type: cryo_facility GUID: 42, MapID: 21
      ...
      LocalObject(2304, VehicleSpawnPad.Constructor(Vector3(534.407f, 2371.416f, 52.21058f), Vector3(0f, 0f, 0f)), owning_building_guid = 42, terminal_guid = 3716)
    ...
    def Building19(): Unit = { // Name: Honsi Type: cryo_facility GUID: 45, MapID: 19
      ...
      LocalObject(2313, VehicleSpawnPad.Constructor(Vector3(4019.989f, 4462.724f, 87.1109f), Vector3(0f, 0f, 0f)), owning_building_guid = 45, terminal_guid = 3723)
    ...
    def Building4(): Unit = { // Name: Chuku Type: cryo_facility GUID: 48, MapID: 4
      ...
      LocalObject(2314, VehicleSpawnPad.Constructor(Vector3(4185.989f, 6898.724f, 52.16964f), Vector3(0f, 0f, 0f)), owning_building_guid = 48, terminal_guid = 3724)
    ...
    def Building8(): Unit = { // Name: Itan Type: cryo_facility GUID: 51, MapID: 8
      ...
      LocalObject(2319, VehicleSpawnPad.Constructor(Vector3(5155.989f, 3270.724f, 46.20449f), Vector3(0f, 0f, 0f)), owning_building_guid = 51, terminal_guid = 3727)
    ...
    def Building16(): Unit = { // Name: Shango Type: cryo_facility GUID: 54, MapID: 16
      ...
      LocalObject(2322, VehicleSpawnPad.Constructor(Vector3(6764.304f, 2221.027f, 61.10852f), Vector3(0f, 0f, 0f)), owning_building_guid = 54, terminal_guid = 3730)
    ...
    def Building7(): Unit = { // Name: Wele Type: tech_plant GUID: 66, MapID: 7
      ...
      LocalObject(2302, VehicleSpawnPad.Constructor(Vector3(510.912f, 6970.165f, 72.47729f), Vector3(0f, 0f, 0f)), owning_building_guid = 66, terminal_guid = 208)
      LocalObject(209, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 66)
      LocalObject(2303, VehicleSpawnPad.Constructor(Vector3(531.93f, 6970.165f, 72.47729f), Vector3(0f, 0f, 0f)), owning_building_guid = 66, terminal_guid = 209)
      ...
      LocalObject(2305, VehicleSpawnPad.Constructor(Vector3(580.055f, 6995.661f, 37.43629f), Vector3(0f, 0f, 0f)), owning_building_guid = 66, terminal_guid = 3717)
    ...
    def Building10(): Unit = { // Name: Leza Type: tech_plant GUID: 69, MapID: 10
      ...
      LocalObject(2309, VehicleSpawnPad.Constructor(Vector3(2666.709f, 1460.221f, 76.56615f), Vector3(0f, 0f, 0f)), owning_building_guid = 69, terminal_guid = 210)
      LocalObject(211, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 69)
      LocalObject(2310, VehicleSpawnPad.Constructor(Vector3(2677.534f, 1442.205f, 76.56615f), Vector3(0f, 0f, 0f)), owning_building_guid = 69, terminal_guid = 211)
      ...
      LocalObject(2311, VehicleSpawnPad.Constructor(Vector3(2724.175f, 1414.085f, 41.52515f), Vector3(0f, 0f, 0f)), owning_building_guid = 69, terminal_guid = 3721)
    ...
    def Building6(): Unit = { // Name: Faro Type: tech_plant GUID: 72, MapID: 6
      ...
      LocalObject(2317, VehicleSpawnPad.Constructor(Vector3(5104.737f, 5769.159f, 69.32656f), Vector3(0f, 0f, 0f)), owning_building_guid = 72, terminal_guid = 212)
      LocalObject(213, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 72)
      LocalObject(2318, VehicleSpawnPad.Constructor(Vector3(5105.837f, 5790.148f, 69.32656f), Vector3(0f, 0f, 0f)), owning_building_guid = 72, terminal_guid = 213)
      ...
      LocalObject(2316, VehicleSpawnPad.Constructor(Vector3(5082.895f, 5839.542f, 34.28556f), Vector3(0f, 0f, 0f)), owning_building_guid = 72, terminal_guid = 3726)
    ...
    def Building14(): Unit = { // Name: Orisha Type: tech_plant GUID: 75, MapID: 14
      ...
      LocalObject(2323, VehicleSpawnPad.Constructor(Vector3(6980.149f, 1239.634f, 69.55667f), Vector3(0f, 0f, 0f)), owning_building_guid = 75, terminal_guid = 214)
      LocalObject(215, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 75)
      LocalObject(2324, VehicleSpawnPad.Constructor(Vector3(6982.347f, 1260.537f, 69.55667f), Vector3(0f, 0f, 0f)), owning_building_guid = 75, terminal_guid = 215)
      ...
      LocalObject(2325, VehicleSpawnPad.Constructor(Vector3(7000.476f, 1189.108f, 34.51567f), Vector3(0f, 0f, 0f)), owning_building_guid = 75, terminal_guid = 3731)
