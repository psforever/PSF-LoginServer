...
object Map03 {
  ...
  val ZoneMap = new ZoneMap("map03") {
    ...
    def Building15(): Unit = { // Name: Pamba Type: amp_station GUID: 13, MapID: 15
      ...
      LocalObject(2535, Terminal.Constructor(Vector3(7301.943f, 3057.017f, 64.47172f), order_terminal), owning_building_guid = 13)
      LocalObject(2536, Terminal.Constructor(Vector3(7301.93f, 3071.895f, 57.23272f), order_terminal), owning_building_guid = 13)
    ...
    def Building11(): Unit = { // Name: Tore Type: comm_station GUID: 36, MapID: 11
      ...
      LocalObject(3425, Terminal.Constructor(Vector3(2994.971f, 2339.243f, 50.62252f), spawn_terminal), owning_building_guid = 36)
      LocalObject(3426, Terminal.Constructor(Vector3(2994.967f, 2346.535f, 50.62252f), spawn_terminal), owning_building_guid = 36)
    ...
    def Building18(): Unit = { // Name: Gunuku Type: comm_station_dsp GUID: 39, MapID: 18
      ...
      LocalObject(3443, Terminal.Constructor(Vector3(4972.971f, 4355.243f, 46.15044f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3444, Terminal.Constructor(Vector3(4972.967f, 4362.535f, 46.15044f), spawn_terminal), owning_building_guid = 39)
    ...
    def Building19(): Unit = { // Name: Honsi Type: cryo_facility GUID: 45, MapID: 19
      ...
      LocalObject(3432, Terminal.Constructor(Vector3(4000.971f, 4529.243f, 81.0979f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3433, Terminal.Constructor(Vector3(4000.967f, 4536.535f, 81.0979f), spawn_terminal), owning_building_guid = 45)
    ...
    def Building4(): Unit = { // Name: Chuku Type: cryo_facility GUID: 48, MapID: 4
      ...
      LocalObject(3439, Terminal.Constructor(Vector3(4166.971f, 6965.243f, 46.15664f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3440, Terminal.Constructor(Vector3(4166.967f, 6972.535f, 46.15664f), spawn_terminal), owning_building_guid = 48)
    ...
    def Building8(): Unit = { // Name: Itan Type: cryo_facility GUID: 51, MapID: 8
      ...
      LocalObject(3462, Terminal.Constructor(Vector3(5136.971f, 3337.243f, 40.19149f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3463, Terminal.Constructor(Vector3(5136.967f, 3344.535f, 40.19149f), spawn_terminal), owning_building_guid = 51)
    ...
    def Building7(): Unit = { // Name: Wele Type: tech_plant GUID: 66, MapID: 7
      ...
      LocalObject(3385, Terminal.Constructor(Vector3(519.03f, 6996.177f, 54.63329f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3386, Terminal.Constructor(Vector3(519.033f, 7003.465f, 54.63329f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3387, Terminal.Constructor(Vector3(519.029f, 7010.757f, 54.63329f), spawn_terminal), owning_building_guid = 66)
    ...
    def Building10(): Unit = { // Name: Leza Type: tech_plant GUID: 69, MapID: 10
      ...
      LocalObject(1366, IFFLock.Constructor(Vector3(2704.728f, 1483.63f, 57.92416f), Vector3(0, 0, 59)), owning_building_guid = 69, door_guid = 936)
