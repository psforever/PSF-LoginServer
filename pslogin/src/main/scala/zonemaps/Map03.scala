...
object Map03 {
  ...
  val ZoneMap = new ZoneMap("map03") {
    ...
    def Building1(): Unit = { // Name: Aja Type: amp_station GUID: 1, MapID: 1
      ...
      LocalObject(2373, Terminal.Constructor(Vector3(688.8893f, 5334.312f, 49.94051f), order_terminal), owning_building_guid = 1)
      LocalObject(2374, Terminal.Constructor(Vector3(702.3105f, 5363.121f, 49.94051f), order_terminal), owning_building_guid = 1)
      LocalObject(2375, Terminal.Constructor(Vector3(705.3431f, 5339.164f, 42.70151f), order_terminal), owning_building_guid = 1)
      LocalObject(2376, Terminal.Constructor(Vector3(706.639f, 5335.604f, 42.70151f), order_terminal), owning_building_guid = 1)
      LocalObject(2377, Terminal.Constructor(Vector3(707.915f, 5332.098f, 42.70151f), order_terminal), owning_building_guid = 1)
      LocalObject(2378, Terminal.Constructor(Vector3(717.6857f, 5320.878f, 49.94051f), order_terminal), owning_building_guid = 1)
      LocalObject(3396, Terminal.Constructor(Vector3(651.4706f, 5362.635f, 42.66851f), spawn_terminal), owning_building_guid = 1)
      LocalObject(3398, Terminal.Constructor(Vector3(682.2317f, 5348.291f, 35.16851f), spawn_terminal), owning_building_guid = 1)
      LocalObject(3399, Terminal.Constructor(Vector3(691.4941f, 5337.205f, 43.24551f), spawn_terminal), owning_building_guid = 1)
      LocalObject(3400, Terminal.Constructor(Vector3(693.9839f, 5330.355f, 43.24551f), spawn_terminal), owning_building_guid = 1)
      LocalObject(3401, Terminal.Constructor(Vector3(696.4818f, 5323.504f, 43.24551f), spawn_terminal), owning_building_guid = 1)
      ...
      LocalObject(2330, ProximityTerminal.Constructor(Vector3(689.2837f, 5334.454f, 53.61151f), medical_terminal), owning_building_guid = 1)
      LocalObject(2331, ProximityTerminal.Constructor(Vector3(716.0126f, 5350.169f, 33.61151f), medical_terminal), owning_building_guid = 1)
      LocalObject(2657, ProximityTerminal.Constructor(Vector3(649.4424f, 5340.999f, 56.91651f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(2658, Terminal.Constructor(Vector3(649.4424f, 5340.999f, 56.91651f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2660, ProximityTerminal.Constructor(Vector3(715.3569f, 5405.046f, 59.07751f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(2661, Terminal.Constructor(Vector3(715.3569f, 5405.046f, 59.07751f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2663, ProximityTerminal.Constructor(Vector3(742.9343f, 5275.775f, 56.93951f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(2664, Terminal.Constructor(Vector3(742.9343f, 5275.775f, 56.93951f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2666, ProximityTerminal.Constructor(Vector3(763.1806f, 5340.25f, 56.91651f), pad_landing_frame), owning_building_guid = 1)
      LocalObject(2667, Terminal.Constructor(Vector3(763.1806f, 5340.25f, 56.91651f), air_rearm_terminal), owning_building_guid = 1)
      LocalObject(3096, ProximityTerminal.Constructor(Vector3(644.0612f, 5318.217f, 47.81151f), repair_silo), owning_building_guid = 1)
      LocalObject(3097, Terminal.Constructor(Vector3(644.0612f, 5318.217f, 47.81151f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(3100, ProximityTerminal.Constructor(Vector3(768.4315f, 5363.686f, 47.81151f), repair_silo), owning_building_guid = 1)
      LocalObject(3101, Terminal.Constructor(Vector3(768.4315f, 5363.686f, 47.81151f), ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(2165, FacilityTurret.Constructor(Vector3(598.3812f, 5412.941f, 57.11951f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(2165, 5000)
      LocalObject(2174, FacilityTurret.Constructor(Vector3(667.386f, 5223.437f, 57.11951f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(2174, 5001)
      LocalObject(2176, FacilityTurret.Constructor(Vector3(724.1415f, 5241.723f, 57.11951f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(2176, 5002)
      LocalObject(2177, FacilityTurret.Constructor(Vector3(742.5974f, 5465.421f, 57.11951f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(2177, 5003)
      LocalObject(2178, FacilityTurret.Constructor(Vector3(766.3595f, 5406.62f, 57.11951f), manned_turret), owning_building_guid = 1)
      TurretToWeapon(2178, 5004)
      LocalObject(2179, FacilityTurret.Constructor(Vector3(811.5665f, 5275.904f, 57.11951f), manned_turret), owning_building_guid = 1)
    ...
    def Building12(): Unit = { // Name: Nzame Type: amp_station GUID: 4, MapID: 12
      ...
      LocalObject(2398, Terminal.Constructor(Vector3(1549.594f, 2700.883f, 46.63047f), order_terminal), owning_building_guid = 4)
      LocalObject(2401, Terminal.Constructor(Vector3(1555.106f, 2669.589f, 46.63047f), order_terminal), owning_building_guid = 4)
      LocalObject(2403, Terminal.Constructor(Vector3(1558.693f, 2684.028f, 39.39148f), order_terminal), owning_building_guid = 4)
      LocalObject(2404, Terminal.Constructor(Vector3(1560.833f, 2687.084f, 39.39148f), order_terminal), owning_building_guid = 4)
      LocalObject(2405, Terminal.Constructor(Vector3(1563.006f, 2690.188f, 39.39148f), order_terminal), owning_building_guid = 4)
      LocalObject(2406, Terminal.Constructor(Vector3(1580.891f, 2706.413f, 46.63047f), order_terminal), owning_building_guid = 4)
      LocalObject(3409, Terminal.Constructor(Vector3(1545.095f, 2688.465f, 39.93547f), spawn_terminal), owning_building_guid = 4)
      LocalObject(3410, Terminal.Constructor(Vector3(1549.275f, 2694.44f, 39.93547f), spawn_terminal), owning_building_guid = 4)
      LocalObject(3411, Terminal.Constructor(Vector3(1551.332f, 2747.78f, 39.35847f), spawn_terminal), owning_building_guid = 4)
      LocalObject(3412, Terminal.Constructor(Vector3(1553.457f, 2700.408f, 39.93547f), spawn_terminal), owning_building_guid = 4)
      LocalObject(3413, Terminal.Constructor(Vector3(1557.226f, 2714.355f, 31.85847f), spawn_terminal), owning_building_guid = 4)
      ...
      LocalObject(2334, ProximityTerminal.Constructor(Vector3(1549.936f, 2700.641f, 50.30148f), medical_terminal), owning_building_guid = 4)
      LocalObject(2335, ProximityTerminal.Constructor(Vector3(1578.14f, 2687.76f, 30.30148f), medical_terminal), owning_building_guid = 4)
      LocalObject(2672, ProximityTerminal.Constructor(Vector3(1532.445f, 2737.031f, 53.60648f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(2673, Terminal.Constructor(Vector3(1532.445f, 2737.031f, 53.60648f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2675, ProximityTerminal.Constructor(Vector3(1532.642f, 2623.037f, 53.62947f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(2676, Terminal.Constructor(Vector3(1532.642f, 2623.037f, 53.62947f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2678, ProximityTerminal.Constructor(Vector3(1597.07f, 2643.433f, 53.60648f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(2679, Terminal.Constructor(Vector3(1597.07f, 2643.433f, 53.60648f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2681, ProximityTerminal.Constructor(Vector3(1622.717f, 2719.774f, 55.76748f), pad_landing_frame), owning_building_guid = 4)
      LocalObject(2682, Terminal.Constructor(Vector3(1622.717f, 2719.774f, 55.76748f), air_rearm_terminal), owning_building_guid = 4)
      LocalObject(3112, ProximityTerminal.Constructor(Vector3(1510.697f, 2728.372f, 44.50148f), repair_silo), owning_building_guid = 4)
      LocalObject(3113, Terminal.Constructor(Vector3(1510.697f, 2728.372f, 44.50148f), ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(3116, ProximityTerminal.Constructor(Vector3(1619.279f, 2652.574f, 44.50148f), repair_silo), owning_building_guid = 4)
      LocalObject(3117, Terminal.Constructor(Vector3(1619.279f, 2652.574f, 44.50148f), ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(2191, FacilityTurret.Constructor(Vector3(1446.436f, 2654.902f, 53.80947f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(2191, 5006)
      LocalObject(2193, FacilityTurret.Constructor(Vector3(1493.969f, 2618.9f, 53.80947f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(2193, 5007)
      LocalObject(2196, FacilityTurret.Constructor(Vector3(1562.09f, 2820.123f, 53.80947f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(2196, 5008)
      LocalObject(2197, FacilityTurret.Constructor(Vector3(1572.113f, 2566.89f, 53.80947f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(2197, 5009)
      LocalObject(2198, FacilityTurret.Constructor(Vector3(1653.26f, 2678.898f, 53.80947f), manned_turret), owning_building_guid = 4)
      TurretToWeapon(2198, 5010)
      LocalObject(2199, FacilityTurret.Constructor(Vector3(1687.798f, 2732.089f, 53.80947f), manned_turret), owning_building_guid = 4)
    ...
    def Building5(): Unit = { // Name: Ekera Type: amp_station GUID: 7, MapID: 5
      ...
      LocalObject(2496, Terminal.Constructor(Vector3(5613.608f, 6620.043f, 52.48942f), order_terminal), owning_building_guid = 7)
      LocalObject(2497, Terminal.Constructor(Vector3(5626.975f, 6626.577f, 45.25042f), order_terminal), owning_building_guid = 7)
      LocalObject(2498, Terminal.Constructor(Vector3(5630.691f, 6626.902f, 45.25042f), order_terminal), owning_building_guid = 7)
      LocalObject(2499, Terminal.Constructor(Vector3(5634.038f, 6644.381f, 52.48942f), order_terminal), owning_building_guid = 7)
      LocalObject(2500, Terminal.Constructor(Vector3(5634.466f, 6627.232f, 45.25042f), order_terminal), owning_building_guid = 7)
      LocalObject(2501, Terminal.Constructor(Vector3(5658.391f, 6623.961f, 52.48942f), order_terminal), owning_building_guid = 7)
      LocalObject(3465, Terminal.Constructor(Vector3(5621.633f, 6639.845f, 45.79442f), spawn_terminal), owning_building_guid = 7)
      LocalObject(3466, Terminal.Constructor(Vector3(5628.897f, 6640.484f, 45.79442f), spawn_terminal), owning_building_guid = 7)
      LocalObject(3467, Terminal.Constructor(Vector3(5631.038f, 6627.091f, 57.68842f), spawn_terminal), owning_building_guid = 7)
      LocalObject(3468, Terminal.Constructor(Vector3(5636.158f, 6641.117f, 45.79442f), spawn_terminal), owning_building_guid = 7)
      LocalObject(3469, Terminal.Constructor(Vector3(5649.264f, 6647.194f, 37.71742f), spawn_terminal), owning_building_guid = 7)
      ...
      LocalObject(2347, ProximityTerminal.Constructor(Vector3(5634.072f, 6643.963f, 56.16042f), medical_terminal), owning_building_guid = 7)
      LocalObject(2348, ProximityTerminal.Constructor(Vector3(5642.334f, 6614.078f, 36.16042f), medical_terminal), owning_building_guid = 7)
      LocalObject(2771, ProximityTerminal.Constructor(Vector3(5563.508f, 6607.328f, 59.48842f), pad_landing_frame), owning_building_guid = 7)
      LocalObject(2772, Terminal.Constructor(Vector3(5563.508f, 6607.328f, 59.48842f), air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2774, ProximityTerminal.Constructor(Vector3(5620.546f, 6571.084f, 59.46542f), pad_landing_frame), owning_building_guid = 7)
      LocalObject(2775, Terminal.Constructor(Vector3(5620.546f, 6571.084f, 59.46542f), air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2777, ProximityTerminal.Constructor(Vector3(5650.706f, 6680.753f, 59.46542f), pad_landing_frame), owning_building_guid = 7)
      LocalObject(2778, Terminal.Constructor(Vector3(5650.706f, 6680.753f, 59.46542f), air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2780, ProximityTerminal.Constructor(Vector3(5695.512f, 6600.508f, 61.62642f), pad_landing_frame), owning_building_guid = 7)
      LocalObject(2781, Terminal.Constructor(Vector3(5695.512f, 6600.508f, 61.62642f), air_rearm_terminal), owning_building_guid = 7)
      LocalObject(3176, ProximityTerminal.Constructor(Vector3(5630.093f, 6691.848f, 50.36042f), repair_silo), owning_building_guid = 7)
      LocalObject(3177, Terminal.Constructor(Vector3(5630.093f, 6691.848f, 50.36042f), ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(3180, ProximityTerminal.Constructor(Vector3(5641.824f, 6559.947f, 50.36042f), repair_silo), owning_building_guid = 7)
      LocalObject(3181, Terminal.Constructor(Vector3(5641.824f, 6559.947f, 50.36042f), ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(2263, FacilityTurret.Constructor(Vector3(5532.506f, 6693.848f, 59.66842f), manned_turret), owning_building_guid = 7)
      TurretToWeapon(2263, 5012)
      LocalObject(2264, FacilityTurret.Constructor(Vector3(5535.48f, 6634.294f, 59.66842f), manned_turret), owning_building_guid = 7)
      TurretToWeapon(2264, 5013)
      LocalObject(2265, FacilityTurret.Constructor(Vector3(5545.869f, 6541.001f, 59.66842f), manned_turret), owning_building_guid = 7)
      TurretToWeapon(2265, 5014)
      LocalObject(2269, FacilityTurret.Constructor(Vector3(5683.832f, 6550.836f, 59.66842f), manned_turret), owning_building_guid = 7)
      TurretToWeapon(2269, 5015)
      LocalObject(2271, FacilityTurret.Constructor(Vector3(5733.413f, 6711.455f, 59.66842f), manned_turret), owning_building_guid = 7)
      TurretToWeapon(2271, 5016)
      LocalObject(2273, FacilityTurret.Constructor(Vector3(5746.779f, 6558.57f, 59.66842f), manned_turret), owning_building_guid = 7)
    ...
    def Building20(): Unit = { // Name: Kaang Type: amp_station GUID: 10, MapID: 20
      ...
      LocalObject(2505, Terminal.Constructor(Vector3(5836.502f, 3976.372f, 63.85329f), order_terminal), owning_building_guid = 10)
      LocalObject(2506, Terminal.Constructor(Vector3(5847.214f, 3966.046f, 56.61429f), order_terminal), owning_building_guid = 10)
      LocalObject(2507, Terminal.Constructor(Vector3(5848.791f, 3962.665f, 56.61429f), order_terminal), owning_building_guid = 10)
      LocalObject(2508, Terminal.Constructor(Vector3(5850.392f, 3959.231f, 56.61429f), order_terminal), owning_building_guid = 10)
      LocalObject(2509, Terminal.Constructor(Vector3(5855.501f, 3935.63f, 63.85329f), order_terminal), owning_building_guid = 10)
      LocalObject(2510, Terminal.Constructor(Vector3(5866.36f, 3965.499f, 63.85329f), order_terminal), owning_building_guid = 10)
      LocalObject(3471, Terminal.Constructor(Vector3(5849.086f, 3962.405f, 69.05229f), spawn_terminal), owning_building_guid = 10)
      LocalObject(3472, Terminal.Constructor(Vector3(5857.855f, 3975.604f, 57.15829f), spawn_terminal), owning_building_guid = 10)
      LocalObject(3473, Terminal.Constructor(Vector3(5860.94f, 3968.997f, 57.15829f), spawn_terminal), owning_building_guid = 10)
      LocalObject(3474, Terminal.Constructor(Vector3(5864.018f, 3962.39f, 57.15829f), spawn_terminal), owning_building_guid = 10)
      LocalObject(3475, Terminal.Constructor(Vector3(5874.211f, 3952.153f, 49.08129f), spawn_terminal), owning_building_guid = 10)
      ...
      LocalObject(2349, ProximityTerminal.Constructor(Vector3(5840.722f, 3947.338f, 47.52429f), medical_terminal), owning_building_guid = 10)
      LocalObject(2350, ProximityTerminal.Constructor(Vector3(5865.98f, 3965.323f, 67.52429f), medical_terminal), owning_building_guid = 10)
      LocalObject(2783, ProximityTerminal.Constructor(Vector3(5792.869f, 3953.108f, 70.82929f), pad_landing_frame), owning_building_guid = 10)
      LocalObject(2784, Terminal.Constructor(Vector3(5792.869f, 3953.108f, 70.82929f), air_rearm_terminal), owning_building_guid = 10)
      LocalObject(2786, ProximityTerminal.Constructor(Vector3(5807.419f, 4019.102f, 70.85229f), pad_landing_frame), owning_building_guid = 10)
      LocalObject(2787, Terminal.Constructor(Vector3(5807.419f, 4019.102f, 70.85229f), air_rearm_terminal), owning_building_guid = 10)
      LocalObject(2789, ProximityTerminal.Constructor(Vector3(5846.158f, 3892.727f, 72.9903f), pad_landing_frame), owning_building_guid = 10)
      LocalObject(2790, Terminal.Constructor(Vector3(5846.158f, 3892.727f, 72.9903f), air_rearm_terminal), owning_building_guid = 10)
      LocalObject(2792, ProximityTerminal.Constructor(Vector3(5906.24f, 3962.275f, 70.82929f), pad_landing_frame), owning_building_guid = 10)
      LocalObject(2793, Terminal.Constructor(Vector3(5906.24f, 3962.275f, 70.82929f), air_rearm_terminal), owning_building_guid = 10)
      LocalObject(3184, ProximityTerminal.Constructor(Vector3(5789.681f, 3929.304f, 61.72429f), repair_silo), owning_building_guid = 10)
      LocalObject(3185, Terminal.Constructor(Vector3(5789.681f, 3929.304f, 61.72429f), ground_rearm_terminal), owning_building_guid = 10)
      LocalObject(3188, ProximityTerminal.Constructor(Vector3(5909.615f, 3985.44f, 61.72429f), repair_silo), owning_building_guid = 10)
      LocalObject(3189, Terminal.Constructor(Vector3(5909.615f, 3985.44f, 61.72429f), ground_rearm_terminal), owning_building_guid = 10)
      LocalObject(2272, FacilityTurret.Constructor(Vector3(5739.06f, 4012.993f, 71.03229f), manned_turret), owning_building_guid = 10)
      TurretToWeapon(2272, 5018)
      LocalObject(2274, FacilityTurret.Constructor(Vector3(5795.487f, 3886.714f, 71.03229f), manned_turret), owning_building_guid = 10)
      TurretToWeapon(2274, 5019)
      LocalObject(2275, FacilityTurret.Constructor(Vector3(5823.173f, 4054.663f, 71.03229f), manned_turret), owning_building_guid = 10)
      TurretToWeapon(2275, 5020)
      LocalObject(2276, FacilityTurret.Constructor(Vector3(5824.284f, 3830.208f, 71.03229f), manned_turret), owning_building_guid = 10)
      TurretToWeapon(2276, 5021)
      LocalObject(2278, FacilityTurret.Constructor(Vector3(5878.118f, 4077.826f, 71.03229f), manned_turret), owning_building_guid = 10)
      TurretToWeapon(2278, 5022)
      LocalObject(2280, FacilityTurret.Constructor(Vector3(5963.377f, 3895.057f, 71.03229f), manned_turret), owning_building_guid = 10)
    ...
    def Building15(): Unit = { // Name: Pamba Type: amp_station GUID: 13, MapID: 15
      ...
      LocalObject(2534, Terminal.Constructor(Vector3(7289.024f, 3086.048f, 64.47172f), order_terminal), owning_building_guid = 13)
      LocalObject(2535, Terminal.Constructor(Vector3(7301.93f, 3071.895f, 57.23272f), order_terminal), owning_building_guid = 13)
      LocalObject(2536, Terminal.Constructor(Vector3(7301.943f, 3057.017f, 64.47172f), order_terminal), owning_building_guid = 13)
      LocalObject(2537, Terminal.Constructor(Vector3(7303.267f, 3075.378f, 57.23272f), order_terminal), owning_building_guid = 13)
      LocalObject(2538, Terminal.Constructor(Vector3(7304.625f, 3078.915f, 57.23272f), order_terminal), owning_building_guid = 13)
      LocalObject(2539, Terminal.Constructor(Vector3(7318.053f, 3098.985f, 64.47172f), order_terminal), owning_building_guid = 13)
      LocalObject(3491, Terminal.Constructor(Vector3(7279.365f, 3131.972f, 57.19972f), spawn_terminal), owning_building_guid = 13)
      LocalObject(3492, Terminal.Constructor(Vector3(7287.663f, 3072.91f, 57.77672f), spawn_terminal), owning_building_guid = 13)
      LocalObject(3493, Terminal.Constructor(Vector3(7290.272f, 3079.719f, 57.77672f), spawn_terminal), owning_building_guid = 13)
      LocalObject(3494, Terminal.Constructor(Vector3(7292.887f, 3086.522f, 57.77672f), spawn_terminal), owning_building_guid = 13)
      LocalObject(3495, Terminal.Constructor(Vector3(7293.17f, 3100.966f, 49.69972f), spawn_terminal), owning_building_guid = 13)
      ...
      LocalObject(2354, ProximityTerminal.Constructor(Vector3(7289.414f, 3085.896f, 68.14272f), medical_terminal), owning_building_guid = 13)
      LocalObject(2355, ProximityTerminal.Constructor(Vector3(7319.897f, 3080.221f, 48.14272f), medical_terminal), owning_building_guid = 13)
      LocalObject(2825, ProximityTerminal.Constructor(Vector3(7263.64f, 3116.974f, 71.44772f), pad_landing_frame), owning_building_guid = 13)
      LocalObject(2826, Terminal.Constructor(Vector3(7263.64f, 3116.974f, 71.44772f), air_rearm_terminal), owning_building_guid = 13)
      LocalObject(2828, ProximityTerminal.Constructor(Vector3(7291.409f, 3006.413f, 71.47072f), pad_landing_frame), owning_building_guid = 13)
      LocalObject(2829, Terminal.Constructor(Vector3(7291.409f, 3006.413f, 71.47072f), air_rearm_terminal), owning_building_guid = 13)
      LocalObject(2831, ProximityTerminal.Constructor(Vector3(7348.988f, 3041.79f, 71.44772f), pad_landing_frame), owning_building_guid = 13)
      LocalObject(2832, Terminal.Constructor(Vector3(7348.988f, 3041.79f, 71.44772f), air_rearm_terminal), owning_building_guid = 13)
      LocalObject(2834, ProximityTerminal.Constructor(Vector3(7355.405f, 3122.067f, 73.60872f), pad_landing_frame), owning_building_guid = 13)
      LocalObject(2835, Terminal.Constructor(Vector3(7355.405f, 3122.067f, 73.60872f), air_rearm_terminal), owning_building_guid = 13)
      LocalObject(3208, ProximityTerminal.Constructor(Vector3(7244.632f, 3103.31f, 62.34272f), repair_silo), owning_building_guid = 13)
      LocalObject(3209, Terminal.Constructor(Vector3(7244.632f, 3103.31f, 62.34272f), ground_rearm_terminal), owning_building_guid = 13)
      LocalObject(3212, ProximityTerminal.Constructor(Vector3(7368.326f, 3056.032f, 62.34272f), repair_silo), owning_building_guid = 13)
      LocalObject(3213, Terminal.Constructor(Vector3(7368.326f, 3056.032f, 62.34272f), ground_rearm_terminal), owning_building_guid = 13)
      LocalObject(2296, FacilityTurret.Constructor(Vector3(7200.055f, 3016.477f, 71.65072f), manned_turret), owning_building_guid = 13)
      TurretToWeapon(2296, 5024)
      LocalObject(2297, FacilityTurret.Constructor(Vector3(7254.885f, 2993.042f, 71.65072f), manned_turret), owning_building_guid = 13)
      TurretToWeapon(2297, 5025)
      LocalObject(2298, FacilityTurret.Constructor(Vector3(7272.302f, 3204.769f, 71.65072f), manned_turret), owning_building_guid = 13)
      TurretToWeapon(2298, 5026)
      LocalObject(2299, FacilityTurret.Constructor(Vector3(7343.29f, 2961.483f, 71.65072f), manned_turret), owning_building_guid = 13)
      TurretToWeapon(2299, 5027)
      LocalObject(2300, FacilityTurret.Constructor(Vector3(7394.93f, 3089.794f, 71.65072f), manned_turret), owning_building_guid = 13)
      TurretToWeapon(2300, 5028)
      LocalObject(2301, FacilityTurret.Constructor(Vector3(7415.573f, 3149.761f, 71.65072f), manned_turret), owning_building_guid = 13)
    ...
    def Building2(): Unit = { // Name: Bomazi Type: comm_station GUID: 33, MapID: 2
      ...
      LocalObject(2385, Terminal.Constructor(Vector3(1174.39f, 4558.467f, 64.38831f), order_terminal), owning_building_guid = 33)
      LocalObject(2386, Terminal.Constructor(Vector3(1190.452f, 4567.445f, 71.7833f), order_terminal), owning_building_guid = 33)
      LocalObject(2387, Terminal.Constructor(Vector3(1191.399f, 4564.5f, 71.7833f), order_terminal), owning_building_guid = 33)
      LocalObject(2388, Terminal.Constructor(Vector3(1193.531f, 4568.343f, 71.7833f), order_terminal), owning_building_guid = 33)
      LocalObject(2389, Terminal.Constructor(Vector3(1245.773f, 4562.918f, 49.61831f), order_terminal), owning_building_guid = 33)
      LocalObject(2390, Terminal.Constructor(Vector3(1247.582f, 4566.182f, 49.61831f), order_terminal), owning_building_guid = 33)
      LocalObject(2391, Terminal.Constructor(Vector3(1249.419f, 4569.496f, 49.61831f), order_terminal), owning_building_guid = 33)
      LocalObject(3403, Terminal.Constructor(Vector3(1181.046f, 4553.705f, 64.6453f), spawn_terminal), owning_building_guid = 33)
      LocalObject(3404, Terminal.Constructor(Vector3(1184.121f, 4589.298f, 42.0853f), spawn_terminal), owning_building_guid = 33)
      LocalObject(3405, Terminal.Constructor(Vector3(1212.847f, 4609.221f, 52.0853f), spawn_terminal), owning_building_guid = 33)
      LocalObject(3406, Terminal.Constructor(Vector3(1231.786f, 4565.91f, 50.1623f), spawn_terminal), owning_building_guid = 33)
      LocalObject(3407, Terminal.Constructor(Vector3(1235.318f, 4572.289f, 50.1623f), spawn_terminal), owning_building_guid = 33)
      ...
      LocalObject(2332, ProximityTerminal.Constructor(Vector3(1180.707f, 4548.237f, 58.02831f), medical_terminal), owning_building_guid = 33)
      LocalObject(2333, ProximityTerminal.Constructor(Vector3(1264.724f, 4568.663f, 40.52831f), medical_terminal), owning_building_guid = 33)
      LocalObject(2669, ProximityTerminal.Constructor(Vector3(1204.271f, 4631.403f, 66.2693f), pad_landing_frame), owning_building_guid = 33)
      LocalObject(2670, Terminal.Constructor(Vector3(1204.271f, 4631.403f, 66.2693f), air_rearm_terminal), owning_building_guid = 33)
      LocalObject(3104, ProximityTerminal.Constructor(Vector3(1151.809f, 4623.89f, 57.5783f), repair_silo), owning_building_guid = 33)
      LocalObject(3105, Terminal.Constructor(Vector3(1151.809f, 4623.89f, 57.5783f), ground_rearm_terminal), owning_building_guid = 33)
      LocalObject(3108, ProximityTerminal.Constructor(Vector3(1236.117f, 4522.836f, 57.5783f), repair_silo), owning_building_guid = 33)
      LocalObject(3109, Terminal.Constructor(Vector3(1236.117f, 4522.836f, 57.5783f), ground_rearm_terminal), owning_building_guid = 33)
      LocalObject(2181, FacilityTurret.Constructor(Vector3(1091.642f, 4538.772f, 66.5363f), manned_turret), owning_building_guid = 33)
      TurretToWeapon(2181, 5030)
      LocalObject(2183, FacilityTurret.Constructor(Vector3(1148.388f, 4643.476f, 66.5363f), manned_turret), owning_building_guid = 33)
      TurretToWeapon(2183, 5031)
      LocalObject(2184, FacilityTurret.Constructor(Vector3(1181.429f, 4487.657f, 66.5363f), manned_turret), owning_building_guid = 33)
      TurretToWeapon(2184, 5032)
      LocalObject(2185, FacilityTurret.Constructor(Vector3(1207f, 4660.263f, 66.5363f), manned_turret), owning_building_guid = 33)
      TurretToWeapon(2185, 5033)
      LocalObject(2186, FacilityTurret.Constructor(Vector3(1240.066f, 4504.447f, 66.5363f), manned_turret), owning_building_guid = 33)
      TurretToWeapon(2186, 5034)
      LocalObject(2187, FacilityTurret.Constructor(Vector3(1296.704f, 4609.036f, 66.5363f), manned_turret), owning_building_guid = 33)
    ...
    def Building11(): Unit = { // Name: Tore Type: comm_station GUID: 36, MapID: 11
      ...
      LocalObject(2423, Terminal.Constructor(Vector3(2948.379f, 2304.907f, 64.84852f), order_terminal), owning_building_guid = 36)
      LocalObject(2424, Terminal.Constructor(Vector3(2958.075f, 2320.547f, 72.24352f), order_terminal), owning_building_guid = 36)
      LocalObject(2425, Terminal.Constructor(Vector3(2960.331f, 2318.43f, 72.24352f), order_terminal), owning_building_guid = 36)
      LocalObject(2426, Terminal.Constructor(Vector3(2960.332f, 2322.825f, 72.24352f), order_terminal), owning_building_guid = 36)
      LocalObject(2427, Terminal.Constructor(Vector3(3008.654f, 2343.408f, 50.07852f), order_terminal), owning_building_guid = 36)
      LocalObject(2428, Terminal.Constructor(Vector3(3008.654f, 2347.139f, 50.07852f), order_terminal), owning_building_guid = 36)
      LocalObject(2429, Terminal.Constructor(Vector3(3008.654f, 2350.928f, 50.07852f), order_terminal), owning_building_guid = 36)
      LocalObject(3422, Terminal.Constructor(Vector3(2941.943f, 2336.591f, 42.54552f), spawn_terminal), owning_building_guid = 36)
      LocalObject(3423, Terminal.Constructor(Vector3(2956.51f, 2303.969f, 65.10552f), spawn_terminal), owning_building_guid = 36)
      LocalObject(3424, Terminal.Constructor(Vector3(2957.409f, 2367.942f, 52.54552f), spawn_terminal), owning_building_guid = 36)
      LocalObject(3425, Terminal.Constructor(Vector3(2994.967f, 2346.535f, 50.62252f), spawn_terminal), owning_building_guid = 36)
      LocalObject(3426, Terminal.Constructor(Vector3(2994.971f, 2339.243f, 50.62252f), spawn_terminal), owning_building_guid = 36)
      ...
      LocalObject(2338, ProximityTerminal.Constructor(Vector3(2958.864f, 2299.023f, 58.48852f), medical_terminal), owning_building_guid = 36)
      LocalObject(2339, ProximityTerminal.Constructor(Vector3(3022.444f, 2357.62f, 40.98852f), medical_terminal), owning_building_guid = 36)
      LocalObject(2702, ProximityTerminal.Constructor(Vector3(2939.154f, 2383.185f, 66.72952f), pad_landing_frame), owning_building_guid = 36)
      LocalObject(2703, Terminal.Constructor(Vector3(2939.154f, 2383.185f, 66.72952f), air_rearm_terminal), owning_building_guid = 36)
      LocalObject(3128, ProximityTerminal.Constructor(Vector3(2896.912f, 2351.18f, 58.03852f), repair_silo), owning_building_guid = 36)
      LocalObject(3129, Terminal.Constructor(Vector3(2896.912f, 2351.18f, 58.03852f), ground_rearm_terminal), owning_building_guid = 36)
      LocalObject(3132, ProximityTerminal.Constructor(Vector3(3019.641f, 2303.67f, 58.03852f), repair_silo), owning_building_guid = 36)
      LocalObject(3133, Terminal.Constructor(Vector3(3019.641f, 2303.67f, 58.03852f), ground_rearm_terminal), owning_building_guid = 36)
      LocalObject(2212, FacilityTurret.Constructor(Vector3(2884.424f, 2366.652f, 66.99652f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(2212, 5036)
      LocalObject(2213, FacilityTurret.Constructor(Vector3(2885.554f, 2247.565f, 66.99652f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(2213, 5037)
      LocalObject(2214, FacilityTurret.Constructor(Vector3(2927.549f, 2409.75f, 66.99652f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(2214, 5038)
      LocalObject(2215, FacilityTurret.Constructor(Vector3(2988.865f, 2246.388f, 66.99652f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(2215, 5039)
      LocalObject(2218, FacilityTurret.Constructor(Vector3(3030.841f, 2408.435f, 66.99652f), manned_turret), owning_building_guid = 36)
      TurretToWeapon(2218, 5040)
      LocalObject(2219, FacilityTurret.Constructor(Vector3(3032.01f, 2289.501f, 66.99652f), manned_turret), owning_building_guid = 36)
    ...
    def Building18(): Unit = { // Name: Gunuku Type: comm_station_dsp GUID: 39, MapID: 18
      ...
      LocalObject(359, Terminal.Constructor(Vector3(4995.879f, 4446.918f, 59.62044f), dropship_vehicle_terminal), owning_building_guid = 39)
      LocalObject(358, VehicleSpawnPad.Constructor(Vector3(5004.328f, 4468.856f, 53.94444f), dropship_pad_doors, Vector3(0, 0, 90)), owning_building_guid = 39, terminal_guid = 359)
      LocalObject(2462, Terminal.Constructor(Vector3(4926.378f, 4320.897f, 60.37644f), order_terminal), owning_building_guid = 39)
      LocalObject(2463, Terminal.Constructor(Vector3(4936.075f, 4336.547f, 67.77144f), order_terminal), owning_building_guid = 39)
      LocalObject(2464, Terminal.Constructor(Vector3(4938.331f, 4334.43f, 67.77144f), order_terminal), owning_building_guid = 39)
      LocalObject(2465, Terminal.Constructor(Vector3(4938.332f, 4338.825f, 67.77144f), order_terminal), owning_building_guid = 39)
      LocalObject(2466, Terminal.Constructor(Vector3(4940.592f, 4336.59f, 67.77144f), order_terminal), owning_building_guid = 39)
      LocalObject(2470, Terminal.Constructor(Vector3(4986.654f, 4359.408f, 45.60644f), order_terminal), owning_building_guid = 39)
      LocalObject(2471, Terminal.Constructor(Vector3(4986.654f, 4363.139f, 45.60644f), order_terminal), owning_building_guid = 39)
      LocalObject(2472, Terminal.Constructor(Vector3(4986.654f, 4366.928f, 45.60644f), order_terminal), owning_building_guid = 39)
      LocalObject(3442, Terminal.Constructor(Vector3(4934.509f, 4319.959f, 60.63344f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3443, Terminal.Constructor(Vector3(4972.967f, 4362.535f, 46.15044f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3444, Terminal.Constructor(Vector3(4972.971f, 4355.243f, 46.15044f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3445, Terminal.Constructor(Vector3(4972.97f, 4369.823f, 46.15044f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3446, Terminal.Constructor(Vector3(4991.103f, 4438.906f, 60.56444f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3447, Terminal.Constructor(Vector3(5000.058f, 4343.409f, 38.04444f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3448, Terminal.Constructor(Vector3(5007.409f, 4399.942f, 38.04444f), spawn_terminal), owning_building_guid = 39)
      LocalObject(3450, Terminal.Constructor(Vector3(5016.058f, 4351.409f, 45.57344f), spawn_terminal), owning_building_guid = 39)
      ...
      LocalObject(2342, ProximityTerminal.Constructor(Vector3(4936.863f, 4315.013f, 54.01644f), medical_terminal), owning_building_guid = 39)
      LocalObject(2343, ProximityTerminal.Constructor(Vector3(5000.444f, 4373.62f, 36.51644f), medical_terminal), owning_building_guid = 39)
      LocalObject(2729, ProximityTerminal.Constructor(Vector3(4917.153f, 4437.398f, 62.32644f), pad_landing_frame), owning_building_guid = 39)
      LocalObject(2730, Terminal.Constructor(Vector3(4917.153f, 4437.398f, 62.32644f), air_rearm_terminal), owning_building_guid = 39)
      LocalObject(2732, ProximityTerminal.Constructor(Vector3(4933.514f, 4391.467f, 59.61044f), pad_landing_frame), owning_building_guid = 39)
      LocalObject(2733, Terminal.Constructor(Vector3(4933.514f, 4391.467f, 59.61044f), air_rearm_terminal), owning_building_guid = 39)
      LocalObject(2735, ProximityTerminal.Constructor(Vector3(4985.804f, 4355.901f, 66.79244f), pad_landing_frame), owning_building_guid = 39)
      LocalObject(2736, Terminal.Constructor(Vector3(4985.804f, 4355.901f, 66.79244f), air_rearm_terminal), owning_building_guid = 39)
      LocalObject(2738, ProximityTerminal.Constructor(Vector3(5021.071f, 4372.159f, 62.33944f), pad_landing_frame), owning_building_guid = 39)
      LocalObject(2739, Terminal.Constructor(Vector3(5021.071f, 4372.159f, 62.33944f), air_rearm_terminal), owning_building_guid = 39)
      LocalObject(3152, ProximityTerminal.Constructor(Vector3(4874.643f, 4382.241f, 53.66644f), repair_silo), owning_building_guid = 39)
      LocalObject(3153, Terminal.Constructor(Vector3(4874.643f, 4382.241f, 53.66644f), ground_rearm_terminal), owning_building_guid = 39)
      LocalObject(3160, ProximityTerminal.Constructor(Vector3(5044.57f, 4385.151f, 53.66644f), repair_silo), owning_building_guid = 39)
      LocalObject(3161, Terminal.Constructor(Vector3(5044.57f, 4385.151f, 53.66644f), ground_rearm_terminal), owning_building_guid = 39)
      LocalObject(2238, FacilityTurret.Constructor(Vector3(4862.401f, 4417.113f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2238, 5042)
      LocalObject(2239, FacilityTurret.Constructor(Vector3(4863.554f, 4263.565f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2239, 5043)
      LocalObject(2240, FacilityTurret.Constructor(Vector3(4907.445f, 4463.667f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2240, 5044)
      LocalObject(2242, FacilityTurret.Constructor(Vector3(4966.428f, 4262.396f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2242, 5045)
      LocalObject(2243, FacilityTurret.Constructor(Vector3(4967.449f, 4522.154f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2243, 5046)
      LocalObject(2246, FacilityTurret.Constructor(Vector3(5008.537f, 4303.011f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2246, 5047)
      LocalObject(2248, FacilityTurret.Constructor(Vector3(5055.619f, 4520.985f, 62.52444f), manned_turret), owning_building_guid = 39)
      TurretToWeapon(2248, 5048)
      LocalObject(2249, FacilityTurret.Constructor(Vector3(5056.773f, 4352.733f, 62.52444f), manned_turret), owning_building_guid = 39)
    ...
    def Building21(): Unit = { // Name: Mukuru Type: cryo_facility GUID: 42, MapID: 21
      ...
      LocalObject(294, Terminal.Constructor(Vector3(636.3127f, 2417.709f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(295, Terminal.Constructor(Vector3(637.3674f, 2419.464f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(296, Terminal.Constructor(Vector3(639.3851f, 2405.386f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(297, Terminal.Constructor(Vector3(641.1404f, 2404.332f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(298, Terminal.Constructor(Vector3(644.4748f, 2421.236f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(299, Terminal.Constructor(Vector3(646.2301f, 2420.182f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(300, Terminal.Constructor(Vector3(648.2478f, 2406.104f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(301, Terminal.Constructor(Vector3(649.3025f, 2407.859f, 44.05358f), cert_terminal), owning_building_guid = 42)
      LocalObject(2360, Terminal.Constructor(Vector3(596.817f, 2422.035f, 55.35858f), order_terminal), owning_building_guid = 42)
      LocalObject(2361, Terminal.Constructor(Vector3(601.7007f, 2393.692f, 45.65358f), order_terminal), owning_building_guid = 42)
      LocalObject(2362, Terminal.Constructor(Vector3(605.3209f, 2394.595f, 45.65358f), order_terminal), owning_building_guid = 42)
      LocalObject(2363, Terminal.Constructor(Vector3(608.9974f, 2395.511f, 45.65358f), order_terminal), owning_building_guid = 42)
      LocalObject(3389, Terminal.Constructor(Vector3(531.1984f, 2411.922f, 48.17658f), spawn_terminal), owning_building_guid = 42)
      LocalObject(3391, Terminal.Constructor(Vector3(577.225f, 2404.852f, 55.64258f), spawn_terminal), owning_building_guid = 42)
      LocalObject(3392, Terminal.Constructor(Vector3(579.7477f, 2448.668f, 45.67658f), spawn_terminal), owning_building_guid = 42)
      LocalObject(3393, Terminal.Constructor(Vector3(594.3492f, 2405.961f, 46.19758f), spawn_terminal), owning_building_guid = 42)
      LocalObject(3394, Terminal.Constructor(Vector3(601.4237f, 2407.729f, 46.19758f), spawn_terminal), owning_building_guid = 42)
      LocalObject(3395, Terminal.Constructor(Vector3(608.4959f, 2409.49f, 46.19758f), spawn_terminal), owning_building_guid = 42)
      ...
      LocalObject(203, ProximityTerminal.Constructor(Vector3(583.5829f, 2406.356f, 53.87358f), adv_med_terminal), owning_building_guid = 42)
      LocalObject(2329, ProximityTerminal.Constructor(Vector3(600.5218f, 2384.135f, 44.06358f), medical_terminal), owning_building_guid = 42)
      LocalObject(2636, ProximityTerminal.Constructor(Vector3(522.3973f, 2395.002f, 62.41558f), pad_landing_frame), owning_building_guid = 42)
      LocalObject(2637, Terminal.Constructor(Vector3(522.3973f, 2395.002f, 62.41558f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(2642, ProximityTerminal.Constructor(Vector3(525.5179f, 2412.594f, 64.35658f), pad_landing_frame), owning_building_guid = 42)
      LocalObject(2643, Terminal.Constructor(Vector3(525.5179f, 2412.594f, 64.35658f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(2651, ProximityTerminal.Constructor(Vector3(634.2289f, 2419.664f, 64.39558f), pad_landing_frame), owning_building_guid = 42)
      LocalObject(2652, Terminal.Constructor(Vector3(634.2289f, 2419.664f, 64.39558f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(2654, ProximityTerminal.Constructor(Vector3(638.4529f, 2437.436f, 62.40558f), pad_landing_frame), owning_building_guid = 42)
      LocalObject(2655, Terminal.Constructor(Vector3(638.4529f, 2437.436f, 62.40558f), air_rearm_terminal), owning_building_guid = 42)
      LocalObject(3084, ProximityTerminal.Constructor(Vector3(499.0919f, 2423.896f, 53.81358f), repair_silo), owning_building_guid = 42)
      LocalObject(3085, Terminal.Constructor(Vector3(499.0919f, 2423.896f, 53.81358f), ground_rearm_terminal), owning_building_guid = 42)
      LocalObject(3092, ProximityTerminal.Constructor(Vector3(618.0981f, 2362.868f, 53.81358f), repair_silo), owning_building_guid = 42)
      LocalObject(3093, Terminal.Constructor(Vector3(618.0981f, 2362.868f, 53.81358f), ground_rearm_terminal), owning_building_guid = 42)
      LocalObject(2162, FacilityTurret.Constructor(Vector3(478.9274f, 2456.098f, 62.46558f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(2162, 5050)
      LocalObject(2163, FacilityTurret.Constructor(Vector3(511.6338f, 2324.887f, 62.46558f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(2163, 5051)
      LocalObject(2171, FacilityTurret.Constructor(Vector3(643.0322f, 2356.425f, 62.46558f), manned_turret), owning_building_guid = 42)
      TurretToWeapon(2171, 5052)
      LocalObject(2172, FacilityTurret.Constructor(Vector3(650.7581f, 2498.949f, 62.46558f), manned_turret), owning_building_guid = 42)
    ...
    def Building19(): Unit = { // Name: Honsi Type: cryo_facility GUID: 45, MapID: 19
      ...
      LocalObject(302, Terminal.Constructor(Vector3(3998.276f, 4574.25f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(303, Terminal.Constructor(Vector3(3998.276f, 4581.575f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(304, Terminal.Constructor(Vector3(3999.724f, 4572.802f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(305, Terminal.Constructor(Vector3(3999.724f, 4583.023f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(306, Terminal.Constructor(Vector3(4012.424f, 4572.802f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(307, Terminal.Constructor(Vector3(4012.424f, 4583.023f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(308, Terminal.Constructor(Vector3(4013.872f, 4574.25f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(309, Terminal.Constructor(Vector3(4013.872f, 4581.575f, 78.9539f), cert_terminal), owning_building_guid = 45)
      LocalObject(2442, Terminal.Constructor(Vector3(3985.972f, 4535.526f, 90.2589f), order_terminal), owning_building_guid = 45)
      LocalObject(2449, Terminal.Constructor(Vector3(4014.654f, 4533.408f, 80.55389f), order_terminal), owning_building_guid = 45)
      LocalObject(2450, Terminal.Constructor(Vector3(4014.654f, 4537.139f, 80.55389f), order_terminal), owning_building_guid = 45)
      LocalObject(2451, Terminal.Constructor(Vector3(4014.654f, 4540.928f, 80.55389f), order_terminal), owning_building_guid = 45)
      LocalObject(3428, Terminal.Constructor(Vector3(3956f, 4525.407f, 80.5769f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3429, Terminal.Constructor(Vector3(3979.91f, 4469.41f, 83.0769f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3430, Terminal.Constructor(Vector3(3995.407f, 4590f, 80.5769f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3431, Terminal.Constructor(Vector3(3997.905f, 4512.359f, 90.5429f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3432, Terminal.Constructor(Vector3(4000.967f, 4536.535f, 81.0979f), spawn_terminal), owning_building_guid = 45)
      LocalObject(3433, Terminal.Constructor(Vector3(4000.971f, 4529.243f, 81.0979f), spawn_terminal), owning_building_guid = 45)
      ...
      LocalObject(204, ProximityTerminal.Constructor(Vector3(3997.983f, 4518.892f, 88.7739f), adv_med_terminal), owning_building_guid = 45)
      LocalObject(2340, ProximityTerminal.Constructor(Vector3(4023.642f, 4529.952f, 78.9639f), medical_terminal), owning_building_guid = 45)
      LocalObject(2705, ProximityTerminal.Constructor(Vector3(3977.883f, 4464.061f, 99.2569f), pad_landing_frame), owning_building_guid = 45)
      LocalObject(2706, Terminal.Constructor(Vector3(3977.883f, 4464.061f, 99.2569f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(2708, ProximityTerminal.Constructor(Vector3(3981.101f, 4579.651f, 97.3059f), pad_landing_frame), owning_building_guid = 45)
      LocalObject(2709, Terminal.Constructor(Vector3(3981.101f, 4579.651f, 97.3059f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(2711, ProximityTerminal.Constructor(Vector3(3994.198f, 4456.777f, 97.3159f), pad_landing_frame), owning_building_guid = 45)
      LocalObject(2712, Terminal.Constructor(Vector3(3994.198f, 4456.777f, 97.3159f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(2714, ProximityTerminal.Constructor(Vector3(3997.323f, 4571.253f, 99.2959f), pad_landing_frame), owning_building_guid = 45)
      LocalObject(2715, Terminal.Constructor(Vector3(3997.323f, 4571.253f, 99.2959f), air_rearm_terminal), owning_building_guid = 45)
      LocalObject(3136, ProximityTerminal.Constructor(Vector3(3960.525f, 4441.154f, 88.7139f), repair_silo), owning_building_guid = 45)
      LocalObject(3137, Terminal.Constructor(Vector3(3960.525f, 4441.154f, 88.7139f), ground_rearm_terminal), owning_building_guid = 45)
      LocalObject(3140, ProximityTerminal.Constructor(Vector3(4048.53f, 4541.861f, 88.7139f), repair_silo), owning_building_guid = 45)
      LocalObject(3141, Terminal.Constructor(Vector3(4048.53f, 4541.861f, 88.7139f), ground_rearm_terminal), owning_building_guid = 45)
      LocalObject(2224, FacilityTurret.Constructor(Vector3(3924.392f, 4606.472f, 97.3659f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(2224, 5055)
      LocalObject(2225, FacilityTurret.Constructor(Vector3(3924.4f, 4429.379f, 97.3659f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(2225, 5056)
      LocalObject(2229, FacilityTurret.Constructor(Vector3(4017.665f, 4607.605f, 97.3659f), manned_turret), owning_building_guid = 45)
      TurretToWeapon(2229, 5057)
      LocalObject(2231, FacilityTurret.Constructor(Vector3(4059.626f, 4429.371f, 97.3659f), manned_turret), owning_building_guid = 45)
      ...
      LocalObject(1216, Terminal.Constructor(Vector3(4006.054f, 4585.706f, 78.4409f), implant_terminal_interface), owning_building_guid = 45)
      TerminalToInterface(1226, 1216)
      LocalObject(1227, ImplantTerminalMech.Constructor, owning_building_guid = 45)
      LocalObject(1217, Terminal.Constructor(Vector3(4006.066f, 4570.386f, 78.4409f), implant_terminal_interface), owning_building_guid = 45)
    ...
    def Building4(): Unit = { // Name: Chuku Type: cryo_facility GUID: 48, MapID: 4
      ...
      LocalObject(310, Terminal.Constructor(Vector3(4164.276f, 7010.25f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(311, Terminal.Constructor(Vector3(4164.276f, 7017.575f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(312, Terminal.Constructor(Vector3(4165.724f, 7008.802f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(313, Terminal.Constructor(Vector3(4165.724f, 7019.023f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(314, Terminal.Constructor(Vector3(4178.424f, 7008.802f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(315, Terminal.Constructor(Vector3(4178.424f, 7019.023f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(316, Terminal.Constructor(Vector3(4179.872f, 7010.25f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(317, Terminal.Constructor(Vector3(4179.872f, 7017.575f, 44.01264f), cert_terminal), owning_building_guid = 48)
      LocalObject(2455, Terminal.Constructor(Vector3(4151.972f, 6971.526f, 55.31764f), order_terminal), owning_building_guid = 48)
      LocalObject(2456, Terminal.Constructor(Vector3(4180.654f, 6969.408f, 45.61264f), order_terminal), owning_building_guid = 48)
      LocalObject(2457, Terminal.Constructor(Vector3(4180.654f, 6973.139f, 45.61264f), order_terminal), owning_building_guid = 48)
      LocalObject(2458, Terminal.Constructor(Vector3(4180.654f, 6976.928f, 45.61264f), order_terminal), owning_building_guid = 48)
      LocalObject(3435, Terminal.Constructor(Vector3(4122f, 6961.407f, 45.63564f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3436, Terminal.Constructor(Vector3(4145.91f, 6905.41f, 48.13564f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3437, Terminal.Constructor(Vector3(4161.407f, 7026f, 45.63564f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3438, Terminal.Constructor(Vector3(4163.905f, 6948.359f, 55.60164f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3439, Terminal.Constructor(Vector3(4166.967f, 6972.535f, 46.15664f), spawn_terminal), owning_building_guid = 48)
      LocalObject(3440, Terminal.Constructor(Vector3(4166.971f, 6965.243f, 46.15664f), spawn_terminal), owning_building_guid = 48)
      ...
      LocalObject(205, ProximityTerminal.Constructor(Vector3(4163.983f, 6954.892f, 53.83265f), adv_med_terminal), owning_building_guid = 48)
      LocalObject(2341, ProximityTerminal.Constructor(Vector3(4189.642f, 6965.952f, 44.02264f), medical_terminal), owning_building_guid = 48)
      LocalObject(2717, ProximityTerminal.Constructor(Vector3(4143.883f, 6900.061f, 64.31564f), pad_landing_frame), owning_building_guid = 48)
      LocalObject(2718, Terminal.Constructor(Vector3(4143.883f, 6900.061f, 64.31564f), air_rearm_terminal), owning_building_guid = 48)
      LocalObject(2720, ProximityTerminal.Constructor(Vector3(4147.101f, 7015.651f, 62.36464f), pad_landing_frame), owning_building_guid = 48)
      LocalObject(2721, Terminal.Constructor(Vector3(4147.101f, 7015.651f, 62.36464f), air_rearm_terminal), owning_building_guid = 48)
      LocalObject(2723, ProximityTerminal.Constructor(Vector3(4160.198f, 6892.777f, 62.37465f), pad_landing_frame), owning_building_guid = 48)
      LocalObject(2724, Terminal.Constructor(Vector3(4160.198f, 6892.777f, 62.37465f), air_rearm_terminal), owning_building_guid = 48)
      LocalObject(2726, ProximityTerminal.Constructor(Vector3(4163.323f, 7007.253f, 64.35464f), pad_landing_frame), owning_building_guid = 48)
      LocalObject(2727, Terminal.Constructor(Vector3(4163.323f, 7007.253f, 64.35464f), air_rearm_terminal), owning_building_guid = 48)
      LocalObject(3144, ProximityTerminal.Constructor(Vector3(4126.524f, 6877.154f, 53.77264f), repair_silo), owning_building_guid = 48)
      LocalObject(3145, Terminal.Constructor(Vector3(4126.524f, 6877.154f, 53.77264f), ground_rearm_terminal), owning_building_guid = 48)
      LocalObject(3148, ProximityTerminal.Constructor(Vector3(4214.53f, 6977.861f, 53.77264f), repair_silo), owning_building_guid = 48)
      LocalObject(3149, Terminal.Constructor(Vector3(4214.53f, 6977.861f, 53.77264f), ground_rearm_terminal), owning_building_guid = 48)
      LocalObject(2233, FacilityTurret.Constructor(Vector3(4090.392f, 7042.472f, 62.42464f), manned_turret), owning_building_guid = 48)
      TurretToWeapon(2233, 5060)
      LocalObject(2234, FacilityTurret.Constructor(Vector3(4090.4f, 6865.379f, 62.42464f), manned_turret), owning_building_guid = 48)
      TurretToWeapon(2234, 5061)
      LocalObject(2235, FacilityTurret.Constructor(Vector3(4183.665f, 7043.605f, 62.42464f), manned_turret), owning_building_guid = 48)
      TurretToWeapon(2235, 5062)
      LocalObject(2236, FacilityTurret.Constructor(Vector3(4225.626f, 6865.371f, 62.42464f), manned_turret), owning_building_guid = 48)
      ...
      LocalObject(1218, Terminal.Constructor(Vector3(4172.054f, 7021.706f, 43.49965f), implant_terminal_interface), owning_building_guid = 48)
      TerminalToInterface(1228, 1218)
      LocalObject(1229, ImplantTerminalMech.Constructor, owning_building_guid = 48)
      LocalObject(1219, Terminal.Constructor(Vector3(4172.066f, 7006.386f, 43.49965f), implant_terminal_interface), owning_building_guid = 48)
    ...
    def Building8(): Unit = { // Name: Itan Type: cryo_facility GUID: 51, MapID: 8
      ...
      LocalObject(318, Terminal.Constructor(Vector3(5134.276f, 3382.25f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(319, Terminal.Constructor(Vector3(5134.276f, 3389.575f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(320, Terminal.Constructor(Vector3(5135.724f, 3380.802f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(321, Terminal.Constructor(Vector3(5135.724f, 3391.023f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(322, Terminal.Constructor(Vector3(5148.424f, 3380.802f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(323, Terminal.Constructor(Vector3(5148.424f, 3391.023f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(324, Terminal.Constructor(Vector3(5149.872f, 3382.25f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(325, Terminal.Constructor(Vector3(5149.872f, 3389.575f, 38.04749f), cert_terminal), owning_building_guid = 51)
      LocalObject(2477, Terminal.Constructor(Vector3(5121.972f, 3343.526f, 49.35249f), order_terminal), owning_building_guid = 51)
      LocalObject(2478, Terminal.Constructor(Vector3(5150.654f, 3341.408f, 39.6475f), order_terminal), owning_building_guid = 51)
      LocalObject(2479, Terminal.Constructor(Vector3(5150.654f, 3345.139f, 39.6475f), order_terminal), owning_building_guid = 51)
      LocalObject(2480, Terminal.Constructor(Vector3(5150.654f, 3348.928f, 39.6475f), order_terminal), owning_building_guid = 51)
      LocalObject(3457, Terminal.Constructor(Vector3(5092f, 3333.407f, 39.67049f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3459, Terminal.Constructor(Vector3(5115.91f, 3277.41f, 42.17049f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3460, Terminal.Constructor(Vector3(5131.407f, 3398f, 39.67049f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3461, Terminal.Constructor(Vector3(5133.905f, 3320.359f, 49.63649f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3462, Terminal.Constructor(Vector3(5136.967f, 3344.535f, 40.19149f), spawn_terminal), owning_building_guid = 51)
      LocalObject(3463, Terminal.Constructor(Vector3(5136.971f, 3337.243f, 40.19149f), spawn_terminal), owning_building_guid = 51)
      ...
      LocalObject(206, ProximityTerminal.Constructor(Vector3(5133.983f, 3326.892f, 47.8675f), adv_med_terminal), owning_building_guid = 51)
      LocalObject(2346, ProximityTerminal.Constructor(Vector3(5159.642f, 3337.952f, 38.0575f), medical_terminal), owning_building_guid = 51)
      LocalObject(2759, ProximityTerminal.Constructor(Vector3(5113.883f, 3272.061f, 58.35049f), pad_landing_frame), owning_building_guid = 51)
      LocalObject(2760, Terminal.Constructor(Vector3(5113.883f, 3272.061f, 58.35049f), air_rearm_terminal), owning_building_guid = 51)
      LocalObject(2762, ProximityTerminal.Constructor(Vector3(5117.101f, 3387.651f, 56.39949f), pad_landing_frame), owning_building_guid = 51)
      LocalObject(2763, Terminal.Constructor(Vector3(5117.101f, 3387.651f, 56.39949f), air_rearm_terminal), owning_building_guid = 51)
      LocalObject(2765, ProximityTerminal.Constructor(Vector3(5130.198f, 3264.777f, 56.4095f), pad_landing_frame), owning_building_guid = 51)
      LocalObject(2766, Terminal.Constructor(Vector3(5130.198f, 3264.777f, 56.4095f), air_rearm_terminal), owning_building_guid = 51)
      LocalObject(2768, ProximityTerminal.Constructor(Vector3(5133.323f, 3379.253f, 58.3895f), pad_landing_frame), owning_building_guid = 51)
      LocalObject(2769, Terminal.Constructor(Vector3(5133.323f, 3379.253f, 58.3895f), air_rearm_terminal), owning_building_guid = 51)
      LocalObject(3164, ProximityTerminal.Constructor(Vector3(5096.524f, 3249.154f, 47.8075f), repair_silo), owning_building_guid = 51)
      LocalObject(3165, Terminal.Constructor(Vector3(5096.524f, 3249.154f, 47.8075f), ground_rearm_terminal), owning_building_guid = 51)
      LocalObject(3172, ProximityTerminal.Constructor(Vector3(5184.53f, 3349.861f, 47.8075f), repair_silo), owning_building_guid = 51)
      LocalObject(3173, Terminal.Constructor(Vector3(5184.53f, 3349.861f, 47.8075f), ground_rearm_terminal), owning_building_guid = 51)
      LocalObject(2250, FacilityTurret.Constructor(Vector3(5060.392f, 3414.472f, 56.4595f), manned_turret), owning_building_guid = 51)
      TurretToWeapon(2250, 5065)
      LocalObject(2251, FacilityTurret.Constructor(Vector3(5060.4f, 3237.379f, 56.4595f), manned_turret), owning_building_guid = 51)
      TurretToWeapon(2251, 5066)
      LocalObject(2254, FacilityTurret.Constructor(Vector3(5153.665f, 3415.605f, 56.4595f), manned_turret), owning_building_guid = 51)
      TurretToWeapon(2254, 5067)
      LocalObject(2255, FacilityTurret.Constructor(Vector3(5195.626f, 3237.371f, 56.4595f), manned_turret), owning_building_guid = 51)
      ...
      LocalObject(1220, Terminal.Constructor(Vector3(5142.054f, 3393.706f, 37.5345f), implant_terminal_interface), owning_building_guid = 51)
      TerminalToInterface(1230, 1220)
      LocalObject(1231, ImplantTerminalMech.Constructor, owning_building_guid = 51)
      LocalObject(1221, Terminal.Constructor(Vector3(5142.066f, 3378.386f, 37.5345f), implant_terminal_interface), owning_building_guid = 51)
    ...
    def Building16(): Unit = { // Name: Shango Type: cryo_facility GUID: 54, MapID: 16
      ...
      LocalObject(326, Terminal.Constructor(Vector3(6799.383f, 2329.097f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(327, Terminal.Constructor(Vector3(6799.947f, 2327.128f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(328, Terminal.Constructor(Vector3(6802.934f, 2335.504f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(329, Terminal.Constructor(Vector3(6804.902f, 2336.068f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(330, Terminal.Constructor(Vector3(6811.055f, 2320.971f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(331, Terminal.Constructor(Vector3(6813.023f, 2321.536f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(332, Terminal.Constructor(Vector3(6816.01f, 2329.911f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(333, Terminal.Constructor(Vector3(6816.575f, 2327.942f, 52.95152f), cert_terminal), owning_building_guid = 54)
      LocalObject(2520, Terminal.Constructor(Vector3(6769.848f, 2301.193f, 64.25652f), order_terminal), owning_building_guid = 54)
      LocalObject(2521, Terminal.Constructor(Vector3(6793.907f, 2285.436f, 54.55152f), order_terminal), owning_building_guid = 54)
      LocalObject(2522, Terminal.Constructor(Vector3(6795.715f, 2288.699f, 54.55152f), order_terminal), owning_building_guid = 54)
      LocalObject(2523, Terminal.Constructor(Vector3(6797.552f, 2292.013f, 54.55152f), order_terminal), owning_building_guid = 54)
      LocalObject(3477, Terminal.Constructor(Vector3(6732.492f, 2246.306f, 57.07452f), spawn_terminal), owning_building_guid = 54)
      LocalObject(3478, Terminal.Constructor(Vector3(6738.728f, 2306.874f, 54.57452f), spawn_terminal), owning_building_guid = 54)
      LocalObject(3479, Terminal.Constructor(Vector3(6769.053f, 2275.146f, 64.54052f), spawn_terminal), owning_building_guid = 54)
      LocalObject(3480, Terminal.Constructor(Vector3(6779.92f, 2288.427f, 55.09552f), spawn_terminal), owning_building_guid = 54)
      LocalObject(3481, Terminal.Constructor(Vector3(6783.452f, 2294.806f, 55.09552f), spawn_terminal), owning_building_guid = 54)
      LocalObject(3482, Terminal.Constructor(Vector3(6786.988f, 2301.179f, 55.09552f), spawn_terminal), owning_building_guid = 54)
      ...
      LocalObject(207, ProximityTerminal.Constructor(Vector3(6772.289f, 2280.822f, 62.77152f), adv_med_terminal), owning_building_guid = 54)
      LocalObject(2351, ProximityTerminal.Constructor(Vector3(6800.092f, 2278.055f, 52.96152f), medical_terminal), owning_building_guid = 54)
      LocalObject(2795, ProximityTerminal.Constructor(Vector3(6728.126f, 2242.61f, 73.25452f), pad_landing_frame), owning_building_guid = 54)
      LocalObject(2796, Terminal.Constructor(Vector3(6728.126f, 2242.61f, 73.25452f), air_rearm_terminal), owning_building_guid = 54)
      LocalObject(2798, ProximityTerminal.Constructor(Vector3(6738.864f, 2228.33f, 71.31351f), pad_landing_frame), owning_building_guid = 54)
      LocalObject(2799, Terminal.Constructor(Vector3(6738.864f, 2228.33f, 71.31351f), air_rearm_terminal), owning_building_guid = 54)
      ...
      LocalObject(2802, Terminal.Constructor(Vector3(6786.979f, 2342.147f, 71.30352f), air_rearm_terminal), owning_building_guid = 54)
      LocalObject(2804, ProximityTerminal.Constructor(Vector3(6797.096f, 2326.938f, 73.29352f), pad_landing_frame), owning_building_guid = 54)
      LocalObject(2805, Terminal.Constructor(Vector3(6797.096f, 2326.938f, 73.29352f), air_rearm_terminal), owning_building_guid = 54)
      LocalObject(3192, ProximityTerminal.Constructor(Vector3(6701.838f, 2230.991f, 62.71152f), repair_silo), owning_building_guid = 54)
      LocalObject(3193, Terminal.Constructor(Vector3(6701.838f, 2230.991f, 62.71152f), ground_rearm_terminal), owning_building_guid = 54)
      LocalObject(3196, ProximityTerminal.Constructor(Vector3(6827.633f, 2276.406f, 62.71152f), repair_silo), owning_building_guid = 54)
      LocalObject(3197, Terminal.Constructor(Vector3(6827.633f, 2276.406f, 62.71152f), ground_rearm_terminal), owning_building_guid = 54)
      LocalObject(2283, FacilityTurret.Constructor(Vector3(6664.535f, 2238.206f, 71.36352f), manned_turret), owning_building_guid = 54)
    ...
    def Building7(): Unit = { // Name: Wele Type: tech_plant GUID: 66, MapID: 7
      ...
      LocalObject(208, Terminal.Constructor(Vector3(515.395f, 6990.859f, 75.60229f), air_vehicle_terminal), owning_building_guid = 66)
      LocalObject(2302, VehicleSpawnPad.Constructor(Vector3(510.912f, 6970.165f, 72.47729f), mb_pad_creation, Vector3(0, 0, 180)), owning_building_guid = 66, terminal_guid = 208)
      LocalObject(209, Terminal.Constructor(Vector3(527.327f, 6990.859f, 75.60229f), air_vehicle_terminal), owning_building_guid = 66)
      LocalObject(2303, VehicleSpawnPad.Constructor(Vector3(531.93f, 6970.165f, 72.47729f), mb_pad_creation, Vector3(0, 0, 180)), owning_building_guid = 66, terminal_guid = 209)
      LocalObject(2356, Terminal.Constructor(Vector3(505.346f, 6999.072f, 54.08929f), order_terminal), owning_building_guid = 66)
      LocalObject(2357, Terminal.Constructor(Vector3(505.346f, 7002.861f, 54.08929f), order_terminal), owning_building_guid = 66)
      LocalObject(2358, Terminal.Constructor(Vector3(505.346f, 7006.592f, 54.08929f), order_terminal), owning_building_guid = 66)
      LocalObject(2359, Terminal.Constructor(Vector3(528.942f, 6992.514f, 66.32928f), order_terminal), owning_building_guid = 66)
      LocalObject(3383, Terminal.Constructor(Vector3(494.758f, 6986.361f, 66.58129f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3384, Terminal.Constructor(Vector3(517.468f, 6962.785f, 71.92229f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3385, Terminal.Constructor(Vector3(519.029f, 7010.757f, 54.63329f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3386, Terminal.Constructor(Vector3(519.03f, 6996.177f, 54.63329f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3387, Terminal.Constructor(Vector3(519.033f, 7003.465f, 54.63329f), spawn_terminal), owning_building_guid = 66)
      LocalObject(3388, Terminal.Constructor(Vector3(524.058f, 7013.409f, 46.55629f), spawn_terminal), owning_building_guid = 66)
      ...
      LocalObject(2327, ProximityTerminal.Constructor(Vector3(491.556f, 6992.38f, 44.99929f), medical_terminal), owning_building_guid = 66)
      LocalObject(2328, ProximityTerminal.Constructor(Vector3(528.941f, 7003.099f, 64.99629f), medical_terminal), owning_building_guid = 66)
      LocalObject(2627, ProximityTerminal.Constructor(Vector3(463.72f, 6991.898f, 68.10728f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2628, Terminal.Constructor(Vector3(463.72f, 6991.898f, 68.10728f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2630, ProximityTerminal.Constructor(Vector3(470.013f, 7008.145f, 70.55128f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2631, Terminal.Constructor(Vector3(470.013f, 7008.145f, 70.55128f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2633, ProximityTerminal.Constructor(Vector3(506.466f, 7047.372f, 68.10728f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2634, Terminal.Constructor(Vector3(506.466f, 7047.372f, 68.10728f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2639, ProximityTerminal.Constructor(Vector3(522.621f, 7030.526f, 75.34629f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2640, Terminal.Constructor(Vector3(522.621f, 7030.526f, 75.34629f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2645, ProximityTerminal.Constructor(Vector3(573.02f, 6974.167f, 70.44929f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2646, Terminal.Constructor(Vector3(573.02f, 6974.167f, 70.44929f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2648, ProximityTerminal.Constructor(Vector3(593.296f, 6990.339f, 68.09428f), pad_landing_frame), owning_building_guid = 66)
      LocalObject(2649, Terminal.Constructor(Vector3(593.296f, 6990.339f, 68.09428f), air_rearm_terminal), owning_building_guid = 66)
      LocalObject(3080, ProximityTerminal.Constructor(Vector3(473.3634f, 7058.792f, 59.64929f), repair_silo), owning_building_guid = 66)
      LocalObject(3081, Terminal.Constructor(Vector3(473.3634f, 7058.792f, 59.64929f), ground_rearm_terminal), owning_building_guid = 66)
      LocalObject(3088, ProximityTerminal.Constructor(Vector3(531.6914f, 6924.363f, 59.62779f), repair_silo), owning_building_guid = 66)
      LocalObject(3089, Terminal.Constructor(Vector3(531.6914f, 6924.363f, 59.62779f), ground_rearm_terminal), owning_building_guid = 66)
      LocalObject(2159, FacilityTurret.Constructor(Vector3(438.119f, 7000.577f, 68.39828f), manned_turret), owning_building_guid = 66)
      TurretToWeapon(2159, 5075)
      LocalObject(2160, FacilityTurret.Constructor(Vector3(445.846f, 6927.602f, 68.39828f), manned_turret), owning_building_guid = 66)
      TurretToWeapon(2160, 5076)
      LocalObject(2161, FacilityTurret.Constructor(Vector3(445.846f, 7065.343f, 68.39828f), manned_turret), owning_building_guid = 66)
      TurretToWeapon(2161, 5077)
      LocalObject(2164, FacilityTurret.Constructor(Vector3(526.399f, 6867.145f, 68.39828f), manned_turret), owning_building_guid = 66)
      TurretToWeapon(2164, 5078)
      LocalObject(2167, FacilityTurret.Constructor(Vector3(610.587f, 7065.335f, 68.39828f), manned_turret), owning_building_guid = 66)
      TurretToWeapon(2167, 5079)
      LocalObject(2168, FacilityTurret.Constructor(Vector3(616.094f, 6867.145f, 68.39828f), manned_turret), owning_building_guid = 66)
    ...
    def Building10(): Unit = { // Name: Leza Type: tech_plant GUID: 69, MapID: 10
      ...
      LocalObject(210, Terminal.Constructor(Vector3(2686.756f, 1467.037f, 79.69115f), air_vehicle_terminal), owning_building_guid = 69)
      LocalObject(2309, VehicleSpawnPad.Constructor(Vector3(2666.709f, 1460.221f, 76.56615f), mb_pad_creation, Vector3(0, 0, 239)), owning_building_guid = 69, terminal_guid = 210)
      LocalObject(211, Terminal.Constructor(Vector3(2692.902f, 1456.809f, 79.69115f), air_vehicle_terminal), owning_building_guid = 69)
      LocalObject(2310, VehicleSpawnPad.Constructor(Vector3(2677.534f, 1442.205f, 76.56615f), mb_pad_creation, Vector3(0, 0, 239)), owning_building_guid = 69, terminal_guid = 211)
      LocalObject(2410, Terminal.Constructor(Vector3(2688.62f, 1479.88f, 58.17815f), order_terminal), owning_building_guid = 69)
      LocalObject(2411, Terminal.Constructor(Vector3(2691.868f, 1481.832f, 58.17815f), order_terminal), owning_building_guid = 69)
      LocalObject(2412, Terminal.Constructor(Vector3(2695.066f, 1483.753f, 58.17815f), order_terminal), owning_building_guid = 69)
      LocalObject(2413, Terminal.Constructor(Vector3(2695.152f, 1456.277f, 70.41815f), order_terminal), owning_building_guid = 69)
      LocalObject(3415, Terminal.Constructor(Vector3(2663.76f, 1450.801f, 76.01115f), spawn_terminal), owning_building_guid = 69)
      LocalObject(3416, Terminal.Constructor(Vector3(2672.272f, 1482.409f, 70.67016f), spawn_terminal), owning_building_guid = 69)
      LocalObject(3417, Terminal.Constructor(Vector3(2693.187f, 1466.66f, 58.72216f), spawn_terminal), owning_building_guid = 69)
      LocalObject(3418, Terminal.Constructor(Vector3(2699.435f, 1470.411f, 58.72216f), spawn_terminal), owning_building_guid = 69)
      LocalObject(3419, Terminal.Constructor(Vector3(2705.684f, 1474.17f, 58.72216f), spawn_terminal), owning_building_guid = 69)
      LocalObject(3420, Terminal.Constructor(Vector3(2710.547f, 1471.225f, 50.64516f), spawn_terminal), owning_building_guid = 69)
      ...
      LocalObject(2336, ProximityTerminal.Constructor(Vector3(2675.782f, 1488.254f, 49.08816f), medical_terminal), owning_building_guid = 69)
      LocalObject(2337, ProximityTerminal.Constructor(Vector3(2704.225f, 1461.729f, 69.08516f), medical_terminal), owning_building_guid = 69)
      LocalObject(2684, ProximityTerminal.Constructor(Vector3(2661.032f, 1511.866f, 72.19615f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2685, Terminal.Constructor(Vector3(2661.032f, 1511.866f, 72.19615f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2687, ProximityTerminal.Constructor(Vector3(2678.2f, 1514.839f, 74.64015f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2688, Terminal.Constructor(Vector3(2678.2f, 1514.839f, 74.64015f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2690, ProximityTerminal.Constructor(Vector3(2702.127f, 1409.045f, 74.53815f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2691, Terminal.Constructor(Vector3(2702.127f, 1409.045f, 74.53815f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2693, ProximityTerminal.Constructor(Vector3(2724.479f, 1481.273f, 79.43516f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2694, Terminal.Constructor(Vector3(2724.479f, 1481.273f, 79.43516f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2696, ProximityTerminal.Constructor(Vector3(2726.432f, 1399.995f, 72.18315f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2697, Terminal.Constructor(Vector3(2726.432f, 1399.995f, 72.18315f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2699, ProximityTerminal.Constructor(Vector3(2730.598f, 1503.797f, 72.19615f), pad_landing_frame), owning_building_guid = 69)
      LocalObject(2700, Terminal.Constructor(Vector3(2730.598f, 1503.797f, 72.19615f), air_rearm_terminal), owning_building_guid = 69)
      LocalObject(3120, ProximityTerminal.Constructor(Vector3(2638.152f, 1418.82f, 63.71666f), repair_silo), owning_building_guid = 69)
      LocalObject(3121, Terminal.Constructor(Vector3(2638.152f, 1418.82f, 63.71666f), ground_rearm_terminal), owning_building_guid = 69)
      LocalObject(3124, ProximityTerminal.Constructor(Vector3(2723.339f, 1538.053f, 63.73816f), repair_silo), owning_building_guid = 69)
      LocalObject(3125, Terminal.Constructor(Vector3(2723.339f, 1538.053f, 63.73816f), ground_rearm_terminal), owning_building_guid = 69)
      LocalObject(2202, FacilityTurret.Constructor(Vector3(2586.38f, 1393.887f, 72.48715f), manned_turret), owning_building_guid = 69)
      TurretToWeapon(2202, 5081)
      LocalObject(2203, FacilityTurret.Constructor(Vector3(2596.714f, 1494.072f, 72.48715f), manned_turret), owning_building_guid = 69)
      TurretToWeapon(2203, 5082)
      LocalObject(2204, FacilityTurret.Constructor(Vector3(2632.576f, 1317.003f, 72.48715f), manned_turret), owning_building_guid = 69)
      TurretToWeapon(2204, 5083)
      LocalObject(2205, FacilityTurret.Constructor(Vector3(2655.286f, 1538.28f, 72.48715f), manned_turret), owning_building_guid = 69)
      TurretToWeapon(2205, 5084)
      LocalObject(2206, FacilityTurret.Constructor(Vector3(2714.781f, 1565.014f, 72.48715f), manned_turret), owning_building_guid = 69)
      TurretToWeapon(2206, 5085)
      LocalObject(2207, FacilityTurret.Constructor(Vector3(2799.622f, 1423.799f, 72.48715f), manned_turret), owning_building_guid = 69)
    ...
    def Building6(): Unit = { // Name: Faro Type: tech_plant GUID: 72, MapID: 6
      ...
      LocalObject(212, Terminal.Constructor(Vector3(5084.306f, 5774.719f, 72.45156f), air_vehicle_terminal), owning_building_guid = 72)
      LocalObject(2317, VehicleSpawnPad.Constructor(Vector3(5104.737f, 5769.159f, 69.32656f), mb_pad_creation, Vector3(0, 0, 93)), owning_building_guid = 72, terminal_guid = 212)
      LocalObject(213, Terminal.Constructor(Vector3(5084.931f, 5786.634f, 72.45156f), air_vehicle_terminal), owning_building_guid = 72)
      LocalObject(2318, VehicleSpawnPad.Constructor(Vector3(5105.837f, 5790.148f, 69.32656f), mb_pad_creation, Vector3(0, 0, 93)), owning_building_guid = 72, terminal_guid = 213)
      LocalObject(2473, Terminal.Constructor(Vector3(5068.069f, 5765.507f, 50.93856f), order_terminal), owning_building_guid = 72)
      LocalObject(2474, Terminal.Constructor(Vector3(5071.794f, 5765.312f, 50.93856f), order_terminal), owning_building_guid = 72)
      LocalObject(2475, Terminal.Constructor(Vector3(5075.578f, 5765.113f, 50.93856f), order_terminal), owning_building_guid = 72)
      LocalObject(2476, Terminal.Constructor(Vector3(5083.362f, 5788.334f, 63.17856f), order_terminal), owning_building_guid = 72)
      LocalObject(3449, Terminal.Constructor(Vector3(5015.981f, 5819.019f, 50.90556f), spawn_terminal), owning_building_guid = 72)
      LocalObject(3452, Terminal.Constructor(Vector3(5062.24f, 5784.55f, 43.40556f), spawn_terminal), owning_building_guid = 72)
      LocalObject(3453, Terminal.Constructor(Vector3(5064.625f, 5779.389f, 51.48256f), spawn_terminal), owning_building_guid = 72)
      LocalObject(3454, Terminal.Constructor(Vector3(5071.908f, 5779.012f, 51.48256f), spawn_terminal), owning_building_guid = 72)
      LocalObject(3455, Terminal.Constructor(Vector3(5079.186f, 5778.627f, 51.48256f), spawn_terminal), owning_building_guid = 72)
      LocalObject(3456, Terminal.Constructor(Vector3(5087.718f, 5753.875f, 63.43056f), spawn_terminal), owning_building_guid = 72)
      ...
      LocalObject(2344, ProximityTerminal.Constructor(Vector3(5072.792f, 5788.887f, 61.84556f), medical_terminal), owning_building_guid = 72)
      LocalObject(2345, ProximityTerminal.Constructor(Vector3(5081.54f, 5750.992f, 41.84856f), medical_terminal), owning_building_guid = 72)
      LocalObject(2741, ProximityTerminal.Constructor(Vector3(5027.403f, 5768.76f, 64.95656f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2742, Terminal.Constructor(Vector3(5027.403f, 5768.76f, 64.95656f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2744, ProximityTerminal.Constructor(Vector3(5045.072f, 5784.011f, 72.19556f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2745, Terminal.Constructor(Vector3(5045.072f, 5784.011f, 72.19556f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2747, ProximityTerminal.Constructor(Vector3(5064.668f, 5730.304f, 67.40056f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2748, Terminal.Constructor(Vector3(5064.668f, 5730.304f, 67.40056f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2750, ProximityTerminal.Constructor(Vector3(5080.564f, 5723.169f, 64.95656f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2751, Terminal.Constructor(Vector3(5080.564f, 5723.169f, 64.95656f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2753, ProximityTerminal.Constructor(Vector3(5088.902f, 5852.486f, 64.94356f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2754, Terminal.Constructor(Vector3(5088.902f, 5852.486f, 64.94356f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2756, ProximityTerminal.Constructor(Vector3(5103.991f, 5831.391f, 67.29856f), pad_landing_frame), owning_building_guid = 72)
      LocalObject(2757, Terminal.Constructor(Vector3(5103.991f, 5831.391f, 67.29856f), air_rearm_terminal), owning_building_guid = 72)
      LocalObject(3156, ProximityTerminal.Constructor(Vector3(5014.266f, 5736.3f, 56.49856f), repair_silo), owning_building_guid = 72)
      LocalObject(3157, Terminal.Constructor(Vector3(5014.266f, 5736.3f, 56.49856f), ground_rearm_terminal), owning_building_guid = 72)
      LocalObject(3168, ProximityTerminal.Constructor(Vector3(5151.563f, 5787.513f, 56.47706f), repair_silo), owning_building_guid = 72)
      LocalObject(3169, Terminal.Constructor(Vector3(5151.563f, 5787.513f, 56.47706f), ground_rearm_terminal), owning_building_guid = 72)
      LocalObject(2245, FacilityTurret.Constructor(Vector3(5006.284f, 5709.163f, 65.24756f), manned_turret), owning_building_guid = 72)
      TurretToWeapon(2245, 5087)
      LocalObject(2247, FacilityTurret.Constructor(Vector3(5014.914f, 5873.678f, 65.24756f), manned_turret), owning_building_guid = 72)
      TurretToWeapon(2247, 5088)
      LocalObject(2252, FacilityTurret.Constructor(Vector3(5070.557f, 5698.057f, 65.24756f), manned_turret), owning_building_guid = 72)
      TurretToWeapon(2252, 5089)
      LocalObject(2253, FacilityTurret.Constructor(Vector3(5143.836f, 5701.955f, 65.24756f), manned_turret), owning_building_guid = 72)
      TurretToWeapon(2253, 5090)
      LocalObject(2257, FacilityTurret.Constructor(Vector3(5208.426f, 5779.233f, 65.24756f), manned_turret), owning_building_guid = 72)
      TurretToWeapon(2257, 5091)
      LocalObject(2258, FacilityTurret.Constructor(Vector3(5213.121f, 5868.805f, 65.24756f), manned_turret), owning_building_guid = 72)
    ...
    def Building14(): Unit = { // Name: Orisha Type: tech_plant GUID: 75, MapID: 14
      ...
      LocalObject(214, Terminal.Constructor(Vector3(7001.211f, 1242.049f, 72.68167f), air_vehicle_terminal), owning_building_guid = 75)
      LocalObject(2323, VehicleSpawnPad.Constructor(Vector3(6980.149f, 1239.634f, 69.55667f), mb_pad_creation, Vector3(0, 0, -84)), owning_building_guid = 75, terminal_guid = 214)
      LocalObject(215, Terminal.Constructor(Vector3(7002.458f, 1253.916f, 72.68167f), air_vehicle_terminal), owning_building_guid = 75)
      LocalObject(2324, VehicleSpawnPad.Constructor(Vector3(6982.347f, 1260.537f, 69.55667f), mb_pad_creation, Vector3(0, 0, -84)), owning_building_guid = 75, terminal_guid = 215)
      LocalObject(2527, Terminal.Constructor(Vector3(7002.688f, 1240.27f, 63.40867f), order_terminal), owning_building_guid = 75)
      LocalObject(2528, Terminal.Constructor(Vector3(7011.677f, 1263.051f, 51.16867f), order_terminal), owning_building_guid = 75)
      LocalObject(2529, Terminal.Constructor(Vector3(7015.445f, 1262.655f, 51.16867f), order_terminal), owning_building_guid = 75)
      LocalObject(2530, Terminal.Constructor(Vector3(7019.156f, 1262.265f, 51.16867f), order_terminal), owning_building_guid = 75)
      LocalObject(3484, Terminal.Constructor(Vector3(6974.322f, 1254.788f, 69.00167f), spawn_terminal), owning_building_guid = 75)
      LocalObject(3485, Terminal.Constructor(Vector3(7000.142f, 1274.91f, 63.66067f), spawn_terminal), owning_building_guid = 75)
      LocalObject(3486, Terminal.Constructor(Vector3(7007.367f, 1249.745f, 51.71267f), spawn_terminal), owning_building_guid = 75)
      LocalObject(3487, Terminal.Constructor(Vector3(7014.615f, 1248.98f, 51.71267f), spawn_terminal), owning_building_guid = 75)
      LocalObject(3488, Terminal.Constructor(Vector3(7021.868f, 1248.222f, 51.71267f), spawn_terminal), owning_building_guid = 75)
      LocalObject(3489, Terminal.Constructor(Vector3(7023.979f, 1242.943f, 43.63567f), spawn_terminal), owning_building_guid = 75)
      ...
      LocalObject(2352, ProximityTerminal.Constructor(Vector3(7006.463f, 1277.465f, 42.07867f), medical_terminal), owning_building_guid = 75)
      LocalObject(2353, ProximityTerminal.Constructor(Vector3(7013.215f, 1239.164f, 62.07567f), medical_terminal), owning_building_guid = 75)
      LocalObject(2807, ProximityTerminal.Constructor(Vector3(6979.834f, 1198.351f, 67.52867f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2808, Terminal.Constructor(Vector3(6979.834f, 1198.351f, 67.52867f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2810, ProximityTerminal.Constructor(Vector3(6993.798f, 1176.496f, 65.17367f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2811, Terminal.Constructor(Vector3(6993.798f, 1176.496f, 65.17367f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2813, ProximityTerminal.Constructor(Vector3(7008.894f, 1305.199f, 65.18667f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2814, Terminal.Constructor(Vector3(7008.894f, 1305.199f, 65.18667f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2816, ProximityTerminal.Constructor(Vector3(7024.394f, 1297.242f, 67.63067f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2817, Terminal.Constructor(Vector3(7024.394f, 1297.242f, 67.63067f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2819, ProximityTerminal.Constructor(Vector3(7041.153f, 1242.583f, 72.42567f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2820, Terminal.Constructor(Vector3(7041.153f, 1242.583f, 72.42567f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(2822, ProximityTerminal.Constructor(Vector3(7059.595f, 1256.888f, 65.18667f), pad_landing_frame), owning_building_guid = 75)
      LocalObject(2823, Terminal.Constructor(Vector3(7059.595f, 1256.888f, 65.18667f), air_rearm_terminal), owning_building_guid = 75)
      LocalObject(3200, ProximityTerminal.Constructor(Vector3(6934.624f, 1244.659f, 56.70717f), repair_silo), owning_building_guid = 75)
      LocalObject(3201, Terminal.Constructor(Vector3(6934.624f, 1244.659f, 56.70717f), ground_rearm_terminal), owning_building_guid = 75)
      LocalObject(3204, ProximityTerminal.Constructor(Vector3(7074.414f, 1288.616f, 56.72867f), repair_silo), owning_building_guid = 75)
      LocalObject(3205, Terminal.Constructor(Vector3(7074.414f, 1288.616f, 56.72867f), ground_rearm_terminal), owning_building_guid = 75)
      LocalObject(2288, FacilityTurret.Constructor(Vector3(6868.896f, 1166.7f, 65.47767f), manned_turret), owning_building_guid = 75)
      TurretToWeapon(2288, 5093)
      LocalObject(2289, FacilityTurret.Constructor(Vector3(6878.272f, 1255.903f, 65.47767f), manned_turret), owning_building_guid = 75)
      TurretToWeapon(2289, 5094)
      LocalObject(2292, FacilityTurret.Constructor(Vector3(6946.818f, 1329.696f, 65.47767f), manned_turret), owning_building_guid = 75)
      TurretToWeapon(2292, 5095)
      LocalObject(2293, FacilityTurret.Constructor(Vector3(7020.201f, 1329.752f, 65.47767f), manned_turret), owning_building_guid = 75)
      TurretToWeapon(2293, 5096)
      LocalObject(2294, FacilityTurret.Constructor(Vector3(7066.576f, 1151.46f, 65.47767f), manned_turret), owning_building_guid = 75)
      TurretToWeapon(2294, 5097)
      LocalObject(2295, FacilityTurret.Constructor(Vector3(7083.804f, 1315.298f, 65.47767f), manned_turret), owning_building_guid = 75)
    ...
    def Building22(): Unit = { // Name: S_Wele_Tower Type: tower_a GUID: 78, MapID: 22
      ...
      LocalObject(2367, Terminal.Constructor(Vector3(638.1472f, 6175.45f, 51.85081f), order_terminal), owning_building_guid = 78)
      LocalObject(2368, Terminal.Constructor(Vector3(639.7204f, 6170.304f, 51.85081f), order_terminal), owning_building_guid = 78)
      LocalObject(2369, Terminal.Constructor(Vector3(641.394f, 6164.83f, 51.85081f), order_terminal), owning_building_guid = 78)
      LocalObject(3241, SpawnTube.Constructor(Vector3(627.0243f, 6175.101f, 50.00082f), respawn_tube_tower, Vector3(0, 0, 343)), owning_building_guid = 78)
      LocalObject(3242, SpawnTube.Constructor(Vector3(631.8221f, 6159.408f, 50.00082f), respawn_tube_tower, Vector3(0, 0, 343)), owning_building_guid = 78)
      LocalObject(2166, FacilityTurret.Constructor(Vector3(609.5886f, 6152.143f, 79.46082f), manned_turret), owning_building_guid = 78)
      TurretToWeapon(2166, 5099)
      LocalObject(2170, FacilityTurret.Constructor(Vector3(635.9423f, 6186.773f, 79.46082f), manned_turret), owning_building_guid = 78)
    ...
    def Building61(): Unit = { // Name: NE_Wele_Tower Type: tower_a GUID: 79, MapID: 61
      ...
      LocalObject(2370, Terminal.Constructor(Vector3(658.2741f, 7213.097f, 53.49809f), order_terminal), owning_building_guid = 79)
      LocalObject(2371, Terminal.Constructor(Vector3(659.7573f, 7207.925f, 53.49809f), order_terminal), owning_building_guid = 79)
      LocalObject(2372, Terminal.Constructor(Vector3(661.3351f, 7202.422f, 53.49809f), order_terminal), owning_building_guid = 79)
      LocalObject(3243, SpawnTube.Constructor(Vector3(647.1469f, 7212.942f, 51.64809f), respawn_tube_tower, Vector3(0, 0, 344)), owning_building_guid = 79)
      LocalObject(3244, SpawnTube.Constructor(Vector3(651.67f, 7197.168f, 51.64809f), respawn_tube_tower, Vector3(0, 0, 344)), owning_building_guid = 79)
      LocalObject(2169, FacilityTurret.Constructor(Vector3(629.3132f, 7190.292f, 81.10809f), manned_turret), owning_building_guid = 79)
      TurretToWeapon(2169, 5101)
      LocalObject(2173, FacilityTurret.Constructor(Vector3(656.2672f, 7224.457f, 81.10809f), manned_turret), owning_building_guid = 79)
    ...
    def Building62(): Unit = { // Name: S_Nzame_Tower Type: tower_a GUID: 80, MapID: 62
      ...
      LocalObject(2395, Terminal.Constructor(Vector3(1446.948f, 2481.727f, 34.21756f), order_terminal), owning_building_guid = 80)
      LocalObject(2396, Terminal.Constructor(Vector3(1449.457f, 2486.872f, 34.21756f), order_terminal), owning_building_guid = 80)
      LocalObject(2397, Terminal.Constructor(Vector3(1451.816f, 2491.708f, 34.21756f), order_terminal), owning_building_guid = 80)
      LocalObject(3257, SpawnTube.Constructor(Vector3(1436.249f, 2484.289f, 32.36756f), respawn_tube_tower, Vector3(0, 0, 26)), owning_building_guid = 80)
      LocalObject(3258, SpawnTube.Constructor(Vector3(1443.443f, 2499.039f, 32.36756f), respawn_tube_tower, Vector3(0, 0, 26)), owning_building_guid = 80)
      LocalObject(2189, FacilityTurret.Constructor(Vector3(1415.034f, 2494.139f, 61.82756f), manned_turret), owning_building_guid = 80)
      TurretToWeapon(2189, 5103)
      LocalObject(2192, FacilityTurret.Constructor(Vector3(1457.925f, 2501.493f, 61.82756f), manned_turret), owning_building_guid = 80)
    ...
    def Building27(): Unit = { // Name: NE_Searhus_Warpgate_Tower Type: tower_a GUID: 81, MapID: 27
      ...
      LocalObject(2399, Terminal.Constructor(Vector3(1553.405f, 1900.555f, 32.3092f), order_terminal), owning_building_guid = 81)
      LocalObject(2400, Terminal.Constructor(Vector3(1554.399f, 1906.192f, 32.3092f), order_terminal), owning_building_guid = 81)
      LocalObject(2402, Terminal.Constructor(Vector3(1555.333f, 1911.491f, 32.3092f), order_terminal), owning_building_guid = 81)
      LocalObject(3259, SpawnTube.Constructor(Vector3(1542.415f, 1900.069f, 30.4592f), respawn_tube_tower, Vector3(0, 0, 10)), owning_building_guid = 81)
      LocalObject(3260, SpawnTube.Constructor(Vector3(1545.264f, 1916.23f, 30.4592f), respawn_tube_tower, Vector3(0, 0, 10)), owning_building_guid = 81)
      LocalObject(2194, FacilityTurret.Constructor(Vector3(1519.306f, 1903.69f, 59.9192f), manned_turret), owning_building_guid = 81)
      TurretToWeapon(2194, 5105)
      LocalObject(2195, FacilityTurret.Constructor(Vector3(1558.51f, 1922.581f, 59.9192f), manned_turret), owning_building_guid = 81)
    ...
    def Building26(): Unit = { // Name: NE_Nzame_Tower Type: tower_a GUID: 82, MapID: 26
      ...
      LocalObject(2407, Terminal.Constructor(Vector3(1970.147f, 3617.45f, 46.65343f), order_terminal), owning_building_guid = 82)
      LocalObject(2408, Terminal.Constructor(Vector3(1971.72f, 3612.304f, 46.65343f), order_terminal), owning_building_guid = 82)
      LocalObject(2409, Terminal.Constructor(Vector3(1973.394f, 3606.83f, 46.65343f), order_terminal), owning_building_guid = 82)
      LocalObject(3264, SpawnTube.Constructor(Vector3(1959.024f, 3617.101f, 44.80343f), respawn_tube_tower, Vector3(0, 0, 343)), owning_building_guid = 82)
      LocalObject(3265, SpawnTube.Constructor(Vector3(1963.822f, 3601.408f, 44.80343f), respawn_tube_tower, Vector3(0, 0, 343)), owning_building_guid = 82)
      LocalObject(2200, FacilityTurret.Constructor(Vector3(1941.589f, 3594.143f, 74.26343f), manned_turret), owning_building_guid = 82)
      TurretToWeapon(2200, 5107)
      LocalObject(2201, FacilityTurret.Constructor(Vector3(1967.942f, 3628.773f, 74.26343f), manned_turret), owning_building_guid = 82)
    ...
    def Building36(): Unit = { // Name: SE_NCSanc_Warpgate_Tower Type: tower_a GUID: 83, MapID: 36
      ...
      LocalObject(2420, Terminal.Constructor(Vector3(2859.064f, 6208.207f, 58.80721f), order_terminal), owning_building_guid = 83)
      LocalObject(2421, Terminal.Constructor(Vector3(2859.813f, 6202.878f, 58.80721f), order_terminal), owning_building_guid = 83)
      LocalObject(2422, Terminal.Constructor(Vector3(2860.61f, 6197.209f, 58.80721f), order_terminal), owning_building_guid = 83)
      LocalObject(3273, SpawnTube.Constructor(Vector3(2848.024f, 6209.602f, 56.95721f), respawn_tube_tower, Vector3(0, 0, 352)), owning_building_guid = 83)
      LocalObject(3274, SpawnTube.Constructor(Vector3(2850.308f, 6193.351f, 56.95721f), respawn_tube_tower, Vector3(0, 0, 352)), owning_building_guid = 83)
      LocalObject(2209, FacilityTurret.Constructor(Vector3(2827.212f, 6189.654f, 86.41721f), manned_turret), owning_building_guid = 83)
      TurretToWeapon(2209, 5109)
      LocalObject(2211, FacilityTurret.Constructor(Vector3(2858.658f, 6219.735f, 86.41721f), manned_turret), owning_building_guid = 83)
    ...
    def Building64(): Unit = { // Name: N_Tore_Tower Type: tower_a GUID: 84, MapID: 64
      ...
      LocalObject(2430, Terminal.Constructor(Vector3(3029.445f, 2522.129f, 45.17487f), order_terminal), owning_building_guid = 84)
      LocalObject(2431, Terminal.Constructor(Vector3(3029.445f, 2527.853f, 45.17487f), order_terminal), owning_building_guid = 84)
      LocalObject(2432, Terminal.Constructor(Vector3(3029.445f, 2533.234f, 45.17487f), order_terminal), owning_building_guid = 84)
      LocalObject(3278, SpawnTube.Constructor(Vector3(3018.706f, 2519.742f, 43.32487f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 84)
      LocalObject(3279, SpawnTube.Constructor(Vector3(3018.706f, 2536.152f, 43.32487f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 84)
      LocalObject(2216, FacilityTurret.Constructor(Vector3(2995.32f, 2519.295f, 72.78487f), manned_turret), owning_building_guid = 84)
      TurretToWeapon(2216, 5111)
      LocalObject(2217, FacilityTurret.Constructor(Vector3(3030.647f, 2544.707f, 72.78487f), manned_turret), owning_building_guid = 84)
    ...
    def Building35(): Unit = { // Name: SW_Honsi_Tower Type: tower_a GUID: 85, MapID: 35
      ...
      LocalObject(2433, Terminal.Constructor(Vector3(3432.993f, 4006.583f, 60.41797f), order_terminal), owning_building_guid = 85)
      LocalObject(2434, Terminal.Constructor(Vector3(3437.847f, 4009.616f, 60.41797f), order_terminal), owning_building_guid = 85)
      LocalObject(2435, Terminal.Constructor(Vector3(3442.411f, 4012.468f, 60.41797f), order_terminal), owning_building_guid = 85)
      LocalObject(3280, SpawnTube.Constructor(Vector3(3425.278f, 4014.425f, 58.56797f), respawn_tube_tower, Vector3(0, 0, 58)), owning_building_guid = 85)
      LocalObject(3281, SpawnTube.Constructor(Vector3(3439.194f, 4023.121f, 58.56797f), respawn_tube_tower, Vector3(0, 0, 58)), owning_building_guid = 85)
      LocalObject(2220, FacilityTurret.Constructor(Vector3(3412.506f, 4034.021f, 88.02797f), manned_turret), owning_building_guid = 85)
      TurretToWeapon(2220, 5113)
      LocalObject(2221, FacilityTurret.Constructor(Vector3(3452.777f, 4017.528f, 88.02797f), manned_turret), owning_building_guid = 85)
    ...
    def Building67(): Unit = { // Name: S_Chuku_Tower Type: tower_a GUID: 86, MapID: 67
      ...
      LocalObject(2452, Terminal.Constructor(Vector3(4029.445f, 5972.129f, 52.43494f), order_terminal), owning_building_guid = 86)
      LocalObject(2453, Terminal.Constructor(Vector3(4029.445f, 5977.853f, 52.43494f), order_terminal), owning_building_guid = 86)
      LocalObject(2454, Terminal.Constructor(Vector3(4029.445f, 5983.234f, 52.43494f), order_terminal), owning_building_guid = 86)
      LocalObject(3293, SpawnTube.Constructor(Vector3(4018.706f, 5969.742f, 50.58494f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 86)
      LocalObject(3294, SpawnTube.Constructor(Vector3(4018.706f, 5986.152f, 50.58494f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 86)
      LocalObject(2227, FacilityTurret.Constructor(Vector3(3995.32f, 5969.295f, 80.04494f), manned_turret), owning_building_guid = 86)
      TurretToWeapon(2227, 5115)
      LocalObject(2230, FacilityTurret.Constructor(Vector3(4030.647f, 5994.707f, 80.04494f), manned_turret), owning_building_guid = 86)
    ...
    def Building33(): Unit = { // Name: N_Gunuku_Tower Type: tower_a GUID: 87, MapID: 33
      ...
      LocalObject(2467, Terminal.Constructor(Vector3(4976.503f, 4774.297f, 35.83165f), order_terminal), owning_building_guid = 87)
      LocalObject(2468, Terminal.Constructor(Vector3(4977.002f, 4780f, 35.83165f), order_terminal), owning_building_guid = 87)
      LocalObject(2469, Terminal.Constructor(Vector3(4977.471f, 4785.36f, 35.83165f), order_terminal), owning_building_guid = 87)
      LocalObject(3300, SpawnTube.Constructor(Vector3(4965.597f, 4772.855f, 33.98165f), respawn_tube_tower, Vector3(0, 0, 5)), owning_building_guid = 87)
      LocalObject(3301, SpawnTube.Constructor(Vector3(4967.027f, 4789.203f, 33.98165f), respawn_tube_tower, Vector3(0, 0, 5)), owning_building_guid = 87)
      LocalObject(2241, FacilityTurret.Constructor(Vector3(4942.261f, 4774.448f, 63.44165f), manned_turret), owning_building_guid = 87)
      TurretToWeapon(2241, 5117)
      LocalObject(2244, FacilityTurret.Constructor(Vector3(4979.668f, 4796.685f, 63.44165f), manned_turret), owning_building_guid = 87)
    ...
    def Building38(): Unit = { // Name: W_Ekera_Tower Type: tower_a GUID: 88, MapID: 38
      ...
      LocalObject(2490, Terminal.Constructor(Vector3(5453.445f, 6730.129f, 61.42691f), order_terminal), owning_building_guid = 88)
      LocalObject(2491, Terminal.Constructor(Vector3(5453.445f, 6735.853f, 61.42691f), order_terminal), owning_building_guid = 88)
      LocalObject(2492, Terminal.Constructor(Vector3(5453.445f, 6741.234f, 61.42691f), order_terminal), owning_building_guid = 88)
      LocalObject(3317, SpawnTube.Constructor(Vector3(5442.706f, 6727.742f, 59.57691f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 88)
      LocalObject(3318, SpawnTube.Constructor(Vector3(5442.706f, 6744.152f, 59.57691f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 88)
      LocalObject(2261, FacilityTurret.Constructor(Vector3(5419.32f, 6727.295f, 89.03691f), manned_turret), owning_building_guid = 88)
      TurretToWeapon(2261, 5119)
      LocalObject(2262, FacilityTurret.Constructor(Vector3(5454.647f, 6752.707f, 89.03691f), manned_turret), owning_building_guid = 88)
    ...
    def Building31(): Unit = { // Name: NW_TRSanc_Warpgate_Tower Type: tower_a GUID: 89, MapID: 31
      ...
      LocalObject(2493, Terminal.Constructor(Vector3(5601.445f, 2070.129f, 50.87727f), order_terminal), owning_building_guid = 89)
      LocalObject(2494, Terminal.Constructor(Vector3(5601.445f, 2075.853f, 50.87727f), order_terminal), owning_building_guid = 89)
      LocalObject(2495, Terminal.Constructor(Vector3(5601.445f, 2081.234f, 50.87727f), order_terminal), owning_building_guid = 89)
      LocalObject(3319, SpawnTube.Constructor(Vector3(5590.706f, 2067.742f, 49.02728f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 89)
      LocalObject(3320, SpawnTube.Constructor(Vector3(5590.706f, 2084.152f, 49.02728f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 89)
      LocalObject(2266, FacilityTurret.Constructor(Vector3(5567.32f, 2067.295f, 78.48727f), manned_turret), owning_building_guid = 89)
      TurretToWeapon(2266, 5121)
      LocalObject(2267, FacilityTurret.Constructor(Vector3(5602.647f, 2092.707f, 78.48727f), manned_turret), owning_building_guid = 89)
    ...
    def Building43(): Unit = { // Name: S_Kaang_Tower Type: tower_a GUID: 90, MapID: 43
      ...
      LocalObject(2511, Terminal.Constructor(Vector3(5899.445f, 3632.129f, 84.96889f), order_terminal), owning_building_guid = 90)
      LocalObject(2512, Terminal.Constructor(Vector3(5899.445f, 3637.853f, 84.96889f), order_terminal), owning_building_guid = 90)
      LocalObject(2513, Terminal.Constructor(Vector3(5899.445f, 3643.234f, 84.96889f), order_terminal), owning_building_guid = 90)
      LocalObject(3329, SpawnTube.Constructor(Vector3(5888.706f, 3629.742f, 83.1189f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 90)
      LocalObject(3330, SpawnTube.Constructor(Vector3(5888.706f, 3646.152f, 83.1189f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 90)
      LocalObject(2277, FacilityTurret.Constructor(Vector3(5865.32f, 3629.295f, 112.5789f), manned_turret), owning_building_guid = 90)
      TurretToWeapon(2277, 5123)
      LocalObject(2279, FacilityTurret.Constructor(Vector3(5900.647f, 3654.707f, 112.5789f), manned_turret), owning_building_guid = 90)
    ...
    def Building41(): Unit = { // Name: NW_Pamba_Tower Type: tower_a GUID: 91, MapID: 41
      ...
      LocalObject(2514, Terminal.Constructor(Vector3(6646.014f, 3687.801f, 38.82307f), order_terminal), owning_building_guid = 91)
      LocalObject(2515, Terminal.Constructor(Vector3(6647.677f, 3682.683f, 38.82307f), order_terminal), owning_building_guid = 91)
      LocalObject(2516, Terminal.Constructor(Vector3(6649.446f, 3677.239f, 38.82307f), order_terminal), owning_building_guid = 91)
      LocalObject(3331, SpawnTube.Constructor(Vector3(6634.899f, 3687.257f, 36.97308f), respawn_tube_tower, Vector3(0, 0, 342)), owning_building_guid = 91)
      LocalObject(3332, SpawnTube.Constructor(Vector3(6639.97f, 3671.65f, 36.97308f), respawn_tube_tower, Vector3(0, 0, 342)), owning_building_guid = 91)
      LocalObject(2281, FacilityTurret.Constructor(Vector3(6617.867f, 3663.999f, 66.43307f), manned_turret), owning_building_guid = 91)
      TurretToWeapon(2281, 5125)
      LocalObject(2282, FacilityTurret.Constructor(Vector3(6643.612f, 3699.083f, 66.43307f), manned_turret), owning_building_guid = 91)
    ...
    def Building65(): Unit = { // Name: E_Shango_Tower Type: tower_a GUID: 92, MapID: 65
      ...
      LocalObject(2524, Terminal.Constructor(Vector3(6926.952f, 2154.155f, 69.46305f), order_terminal), owning_building_guid = 92)
      LocalObject(2525, Terminal.Constructor(Vector3(6930.855f, 2158.342f, 69.46305f), order_terminal), owning_building_guid = 92)
      LocalObject(2526, Terminal.Constructor(Vector3(6934.525f, 2162.277f, 69.46305f), order_terminal), owning_building_guid = 92)
      LocalObject(3338, SpawnTube.Constructor(Vector3(6917.47f, 2159.734f, 67.61305f), respawn_tube_tower, Vector3(0, 0, 43)), owning_building_guid = 92)
      LocalObject(3339, SpawnTube.Constructor(Vector3(6928.662f, 2171.735f, 67.61305f), respawn_tube_tower, Vector3(0, 0, 43)), owning_building_guid = 92)
      LocalObject(2290, FacilityTurret.Constructor(Vector3(6900.062f, 2175.356f, 97.07305f), manned_turret), owning_building_guid = 92)
      TurretToWeapon(2290, 5127)
      LocalObject(2291, FacilityTurret.Constructor(Vector3(6943.229f, 2169.848f, 97.07305f), manned_turret), owning_building_guid = 92)
    ...
    def Building23(): Unit = { // Name: N_Aja_Tower Type: tower_b GUID: 93, MapID: 23
      ...
      LocalObject(2364, Terminal.Constructor(Vector3(623.446f, 5706.129f, 49.93914f), order_terminal), owning_building_guid = 93)
      LocalObject(2365, Terminal.Constructor(Vector3(623.446f, 5711.853f, 49.93914f), order_terminal), owning_building_guid = 93)
      LocalObject(2366, Terminal.Constructor(Vector3(623.446f, 5717.234f, 49.93914f), order_terminal), owning_building_guid = 93)
      LocalObject(3239, SpawnTube.Constructor(Vector3(612.706f, 5703.742f, 48.08913f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 93)
      LocalObject(3240, SpawnTube.Constructor(Vector3(612.706f, 5720.152f, 48.08913f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 93)
    ...
    def Building63(): Unit = { // Name: E_Mukuru_Tower Type: tower_b GUID: 94, MapID: 63
      ...
      LocalObject(2379, Terminal.Constructor(Vector3(891.446f, 2280.129f, 40.25683f), order_terminal), owning_building_guid = 94)
      LocalObject(2380, Terminal.Constructor(Vector3(891.446f, 2285.853f, 40.25683f), order_terminal), owning_building_guid = 94)
      LocalObject(2381, Terminal.Constructor(Vector3(891.446f, 2291.234f, 40.25683f), order_terminal), owning_building_guid = 94)
      LocalObject(3248, SpawnTube.Constructor(Vector3(880.706f, 2277.742f, 38.40683f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 94)
      LocalObject(3249, SpawnTube.Constructor(Vector3(880.706f, 2294.152f, 38.40683f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 94)
    ...
    def Building28(): Unit = { // Name: S_Leza_Tower Type: tower_b GUID: 95, MapID: 28
      ...
      LocalObject(2414, Terminal.Constructor(Vector3(2799.446f, 1244.129f, 55.40866f), order_terminal), owning_building_guid = 95)
      LocalObject(2415, Terminal.Constructor(Vector3(2799.446f, 1249.853f, 55.40866f), order_terminal), owning_building_guid = 95)
      LocalObject(2416, Terminal.Constructor(Vector3(2799.446f, 1255.234f, 55.40866f), order_terminal), owning_building_guid = 95)
      LocalObject(3269, SpawnTube.Constructor(Vector3(2788.706f, 1241.742f, 53.55866f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 95)
      LocalObject(3270, SpawnTube.Constructor(Vector3(2788.706f, 1258.152f, 53.55866f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 95)
    ...
    def Building30(): Unit = { // Name: NE_Tore_Tower Type: tower_b GUID: 96, MapID: 30
      ...
      LocalObject(2436, Terminal.Constructor(Vector3(3601.446f, 3216.129f, 37.81413f), order_terminal), owning_building_guid = 96)
      LocalObject(2437, Terminal.Constructor(Vector3(3601.446f, 3221.853f, 37.81413f), order_terminal), owning_building_guid = 96)
      LocalObject(2438, Terminal.Constructor(Vector3(3601.446f, 3227.234f, 37.81413f), order_terminal), owning_building_guid = 96)
      LocalObject(3282, SpawnTube.Constructor(Vector3(3590.706f, 3213.742f, 35.96413f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 96)
      LocalObject(3283, SpawnTube.Constructor(Vector3(3590.706f, 3230.152f, 35.96413f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 96)
    ...
    def Building68(): Unit = { // Name: N_Honsi_Tower Type: tower_b GUID: 97, MapID: 68
      ...
      LocalObject(2443, Terminal.Constructor(Vector3(3991.446f, 4806.129f, 82.52619f), order_terminal), owning_building_guid = 97)
      LocalObject(2444, Terminal.Constructor(Vector3(3991.446f, 4811.853f, 82.52619f), order_terminal), owning_building_guid = 97)
      LocalObject(2445, Terminal.Constructor(Vector3(3991.446f, 4817.234f, 82.52619f), order_terminal), owning_building_guid = 97)
      LocalObject(3286, SpawnTube.Constructor(Vector3(3980.706f, 4803.742f, 80.67619f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 97)
      LocalObject(3287, SpawnTube.Constructor(Vector3(3980.706f, 4820.152f, 80.67619f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 97)
    ...
    def Building45(): Unit = { // Name: SW_Itan_Tower Type: tower_b GUID: 98, MapID: 45
      ...
      LocalObject(2459, Terminal.Constructor(Vector3(4859.972f, 3096.969f, 50.39908f), order_terminal), owning_building_guid = 98)
      LocalObject(2460, Terminal.Constructor(Vector3(4862.747f, 3101.976f, 50.39908f), order_terminal), owning_building_guid = 98)
      LocalObject(2461, Terminal.Constructor(Vector3(4865.355f, 3106.682f, 50.39908f), order_terminal), owning_building_guid = 98)
      LocalObject(3298, SpawnTube.Constructor(Vector3(4849.421f, 3100.089f, 48.54908f), respawn_tube_tower, Vector3(0, 0, 29)), owning_building_guid = 98)
      LocalObject(3299, SpawnTube.Constructor(Vector3(4857.376f, 3114.441f, 48.54908f), respawn_tube_tower, Vector3(0, 0, 29)), owning_building_guid = 98)
    ...
    def Building32(): Unit = { // Name: SE_Gunuku_Tower Type: tower_b GUID: 99, MapID: 32
      ...
      LocalObject(2481, Terminal.Constructor(Vector3(5165.168f, 3954.218f, 41.61979f), order_terminal), owning_building_guid = 99)
      LocalObject(2482, Terminal.Constructor(Vector3(5166.261f, 3959.837f, 41.61979f), order_terminal), owning_building_guid = 99)
      LocalObject(2483, Terminal.Constructor(Vector3(5167.288f, 3965.119f, 41.61979f), order_terminal), owning_building_guid = 99)
      LocalObject(3311, SpawnTube.Constructor(Vector3(5154.17f, 3953.924f, 39.76979f), respawn_tube_tower, Vector3(0, 0, 11)), owning_building_guid = 99)
      LocalObject(3312, SpawnTube.Constructor(Vector3(5157.302f, 3970.033f, 39.76979f), respawn_tube_tower, Vector3(0, 0, 11)), owning_building_guid = 99)
    ...
    def Building34(): Unit = { // Name: S_Faro_Tower Type: tower_b GUID: 100, MapID: 34
      ...
      LocalObject(2484, Terminal.Constructor(Vector3(5262.423f, 5278.664f, 46.30496f), order_terminal), owning_building_guid = 100)
      LocalObject(2485, Terminal.Constructor(Vector3(5267.925f, 5280.242f, 46.30496f), order_terminal), owning_building_guid = 100)
      LocalObject(2486, Terminal.Constructor(Vector3(5273.098f, 5281.725f, 46.30496f), order_terminal), owning_building_guid = 100)
      LocalObject(3313, SpawnTube.Constructor(Vector3(5257.168f, 5288.33f, 44.45496f), respawn_tube_tower, Vector3(0, 0, 74)), owning_building_guid = 100)
      LocalObject(3314, SpawnTube.Constructor(Vector3(5272.942f, 5292.853f, 44.45496f), respawn_tube_tower, Vector3(0, 0, 74)), owning_building_guid = 100)
    ...
    def Building42(): Unit = { // Name: W_Orisha_Tower Type: tower_b GUID: 101, MapID: 42
      ...
      LocalObject(2517, Terminal.Constructor(Vector3(6681.446f, 1292.129f, 42.50483f), order_terminal), owning_building_guid = 101)
      LocalObject(2518, Terminal.Constructor(Vector3(6681.446f, 1297.853f, 42.50483f), order_terminal), owning_building_guid = 101)
      LocalObject(2519, Terminal.Constructor(Vector3(6681.446f, 1303.234f, 42.50483f), order_terminal), owning_building_guid = 101)
      LocalObject(3333, SpawnTube.Constructor(Vector3(6670.706f, 1289.742f, 40.65482f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 101)
      LocalObject(3334, SpawnTube.Constructor(Vector3(6670.706f, 1306.152f, 40.65482f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 101)
    ...
    def Building40(): Unit = { // Name: SW_Solsar_Warpgate_Tower Type: tower_b GUID: 102, MapID: 40
      ...
      LocalObject(2531, Terminal.Constructor(Vector3(7057.446f, 4988.129f, 45.93517f), order_terminal), owning_building_guid = 102)
      LocalObject(2532, Terminal.Constructor(Vector3(7057.446f, 4993.853f, 45.93517f), order_terminal), owning_building_guid = 102)
      LocalObject(2533, Terminal.Constructor(Vector3(7057.446f, 4999.234f, 45.93517f), order_terminal), owning_building_guid = 102)
      LocalObject(3343, SpawnTube.Constructor(Vector3(7046.706f, 4985.742f, 44.08517f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 102)
      LocalObject(3344, SpawnTube.Constructor(Vector3(7046.706f, 5002.152f, 44.08517f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 102)
    ...
    def Building66(): Unit = { // Name: SE_Pamba_Tower Type: tower_b GUID: 103, MapID: 66
      ...
      LocalObject(2540, Terminal.Constructor(Vector3(7545.446f, 2900.129f, 48.31398f), order_terminal), owning_building_guid = 103)
      LocalObject(2541, Terminal.Constructor(Vector3(7545.446f, 2905.853f, 48.31398f), order_terminal), owning_building_guid = 103)
      LocalObject(2542, Terminal.Constructor(Vector3(7545.446f, 2911.234f, 48.31398f), order_terminal), owning_building_guid = 103)
      LocalObject(3348, SpawnTube.Constructor(Vector3(7534.706f, 2897.742f, 46.46398f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 103)
      LocalObject(3349, SpawnTube.Constructor(Vector3(7534.706f, 2914.152f, 46.46398f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 103)
    ...
    def Building25(): Unit = { // Name: S_Bomazi_Tower Type: tower_c GUID: 104, MapID: 25
      ...
      LocalObject(2382, Terminal.Constructor(Vector3(1098.159f, 4312.915f, 59.63914f), order_terminal), owning_building_guid = 104)
      LocalObject(2383, Terminal.Constructor(Vector3(1099.641f, 4318.444f, 59.63914f), order_terminal), owning_building_guid = 104)
      LocalObject(2384, Terminal.Constructor(Vector3(1101.034f, 4323.642f, 59.63914f), order_terminal), owning_building_guid = 104)
      LocalObject(3250, SpawnTube.Constructor(Vector3(1087.169f, 4313.389f, 57.78914f), respawn_tube_tower, Vector3(0, 0, 15)), owning_building_guid = 104)
      LocalObject(3251, SpawnTube.Constructor(Vector3(1091.416f, 4329.24f, 57.78914f), respawn_tube_tower, Vector3(0, 0, 15)), owning_building_guid = 104)
      LocalObject(2837, ProximityTerminal.Constructor(Vector3(1077.579f, 4323.188f, 95.87714f), pad_landing_tower_frame), owning_building_guid = 104)
      LocalObject(2838, Terminal.Constructor(Vector3(1077.579f, 4323.188f, 95.87714f), air_rearm_terminal), owning_building_guid = 104)
      LocalObject(2840, ProximityTerminal.Constructor(Vector3(1080.282f, 4333.277f, 95.87714f), pad_landing_tower_frame), owning_building_guid = 104)
      LocalObject(2841, Terminal.Constructor(Vector3(1080.282f, 4333.277f, 95.87714f), air_rearm_terminal), owning_building_guid = 104)
      LocalObject(2180, FacilityTurret.Constructor(Vector3(1061.708f, 4317.419f, 87.24914f), manned_turret), owning_building_guid = 104)
      TurretToWeapon(2180, 5129)
      LocalObject(2182, FacilityTurret.Constructor(Vector3(1106.568f, 4336.366f, 87.24914f), manned_turret), owning_building_guid = 104)
    ...
    def Building24(): Unit = { // Name: NE_Aja_Tower Type: tower_c GUID: 105, MapID: 24
      ...
      LocalObject(2392, Terminal.Constructor(Vector3(1431.445f, 5804.129f, 29.66294f), order_terminal), owning_building_guid = 105)
      LocalObject(2393, Terminal.Constructor(Vector3(1431.445f, 5809.853f, 29.66294f), order_terminal), owning_building_guid = 105)
      LocalObject(2394, Terminal.Constructor(Vector3(1431.445f, 5815.234f, 29.66294f), order_terminal), owning_building_guid = 105)
      LocalObject(3255, SpawnTube.Constructor(Vector3(1420.706f, 5801.742f, 27.81294f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 105)
      LocalObject(3256, SpawnTube.Constructor(Vector3(1420.706f, 5818.152f, 27.81294f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 105)
      LocalObject(2843, ProximityTerminal.Constructor(Vector3(1408.907f, 5808.725f, 65.90094f), pad_landing_tower_frame), owning_building_guid = 105)
      LocalObject(2844, Terminal.Constructor(Vector3(1408.907f, 5808.725f, 65.90094f), air_rearm_terminal), owning_building_guid = 105)
      LocalObject(2846, ProximityTerminal.Constructor(Vector3(1408.907f, 5819.17f, 65.90094f), pad_landing_tower_frame), owning_building_guid = 105)
      LocalObject(2847, Terminal.Constructor(Vector3(1408.907f, 5819.17f, 65.90094f), air_rearm_terminal), owning_building_guid = 105)
      LocalObject(2188, FacilityTurret.Constructor(Vector3(1395.07f, 5799.045f, 57.27293f), manned_turret), owning_building_guid = 105)
      TurretToWeapon(2188, 5131)
      LocalObject(2190, FacilityTurret.Constructor(Vector3(1433.497f, 5828.957f, 57.27293f), manned_turret), owning_building_guid = 105)
    ...
    def Building69(): Unit = { // Name: Outpost_Tower Type: tower_c GUID: 106, MapID: 69
      ...
      LocalObject(2417, Terminal.Constructor(Vector3(2851.445f, 4332.129f, 80.75612f), order_terminal), owning_building_guid = 106)
      LocalObject(2418, Terminal.Constructor(Vector3(2851.445f, 4337.853f, 80.75612f), order_terminal), owning_building_guid = 106)
      LocalObject(2419, Terminal.Constructor(Vector3(2851.445f, 4343.234f, 80.75612f), order_terminal), owning_building_guid = 106)
      LocalObject(3271, SpawnTube.Constructor(Vector3(2840.706f, 4329.742f, 78.90612f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 106)
      LocalObject(3272, SpawnTube.Constructor(Vector3(2840.706f, 4346.152f, 78.90612f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 106)
      LocalObject(2849, ProximityTerminal.Constructor(Vector3(2828.907f, 4336.725f, 116.9941f), pad_landing_tower_frame), owning_building_guid = 106)
      LocalObject(2850, Terminal.Constructor(Vector3(2828.907f, 4336.725f, 116.9941f), air_rearm_terminal), owning_building_guid = 106)
      LocalObject(2852, ProximityTerminal.Constructor(Vector3(2828.907f, 4347.17f, 116.9941f), pad_landing_tower_frame), owning_building_guid = 106)
      LocalObject(2853, Terminal.Constructor(Vector3(2828.907f, 4347.17f, 116.9941f), air_rearm_terminal), owning_building_guid = 106)
      LocalObject(2208, FacilityTurret.Constructor(Vector3(2815.07f, 4327.045f, 108.3661f), manned_turret), owning_building_guid = 106)
      TurretToWeapon(2208, 5133)
      LocalObject(2210, FacilityTurret.Constructor(Vector3(2853.497f, 4356.957f, 108.3661f), manned_turret), owning_building_guid = 106)
    ...
    def Building29(): Unit = { // Name: SE_Tore_Tower Type: tower_c GUID: 107, MapID: 29
      ...
      LocalObject(2439, Terminal.Constructor(Vector3(3746.139f, 1656.175f, 37.81413f), order_terminal), owning_building_guid = 107)
      LocalObject(2440, Terminal.Constructor(Vector3(3749.452f, 1651.935f, 37.81413f), order_terminal), owning_building_guid = 107)
      LocalObject(2441, Terminal.Constructor(Vector3(3752.976f, 1647.424f, 37.81413f), order_terminal), owning_building_guid = 107)
      LocalObject(3284, SpawnTube.Constructor(Vector3(3735.88f, 1651.863f, 35.96413f), respawn_tube_tower, Vector3(0, 0, 322)), owning_building_guid = 107)
      LocalObject(3285, SpawnTube.Constructor(Vector3(3745.983f, 1638.932f, 35.96413f), respawn_tube_tower, Vector3(0, 0, 322)), owning_building_guid = 107)
      LocalObject(2855, ProximityTerminal.Constructor(Vector3(3725.956f, 1645.401f, 74.05213f), pad_landing_tower_frame), owning_building_guid = 107)
      LocalObject(2856, Terminal.Constructor(Vector3(3725.956f, 1645.401f, 74.05213f), air_rearm_terminal), owning_building_guid = 107)
      LocalObject(2858, ProximityTerminal.Constructor(Vector3(3732.386f, 1637.17f, 74.05213f), pad_landing_tower_frame), owning_building_guid = 107)
      LocalObject(2859, Terminal.Constructor(Vector3(3732.386f, 1637.17f, 74.05213f), air_rearm_terminal), owning_building_guid = 107)
      LocalObject(2222, FacilityTurret.Constructor(Vector3(3727.442f, 1621.023f, 65.42413f), manned_turret), owning_building_guid = 107)
      TurretToWeapon(2222, 5135)
      LocalObject(2223, FacilityTurret.Constructor(Vector3(3739.307f, 1668.252f, 65.42413f), manned_turret), owning_building_guid = 107)
    ...
    def Building37(): Unit = { // Name: W_Chuku_Tower Type: tower_c GUID: 108, MapID: 37
      ...
      LocalObject(2446, Terminal.Constructor(Vector3(3999.445f, 7018.129f, 40.47562f), order_terminal), owning_building_guid = 108)
      LocalObject(2447, Terminal.Constructor(Vector3(3999.445f, 7023.853f, 40.47562f), order_terminal), owning_building_guid = 108)
      LocalObject(2448, Terminal.Constructor(Vector3(3999.445f, 7029.234f, 40.47562f), order_terminal), owning_building_guid = 108)
      LocalObject(3288, SpawnTube.Constructor(Vector3(3988.706f, 7015.742f, 38.62562f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 108)
      LocalObject(3289, SpawnTube.Constructor(Vector3(3988.706f, 7032.152f, 38.62562f), respawn_tube_tower, Vector3(0, 0, 0)), owning_building_guid = 108)
      LocalObject(2861, ProximityTerminal.Constructor(Vector3(3976.907f, 7022.725f, 76.71362f), pad_landing_tower_frame), owning_building_guid = 108)
      LocalObject(2862, Terminal.Constructor(Vector3(3976.907f, 7022.725f, 76.71362f), air_rearm_terminal), owning_building_guid = 108)
      LocalObject(2864, ProximityTerminal.Constructor(Vector3(3976.907f, 7033.17f, 76.71362f), pad_landing_tower_frame), owning_building_guid = 108)
      LocalObject(2865, Terminal.Constructor(Vector3(3976.907f, 7033.17f, 76.71362f), air_rearm_terminal), owning_building_guid = 108)
      LocalObject(2226, FacilityTurret.Constructor(Vector3(3963.07f, 7013.045f, 68.08562f), manned_turret), owning_building_guid = 108)
      TurretToWeapon(2226, 5137)
      LocalObject(2228, FacilityTurret.Constructor(Vector3(4001.497f, 7042.957f, 68.08562f), manned_turret), owning_building_guid = 108)
    ...
    def Building39(): Unit = { // Name: E_Faro_Tower Type: tower_c GUID: 109, MapID: 39
      ...
      LocalObject(2487, Terminal.Constructor(Vector3(5353.971f, 5814.97f, 64.08202f), order_terminal), owning_building_guid = 109)
      LocalObject(2488, Terminal.Constructor(Vector3(5356.746f, 5819.976f, 64.08202f), order_terminal), owning_building_guid = 109)
      LocalObject(2489, Terminal.Constructor(Vector3(5359.354f, 5824.683f, 64.08202f), order_terminal), owning_building_guid = 109)
      LocalObject(3315, SpawnTube.Constructor(Vector3(5343.421f, 5818.088f, 62.23203f), respawn_tube_tower, Vector3(0, 0, 29)), owning_building_guid = 109)
      LocalObject(3316, SpawnTube.Constructor(Vector3(5351.376f, 5832.441f, 62.23203f), respawn_tube_tower, Vector3(0, 0, 29)), owning_building_guid = 109)
      LocalObject(2867, ProximityTerminal.Constructor(Vector3(5336.487f, 5829.917f, 100.32f), pad_landing_tower_frame), owning_building_guid = 109)
      LocalObject(2868, Terminal.Constructor(Vector3(5336.487f, 5829.917f, 100.32f), air_rearm_terminal), owning_building_guid = 109)
      LocalObject(2870, ProximityTerminal.Constructor(Vector3(5341.55f, 5839.052f, 100.32f), pad_landing_tower_frame), owning_building_guid = 109)
      LocalObject(2871, Terminal.Constructor(Vector3(5341.55f, 5839.052f, 100.32f), air_rearm_terminal), owning_building_guid = 109)
      LocalObject(2259, FacilityTurret.Constructor(Vector3(5319.691f, 5828.158f, 91.69202f), manned_turret), owning_building_guid = 109)
      TurretToWeapon(2259, 5139)
      LocalObject(2260, FacilityTurret.Constructor(Vector3(5367.802f, 5835.69f, 91.69202f), manned_turret), owning_building_guid = 109)
    ...
    def Building44(): Unit = { // Name: N_Kanng_Tower Type: tower_c GUID: 110, MapID: 44
      ...
      LocalObject(2502, Terminal.Constructor(Vector3(5704.483f, 4879.1f, 38.32745f), order_terminal), owning_building_guid = 110)
      LocalObject(2503, Terminal.Constructor(Vector3(5706.535f, 4884.443f, 38.32745f), order_terminal), owning_building_guid = 110)
      LocalObject(2504, Terminal.Constructor(Vector3(5708.463f, 4889.467f, 38.32745f), order_terminal), owning_building_guid = 110)
      LocalObject(3324, SpawnTube.Constructor(Vector3(5693.602f, 4880.72f, 36.47746f), respawn_tube_tower, Vector3(0, 0, 21)), owning_building_guid = 110)
      LocalObject(3325, SpawnTube.Constructor(Vector3(5699.483f, 4896.04f, 36.47746f), respawn_tube_tower, Vector3(0, 0, 21)), owning_building_guid = 110)
      LocalObject(2873, ProximityTerminal.Constructor(Vector3(5685.089f, 4891.467f, 74.56545f), pad_landing_tower_frame), owning_building_guid = 110)
      LocalObject(2874, Terminal.Constructor(Vector3(5685.089f, 4891.467f, 74.56545f), air_rearm_terminal), owning_building_guid = 110)
      LocalObject(2876, ProximityTerminal.Constructor(Vector3(5688.833f, 4901.218f, 74.56545f), pad_landing_tower_frame), owning_building_guid = 110)
      LocalObject(2877, Terminal.Constructor(Vector3(5688.833f, 4901.218f, 74.56545f), air_rearm_terminal), owning_building_guid = 110)
      LocalObject(2268, FacilityTurret.Constructor(Vector3(5668.702f, 4887.389f, 65.93745f), manned_turret), owning_building_guid = 110)
      TurretToWeapon(2268, 5141)
      LocalObject(2270, FacilityTurret.Constructor(Vector3(5715.296f, 4901.543f, 65.93745f), manned_turret), owning_building_guid = 110)
