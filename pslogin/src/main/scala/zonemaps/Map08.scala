...
object Map08 {
  ...
  val ZoneMap = new ZoneMap("map08") {
    ...
    def Building10(): Unit = { // Name: Mithra Type: amp_station GUID: 1, MapID: 10
      ...
      LocalObject(1344, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1345, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      ...
      LocalObject(1952, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(1953, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(1954, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(1955, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(1956, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(1957, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2132, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 1)
      LocalObject(1310, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2602.626f, 4458.341f, 41.49125f), Vector3(0, 0, 1)), owning_building_guid = 1, terminal_guid = 2132)
      ...
      LocalObject(1324, ProximityTerminal.Constructor(medical_terminal, Vector3(2547.459f, 4522.528f, 28.74625f)), owning_building_guid = 1)
      LocalObject(1325, ProximityTerminal.Constructor(medical_terminal, Vector3(2578.045f, 4527.621f, 48.74625f)), owning_building_guid = 1)
      LocalObject(1516, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2506.979f, 4548.692f, 52.05125f)), owning_building_guid = 1)
      LocalObject(1517, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1519, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2528.405f, 4471.061f, 54.21225f)), owning_building_guid = 1)
      LocalObject(1520, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1522, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2548.986f, 4601.628f, 52.07425f)), owning_building_guid = 1)
      LocalObject(1523, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1525, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2612.894f, 4507.233f, 52.05125f)), owning_building_guid = 1)
      LocalObject(1526, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1782, ProximityTerminal.Constructor(repair_silo, Vector3(2493.678f, 4528.694f, 42.94625f)), owning_building_guid = 1)
      LocalObject(1783, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1786, ProximityTerminal.Constructor(repair_silo, Vector3(2626.082f, 4526.573f, 42.94625f)), owning_building_guid = 1)
      LocalObject(1787, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1232, FacilityTurret.Constructor(manned_turret, Vector3(2480.226f, 4487.869f, 52.25425f)), owning_building_guid = 1)
      TurretToWeapon(1232, 5000)
      LocalObject(1233, FacilityTurret.Constructor(manned_turret, Vector3(2481.338f, 4424.458f, 52.25425f)), owning_building_guid = 1)
      TurretToWeapon(1233, 5001)
      LocalObject(1234, FacilityTurret.Constructor(manned_turret, Vector3(2484.866f, 4626.104f, 52.25425f)), owning_building_guid = 1)
      TurretToWeapon(1234, 5002)
      LocalObject(1235, FacilityTurret.Constructor(manned_turret, Vector3(2578.734f, 4626.684f, 52.25425f)), owning_building_guid = 1)
      TurretToWeapon(1235, 5003)
      LocalObject(1236, FacilityTurret.Constructor(manned_turret, Vector3(2634.782f, 4421.77f, 52.25425f)), owning_building_guid = 1)
      TurretToWeapon(1236, 5004)
      LocalObject(1237, FacilityTurret.Constructor(manned_turret, Vector3(2638.273f, 4623.417f, 52.25425f)), owning_building_guid = 1)
    ...
    def Building7(): Unit = { // Name: Hvar Type: comm_station GUID: 16, MapID: 7
      ...
      LocalObject(1383, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1384, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1385, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1386, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1387, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1388, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1389, Terminal.Constructor(order_terminal), owning_building_guid = 16)
      LocalObject(1974, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(1975, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(1976, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(1977, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(1978, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(1979, Terminal.Constructor(spawn_terminal), owning_building_guid = 16)
      LocalObject(2135, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 16)
      LocalObject(1313, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3868.22f, 4634.066f, 47.35861f), Vector3(0, 0, 91)), owning_building_guid = 16, terminal_guid = 2135)
      ...
      LocalObject(1329, ProximityTerminal.Constructor(medical_terminal, Vector3(3843.049f, 4659.509f, 31.32961f)), owning_building_guid = 16)
      LocalObject(1330, ProximityTerminal.Constructor(medical_terminal, Vector3(3907.642f, 4716.988f, 48.82961f)), owning_building_guid = 16)
      LocalObject(1555, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3925.88f, 4632.495f, 57.07061f)), owning_building_guid = 16)
      LocalObject(1556, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 16)
      LocalObject(1806, ProximityTerminal.Constructor(repair_silo, Vector3(3846.793f, 4713.402f, 48.37961f)), owning_building_guid = 16)
      LocalObject(1807, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 16)
      LocalObject(1818, ProximityTerminal.Constructor(repair_silo, Vector3(3968.675f, 4663.758f, 48.37961f)), owning_building_guid = 16)
      LocalObject(1819, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 16)
      LocalObject(1261, FacilityTurret.Constructor(manned_turret, Vector3(3833.766f, 4608.849f, 57.33761f)), owning_building_guid = 16)
      TurretToWeapon(1261, 5006)
      LocalObject(1262, FacilityTurret.Constructor(manned_turret, Vector3(3834.673f, 4727.785f, 57.33761f)), owning_building_guid = 16)
      TurretToWeapon(1262, 5007)
      LocalObject(1264, FacilityTurret.Constructor(manned_turret, Vector3(3878.564f, 4770.138f, 57.33761f)), owning_building_guid = 16)
      TurretToWeapon(1264, 5008)
      LocalObject(1265, FacilityTurret.Constructor(manned_turret, Vector3(3937.02f, 4605.731f, 57.33761f)), owning_building_guid = 16)
      TurretToWeapon(1265, 5009)
      LocalObject(1268, FacilityTurret.Constructor(manned_turret, Vector3(3980.89f, 4648.07f, 57.33761f)), owning_building_guid = 16)
      TurretToWeapon(1268, 5010)
      LocalObject(1269, FacilityTurret.Constructor(manned_turret, Vector3(3981.839f, 4767.158f, 57.33761f)), owning_building_guid = 16)
    ...
    def Building5(): Unit = { // Name: Atar Type: comm_station_dsp GUID: 19, MapID: 5
      ...
      LocalObject(206, Terminal.Constructor(dropship_vehicle_terminal), owning_building_guid = 19)
      LocalObject(205, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(3618.328f, 2922.856f, 47.06811f), Vector3(0, 0, 90)), owning_building_guid = 19, terminal_guid = 206)
      LocalObject(1366, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1370, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1371, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1372, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1373, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1377, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1378, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1379, Terminal.Constructor(order_terminal), owning_building_guid = 19)
      LocalObject(1965, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1966, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1967, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1968, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1969, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1970, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1971, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1972, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(1973, Terminal.Constructor(spawn_terminal), owning_building_guid = 19)
      LocalObject(2134, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 19)
      LocalObject(1312, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3567.786f, 2892.411f, 45.66911f), Vector3(0, 0, 180)), owning_building_guid = 19, terminal_guid = 2134)
      ...
      LocalObject(1327, ProximityTerminal.Constructor(medical_terminal, Vector3(3550.863f, 2769.013f, 47.14011f)), owning_building_guid = 19)
      LocalObject(1328, ProximityTerminal.Constructor(medical_terminal, Vector3(3614.444f, 2827.62f, 29.64011f)), owning_building_guid = 19)
      LocalObject(1540, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3531.153f, 2891.398f, 55.45011f)), owning_building_guid = 19)
      LocalObject(1541, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1543, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3547.514f, 2845.467f, 52.73411f)), owning_building_guid = 19)
      LocalObject(1544, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1546, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3599.804f, 2809.901f, 59.91611f)), owning_building_guid = 19)
      LocalObject(1547, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1549, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3635.071f, 2826.159f, 55.46311f)), owning_building_guid = 19)
      LocalObject(1550, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 19)
      LocalObject(1798, ProximityTerminal.Constructor(repair_silo, Vector3(3488.642f, 2836.24f, 46.79011f)), owning_building_guid = 19)
      LocalObject(1799, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 19)
      LocalObject(1802, ProximityTerminal.Constructor(repair_silo, Vector3(3658.57f, 2839.152f, 46.79011f)), owning_building_guid = 19)
      LocalObject(1803, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 19)
      LocalObject(1249, FacilityTurret.Constructor(manned_turret, Vector3(3476.401f, 2871.113f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1249, 5012)
      LocalObject(1250, FacilityTurret.Constructor(manned_turret, Vector3(3477.554f, 2717.565f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1250, 5013)
      LocalObject(1252, FacilityTurret.Constructor(manned_turret, Vector3(3521.445f, 2917.667f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1252, 5014)
      LocalObject(1255, FacilityTurret.Constructor(manned_turret, Vector3(3580.428f, 2716.396f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1255, 5015)
      LocalObject(1256, FacilityTurret.Constructor(manned_turret, Vector3(3581.449f, 2976.154f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1256, 5016)
      LocalObject(1258, FacilityTurret.Constructor(manned_turret, Vector3(3622.537f, 2757.011f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1258, 5017)
      LocalObject(1259, FacilityTurret.Constructor(manned_turret, Vector3(3669.619f, 2974.985f, 55.64811f)), owning_building_guid = 19)
      TurretToWeapon(1259, 5018)
      LocalObject(1260, FacilityTurret.Constructor(manned_turret, Vector3(3670.773f, 2806.733f, 55.64811f)), owning_building_guid = 19)
    ...
    def Building11(): Unit = { // Name: Rashnu Type: cryo_facility GUID: 22, MapID: 11
      ...
      LocalObject(169, Terminal.Constructor(cert_terminal), owning_building_guid = 22)
      LocalObject(170, Terminal.Constructor(cert_terminal), owning_building_guid = 22)
      LocalObject(171, Terminal.Constructor(cert_terminal), owning_building_guid = 22)
      LocalObject(172, Terminal.Constructor(cert_terminal), owning_building_guid = 22)
      LocalObject(173, Terminal.Constructor(cert_terminal), owning_building_guid = 22)
      LocalObject(1359, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1360, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1361, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1362, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1958, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1959, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1960, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1961, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1962, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1963, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(1964, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2133, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 22)
      LocalObject(1311, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3073.989f, 3834.724f, 57.67459f), Vector3(0, 0, -90)), owning_building_guid = 22, terminal_guid = 2133)
      ...
      LocalObject(119, ProximityTerminal.Constructor(adv_med_terminal, Vector3(3051.983f, 3890.892f, 59.3376f)), owning_building_guid = 22)
      LocalObject(1326, ProximityTerminal.Constructor(medical_terminal, Vector3(3077.642f, 3901.952f, 49.5276f)), owning_building_guid = 22)
      LocalObject(1528, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3031.883f, 3836.061f, 69.82059f)), owning_building_guid = 22)
      LocalObject(1529, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1531, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3035.101f, 3951.651f, 67.8696f)), owning_building_guid = 22)
      LocalObject(1532, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1534, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3048.198f, 3828.777f, 67.87959f)), owning_building_guid = 22)
      LocalObject(1535, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1537, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3051.323f, 3943.253f, 69.8596f)), owning_building_guid = 22)
      LocalObject(1538, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 22)
      LocalObject(1790, ProximityTerminal.Constructor(repair_silo, Vector3(3014.525f, 3813.154f, 59.2776f)), owning_building_guid = 22)
      LocalObject(1791, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(1794, ProximityTerminal.Constructor(repair_silo, Vector3(3102.53f, 3913.861f, 59.2776f)), owning_building_guid = 22)
      LocalObject(1795, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(1241, FacilityTurret.Constructor(manned_turret, Vector3(2978.392f, 3978.472f, 67.9296f)), owning_building_guid = 22)
      TurretToWeapon(1241, 5020)
      LocalObject(1242, FacilityTurret.Constructor(manned_turret, Vector3(2978.4f, 3801.379f, 67.9296f)), owning_building_guid = 22)
      TurretToWeapon(1242, 5021)
      LocalObject(1244, FacilityTurret.Constructor(manned_turret, Vector3(3071.665f, 3979.605f, 67.9296f)), owning_building_guid = 22)
      TurretToWeapon(1244, 5022)
      LocalObject(1245, FacilityTurret.Constructor(manned_turret, Vector3(3113.626f, 3801.371f, 67.9296f)), owning_building_guid = 22)
      TurretToWeapon(1245, 5023)
      LocalObject(1246, FacilityTurret.Constructor(manned_turret, Vector3(3114.813f, 3936.496f, 67.9296f)), owning_building_guid = 22)
      TurretToWeapon(1246, 5024)
      LocalObject(681, ImplantTerminalMech.Constructor, owning_building_guid = 22)
      LocalObject(675, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 22)
      TerminalToInterface(681, 675)
      LocalObject(682, ImplantTerminalMech.Constructor, owning_building_guid = 22)
      LocalObject(676, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 22)
    ...
    def Building13(): Unit = { // Name: Zal Type: cryo_facility GUID: 25, MapID: 13
      ...
      LocalObject(177, Terminal.Constructor(cert_terminal), owning_building_guid = 25)
      LocalObject(178, Terminal.Constructor(cert_terminal), owning_building_guid = 25)
      LocalObject(179, Terminal.Constructor(cert_terminal), owning_building_guid = 25)
      LocalObject(180, Terminal.Constructor(cert_terminal), owning_building_guid = 25)
      LocalObject(181, Terminal.Constructor(cert_terminal), owning_building_guid = 25)
      LocalObject(1390, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1391, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1392, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1393, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1980, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1981, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1982, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1983, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1984, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1985, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(1986, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2136, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 25)
      LocalObject(1314, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3907.362f, 2267.61f, 59.38597f), Vector3(0, 0, 43)), owning_building_guid = 25, terminal_guid = 2136)
      ...
      LocalObject(120, ProximityTerminal.Constructor(adv_med_terminal, Vector3(3963.449f, 2245.397f, 61.04898f)), owning_building_guid = 25)
      LocalObject(1331, ProximityTerminal.Constructor(medical_terminal, Vector3(3954.039f, 2219.089f, 51.23898f)), owning_building_guid = 25)
      LocalObject(1552, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3920.603f, 2290.528f, 69.59097f)), owning_building_guid = 25)
      LocalObject(1553, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1558, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3937.056f, 2297.492f, 71.53197f)), owning_building_guid = 25)
      LocalObject(1559, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1561, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4002.194f, 2210.17f, 71.57098f)), owning_building_guid = 25)
      LocalObject(1562, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1564, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4019.399f, 2216.307f, 69.58098f)), owning_building_guid = 25)
      LocalObject(1565, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 25)
      LocalObject(1810, ProximityTerminal.Constructor(repair_silo, Vector3(3932.142f, 2325.81f, 60.98898f)), owning_building_guid = 25)
      LocalObject(1811, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(1814, ProximityTerminal.Constructor(repair_silo, Vector3(3945.775f, 2192.765f, 60.98898f)), owning_building_guid = 25)
      LocalObject(1815, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(1263, FacilityTurret.Constructor(manned_turret, Vector3(3855.937f, 2261.368f, 69.64098f)), owning_building_guid = 25)
      TurretToWeapon(1263, 5025)
      LocalObject(1266, FacilityTurret.Constructor(manned_turret, Vector3(3948.167f, 2360.26f, 69.64098f)), owning_building_guid = 25)
      TurretToWeapon(1266, 5026)
      LocalObject(1267, FacilityTurret.Constructor(manned_turret, Vector3(3953.952f, 2168.344f, 69.64098f)), owning_building_guid = 25)
      TurretToWeapon(1267, 5027)
      LocalObject(1270, FacilityTurret.Constructor(manned_turret, Vector3(4014.907f, 2170.501f, 69.64098f)), owning_building_guid = 25)
      TurretToWeapon(1270, 5028)
      LocalObject(1272, FacilityTurret.Constructor(manned_turret, Vector3(4077.69f, 2239.489f, 69.64098f)), owning_building_guid = 25)
      TurretToWeapon(1272, 5029)
      LocalObject(683, ImplantTerminalMech.Constructor, owning_building_guid = 25)
      LocalObject(677, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 25)
      TerminalToInterface(683, 677)
      LocalObject(684, ImplantTerminalMech.Constructor, owning_building_guid = 25)
      LocalObject(678, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 25)
    ...
    def Building12(): Unit = { // Name: Yazata Type: cryo_facility GUID: 28, MapID: 12
      ...
      LocalObject(185, Terminal.Constructor(cert_terminal), owning_building_guid = 28)
      LocalObject(186, Terminal.Constructor(cert_terminal), owning_building_guid = 28)
      LocalObject(187, Terminal.Constructor(cert_terminal), owning_building_guid = 28)
      LocalObject(188, Terminal.Constructor(cert_terminal), owning_building_guid = 28)
      LocalObject(189, Terminal.Constructor(cert_terminal), owning_building_guid = 28)
      LocalObject(1409, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1410, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1411, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1412, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1987, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1988, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1989, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1990, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1991, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1992, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(1999, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2137, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 28)
      LocalObject(1316, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4743.276f, 3957.989f, 59.8938f), Vector3(0, 0, 180)), owning_building_guid = 28, terminal_guid = 2137)
      ...
      LocalObject(121, ProximityTerminal.Constructor(adv_med_terminal, Vector3(4687.108f, 3935.983f, 61.5568f)), owning_building_guid = 28)
      LocalObject(1332, ProximityTerminal.Constructor(medical_terminal, Vector3(4676.048f, 3961.642f, 51.7468f)), owning_building_guid = 28)
      LocalObject(1567, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4626.349f, 3919.101f, 70.08881f)), owning_building_guid = 28)
      LocalObject(1568, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1570, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4634.747f, 3935.323f, 72.0788f)), owning_building_guid = 28)
      LocalObject(1571, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1585, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4741.939f, 3915.883f, 72.0398f)), owning_building_guid = 28)
      LocalObject(1586, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1588, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4749.223f, 3932.198f, 70.0988f)), owning_building_guid = 28)
      LocalObject(1589, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(1826, ProximityTerminal.Constructor(repair_silo, Vector3(4664.139f, 3986.53f, 61.4968f)), owning_building_guid = 28)
      LocalObject(1827, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(1830, ProximityTerminal.Constructor(repair_silo, Vector3(4764.846f, 3898.525f, 61.4968f)), owning_building_guid = 28)
      LocalObject(1831, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(1276, FacilityTurret.Constructor(manned_turret, Vector3(4598.395f, 3955.665f, 70.1488f)), owning_building_guid = 28)
      TurretToWeapon(1276, 5030)
      LocalObject(1277, FacilityTurret.Constructor(manned_turret, Vector3(4599.528f, 3862.392f, 70.1488f)), owning_building_guid = 28)
      TurretToWeapon(1277, 5031)
      LocalObject(1280, FacilityTurret.Constructor(manned_turret, Vector3(4641.504f, 3998.813f, 70.1488f)), owning_building_guid = 28)
      TurretToWeapon(1280, 5032)
      LocalObject(1285, FacilityTurret.Constructor(manned_turret, Vector3(4776.621f, 3862.4f, 70.1488f)), owning_building_guid = 28)
      TurretToWeapon(1285, 5033)
      LocalObject(1286, FacilityTurret.Constructor(manned_turret, Vector3(4776.629f, 3997.626f, 70.1488f)), owning_building_guid = 28)
      TurretToWeapon(1286, 5034)
      LocalObject(685, ImplantTerminalMech.Constructor, owning_building_guid = 28)
      LocalObject(679, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 28)
      TerminalToInterface(685, 679)
      LocalObject(686, ImplantTerminalMech.Constructor, owning_building_guid = 28)
      LocalObject(680, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 28)
    ...
    def Building9(): Unit = { // Name: Jamshid Type: tech_plant GUID: 34, MapID: 9
      ...
      LocalObject(122, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 34)
      LocalObject(1308, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2274.07f, 3443.835f, 65.0214f), Vector3(0, 0, 0)), owning_building_guid = 34, terminal_guid = 122)
      LocalObject(123, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 34)
      LocalObject(1309, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2295.088f, 3443.835f, 65.0214f), Vector3(0, 0, 0)), owning_building_guid = 34, terminal_guid = 123)
      LocalObject(1337, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1338, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1339, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1340, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1945, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1946, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1947, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1948, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1949, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1950, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(1951, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2131, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 34)
      LocalObject(1307, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2225.945f, 3418.339f, 29.9804f), Vector3(0, 0, 0)), owning_building_guid = 34, terminal_guid = 2131)
      ...
      LocalObject(1322, ProximityTerminal.Constructor(medical_terminal, Vector3(2277.059f, 3410.901f, 57.5404f)), owning_building_guid = 34)
      LocalObject(1323, ProximityTerminal.Constructor(medical_terminal, Vector3(2314.444f, 3421.62f, 37.5434f)), owning_building_guid = 34)
      LocalObject(1498, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2212.704f, 3423.661f, 60.6384f)), owning_building_guid = 34)
      LocalObject(1499, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1501, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2232.98f, 3439.833f, 62.9934f)), owning_building_guid = 34)
      LocalObject(1502, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1504, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2283.379f, 3383.474f, 67.8904f)), owning_building_guid = 34)
      LocalObject(1505, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1507, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2299.534f, 3366.628f, 60.6514f)), owning_building_guid = 34)
      LocalObject(1508, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1510, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2335.987f, 3405.855f, 63.0954f)), owning_building_guid = 34)
      LocalObject(1511, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1513, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2342.28f, 3422.102f, 60.6514f)), owning_building_guid = 34)
      LocalObject(1514, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(1774, ProximityTerminal.Constructor(repair_silo, Vector3(2274.309f, 3489.637f, 52.1719f)), owning_building_guid = 34)
      LocalObject(1775, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 34)
      LocalObject(1778, ProximityTerminal.Constructor(repair_silo, Vector3(2332.637f, 3355.208f, 52.1934f)), owning_building_guid = 34)
      LocalObject(1779, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 34)
      LocalObject(1224, FacilityTurret.Constructor(manned_turret, Vector3(2189.906f, 3546.855f, 60.9424f)), owning_building_guid = 34)
      TurretToWeapon(1224, 5035)
      LocalObject(1225, FacilityTurret.Constructor(manned_turret, Vector3(2195.413f, 3348.665f, 60.9424f)), owning_building_guid = 34)
      TurretToWeapon(1225, 5036)
      LocalObject(1226, FacilityTurret.Constructor(manned_turret, Vector3(2279.601f, 3546.855f, 60.9424f)), owning_building_guid = 34)
      TurretToWeapon(1226, 5037)
      LocalObject(1229, FacilityTurret.Constructor(manned_turret, Vector3(2360.154f, 3348.657f, 60.9424f)), owning_building_guid = 34)
      TurretToWeapon(1229, 5038)
      LocalObject(1230, FacilityTurret.Constructor(manned_turret, Vector3(2360.154f, 3486.398f, 60.9424f)), owning_building_guid = 34)
      TurretToWeapon(1230, 5039)
      LocalObject(1231, FacilityTurret.Constructor(manned_turret, Vector3(2367.881f, 3413.423f, 60.9424f)), owning_building_guid = 34)
    ...
    def Building6(): Unit = { // Name: Dahaka Type: tech_plant GUID: 37, MapID: 6
      ...
      LocalObject(124, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 37)
      LocalObject(1315, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4739.542f, 5376.984f, 66.22495f), Vector3(0, 0, 138)), owning_building_guid = 37, terminal_guid = 124)
      LocalObject(125, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 37)
      LocalObject(1317, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4755.161f, 5391.048f, 66.22495f), Vector3(0, 0, 138)), owning_building_guid = 37, terminal_guid = 125)
      LocalObject(1413, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1414, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1415, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1416, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1993, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(1994, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(1995, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(1996, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(1997, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(1998, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2000, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2138, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 37)
      LocalObject(1318, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4773.865f, 5442.197f, 31.18395f), Vector3(0, 0, 138)), owning_building_guid = 37, terminal_guid = 2138)
      ...
      LocalObject(1333, ProximityTerminal.Constructor(medical_terminal, Vector3(4710.292f, 5380.542f, 38.74695f)), owning_building_guid = 37)
      LocalObject(1334, ProximityTerminal.Constructor(medical_terminal, Vector3(4730.903f, 5413.523f, 58.74395f)), owning_building_guid = 37)
      LocalObject(1573, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4683.734f, 5377.842f, 64.29895f)), owning_building_guid = 37)
      LocalObject(1574, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1576, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4684.576f, 5431.386f, 61.85495f)), owning_building_guid = 37)
      LocalObject(1577, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1579, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4689.929f, 5361.558f, 61.85495f)), owning_building_guid = 37)
      LocalObject(1580, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1582, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4707.854f, 5429.676f, 69.09395f)), owning_building_guid = 37)
      LocalObject(1583, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1591, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4783.019f, 5421.517f, 64.19695f)), owning_building_guid = 37)
      LocalObject(1592, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1594, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4787.266f, 5447.103f, 61.84195f)), owning_building_guid = 37)
      LocalObject(1595, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(1822, ProximityTerminal.Constructor(repair_silo, Vector3(4652.334f, 5417.723f, 53.39695f)), owning_building_guid = 37)
      LocalObject(1823, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 37)
      LocalObject(1834, ProximityTerminal.Constructor(repair_silo, Vector3(4785.631f, 5356.852f, 53.37545f)), owning_building_guid = 37)
      LocalObject(1835, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 37)
      LocalObject(1279, FacilityTurret.Constructor(manned_turret, Vector3(4627.501f, 5404.178f, 62.14595f)), owning_building_guid = 37)
      TurretToWeapon(1279, 5041)
      LocalObject(1282, FacilityTurret.Constructor(manned_turret, Vector3(4665.096f, 5350.877f, 62.14595f)), owning_building_guid = 37)
      TurretToWeapon(1282, 5042)
      LocalObject(1283, FacilityTurret.Constructor(manned_turret, Vector3(4719.668f, 5301.816f, 62.14595f)), owning_building_guid = 37)
      TurretToWeapon(1283, 5043)
      LocalObject(1284, FacilityTurret.Constructor(manned_turret, Vector3(4749.934f, 5514.405f, 62.14595f)), owning_building_guid = 37)
      TurretToWeapon(1284, 5044)
      LocalObject(1287, FacilityTurret.Constructor(manned_turret, Vector3(4819.984f, 5310.789f, 62.14595f)), owning_building_guid = 37)
      TurretToWeapon(1287, 5045)
      LocalObject(1289, FacilityTurret.Constructor(manned_turret, Vector3(4886.641f, 5370.806f, 62.14595f)), owning_building_guid = 37)
    ...
    def Building8(): Unit = { // Name: Izha Type: tech_plant GUID: 40, MapID: 8
      ...
      LocalObject(126, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 40)
      LocalObject(1319, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5501.254f, 3864.523f, 63.1007f), Vector3(0, 0, 130)), owning_building_guid = 40, terminal_guid = 126)
      LocalObject(127, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 40)
      LocalObject(1320, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5514.765f, 3880.624f, 63.1007f), Vector3(0, 0, 130)), owning_building_guid = 40, terminal_guid = 127)
      LocalObject(1432, Terminal.Constructor(order_terminal), owning_building_guid = 40)
      LocalObject(1433, Terminal.Constructor(order_terminal), owning_building_guid = 40)
      LocalObject(1434, Terminal.Constructor(order_terminal), owning_building_guid = 40)
      LocalObject(1435, Terminal.Constructor(order_terminal), owning_building_guid = 40)
      LocalObject(2001, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2002, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2003, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2004, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2005, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2006, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2007, Terminal.Constructor(spawn_terminal), owning_building_guid = 40)
      LocalObject(2139, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 40)
      LocalObject(1321, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5526.167f, 3933.878f, 28.0597f), Vector3(0, 0, 130)), owning_building_guid = 40, terminal_guid = 2139)
      ...
      LocalObject(1335, ProximityTerminal.Constructor(medical_terminal, Vector3(5471.795f, 3863.975f, 35.6227f)), owning_building_guid = 40)
      LocalObject(1336, ProximityTerminal.Constructor(medical_terminal, Vector3(5487.614f, 3899.503f, 55.6197f)), owning_building_guid = 40)
      LocalObject(1597, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5439.252f, 3910.745f, 58.7307f)), owning_building_guid = 40)
      LocalObject(1598, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1600, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5445.871f, 3857.605f, 61.1747f)), owning_building_guid = 40)
      LocalObject(1601, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1603, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5454.271f, 3842.341f, 58.7307f)), owning_building_guid = 40)
      LocalObject(1604, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1606, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5462.542f, 3912.292f, 65.9697f)), owning_building_guid = 40)
      LocalObject(1607, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1609, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5538.111f, 3914.673f, 61.0727f)), owning_building_guid = 40)
      LocalObject(1610, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1612, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5538.755f, 3940.6f, 58.7177f)), owning_building_guid = 40)
      LocalObject(1613, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 40)
      LocalObject(1838, ProximityTerminal.Constructor(repair_silo, Vector3(5409.226f, 3892.728f, 50.2727f)), owning_building_guid = 40)
      LocalObject(1839, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 40)
      LocalObject(1842, ProximityTerminal.Constructor(repair_silo, Vector3(5549.697f, 3851f, 50.2512f)), owning_building_guid = 40)
      LocalObject(1843, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 40)
      LocalObject(1299, FacilityTurret.Constructor(manned_turret, Vector3(5386.52f, 3875.859f, 59.0217f)), owning_building_guid = 40)
      TurretToWeapon(1299, 5047)
      LocalObject(1300, FacilityTurret.Constructor(manned_turret, Vector3(5431.167f, 3828.309f, 59.0217f)), owning_building_guid = 40)
      TurretToWeapon(1300, 5048)
      LocalObject(1301, FacilityTurret.Constructor(manned_turret, Vector3(5492.036f, 3787.321f, 59.0217f)), owning_building_guid = 40)
      TurretToWeapon(1301, 5049)
      LocalObject(1302, FacilityTurret.Constructor(manned_turret, Vector3(5492.42f, 4002.052f, 59.0217f)), owning_building_guid = 40)
      TurretToWeapon(1302, 5050)
      LocalObject(1303, FacilityTurret.Constructor(manned_turret, Vector3(5590.127f, 3810.167f, 59.0217f)), owning_building_guid = 40)
      TurretToWeapon(1303, 5051)
      LocalObject(1304, FacilityTurret.Constructor(manned_turret, Vector3(5647.782f, 3878.877f, 59.0217f)), owning_building_guid = 40)
    ...
    def Building16(): Unit = { // Name: N_Jamshid_Tower Type: tower_a GUID: 43, MapID: 16
      ...
      LocalObject(1341, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1342, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1343, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1858, SpawnTube.Constructor(respawn_tube_tower, Vector3(2322.706f, 3679.742f, 30.26567f), Vector3(0, 0, 0)), owning_building_guid = 43)
      LocalObject(1859, SpawnTube.Constructor(respawn_tube_tower, Vector3(2322.706f, 3696.152f, 30.26567f), Vector3(0, 0, 0)), owning_building_guid = 43)
      LocalObject(1227, FacilityTurret.Constructor(manned_turret, Vector3(2299.32f, 3679.295f, 59.72566f)), owning_building_guid = 43)
      TurretToWeapon(1227, 5053)
      LocalObject(1228, FacilityTurret.Constructor(manned_turret, Vector3(2334.647f, 3704.707f, 59.72566f)), owning_building_guid = 43)
    ...
    def Building40(): Unit = { // Name: Rashnu_Tower Type: tower_a GUID: 44, MapID: 40
      ...
      LocalObject(1363, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1364, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1365, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1872, SpawnTube.Constructor(respawn_tube_tower, Vector3(3254.706f, 3745.742f, 39.24406f), Vector3(0, 0, 0)), owning_building_guid = 44)
      LocalObject(1873, SpawnTube.Constructor(respawn_tube_tower, Vector3(3254.706f, 3762.152f, 39.24406f), Vector3(0, 0, 0)), owning_building_guid = 44)
      LocalObject(1247, FacilityTurret.Constructor(manned_turret, Vector3(3231.32f, 3745.295f, 68.70406f)), owning_building_guid = 44)
      TurretToWeapon(1247, 5055)
      LocalObject(1248, FacilityTurret.Constructor(manned_turret, Vector3(3266.647f, 3770.707f, 68.70406f)), owning_building_guid = 44)
    ...
    def Building14(): Unit = { // Name: S_Forseral_Warpgate_Tower Type: tower_a GUID: 45, MapID: 14
      ...
      LocalObject(1367, Terminal.Constructor(order_terminal), owning_building_guid = 45)
      LocalObject(1368, Terminal.Constructor(order_terminal), owning_building_guid = 45)
      LocalObject(1369, Terminal.Constructor(order_terminal), owning_building_guid = 45)
      LocalObject(1874, SpawnTube.Constructor(respawn_tube_tower, Vector3(3530.706f, 5565.742f, 42.76331f), Vector3(0, 0, 0)), owning_building_guid = 45)
      LocalObject(1875, SpawnTube.Constructor(respawn_tube_tower, Vector3(3530.706f, 5582.152f, 42.76331f), Vector3(0, 0, 0)), owning_building_guid = 45)
      LocalObject(1251, FacilityTurret.Constructor(manned_turret, Vector3(3507.32f, 5565.295f, 72.22331f)), owning_building_guid = 45)
      TurretToWeapon(1251, 5057)
      LocalObject(1253, FacilityTurret.Constructor(manned_turret, Vector3(3542.647f, 5590.707f, 72.22331f)), owning_building_guid = 45)
    ...
    def Building21(): Unit = { // Name: W_Yazata_Tower Type: tower_a GUID: 46, MapID: 21
      ...
      LocalObject(1394, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1395, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1396, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1889, SpawnTube.Constructor(respawn_tube_tower, Vector3(4084.706f, 3875.742f, 26.46711f), Vector3(0, 0, 0)), owning_building_guid = 46)
      LocalObject(1890, SpawnTube.Constructor(respawn_tube_tower, Vector3(4084.706f, 3892.152f, 26.46711f), Vector3(0, 0, 0)), owning_building_guid = 46)
      LocalObject(1271, FacilityTurret.Constructor(manned_turret, Vector3(4061.32f, 3875.295f, 55.92711f)), owning_building_guid = 46)
      TurretToWeapon(1271, 5059)
      LocalObject(1273, FacilityTurret.Constructor(manned_turret, Vector3(4096.647f, 3900.707f, 55.92711f)), owning_building_guid = 46)
    ...
    def Building42(): Unit = { // Name: Zal_Tower Type: tower_a GUID: 47, MapID: 42
      ...
      LocalObject(1397, Terminal.Constructor(order_terminal), owning_building_guid = 47)
      ...
      LocalObject(1891, SpawnTube.Constructor(respawn_tube_tower, Vector3(4142.706f, 2049.742f, 33.95757f), Vector3(0, 0, 0)), owning_building_guid = 47)
      LocalObject(1892, SpawnTube.Constructor(respawn_tube_tower, Vector3(4142.706f, 2066.152f, 33.95757f), Vector3(0, 0, 0)), owning_building_guid = 47)
      LocalObject(1274, FacilityTurret.Constructor(manned_turret, Vector3(4119.32f, 2049.295f, 63.41757f)), owning_building_guid = 47)
      TurretToWeapon(1274, 5061)
      LocalObject(1275, FacilityTurret.Constructor(manned_turret, Vector3(4154.647f, 2074.707f, 63.41757f)), owning_building_guid = 47)
    ...
    def Building27(): Unit = { // Name: SW_Esamir_Warpgate_Tower Type: tower_a GUID: 48, MapID: 27
      ...
      LocalObject(1420, Terminal.Constructor(order_terminal), owning_building_guid = 48)
      LocalObject(1421, Terminal.Constructor(order_terminal), owning_building_guid = 48)
      LocalObject(1422, Terminal.Constructor(order_terminal), owning_building_guid = 48)
      LocalObject(1907, SpawnTube.Constructor(respawn_tube_tower, Vector3(5050.706f, 2287.742f, 46.48569f), Vector3(0, 0, 0)), owning_building_guid = 48)
      LocalObject(1908, SpawnTube.Constructor(respawn_tube_tower, Vector3(5050.706f, 2304.152f, 46.48569f), Vector3(0, 0, 0)), owning_building_guid = 48)
      LocalObject(1291, FacilityTurret.Constructor(manned_turret, Vector3(5027.32f, 2287.295f, 75.94569f)), owning_building_guid = 48)
      TurretToWeapon(1291, 5063)
      LocalObject(1292, FacilityTurret.Constructor(manned_turret, Vector3(5062.647f, 2312.707f, 75.94569f)), owning_building_guid = 48)
    ...
    def Building22(): Unit = { // Name: S_Hossin_Warpgate_Tower Type: tower_a GUID: 49, MapID: 22
      ...
      LocalObject(1423, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1424, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1425, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1909, SpawnTube.Constructor(respawn_tube_tower, Vector3(5090.706f, 4753.742f, 64.57548f), Vector3(0, 0, 0)), owning_building_guid = 49)
      LocalObject(1910, SpawnTube.Constructor(respawn_tube_tower, Vector3(5090.706f, 4770.152f, 64.57548f), Vector3(0, 0, 0)), owning_building_guid = 49)
      LocalObject(1293, FacilityTurret.Constructor(manned_turret, Vector3(5067.32f, 4753.295f, 94.03548f)), owning_building_guid = 49)
      TurretToWeapon(1293, 5065)
      LocalObject(1294, FacilityTurret.Constructor(manned_turret, Vector3(5102.647f, 4778.707f, 94.03548f)), owning_building_guid = 49)
    ...
    def Building44(): Unit = { // Name: Izha_Tower Type: tower_a GUID: 50, MapID: 44
      ...
      LocalObject(1426, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1427, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1428, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1911, SpawnTube.Constructor(respawn_tube_tower, Vector3(5250.706f, 3921.742f, 38.6753f), Vector3(0, 0, 0)), owning_building_guid = 50)
      LocalObject(1912, SpawnTube.Constructor(respawn_tube_tower, Vector3(5250.706f, 3938.152f, 38.6753f), Vector3(0, 0, 0)), owning_building_guid = 50)
      LocalObject(1295, FacilityTurret.Constructor(manned_turret, Vector3(5227.32f, 3921.295f, 68.1353f)), owning_building_guid = 50)
      TurretToWeapon(1295, 5067)
      LocalObject(1296, FacilityTurret.Constructor(manned_turret, Vector3(5262.647f, 3946.707f, 68.1353f)), owning_building_guid = 50)
    ...
    def Building18(): Unit = { // Name: NE_Amerish_Warpgate_Tower Type: tower_b GUID: 51, MapID: 18
      ...
      LocalObject(1354, Terminal.Constructor(order_terminal), owning_building_guid = 51)
      LocalObject(1355, Terminal.Constructor(order_terminal), owning_building_guid = 51)
      LocalObject(1865, SpawnTube.Constructor(respawn_tube_tower, Vector3(2898.706f, 2135.742f, 27.47261f), Vector3(0, 0, 0)), owning_building_guid = 51)
      LocalObject(1866, SpawnTube.Constructor(respawn_tube_tower, Vector3(2898.706f, 2152.152f, 27.47261f), Vector3(0, 0, 0)), owning_building_guid = 51)
    ...
    def Building15(): Unit = { // Name: W_Hvar_Tower Type: tower_b GUID: 52, MapID: 15
      ...
      LocalObject(1380, Terminal.Constructor(order_terminal), owning_building_guid = 52)
      ...
      LocalObject(1881, SpawnTube.Constructor(respawn_tube_tower, Vector3(3710.706f, 4443.742f, 42.74808f), Vector3(0, 0, 0)), owning_building_guid = 52)
      LocalObject(1882, SpawnTube.Constructor(respawn_tube_tower, Vector3(3710.706f, 4460.152f, 42.74808f), Vector3(0, 0, 0)), owning_building_guid = 52)
    ...
    def Building23(): Unit = { // Name: NE_Zal_Tower Type: tower_b GUID: 53, MapID: 23
      ...
      LocalObject(1400, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1401, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1402, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1893, SpawnTube.Constructor(respawn_tube_tower, Vector3(4300.706f, 2977.742f, 31.66727f), Vector3(0, 0, 0)), owning_building_guid = 53)
      LocalObject(1894, SpawnTube.Constructor(respawn_tube_tower, Vector3(4300.706f, 2994.152f, 31.66727f), Vector3(0, 0, 0)), owning_building_guid = 53)
    ...
    def Building20(): Unit = { // Name: S_Dahaka_Tower Type: tower_b GUID: 54, MapID: 20
      ...
      LocalObject(1403, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(1404, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(1405, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(1895, SpawnTube.Constructor(respawn_tube_tower, Vector3(4524.706f, 4755.742f, 63.97021f), Vector3(0, 0, 0)), owning_building_guid = 54)
      LocalObject(1896, SpawnTube.Constructor(respawn_tube_tower, Vector3(4524.706f, 4772.152f, 63.97021f), Vector3(0, 0, 0)), owning_building_guid = 54)
    ...
    def Building45(): Unit = { // Name: Hossin_Warpgate_Tower Type: tower_b GUID: 55, MapID: 45
      ...
      LocalObject(1436, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(1437, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(1438, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(1918, SpawnTube.Constructor(respawn_tube_tower, Vector3(5530.706f, 5519.742f, 26.69563f), Vector3(0, 0, 0)), owning_building_guid = 55)
      LocalObject(1919, SpawnTube.Constructor(respawn_tube_tower, Vector3(5530.706f, 5536.152f, 26.69563f), Vector3(0, 0, 0)), owning_building_guid = 55)
    ...
    def Building26(): Unit = { // Name: E_Esamir_Warpgate_Tower Type: tower_b GUID: 56, MapID: 26
      ...
      LocalObject(1439, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1440, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1441, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1920, SpawnTube.Constructor(respawn_tube_tower, Vector3(5854.706f, 2589.742f, 25.64951f), Vector3(0, 0, 0)), owning_building_guid = 56)
      LocalObject(1921, SpawnTube.Constructor(respawn_tube_tower, Vector3(5854.706f, 2606.152f, 25.64951f), Vector3(0, 0, 0)), owning_building_guid = 56)
    ...
    def Building39(): Unit = { // Name: Mithra_Tower Type: tower_c GUID: 57, MapID: 39
      ...
      LocalObject(1350, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1351, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1352, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1863, SpawnTube.Constructor(respawn_tube_tower, Vector3(2840.706f, 4489.742f, 45.04346f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(1864, SpawnTube.Constructor(respawn_tube_tower, Vector3(2840.706f, 4506.152f, 45.04346f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(1615, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2828.907f, 4496.725f, 83.13145f)), owning_building_guid = 57)
      LocalObject(1616, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 57)
      LocalObject(1618, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2828.907f, 4507.17f, 83.13145f)), owning_building_guid = 57)
      LocalObject(1619, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 57)
      LocalObject(1238, FacilityTurret.Constructor(manned_turret, Vector3(2815.07f, 4487.045f, 74.50346f)), owning_building_guid = 57)
      TurretToWeapon(1238, 5069)
      LocalObject(1239, FacilityTurret.Constructor(manned_turret, Vector3(2853.497f, 4516.957f, 74.50346f)), owning_building_guid = 57)
    ...
    def Building17(): Unit = { // Name: S_Rashnu_Tower Type: tower_c GUID: 58, MapID: 17
      ...
      LocalObject(1356, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1357, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1358, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1867, SpawnTube.Constructor(respawn_tube_tower, Vector3(2982.706f, 2919.742f, 49.35492f), Vector3(0, 0, 0)), owning_building_guid = 58)
      LocalObject(1868, SpawnTube.Constructor(respawn_tube_tower, Vector3(2982.706f, 2936.152f, 49.35492f), Vector3(0, 0, 0)), owning_building_guid = 58)
      LocalObject(1621, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2970.907f, 2926.725f, 87.44292f)), owning_building_guid = 58)
      LocalObject(1622, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 58)
      LocalObject(1624, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2970.907f, 2937.17f, 87.44292f)), owning_building_guid = 58)
      LocalObject(1625, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 58)
      LocalObject(1240, FacilityTurret.Constructor(manned_turret, Vector3(2957.07f, 2917.045f, 78.81492f)), owning_building_guid = 58)
      TurretToWeapon(1240, 5071)
      LocalObject(1243, FacilityTurret.Constructor(manned_turret, Vector3(2995.497f, 2946.957f, 78.81492f)), owning_building_guid = 58)
    ...
    def Building41(): Unit = { // Name: Atar_Tower Type: tower_c GUID: 59, MapID: 41
      ...
      LocalObject(1374, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1375, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1376, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1876, SpawnTube.Constructor(respawn_tube_tower, Vector3(3572.706f, 3121.742f, 29.42267f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(1877, SpawnTube.Constructor(respawn_tube_tower, Vector3(3572.706f, 3138.152f, 29.42267f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(1627, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3560.907f, 3128.725f, 67.51067f)), owning_building_guid = 59)
      LocalObject(1628, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 59)
      LocalObject(1630, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3560.907f, 3139.17f, 67.51067f)), owning_building_guid = 59)
      LocalObject(1631, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 59)
      LocalObject(1254, FacilityTurret.Constructor(manned_turret, Vector3(3547.07f, 3119.045f, 58.88267f)), owning_building_guid = 59)
      TurretToWeapon(1254, 5073)
      LocalObject(1257, FacilityTurret.Constructor(manned_turret, Vector3(3585.497f, 3148.957f, 58.88267f)), owning_building_guid = 59)
    ...
    def Building43(): Unit = { // Name: Yazata_Tower Type: tower_c GUID: 60, MapID: 43
      ...
      LocalObject(1406, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1407, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1408, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1897, SpawnTube.Constructor(respawn_tube_tower, Vector3(4650.706f, 3661.742f, 60.61855f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(1898, SpawnTube.Constructor(respawn_tube_tower, Vector3(4650.706f, 3678.152f, 60.61855f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(1633, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4638.907f, 3668.725f, 98.70654f)), owning_building_guid = 60)
      LocalObject(1634, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 60)
      LocalObject(1636, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4638.907f, 3679.17f, 98.70654f)), owning_building_guid = 60)
      LocalObject(1637, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 60)
      LocalObject(1278, FacilityTurret.Constructor(manned_turret, Vector3(4625.07f, 3659.045f, 90.07854f)), owning_building_guid = 60)
      TurretToWeapon(1278, 5075)
      LocalObject(1281, FacilityTurret.Constructor(manned_turret, Vector3(4663.497f, 3688.957f, 90.07854f)), owning_building_guid = 60)
    ...
    def Building19(): Unit = { // Name: NE_Dahaka_Tower Type: tower_c GUID: 61, MapID: 19
      ...
      LocalObject(1417, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1418, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1419, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1905, SpawnTube.Constructor(respawn_tube_tower, Vector3(4892.706f, 5567.742f, 63.85341f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(1906, SpawnTube.Constructor(respawn_tube_tower, Vector3(4892.706f, 5584.152f, 63.85341f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(1639, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4880.907f, 5574.725f, 101.9414f)), owning_building_guid = 61)
      LocalObject(1640, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 61)
      LocalObject(1642, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4880.907f, 5585.17f, 101.9414f)), owning_building_guid = 61)
      LocalObject(1643, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 61)
      LocalObject(1288, FacilityTurret.Constructor(manned_turret, Vector3(4867.07f, 5565.045f, 93.31341f)), owning_building_guid = 61)
      TurretToWeapon(1288, 5077)
      LocalObject(1290, FacilityTurret.Constructor(manned_turret, Vector3(4905.497f, 5594.957f, 93.31341f)), owning_building_guid = 61)
    ...
    def Building25(): Unit = { // Name: S_Izha_Tower Type: tower_c GUID: 62, MapID: 25
      ...
      LocalObject(1429, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1430, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1431, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1913, SpawnTube.Constructor(respawn_tube_tower, Vector3(5306.706f, 3311.742f, 25.83233f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(1914, SpawnTube.Constructor(respawn_tube_tower, Vector3(5306.706f, 3328.152f, 25.83233f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(1645, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5294.907f, 3318.725f, 63.92033f)), owning_building_guid = 62)
      LocalObject(1646, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 62)
      LocalObject(1648, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5294.907f, 3329.17f, 63.92033f)), owning_building_guid = 62)
      LocalObject(1649, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 62)
      LocalObject(1297, FacilityTurret.Constructor(manned_turret, Vector3(5281.07f, 3309.045f, 55.29233f)), owning_building_guid = 62)
      TurretToWeapon(1297, 5079)
      LocalObject(1298, FacilityTurret.Constructor(manned_turret, Vector3(5319.497f, 3338.957f, 55.29233f)), owning_building_guid = 62)
    ...
    def Building24(): Unit = { // Name: SE_Izha_Tower Type: tower_c GUID: 63, MapID: 24
      ...
      LocalObject(1442, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1443, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1444, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1922, SpawnTube.Constructor(respawn_tube_tower, Vector3(6258.706f, 3489.742f, 49.81705f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(1923, SpawnTube.Constructor(respawn_tube_tower, Vector3(6258.706f, 3506.152f, 49.81705f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(1651, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6246.907f, 3496.725f, 87.90504f)), owning_building_guid = 63)
      LocalObject(1652, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 63)
      LocalObject(1654, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6246.907f, 3507.17f, 87.90504f)), owning_building_guid = 63)
      LocalObject(1655, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 63)
      LocalObject(1305, FacilityTurret.Constructor(manned_turret, Vector3(6233.07f, 3487.045f, 79.27705f)), owning_building_guid = 63)
