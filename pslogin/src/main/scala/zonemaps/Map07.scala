...
object Map07 {
  ...
  val ZoneMap = new ZoneMap("map07") {
    ...
    def Building8(): Unit = { // Name: Freyr Type: amp_station GUID: 1, MapID: 8
      ...
      LocalObject(1806, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1807, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1808, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1809, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1810, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1811, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(2576, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2577, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2578, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2579, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2580, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2581, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2808, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 1)
      LocalObject(1728, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2827.752f, 3721.777f, 53.52836f), Vector3(0, 0, 108)), owning_building_guid = 1, terminal_guid = 2808)
      ...
      LocalObject(1749, ProximityTerminal.Constructor(medical_terminal, Vector3(2901.192f, 3725.029f, 60.78336f)), owning_building_guid = 1)
      LocalObject(1750, ProximityTerminal.Constructor(medical_terminal, Vector3(2905.264f, 3755.767f, 40.78336f)), owning_building_guid = 1)
      LocalObject(2018, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2861.617f, 3789.037f, 66.24936f)), owning_building_guid = 1)
      LocalObject(2019, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2021, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2871.506f, 3697.664f, 64.08836f)), owning_building_guid = 1)
      LocalObject(2022, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2024, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2942.12f, 3786.83f, 64.08836f)), owning_building_guid = 1)
      LocalObject(2025, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2027, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2980.462f, 3731.181f, 64.11136f)), owning_building_guid = 1)
      LocalObject(2028, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2350, ProximityTerminal.Constructor(repair_silo, Vector3(2886.146f, 3679.397f, 54.98336f)), owning_building_guid = 1)
      LocalObject(2351, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(2354, ProximityTerminal.Constructor(repair_silo, Vector3(2926.885f, 3805.396f, 54.98336f)), owning_building_guid = 1)
      LocalObject(2355, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1637, FacilityTurret.Constructor(manned_turret, Vector3(2783.378f, 3701.719f, 64.29137f)), owning_building_guid = 1)
      TurretToWeapon(1637, 5000)
      LocalObject(1638, FacilityTurret.Constructor(manned_turret, Vector3(2830.812f, 3847.673f, 64.29137f)), owning_building_guid = 1)
      TurretToWeapon(1638, 5001)
      LocalObject(1639, FacilityTurret.Constructor(manned_turret, Vector3(2891.777f, 3830.196f, 64.29137f)), owning_building_guid = 1)
      TurretToWeapon(1639, 5002)
      LocalObject(1640, FacilityTurret.Constructor(manned_turret, Vector3(2975.193f, 3639.425f, 64.29137f)), owning_building_guid = 1)
      TurretToWeapon(1640, 5003)
      LocalObject(1641, FacilityTurret.Constructor(manned_turret, Vector3(2995.726f, 3695.407f, 64.29137f)), owning_building_guid = 1)
      TurretToWeapon(1641, 5004)
      LocalObject(1642, FacilityTurret.Constructor(manned_turret, Vector3(3022.615f, 3785.343f, 64.29137f)), owning_building_guid = 1)
    ...
    def Building11(): Unit = { // Name: Kvasir Type: amp_station GUID: 4, MapID: 11
      ...
      LocalObject(1853, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1854, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1855, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1856, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1857, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1858, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(2610, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2611, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2612, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2613, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2615, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2616, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2813, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 4)
      LocalObject(1737, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4077.508f, 1692.949f, 66.31866f), Vector3(0, 0, 262)), owning_building_guid = 4, terminal_guid = 2813)
      ...
      LocalObject(1759, ProximityTerminal.Constructor(medical_terminal, Vector3(4012.926f, 1657.833f, 73.57366f)), owning_building_guid = 4)
      LocalObject(1760, ProximityTerminal.Constructor(medical_terminal, Vector3(4022.74f, 1628.42f, 53.57367f)), owning_building_guid = 4)
      LocalObject(2066, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3944.375f, 1617.554f, 76.90166f)), owning_building_guid = 4)
      LocalObject(2067, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2081, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4003.232f, 1584.345f, 76.87866f)), owning_building_guid = 4)
      LocalObject(2082, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2087, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4027.611f, 1695.443f, 76.87866f)), owning_building_guid = 4)
      LocalObject(2088, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2090, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4076.555f, 1617.652f, 79.03967f)), owning_building_guid = 4)
      LocalObject(2091, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2386, ProximityTerminal.Constructor(repair_silo, Vector3(4006.446f, 1705.443f, 67.77367f)), owning_building_guid = 4)
      LocalObject(2387, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(2390, ProximityTerminal.Constructor(repair_silo, Vector3(4025.063f, 1574.337f, 67.77367f)), owning_building_guid = 4)
      LocalObject(2391, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(1677, FacilityTurret.Constructor(manned_turret, Vector3(3908.888f, 1702.333f, 77.08167f)), owning_building_guid = 4)
      TurretToWeapon(1677, 5006)
      LocalObject(1679, FacilityTurret.Constructor(manned_turret, Vector3(3914.974f, 1643.016f, 77.08167f)), owning_building_guid = 4)
      TurretToWeapon(1679, 5007)
      LocalObject(1680, FacilityTurret.Constructor(manned_turret, Vector3(3930.231f, 1550.395f, 77.08167f)), owning_building_guid = 4)
      TurretToWeapon(1680, 5008)
      LocalObject(1684, FacilityTurret.Constructor(manned_turret, Vector3(4067.49f, 1567.437f, 77.08167f)), owning_building_guid = 4)
      TurretToWeapon(1684, 5009)
      LocalObject(1686, FacilityTurret.Constructor(manned_turret, Vector3(4108.598f, 1730.43f, 77.08167f)), owning_building_guid = 4)
      TurretToWeapon(1686, 5010)
      LocalObject(1687, FacilityTurret.Constructor(manned_turret, Vector3(4129.947f, 1578.454f, 77.08167f)), owning_building_guid = 4)
    ...
    def Building13(): Unit = { // Name: Nott Type: amp_station GUID: 7, MapID: 13
      ...
      LocalObject(1897, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1898, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1899, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1900, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1901, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(1902, Terminal.Constructor(order_terminal), owning_building_guid = 7)
      LocalObject(2631, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2632, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2633, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2634, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2635, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2636, Terminal.Constructor(spawn_terminal), owning_building_guid = 7)
      LocalObject(2816, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 7)
      LocalObject(1742, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6738.765f, 4224.08f, 44.2721f), Vector3(0, 0, 118)), owning_building_guid = 7, terminal_guid = 2816)
      ...
      LocalObject(1764, ProximityTerminal.Constructor(medical_terminal, Vector3(6811.654f, 4214.53f, 51.5271f)), owning_building_guid = 7)
      LocalObject(1765, ProximityTerminal.Constructor(medical_terminal, Vector3(6821.002f, 4244.094f, 31.5271f)), owning_building_guid = 7)
      LocalObject(2123, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6777.667f, 4192.735f, 54.8321f)), owning_building_guid = 7)
      LocalObject(2124, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2126, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6783.795f, 4284.437f, 56.9931f)), owning_building_guid = 7)
      LocalObject(2127, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2129, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6862.692f, 4268.285f, 54.8321f)), owning_building_guid = 7)
      LocalObject(2130, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2132, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6890.788f, 4206.823f, 54.8551f)), owning_building_guid = 7)
      LocalObject(2133, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 7)
      LocalObject(2414, ProximityTerminal.Constructor(repair_silo, Vector3(6788.912f, 4172.204f, 45.7271f)), owning_building_guid = 7)
      LocalObject(2415, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(2418, ProximityTerminal.Constructor(repair_silo, Vector3(6850.913f, 4289.214f, 45.7271f)), owning_building_guid = 7)
      LocalObject(2419, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 7)
      LocalObject(1712, FacilityTurret.Constructor(manned_turret, Vector3(6691.582f, 4212.032f, 55.0351f)), owning_building_guid = 7)
      TurretToWeapon(1712, 5012)
      LocalObject(1713, FacilityTurret.Constructor(manned_turret, Vector3(6763.64f, 4347.532f, 55.0351f)), owning_building_guid = 7)
      TurretToWeapon(1713, 5013)
      LocalObject(1714, FacilityTurret.Constructor(manned_turret, Vector3(6820.644f, 4319.734f, 55.0351f)), owning_building_guid = 7)
      TurretToWeapon(1714, 5014)
      LocalObject(1715, FacilityTurret.Constructor(manned_turret, Vector3(6869.666f, 4117.376f, 55.0351f)), owning_building_guid = 7)
      TurretToWeapon(1715, 5015)
      LocalObject(1716, FacilityTurret.Constructor(manned_turret, Vector3(6899.607f, 4168.942f, 55.0351f)), owning_building_guid = 7)
      TurretToWeapon(1716, 5016)
      LocalObject(1718, FacilityTurret.Constructor(manned_turret, Vector3(6941.706f, 4252.842f, 55.0351f)), owning_building_guid = 7)
    ...
    def Building16(): Unit = { // Name: Jarl Type: comm_station GUID: 22, MapID: 16
      ...
      LocalObject(1786, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1787, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1788, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1789, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1790, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1791, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(1792, Terminal.Constructor(order_terminal), owning_building_guid = 22)
      LocalObject(2563, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2564, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2565, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2566, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2567, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2568, Terminal.Constructor(spawn_terminal), owning_building_guid = 22)
      LocalObject(2806, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 22)
      LocalObject(1726, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2076.287f, 5511.065f, 67.01111f), Vector3(0, 0, -19)), owning_building_guid = 22, terminal_guid = 2806)
      ...
      LocalObject(1746, ProximityTerminal.Constructor(medical_terminal, Vector3(1984.883f, 5519.749f, 68.48211f)), owning_building_guid = 22)
      LocalObject(1747, ProximityTerminal.Constructor(medical_terminal, Vector3(2060.987f, 5478.71f, 50.98211f)), owning_building_guid = 22)
      LocalObject(2003, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2058.043f, 5565.786f, 76.72311f)), owning_building_guid = 22)
      LocalObject(2004, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 22)
      LocalObject(2334, ProximityTerminal.Constructor(repair_silo, Vector3(2009.064f, 5463.796f, 68.03211f)), owning_building_guid = 22)
      LocalObject(2335, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(2338, ProximityTerminal.Constructor(repair_silo, Vector3(2014.028f, 5595.307f, 68.03211f)), owning_building_guid = 22)
      LocalObject(2339, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 22)
      LocalObject(1618, FacilityTurret.Constructor(manned_turret, Vector3(1912.361f, 5572.312f, 76.99011f)), owning_building_guid = 22)
      TurretToWeapon(1618, 5018)
      LocalObject(1621, FacilityTurret.Constructor(manned_turret, Vector3(1944.883f, 5474.246f, 76.99011f)), owning_building_guid = 22)
      TurretToWeapon(1621, 5019)
      LocalObject(1622, FacilityTurret.Constructor(manned_turret, Vector3(1999.694f, 5447.488f, 76.99011f)), owning_building_guid = 22)
      TurretToWeapon(1622, 5020)
      LocalObject(1623, FacilityTurret.Constructor(manned_turret, Vector3(2024.592f, 5612.151f, 76.99011f)), owning_building_guid = 22)
      TurretToWeapon(1623, 5021)
      LocalObject(1624, FacilityTurret.Constructor(manned_turret, Vector3(2079.382f, 5585.407f, 76.99011f)), owning_building_guid = 22)
      TurretToWeapon(1624, 5022)
      LocalObject(1625, FacilityTurret.Constructor(manned_turret, Vector3(2111.768f, 5487.314f, 76.99011f)), owning_building_guid = 22)
    ...
    def Building14(): Unit = { // Name: Vidar Type: comm_station GUID: 25, MapID: 14
      ...
      LocalObject(1842, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1843, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1844, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1845, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1846, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1847, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(1848, Terminal.Constructor(order_terminal), owning_building_guid = 25)
      LocalObject(2598, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2599, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2600, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2601, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2602, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2603, Terminal.Constructor(spawn_terminal), owning_building_guid = 25)
      LocalObject(2811, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 25)
      LocalObject(1733, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3758.833f, 3156.62f, 65.31733f), Vector3(0, 0, -90)), owning_building_guid = 25, terminal_guid = 2811)
      ...
      LocalObject(1755, ProximityTerminal.Constructor(medical_terminal, Vector3(3720.864f, 3073.023f, 66.78833f)), owning_building_guid = 25)
      LocalObject(1756, ProximityTerminal.Constructor(medical_terminal, Vector3(3784.444f, 3131.62f, 49.28833f)), owning_building_guid = 25)
      LocalObject(2060, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3701.154f, 3157.185f, 75.02934f)), owning_building_guid = 25)
      LocalObject(2061, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 25)
      LocalObject(2374, ProximityTerminal.Constructor(repair_silo, Vector3(3658.912f, 3125.18f, 66.33833f)), owning_building_guid = 25)
      LocalObject(2375, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(2378, ProximityTerminal.Constructor(repair_silo, Vector3(3781.641f, 3077.67f, 66.33833f)), owning_building_guid = 25)
      LocalObject(2379, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 25)
      LocalObject(1668, FacilityTurret.Constructor(manned_turret, Vector3(3646.424f, 3140.652f, 75.29633f)), owning_building_guid = 25)
      TurretToWeapon(1668, 5024)
      LocalObject(1669, FacilityTurret.Constructor(manned_turret, Vector3(3647.554f, 3021.565f, 75.29633f)), owning_building_guid = 25)
      TurretToWeapon(1669, 5025)
      LocalObject(1671, FacilityTurret.Constructor(manned_turret, Vector3(3689.549f, 3183.75f, 75.29633f)), owning_building_guid = 25)
      TurretToWeapon(1671, 5026)
      LocalObject(1672, FacilityTurret.Constructor(manned_turret, Vector3(3750.865f, 3020.388f, 75.29633f)), owning_building_guid = 25)
      TurretToWeapon(1672, 5027)
      LocalObject(1673, FacilityTurret.Constructor(manned_turret, Vector3(3792.841f, 3182.435f, 75.29633f)), owning_building_guid = 25)
      TurretToWeapon(1673, 5028)
      LocalObject(1674, FacilityTurret.Constructor(manned_turret, Vector3(3794.01f, 3063.501f, 75.29633f)), owning_building_guid = 25)
    ...
    def Building5(): Unit = { // Name: Andvari Type: comm_station_dsp GUID: 28, MapID: 5
      ...
      LocalObject(263, Terminal.Constructor(dropship_vehicle_terminal), owning_building_guid = 28)
      LocalObject(262, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(3240.328f, 7396.856f, 77.56638f), Vector3(0, 0, 90)), owning_building_guid = 28, terminal_guid = 263)
      LocalObject(1812, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1813, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1814, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1815, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1816, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1817, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1818, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(1819, Terminal.Constructor(order_terminal), owning_building_guid = 28)
      LocalObject(2582, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2583, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2584, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2585, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2586, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2587, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2588, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2589, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2590, Terminal.Constructor(spawn_terminal), owning_building_guid = 28)
      LocalObject(2809, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 28)
      LocalObject(1729, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3189.786f, 7366.411f, 76.16737f), Vector3(0, 0, 180)), owning_building_guid = 28, terminal_guid = 2809)
      ...
      LocalObject(1751, ProximityTerminal.Constructor(medical_terminal, Vector3(3172.863f, 7243.013f, 77.63837f)), owning_building_guid = 28)
      LocalObject(1752, ProximityTerminal.Constructor(medical_terminal, Vector3(3236.444f, 7301.62f, 60.13837f)), owning_building_guid = 28)
      LocalObject(2030, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3153.153f, 7365.398f, 85.94838f)), owning_building_guid = 28)
      LocalObject(2031, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(2033, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3169.514f, 7319.467f, 83.23238f)), owning_building_guid = 28)
      LocalObject(2034, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(2036, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3221.804f, 7283.901f, 90.41438f)), owning_building_guid = 28)
      LocalObject(2037, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(2039, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3257.071f, 7300.159f, 85.96138f)), owning_building_guid = 28)
      LocalObject(2040, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 28)
      LocalObject(2358, ProximityTerminal.Constructor(repair_silo, Vector3(3110.642f, 7310.241f, 77.28838f)), owning_building_guid = 28)
      LocalObject(2359, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(2362, ProximityTerminal.Constructor(repair_silo, Vector3(3280.57f, 7313.151f, 77.28838f)), owning_building_guid = 28)
      LocalObject(2363, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 28)
      LocalObject(1643, FacilityTurret.Constructor(manned_turret, Vector3(3098.401f, 7345.113f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1643, 5030)
      LocalObject(1644, FacilityTurret.Constructor(manned_turret, Vector3(3099.554f, 7191.565f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1644, 5031)
      LocalObject(1645, FacilityTurret.Constructor(manned_turret, Vector3(3143.445f, 7391.667f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1645, 5032)
      LocalObject(1646, FacilityTurret.Constructor(manned_turret, Vector3(3202.428f, 7190.396f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1646, 5033)
      LocalObject(1647, FacilityTurret.Constructor(manned_turret, Vector3(3203.449f, 7450.154f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1647, 5034)
      LocalObject(1649, FacilityTurret.Constructor(manned_turret, Vector3(3244.537f, 7231.011f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1649, 5035)
      LocalObject(1654, FacilityTurret.Constructor(manned_turret, Vector3(3291.619f, 7448.985f, 86.14638f)), owning_building_guid = 28)
      TurretToWeapon(1654, 5036)
      LocalObject(1655, FacilityTurret.Constructor(manned_turret, Vector3(3292.773f, 7280.733f, 86.14638f)), owning_building_guid = 28)
    ...
    def Building15(): Unit = { // Name: ymir Type: cryo_facility GUID: 31, MapID: 15
      ...
      LocalObject(222, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(223, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(224, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(225, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(226, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(227, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(228, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(229, Terminal.Constructor(cert_terminal), owning_building_guid = 31)
      LocalObject(1782, Terminal.Constructor(order_terminal), owning_building_guid = 31)
      LocalObject(1783, Terminal.Constructor(order_terminal), owning_building_guid = 31)
      LocalObject(1784, Terminal.Constructor(order_terminal), owning_building_guid = 31)
      LocalObject(1785, Terminal.Constructor(order_terminal), owning_building_guid = 31)
      LocalObject(2556, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2557, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2558, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2559, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2560, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2561, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2562, Terminal.Constructor(spawn_terminal), owning_building_guid = 31)
      LocalObject(2805, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 31)
      LocalObject(1725, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(1883.989f, 3882.724f, 67.18903f), Vector3(0, 0, -90)), owning_building_guid = 31, terminal_guid = 2805)
      ...
      LocalObject(153, ProximityTerminal.Constructor(adv_med_terminal, Vector3(1861.983f, 3938.892f, 68.85202f)), owning_building_guid = 31)
      LocalObject(1745, ProximityTerminal.Constructor(medical_terminal, Vector3(1887.642f, 3949.952f, 59.04202f)), owning_building_guid = 31)
      LocalObject(1991, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1841.883f, 3884.061f, 79.33502f)), owning_building_guid = 31)
      LocalObject(1992, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 31)
      LocalObject(1994, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1845.101f, 3999.651f, 77.38403f)), owning_building_guid = 31)
      LocalObject(1995, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 31)
      LocalObject(1997, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1858.198f, 3876.777f, 77.39402f)), owning_building_guid = 31)
      LocalObject(1998, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 31)
      LocalObject(2000, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1861.323f, 3991.253f, 79.37402f)), owning_building_guid = 31)
      LocalObject(2001, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 31)
      LocalObject(2326, ProximityTerminal.Constructor(repair_silo, Vector3(1824.525f, 3861.154f, 68.79202f)), owning_building_guid = 31)
      LocalObject(2327, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 31)
      LocalObject(2330, ProximityTerminal.Constructor(repair_silo, Vector3(1912.53f, 3961.861f, 68.79202f)), owning_building_guid = 31)
      LocalObject(2331, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 31)
      LocalObject(1613, FacilityTurret.Constructor(manned_turret, Vector3(1788.392f, 4026.472f, 77.44402f)), owning_building_guid = 31)
      TurretToWeapon(1613, 5038)
      LocalObject(1614, FacilityTurret.Constructor(manned_turret, Vector3(1788.4f, 3849.379f, 77.44402f)), owning_building_guid = 31)
      TurretToWeapon(1614, 5039)
      LocalObject(1617, FacilityTurret.Constructor(manned_turret, Vector3(1881.665f, 4027.605f, 77.44402f)), owning_building_guid = 31)
      TurretToWeapon(1617, 5040)
      LocalObject(1619, FacilityTurret.Constructor(manned_turret, Vector3(1923.626f, 3849.371f, 77.44402f)), owning_building_guid = 31)
      TurretToWeapon(1619, 5041)
      LocalObject(1620, FacilityTurret.Constructor(manned_turret, Vector3(1924.813f, 3984.496f, 77.44402f)), owning_building_guid = 31)
      TurretToWeapon(1620, 5042)
      LocalObject(914, ImplantTerminalMech.Constructor, owning_building_guid = 31)
      LocalObject(908, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 31)
      TerminalToInterface(914, 908)
      LocalObject(915, ImplantTerminalMech.Constructor, owning_building_guid = 31)
      LocalObject(909, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 31)
    ...
    def Building17(): Unit = { // Name: Ran Type: cryo_facility GUID: 34, MapID: 17
      ...
      LocalObject(230, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(231, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(232, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(233, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(234, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(235, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(236, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(237, Terminal.Constructor(cert_terminal), owning_building_guid = 34)
      LocalObject(1802, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1803, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1804, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(1805, Terminal.Constructor(order_terminal), owning_building_guid = 34)
      LocalObject(2569, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2570, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2571, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2572, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2573, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2574, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2575, Terminal.Constructor(spawn_terminal), owning_building_guid = 34)
      LocalObject(2807, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 34)
      LocalObject(1727, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2274.437f, 1995.822f, 83.65987f), Vector3(0, 0, 24)), owning_building_guid = 34, terminal_guid = 2807)
      ...
      LocalObject(154, ProximityTerminal.Constructor(adv_med_terminal, Vector3(2334.7f, 1993.079f, 85.32286f)), owning_building_guid = 34)
      LocalObject(1748, ProximityTerminal.Constructor(medical_terminal, Vector3(2334.367f, 1965.14f, 75.51286f)), owning_building_guid = 34)
      LocalObject(2006, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2279.495f, 2021.802f, 93.86486f)), owning_building_guid = 34)
      LocalObject(2007, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(2009, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2292.785f, 2033.744f, 95.80586f)), owning_building_guid = 34)
      LocalObject(2010, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(2012, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2382.802f, 1972.385f, 95.84486f)), owning_building_guid = 34)
      LocalObject(2013, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(2015, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2397.073f, 1983.789f, 93.85487f)), owning_building_guid = 34)
      LocalObject(2016, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 34)
      LocalObject(2342, ProximityTerminal.Constructor(repair_silo, Vector3(2278.918f, 2058.918f, 85.26286f)), owning_building_guid = 34)
      LocalObject(2343, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 34)
      LocalObject(2346, ProximityTerminal.Constructor(repair_silo, Vector3(2335.124f, 1937.56f, 85.26286f)), owning_building_guid = 34)
      LocalObject(2347, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 34)
      LocalObject(1627, FacilityTurret.Constructor(manned_turret, Vector3(2227.846f, 1973.177f, 93.91486f)), owning_building_guid = 34)
      TurretToWeapon(1627, 5043)
      LocalObject(1629, FacilityTurret.Constructor(manned_turret, Vector3(2282.855f, 2096.709f, 93.91486f)), owning_building_guid = 34)
      TurretToWeapon(1629, 5044)
      LocalObject(1634, FacilityTurret.Constructor(manned_turret, Vector3(2350.806f, 1917.133f, 93.91486f)), owning_building_guid = 34)
      TurretToWeapon(1634, 5045)
      LocalObject(1635, FacilityTurret.Constructor(manned_turret, Vector3(2407.738f, 1939.016f, 93.91486f)), owning_building_guid = 34)
      TurretToWeapon(1635, 5046)
      LocalObject(1636, FacilityTurret.Constructor(manned_turret, Vector3(2444.64f, 2024.686f, 93.91486f)), owning_building_guid = 34)
      TurretToWeapon(1636, 5047)
      LocalObject(916, ImplantTerminalMech.Constructor, owning_building_guid = 34)
      LocalObject(910, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 34)
      TerminalToInterface(916, 910)
      LocalObject(917, ImplantTerminalMech.Constructor, owning_building_guid = 34)
      LocalObject(911, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 34)
    ...
    def Building12(): Unit = { // Name: Mani Type: cryo_facility GUID: 37, MapID: 12
      ...
      LocalObject(238, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(239, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(240, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(241, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(242, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(243, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(244, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(245, Terminal.Constructor(cert_terminal), owning_building_guid = 37)
      LocalObject(1874, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1878, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1879, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(1880, Terminal.Constructor(order_terminal), owning_building_guid = 37)
      LocalObject(2617, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2618, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2619, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2620, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2621, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2622, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2623, Terminal.Constructor(spawn_terminal), owning_building_guid = 37)
      LocalObject(2814, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 37)
      LocalObject(1738, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5031.989f, 4862.724f, 55.91854f), Vector3(0, 0, -90)), owning_building_guid = 37, terminal_guid = 2814)
      ...
      LocalObject(155, ProximityTerminal.Constructor(adv_med_terminal, Vector3(5009.983f, 4918.892f, 57.58154f)), owning_building_guid = 37)
      LocalObject(1761, ProximityTerminal.Constructor(medical_terminal, Vector3(5035.642f, 4929.952f, 47.77154f)), owning_building_guid = 37)
      LocalObject(2093, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4989.883f, 4864.061f, 68.06454f)), owning_building_guid = 37)
      LocalObject(2094, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(2096, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4993.101f, 4979.651f, 66.11354f)), owning_building_guid = 37)
      LocalObject(2097, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(2099, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5006.198f, 4856.777f, 66.12354f)), owning_building_guid = 37)
      LocalObject(2100, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(2102, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5009.323f, 4971.253f, 68.10354f)), owning_building_guid = 37)
      LocalObject(2103, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 37)
      LocalObject(2398, ProximityTerminal.Constructor(repair_silo, Vector3(4972.524f, 4841.154f, 57.52154f)), owning_building_guid = 37)
      LocalObject(2399, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 37)
      LocalObject(2402, ProximityTerminal.Constructor(repair_silo, Vector3(5060.53f, 4941.861f, 57.52154f)), owning_building_guid = 37)
      LocalObject(2403, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 37)
      LocalObject(1691, FacilityTurret.Constructor(manned_turret, Vector3(4936.392f, 5006.472f, 66.17354f)), owning_building_guid = 37)
      TurretToWeapon(1691, 5048)
      LocalObject(1692, FacilityTurret.Constructor(manned_turret, Vector3(4936.4f, 4829.379f, 66.17354f)), owning_building_guid = 37)
      TurretToWeapon(1692, 5049)
      LocalObject(1697, FacilityTurret.Constructor(manned_turret, Vector3(5029.665f, 5007.605f, 66.17354f)), owning_building_guid = 37)
      TurretToWeapon(1697, 5050)
      LocalObject(1698, FacilityTurret.Constructor(manned_turret, Vector3(5071.626f, 4829.371f, 66.17354f)), owning_building_guid = 37)
      TurretToWeapon(1698, 5051)
      LocalObject(1699, FacilityTurret.Constructor(manned_turret, Vector3(5072.813f, 4964.496f, 66.17354f)), owning_building_guid = 37)
      TurretToWeapon(1699, 5052)
      LocalObject(918, ImplantTerminalMech.Constructor, owning_building_guid = 37)
      LocalObject(912, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 37)
      TerminalToInterface(918, 912)
      LocalObject(919, ImplantTerminalMech.Constructor, owning_building_guid = 37)
      LocalObject(913, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 37)
    ...
    def Building9(): Unit = { // Name: Gjallar Type: tech_plant GUID: 44, MapID: 9
      ...
      LocalObject(156, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 44)
      LocalObject(1723, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(958.07f, 2729.835f, 86.63727f), Vector3(0, 0, 0)), owning_building_guid = 44, terminal_guid = 156)
      LocalObject(157, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 44)
      LocalObject(1724, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(979.088f, 2729.835f, 86.63727f), Vector3(0, 0, 0)), owning_building_guid = 44, terminal_guid = 157)
      LocalObject(1769, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1770, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1771, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(1772, Terminal.Constructor(order_terminal), owning_building_guid = 44)
      LocalObject(2549, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2550, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2551, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2552, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2553, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2554, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2555, Terminal.Constructor(spawn_terminal), owning_building_guid = 44)
      LocalObject(2804, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 44)
      LocalObject(1722, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(909.945f, 2704.339f, 51.59627f), Vector3(0, 0, 0)), owning_building_guid = 44, terminal_guid = 2804)
      ...
      LocalObject(1743, ProximityTerminal.Constructor(medical_terminal, Vector3(961.059f, 2696.901f, 79.15627f)), owning_building_guid = 44)
      LocalObject(1744, ProximityTerminal.Constructor(medical_terminal, Vector3(998.444f, 2707.62f, 59.15926f)), owning_building_guid = 44)
      LocalObject(1973, ProximityTerminal.Constructor(pad_landing_frame, Vector3(896.704f, 2709.661f, 82.25426f)), owning_building_guid = 44)
      LocalObject(1974, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(1976, ProximityTerminal.Constructor(pad_landing_frame, Vector3(916.98f, 2725.833f, 84.60927f)), owning_building_guid = 44)
      LocalObject(1977, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(1979, ProximityTerminal.Constructor(pad_landing_frame, Vector3(967.379f, 2669.474f, 89.50626f)), owning_building_guid = 44)
      LocalObject(1980, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(1982, ProximityTerminal.Constructor(pad_landing_frame, Vector3(983.534f, 2652.628f, 82.26727f)), owning_building_guid = 44)
      LocalObject(1983, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(1985, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1019.987f, 2691.855f, 84.71127f)), owning_building_guid = 44)
      LocalObject(1986, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(1988, ProximityTerminal.Constructor(pad_landing_frame, Vector3(1026.28f, 2708.102f, 82.26727f)), owning_building_guid = 44)
      LocalObject(1989, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 44)
      LocalObject(2318, ProximityTerminal.Constructor(repair_silo, Vector3(958.3086f, 2775.637f, 73.78777f)), owning_building_guid = 44)
      LocalObject(2319, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 44)
      LocalObject(2322, ProximityTerminal.Constructor(repair_silo, Vector3(1016.637f, 2641.208f, 73.80927f)), owning_building_guid = 44)
      LocalObject(2323, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 44)
      LocalObject(1605, FacilityTurret.Constructor(manned_turret, Vector3(873.906f, 2832.855f, 82.55827f)), owning_building_guid = 44)
      TurretToWeapon(1605, 5053)
      LocalObject(1606, FacilityTurret.Constructor(manned_turret, Vector3(879.413f, 2634.665f, 82.55827f)), owning_building_guid = 44)
      TurretToWeapon(1606, 5054)
      LocalObject(1607, FacilityTurret.Constructor(manned_turret, Vector3(963.601f, 2832.855f, 82.55827f)), owning_building_guid = 44)
      TurretToWeapon(1607, 5055)
      LocalObject(1610, FacilityTurret.Constructor(manned_turret, Vector3(1044.154f, 2634.657f, 82.55827f)), owning_building_guid = 44)
      TurretToWeapon(1610, 5056)
      LocalObject(1611, FacilityTurret.Constructor(manned_turret, Vector3(1044.154f, 2772.398f, 82.55827f)), owning_building_guid = 44)
      TurretToWeapon(1611, 5057)
      LocalObject(1612, FacilityTurret.Constructor(manned_turret, Vector3(1051.881f, 2699.423f, 82.55827f)), owning_building_guid = 44)
    ...
    def Building7(): Unit = { // Name: Eisa Type: tech_plant GUID: 47, MapID: 7
      ...
      LocalObject(158, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 47)
      LocalObject(1731, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3392.437f, 4618.139f, 87.88242f), Vector3(0, 0, 23)), owning_building_guid = 47, terminal_guid = 158)
      LocalObject(159, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 47)
      LocalObject(1732, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3411.784f, 4609.926f, 87.88242f), Vector3(0, 0, 23)), owning_building_guid = 47, terminal_guid = 159)
      LocalObject(1832, Terminal.Constructor(order_terminal), owning_building_guid = 47)
      LocalObject(1833, Terminal.Constructor(order_terminal), owning_building_guid = 47)
      LocalObject(1834, Terminal.Constructor(order_terminal), owning_building_guid = 47)
      LocalObject(1835, Terminal.Constructor(order_terminal), owning_building_guid = 47)
      LocalObject(2591, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2592, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2593, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2594, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2595, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2596, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2597, Terminal.Constructor(spawn_terminal), owning_building_guid = 47)
      LocalObject(2810, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 47)
      LocalObject(1730, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3338.176f, 4613.474f, 52.84142f), Vector3(0, 0, 23)), owning_building_guid = 47, terminal_guid = 2810)
      ...
      LocalObject(1753, ProximityTerminal.Constructor(medical_terminal, Vector3(3382.32f, 4586.655f, 80.40142f)), owning_building_guid = 47)
      LocalObject(1754, ProximityTerminal.Constructor(medical_terminal, Vector3(3420.921f, 4581.915f, 60.40442f)), owning_building_guid = 47)
      LocalObject(2042, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3328.067f, 4623.546f, 83.49942f)), owning_building_guid = 47)
      LocalObject(2043, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2045, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3353.05f, 4630.51f, 85.85442f)), owning_building_guid = 47)
      LocalObject(2046, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2048, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3377.421f, 4558.939f, 90.75142f)), owning_building_guid = 47)
      LocalObject(2049, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2051, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3385.71f, 4537.12f, 83.51242f)), owning_building_guid = 47)
      LocalObject(2052, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2054, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3434.592f, 4558.985f, 85.95642f)), owning_building_guid = 47)
      LocalObject(2055, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2057, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3446.733f, 4571.481f, 83.51242f)), owning_building_guid = 47)
      LocalObject(2058, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 47)
      LocalObject(2366, ProximityTerminal.Constructor(repair_silo, Vector3(3410.553f, 4660.206f, 75.03292f)), owning_building_guid = 47)
      LocalObject(2367, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 47)
      LocalObject(2370, ProximityTerminal.Constructor(repair_silo, Vector3(3411.718f, 4513.673f, 75.05442f)), owning_building_guid = 47)
      LocalObject(2371, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 47)
      LocalObject(1653, FacilityTurret.Constructor(manned_turret, Vector3(3282.847f, 4561.268f, 83.80342f)), owning_building_guid = 47)
      TurretToWeapon(1653, 5059)
      LocalObject(1660, FacilityTurret.Constructor(manned_turret, Vector3(3355.217f, 4745.854f, 83.80342f)), owning_building_guid = 47)
      TurretToWeapon(1660, 5060)
      LocalObject(1662, FacilityTurret.Constructor(manned_turret, Vector3(3434.489f, 4496.891f, 83.80342f)), owning_building_guid = 47)
      TurretToWeapon(1662, 5061)
      LocalObject(1663, FacilityTurret.Constructor(manned_turret, Vector3(3437.781f, 4710.808f, 83.80342f)), owning_building_guid = 47)
      TurretToWeapon(1663, 5062)
      LocalObject(1664, FacilityTurret.Constructor(manned_turret, Vector3(3466.908f, 4553.489f, 83.80342f)), owning_building_guid = 47)
      TurretToWeapon(1664, 5063)
      LocalObject(1666, FacilityTurret.Constructor(manned_turret, Vector3(3488.309f, 4623.683f, 83.80342f)), owning_building_guid = 47)
    ...
    def Building6(): Unit = { // Name: Dagur Type: tech_plant GUID: 50, MapID: 6
      ...
      LocalObject(160, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1734, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3940.102f, 6107.274f, 72.63843f), Vector3(0, 0, -79)), owning_building_guid = 50, terminal_guid = 160)
      LocalObject(161, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1735, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3944.112f, 6127.906f, 72.63843f), Vector3(0, 0, -79)), owning_building_guid = 50, terminal_guid = 161)
      LocalObject(1849, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1850, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1851, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(1852, Terminal.Constructor(order_terminal), owning_building_guid = 50)
      LocalObject(2604, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2605, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2606, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2607, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2608, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2609, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2614, Terminal.Constructor(spawn_terminal), owning_building_guid = 50)
      LocalObject(2812, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 50)
      LocalObject(1736, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3955.947f, 6055.168f, 37.59743f), Vector3(0, 0, -79)), owning_building_guid = 50, terminal_guid = 2812)
      ...
      LocalObject(1757, ProximityTerminal.Constructor(medical_terminal, Vector3(3969.612f, 6142.667f, 45.16042f)), owning_building_guid = 50)
      LocalObject(1758, ProximityTerminal.Constructor(medical_terminal, Vector3(3973.001f, 6103.924f, 65.15742f)), owning_building_guid = 50)
      LocalObject(2063, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3936.19f, 6066.175f, 70.61043f)), owning_building_guid = 50)
      LocalObject(2064, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2069, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3948.196f, 6043.186f, 68.25542f)), owning_building_guid = 50)
      LocalObject(2070, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2072, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3974.451f, 6170.084f, 68.26842f)), owning_building_guid = 50)
      LocalObject(2073, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2075, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3989.198f, 6160.807f, 70.71243f)), owning_building_guid = 50)
      LocalObject(2076, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2078, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4001.13f, 6104.895f, 75.50742f)), owning_building_guid = 50)
      LocalObject(2079, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2084, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4020.749f, 6117.539f, 68.26842f)), owning_building_guid = 50)
      LocalObject(2085, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 50)
      LocalObject(2382, ProximityTerminal.Constructor(repair_silo, Vector3(3895.187f, 6116.248f, 59.78893f)), owning_building_guid = 50)
      LocalObject(2383, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 50)
      LocalObject(2394, ProximityTerminal.Constructor(repair_silo, Vector3(4038.276f, 6147.854f, 59.81042f)), owning_building_guid = 50)
      LocalObject(2395, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 50)
      LocalObject(1675, FacilityTurret.Constructor(manned_turret, Vector3(3822.915f, 6044.313f, 68.55943f)), owning_building_guid = 50)
      TurretToWeapon(1675, 5065)
      LocalObject(1676, FacilityTurret.Constructor(manned_turret, Vector3(3840.03f, 6132.36f, 68.55943f)), owning_building_guid = 50)
      TurretToWeapon(1676, 5066)
      LocalObject(1678, FacilityTurret.Constructor(manned_turret, Vector3(3914.746f, 6199.898f, 68.55943f)), owning_building_guid = 50)
      TurretToWeapon(1678, 5067)
      LocalObject(1681, FacilityTurret.Constructor(manned_turret, Vector3(3987.855f, 6193.559f, 68.55943f)), owning_building_guid = 50)
      TurretToWeapon(1681, 5068)
      LocalObject(1682, FacilityTurret.Constructor(manned_turret, Vector3(4018.515f, 6011.903f, 68.55943f)), owning_building_guid = 50)
      TurretToWeapon(1682, 5069)
      LocalObject(1683, FacilityTurret.Constructor(manned_turret, Vector3(4049.957f, 6173.616f, 68.55943f)), owning_building_guid = 50)
    ...
    def Building10(): Unit = { // Name: Helhiem Type: tech_plant GUID: 53, MapID: 10
      ...
      LocalObject(162, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1740, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5448.07f, 2603.835f, 65.9091f), Vector3(0, 0, 0)), owning_building_guid = 53, terminal_guid = 162)
      LocalObject(163, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1741, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5469.088f, 2603.835f, 65.9091f), Vector3(0, 0, 0)), owning_building_guid = 53, terminal_guid = 163)
      LocalObject(1881, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1882, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1883, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1884, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(2624, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2625, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2626, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2627, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2628, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2629, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2630, Terminal.Constructor(spawn_terminal), owning_building_guid = 53)
      LocalObject(2815, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 53)
      LocalObject(1739, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5399.945f, 2578.339f, 30.8681f), Vector3(0, 0, 0)), owning_building_guid = 53, terminal_guid = 2815)
      ...
      LocalObject(1762, ProximityTerminal.Constructor(medical_terminal, Vector3(5451.059f, 2570.901f, 58.4281f)), owning_building_guid = 53)
      LocalObject(1763, ProximityTerminal.Constructor(medical_terminal, Vector3(5488.444f, 2581.62f, 38.4311f)), owning_building_guid = 53)
      LocalObject(2105, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5386.704f, 2583.661f, 61.5261f)), owning_building_guid = 53)
      LocalObject(2106, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2108, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5406.98f, 2599.833f, 63.8811f)), owning_building_guid = 53)
      LocalObject(2109, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2111, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5457.379f, 2543.474f, 68.7781f)), owning_building_guid = 53)
      LocalObject(2112, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2114, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5473.534f, 2526.628f, 61.5391f)), owning_building_guid = 53)
      LocalObject(2115, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2117, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5509.987f, 2565.855f, 63.9831f)), owning_building_guid = 53)
      LocalObject(2118, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2120, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5516.28f, 2582.102f, 61.5391f)), owning_building_guid = 53)
      LocalObject(2121, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 53)
      LocalObject(2406, ProximityTerminal.Constructor(repair_silo, Vector3(5448.309f, 2649.637f, 53.0596f)), owning_building_guid = 53)
      LocalObject(2407, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 53)
      LocalObject(2410, ProximityTerminal.Constructor(repair_silo, Vector3(5506.637f, 2515.208f, 53.0811f)), owning_building_guid = 53)
      LocalObject(2411, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 53)
      LocalObject(1700, FacilityTurret.Constructor(manned_turret, Vector3(5363.906f, 2706.855f, 61.8301f)), owning_building_guid = 53)
      TurretToWeapon(1700, 5071)
      LocalObject(1701, FacilityTurret.Constructor(manned_turret, Vector3(5369.413f, 2508.665f, 61.8301f)), owning_building_guid = 53)
      TurretToWeapon(1701, 5072)
      LocalObject(1702, FacilityTurret.Constructor(manned_turret, Vector3(5453.601f, 2706.855f, 61.8301f)), owning_building_guid = 53)
      TurretToWeapon(1702, 5073)
      LocalObject(1703, FacilityTurret.Constructor(manned_turret, Vector3(5534.154f, 2508.657f, 61.8301f)), owning_building_guid = 53)
      TurretToWeapon(1703, 5074)
      LocalObject(1704, FacilityTurret.Constructor(manned_turret, Vector3(5534.154f, 2646.398f, 61.8301f)), owning_building_guid = 53)
      TurretToWeapon(1704, 5075)
      LocalObject(1705, FacilityTurret.Constructor(manned_turret, Vector3(5541.881f, 2573.423f, 61.8301f)), owning_building_guid = 53)
    ...
    def Building53(): Unit = { // Name: N_Gjallar_Tower Type: tower_a GUID: 56, MapID: 53
      ...
      LocalObject(1773, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1774, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1775, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(2440, SpawnTube.Constructor(respawn_tube_tower, Vector3(993.6741f, 3001.648f, 71.48286f), Vector3(0, 0, 13)), owning_building_guid = 56)
      LocalObject(2441, SpawnTube.Constructor(respawn_tube_tower, Vector3(997.3656f, 3017.637f, 71.48286f), Vector3(0, 0, 13)), owning_building_guid = 56)
      LocalObject(1608, FacilityTurret.Constructor(manned_turret, Vector3(970.787f, 3006.473f, 100.9429f)), owning_building_guid = 56)
      TurretToWeapon(1608, 5077)
      LocalObject(1609, FacilityTurret.Constructor(manned_turret, Vector3(1010.925f, 3023.287f, 100.9429f)), owning_building_guid = 56)
    ...
    def Building31(): Unit = { // Name: N_Ymir_Tower Type: tower_a GUID: 57, MapID: 31
      ...
      LocalObject(1779, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1780, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1781, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(2444, SpawnTube.Constructor(respawn_tube_tower, Vector3(1820.706f, 4181.742f, 69.30011f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(2445, SpawnTube.Constructor(respawn_tube_tower, Vector3(1820.706f, 4198.152f, 69.30011f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(1615, FacilityTurret.Constructor(manned_turret, Vector3(1797.32f, 4181.295f, 98.76011f)), owning_building_guid = 57)
      TurretToWeapon(1615, 5079)
      LocalObject(1616, FacilityTurret.Constructor(manned_turret, Vector3(1832.647f, 4206.707f, 98.76011f)), owning_building_guid = 57)
    ...
    def Building52(): Unit = { // Name: E_Jarl_Tower Type: tower_a GUID: 58, MapID: 52
      ...
      LocalObject(1793, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1794, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1795, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(2452, SpawnTube.Constructor(respawn_tube_tower, Vector3(2226.45f, 5666.585f, 56.85771f), Vector3(0, 0, 314)), owning_building_guid = 58)
      LocalObject(2453, SpawnTube.Constructor(respawn_tube_tower, Vector3(2238.255f, 5655.186f, 56.85771f), Vector3(0, 0, 314)), owning_building_guid = 58)
      LocalObject(1626, FacilityTurret.Constructor(manned_turret, Vector3(2222.331f, 5638.053f, 86.31771f)), owning_building_guid = 58)
      TurretToWeapon(1626, 5081)
      LocalObject(1628, FacilityTurret.Constructor(manned_turret, Vector3(2228.591f, 5681.118f, 86.31771f)), owning_building_guid = 58)
    ...
    def Building49(): Unit = { // Name: N_Ran_Tower Type: tower_a GUID: 59, MapID: 49
      ...
      LocalObject(1796, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1797, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1798, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(2454, SpawnTube.Constructor(respawn_tube_tower, Vector3(2308.706f, 2197.742f, 75.18713f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(2455, SpawnTube.Constructor(respawn_tube_tower, Vector3(2308.706f, 2214.152f, 75.18713f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(1630, FacilityTurret.Constructor(manned_turret, Vector3(2285.32f, 2197.295f, 104.6471f)), owning_building_guid = 59)
      TurretToWeapon(1630, 5083)
      LocalObject(1632, FacilityTurret.Constructor(manned_turret, Vector3(2320.647f, 2222.707f, 104.6471f)), owning_building_guid = 59)
    ...
    def Building21(): Unit = { // Name: W_Searhus_Warpgate_Tower Type: tower_a GUID: 60, MapID: 21
      ...
      LocalObject(1799, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1800, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1801, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(2456, SpawnTube.Constructor(respawn_tube_tower, Vector3(2310.706f, 3021.742f, 77.66829f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(2457, SpawnTube.Constructor(respawn_tube_tower, Vector3(2310.706f, 3038.152f, 77.66829f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(1631, FacilityTurret.Constructor(manned_turret, Vector3(2287.32f, 3021.295f, 107.1283f)), owning_building_guid = 60)
      TurretToWeapon(1631, 5085)
      LocalObject(1633, FacilityTurret.Constructor(manned_turret, Vector3(2322.647f, 3046.707f, 107.1283f)), owning_building_guid = 60)
    ...
    def Building48(): Unit = { // Name: E_Freyr_Tower Type: tower_a GUID: 61, MapID: 48
      ...
      LocalObject(1826, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1827, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1828, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(2471, SpawnTube.Constructor(respawn_tube_tower, Vector3(3286.706f, 3697.742f, 43.24341f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(2472, SpawnTube.Constructor(respawn_tube_tower, Vector3(3286.706f, 3714.152f, 43.24341f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(1652, FacilityTurret.Constructor(manned_turret, Vector3(3263.32f, 3697.295f, 72.70341f)), owning_building_guid = 61)
      TurretToWeapon(1652, 5087)
      LocalObject(1657, FacilityTurret.Constructor(manned_turret, Vector3(3298.647f, 3722.707f, 72.70341f)), owning_building_guid = 61)
    ...
    def Building22(): Unit = { // Name: S_Andvari_Tower Type: tower_a GUID: 62, MapID: 22
      ...
      LocalObject(1829, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1830, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1831, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(2473, SpawnTube.Constructor(respawn_tube_tower, Vector3(3330.706f, 6537.742f, 80.92767f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(2474, SpawnTube.Constructor(respawn_tube_tower, Vector3(3330.706f, 6554.152f, 80.92767f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(1658, FacilityTurret.Constructor(manned_turret, Vector3(3307.32f, 6537.295f, 110.3877f)), owning_building_guid = 62)
      TurretToWeapon(1658, 5089)
      LocalObject(1659, FacilityTurret.Constructor(manned_turret, Vector3(3342.647f, 6562.707f, 110.3877f)), owning_building_guid = 62)
    ...
    def Building18(): Unit = { // Name: SE_Eisa_Tower Type: tower_a GUID: 63, MapID: 18
      ...
      LocalObject(1839, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1840, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1841, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(2480, SpawnTube.Constructor(respawn_tube_tower, Vector3(3654.706f, 4325.742f, 93.43415f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(2481, SpawnTube.Constructor(respawn_tube_tower, Vector3(3654.706f, 4342.152f, 93.43415f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(1667, FacilityTurret.Constructor(manned_turret, Vector3(3631.32f, 4325.295f, 122.8941f)), owning_building_guid = 63)
      TurretToWeapon(1667, 5091)
      LocalObject(1670, FacilityTurret.Constructor(manned_turret, Vector3(3666.647f, 4350.707f, 122.8941f)), owning_building_guid = 63)
    ...
    def Building32(): Unit = { // Name: S_Kvasir_Tower Type: tower_a GUID: 64, MapID: 32
      ...
      LocalObject(1859, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1860, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1861, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(2491, SpawnTube.Constructor(respawn_tube_tower, Vector3(4125.754f, 1345.727f, 52.05105f), Vector3(0, 0, 42)), owning_building_guid = 64)
      LocalObject(2492, SpawnTube.Constructor(respawn_tube_tower, Vector3(4136.734f, 1357.922f, 52.05105f), Vector3(0, 0, 42)), owning_building_guid = 64)
      LocalObject(1685, FacilityTurret.Constructor(manned_turret, Vector3(4108.076f, 1361.043f, 81.51105f)), owning_building_guid = 64)
      TurretToWeapon(1685, 5093)
      LocalObject(1688, FacilityTurret.Constructor(manned_turret, Vector3(4151.333f, 1356.289f, 81.51105f)), owning_building_guid = 64)
    ...
    def Building46(): Unit = { // Name: N_Mani_Tower Type: tower_a GUID: 65, MapID: 46
      ...
      LocalObject(1871, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1872, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1873, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(2499, SpawnTube.Constructor(respawn_tube_tower, Vector3(4978.706f, 5141.742f, 37.25568f), Vector3(0, 0, 0)), owning_building_guid = 65)
      LocalObject(2500, SpawnTube.Constructor(respawn_tube_tower, Vector3(4978.706f, 5158.152f, 37.25568f), Vector3(0, 0, 0)), owning_building_guid = 65)
      LocalObject(1693, FacilityTurret.Constructor(manned_turret, Vector3(4955.32f, 5141.295f, 66.71568f)), owning_building_guid = 65)
      TurretToWeapon(1693, 5095)
      LocalObject(1694, FacilityTurret.Constructor(manned_turret, Vector3(4990.647f, 5166.707f, 66.71568f)), owning_building_guid = 65)
    ...
    def Building50(): Unit = { // Name: E_Helhiem_Tower Type: tower_a GUID: 66, MapID: 50
      ...
      LocalObject(1885, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1886, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1887, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(2509, SpawnTube.Constructor(respawn_tube_tower, Vector3(5674.303f, 2685.889f, 41.92501f), Vector3(0, 0, 33)), owning_building_guid = 66)
      LocalObject(2510, SpawnTube.Constructor(respawn_tube_tower, Vector3(5683.24f, 2699.651f, 41.92501f), Vector3(0, 0, 33)), owning_building_guid = 66)
      LocalObject(1706, FacilityTurret.Constructor(manned_turret, Vector3(5654.446f, 2698.251f, 71.38501f)), owning_building_guid = 66)
      TurretToWeapon(1706, 5097)
      LocalObject(1707, FacilityTurret.Constructor(manned_turret, Vector3(5697.914f, 2700.323f, 71.38501f)), owning_building_guid = 66)
    ...
    def Building19(): Unit = { // Name: E_Oshur_Warpgate_Tower Type: tower_a GUID: 67, MapID: 19
      ...
      LocalObject(1891, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1892, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1893, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(2513, SpawnTube.Constructor(respawn_tube_tower, Vector3(5926.706f, 3977.742f, 45.81612f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(2514, SpawnTube.Constructor(respawn_tube_tower, Vector3(5926.706f, 3994.152f, 45.81612f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(1708, FacilityTurret.Constructor(manned_turret, Vector3(5903.32f, 3977.295f, 75.27612f)), owning_building_guid = 67)
      TurretToWeapon(1708, 5099)
      LocalObject(1709, FacilityTurret.Constructor(manned_turret, Vector3(5938.647f, 4002.707f, 75.27612f)), owning_building_guid = 67)
    ...
    def Building23(): Unit = { // Name: Outpost_Tower Type: tower_a GUID: 68, MapID: 23
      ...
      LocalObject(1894, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(1895, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(1896, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(2515, SpawnTube.Constructor(respawn_tube_tower, Vector3(6341.422f, 5243.516f, 48.36136f), Vector3(0, 0, 14)), owning_building_guid = 68)
      LocalObject(2516, SpawnTube.Constructor(respawn_tube_tower, Vector3(6345.393f, 5259.438f, 48.36136f), Vector3(0, 0, 14)), owning_building_guid = 68)
      LocalObject(1710, FacilityTurret.Constructor(manned_turret, Vector3(6318.623f, 5248.74f, 77.82136f)), owning_building_guid = 68)
      TurretToWeapon(1710, 5101)
      LocalObject(1711, FacilityTurret.Constructor(manned_turret, Vector3(6359.048f, 5264.851f, 77.82136f)), owning_building_guid = 68)
    ...
    def Building20(): Unit = { // Name: NE_VSSanc_Warpgate_Tower Type: tower_a GUID: 69, MapID: 20
      ...
      LocalObject(1903, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1904, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1905, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(2520, SpawnTube.Constructor(respawn_tube_tower, Vector3(6938.706f, 1745.742f, 67.72536f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(2521, SpawnTube.Constructor(respawn_tube_tower, Vector3(6938.706f, 1762.152f, 67.72536f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(1717, FacilityTurret.Constructor(manned_turret, Vector3(6915.32f, 1745.295f, 97.18536f)), owning_building_guid = 69)
      TurretToWeapon(1717, 5103)
      LocalObject(1719, FacilityTurret.Constructor(manned_turret, Vector3(6950.647f, 1770.707f, 97.18536f)), owning_building_guid = 69)
    ...
    def Building47(): Unit = { // Name: SE_Nott_Tower Type: tower_a GUID: 70, MapID: 47
      ...
      LocalObject(1906, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1907, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1908, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(2522, SpawnTube.Constructor(respawn_tube_tower, Vector3(7023.334f, 4108.624f, 36.66056f), Vector3(0, 0, 22)), owning_building_guid = 70)
      LocalObject(2523, SpawnTube.Constructor(respawn_tube_tower, Vector3(7029.482f, 4123.839f, 36.66056f), Vector3(0, 0, 22)), owning_building_guid = 70)
      LocalObject(1720, FacilityTurret.Constructor(manned_turret, Vector3(7001.484f, 4116.97f, 66.12056f)), owning_building_guid = 70)
      TurretToWeapon(1720, 5105)
      LocalObject(1721, FacilityTurret.Constructor(manned_turret, Vector3(7043.758f, 4127.298f, 66.12056f)), owning_building_guid = 70)
    ...
    def Building41(): Unit = { // Name: N_NCSanc_Warpgate_Tower Type: tower_b GUID: 71, MapID: 41
      ...
      LocalObject(1766, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1767, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1768, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(2435, SpawnTube.Constructor(respawn_tube_tower, Vector3(761.1957f, 6940.949f, 34.17941f), Vector3(0, 0, 330)), owning_building_guid = 71)
      LocalObject(2436, SpawnTube.Constructor(respawn_tube_tower, Vector3(769.4007f, 6926.737f, 34.17941f), Vector3(0, 0, 330)), owning_building_guid = 71)
    ...
    def Building54(): Unit = { // Name: S_NCSanc_Tower Type: tower_b GUID: 72, MapID: 54
      ...
      LocalObject(1776, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1777, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1778, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(2442, SpawnTube.Constructor(respawn_tube_tower, Vector3(1466.706f, 6047.742f, 109.9325f), Vector3(0, 0, 0)), owning_building_guid = 72)
      LocalObject(2443, SpawnTube.Constructor(respawn_tube_tower, Vector3(1466.706f, 6064.152f, 109.9325f), Vector3(0, 0, 0)), owning_building_guid = 72)
    ...
    def Building25(): Unit = { // Name: SE_Dagur_Tower Type: tower_b GUID: 73, MapID: 25
      ...
      LocalObject(1862, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1863, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1864, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(2493, SpawnTube.Constructor(respawn_tube_tower, Vector3(4258.706f, 5789.742f, 37.64936f), Vector3(0, 0, 0)), owning_building_guid = 73)
      LocalObject(2494, SpawnTube.Constructor(respawn_tube_tower, Vector3(4258.706f, 5806.152f, 37.64936f), Vector3(0, 0, 0)), owning_building_guid = 73)
    ...
    def Building28(): Unit = { // Name: SW_Mani_Tower Type: tower_b GUID: 74, MapID: 28
      ...
      LocalObject(1865, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1866, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1867, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(2495, SpawnTube.Constructor(respawn_tube_tower, Vector3(4486.706f, 4295.742f, 59.73256f), Vector3(0, 0, 0)), owning_building_guid = 74)
      LocalObject(2496, SpawnTube.Constructor(respawn_tube_tower, Vector3(4486.706f, 4312.152f, 59.73256f), Vector3(0, 0, 0)), owning_building_guid = 74)
    ...
    def Building30(): Unit = { // Name: NW_VSSanc_Warpgate_Tower Type: tower_b GUID: 75, MapID: 30
      ...
      LocalObject(1888, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(1889, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(1890, Terminal.Constructor(order_terminal), owning_building_guid = 75)
      LocalObject(2511, SpawnTube.Constructor(respawn_tube_tower, Vector3(5746.706f, 1369.742f, 74.07015f), Vector3(0, 0, 0)), owning_building_guid = 75)
      LocalObject(2512, SpawnTube.Constructor(respawn_tube_tower, Vector3(5746.706f, 1386.152f, 74.07015f), Vector3(0, 0, 0)), owning_building_guid = 75)
    ...
    def Building29(): Unit = { // Name: SE_Searhus_Warpgate_Tower Type: tower_c GUID: 76, MapID: 29
      ...
      LocalObject(1820, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(1821, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(1822, Terminal.Constructor(order_terminal), owning_building_guid = 76)
      LocalObject(2467, SpawnTube.Constructor(respawn_tube_tower, Vector3(3232.706f, 2475.742f, 78.56553f), Vector3(0, 0, 0)), owning_building_guid = 76)
      LocalObject(2468, SpawnTube.Constructor(respawn_tube_tower, Vector3(3232.706f, 2492.152f, 78.56553f), Vector3(0, 0, 0)), owning_building_guid = 76)
      LocalObject(2135, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3220.907f, 2482.725f, 116.6535f)), owning_building_guid = 76)
      LocalObject(2136, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 76)
      LocalObject(2138, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3220.907f, 2493.17f, 116.6535f)), owning_building_guid = 76)
      LocalObject(2139, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 76)
      LocalObject(1648, FacilityTurret.Constructor(manned_turret, Vector3(3207.07f, 2473.045f, 108.0255f)), owning_building_guid = 76)
      TurretToWeapon(1648, 5107)
      LocalObject(1650, FacilityTurret.Constructor(manned_turret, Vector3(3245.497f, 2502.957f, 108.0255f)), owning_building_guid = 76)
    ...
    def Building26(): Unit = { // Name: W_Vidar_Tower Type: tower_c GUID: 77, MapID: 26
      ...
      LocalObject(1823, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(1824, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(1825, Terminal.Constructor(order_terminal), owning_building_guid = 77)
      LocalObject(2469, SpawnTube.Constructor(respawn_tube_tower, Vector3(3280.706f, 3155.742f, 75.11389f), Vector3(0, 0, 0)), owning_building_guid = 77)
      LocalObject(2470, SpawnTube.Constructor(respawn_tube_tower, Vector3(3280.706f, 3172.152f, 75.11389f), Vector3(0, 0, 0)), owning_building_guid = 77)
      LocalObject(2141, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3268.907f, 3162.725f, 113.2019f)), owning_building_guid = 77)
      LocalObject(2142, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 77)
      LocalObject(2144, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3268.907f, 3173.17f, 113.2019f)), owning_building_guid = 77)
      LocalObject(2145, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 77)
      LocalObject(1651, FacilityTurret.Constructor(manned_turret, Vector3(3255.07f, 3153.045f, 104.5739f)), owning_building_guid = 77)
      TurretToWeapon(1651, 5109)
      LocalObject(1656, FacilityTurret.Constructor(manned_turret, Vector3(3293.497f, 3182.957f, 104.5739f)), owning_building_guid = 77)
    ...
    def Building51(): Unit = { // Name: NE_Andvari_Tower Type: tower_c GUID: 78, MapID: 51
      ...
      LocalObject(1836, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(1837, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(1838, Terminal.Constructor(order_terminal), owning_building_guid = 78)
      LocalObject(2478, SpawnTube.Constructor(respawn_tube_tower, Vector3(3456.706f, 7585.742f, 39.52625f), Vector3(0, 0, 0)), owning_building_guid = 78)
      LocalObject(2479, SpawnTube.Constructor(respawn_tube_tower, Vector3(3456.706f, 7602.152f, 39.52625f), Vector3(0, 0, 0)), owning_building_guid = 78)
      LocalObject(2147, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3444.907f, 7592.725f, 77.61425f)), owning_building_guid = 78)
      LocalObject(2148, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 78)
      LocalObject(2150, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3444.907f, 7603.17f, 77.61425f)), owning_building_guid = 78)
      LocalObject(2151, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 78)
      LocalObject(1661, FacilityTurret.Constructor(manned_turret, Vector3(3431.07f, 7583.045f, 68.98625f)), owning_building_guid = 78)
      TurretToWeapon(1661, 5111)
      LocalObject(1665, FacilityTurret.Constructor(manned_turret, Vector3(3469.497f, 7612.957f, 68.98625f)), owning_building_guid = 78)
    ...
    def Building27(): Unit = { // Name: SW_Oshur_Warpgate_Tower Type: tower_c GUID: 79, MapID: 27
      ...
      LocalObject(1868, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(1869, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(1870, Terminal.Constructor(order_terminal), owning_building_guid = 79)
      LocalObject(2497, SpawnTube.Constructor(respawn_tube_tower, Vector3(4882.706f, 3395.742f, 48.2515f), Vector3(0, 0, 0)), owning_building_guid = 79)
      LocalObject(2498, SpawnTube.Constructor(respawn_tube_tower, Vector3(4882.706f, 3412.152f, 48.2515f), Vector3(0, 0, 0)), owning_building_guid = 79)
      LocalObject(2153, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4870.907f, 3402.725f, 86.33949f)), owning_building_guid = 79)
      LocalObject(2154, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 79)
      LocalObject(2156, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4870.907f, 3413.17f, 86.33949f)), owning_building_guid = 79)
      LocalObject(2157, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 79)
      LocalObject(1689, FacilityTurret.Constructor(manned_turret, Vector3(4857.07f, 3393.045f, 77.71149f)), owning_building_guid = 79)
      TurretToWeapon(1689, 5113)
      LocalObject(1690, FacilityTurret.Constructor(manned_turret, Vector3(4895.497f, 3422.957f, 77.71149f)), owning_building_guid = 79)
    ...
    def Building24(): Unit = { // Name: E_Dagur_Tower Type: tower_c GUID: 80, MapID: 24
      ...
      LocalObject(1875, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(1876, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(1877, Terminal.Constructor(order_terminal), owning_building_guid = 80)
      LocalObject(2501, SpawnTube.Constructor(respawn_tube_tower, Vector3(4999.356f, 5878.157f, 40.27701f), Vector3(0, 0, 319)), owning_building_guid = 80)
      LocalObject(2502, SpawnTube.Constructor(respawn_tube_tower, Vector3(5010.122f, 5865.772f, 40.27701f), Vector3(0, 0, 319)), owning_building_guid = 80)
      LocalObject(2159, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4989.783f, 5871.185f, 78.36501f)), owning_building_guid = 80)
      LocalObject(2160, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 80)
      LocalObject(2162, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4996.636f, 5863.302f, 78.36501f)), owning_building_guid = 80)
      LocalObject(2163, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 80)
      LocalObject(1695, FacilityTurret.Constructor(manned_turret, Vector3(4992.543f, 5846.918f, 69.73701f)), owning_building_guid = 80)
