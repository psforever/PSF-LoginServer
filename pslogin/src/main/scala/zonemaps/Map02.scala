...
object Map02 {
  ...
  val ZoneMap = new ZoneMap("map02") {
    ...
    def Building12(): Unit = { // Name: Ixtab Type: amp_station GUID: 1, MapID: 12
      ...
      LocalObject(1543, VehicleSpawnPad.Constructor(Vector3(3404.849f, 3232.498f, 37.92425f), Vector3(0f, 0f, 0f)), owning_building_guid = 1, terminal_guid = 2509)
    ...
    def Building48(): Unit = { // Name: Hurakan Type: comm_station GUID: 17, MapID: 48
      ...
      LocalObject(1538, VehicleSpawnPad.Constructor(Vector3(1958.62f, 2949.167f, 37.19453f), Vector3(0f, 0f, 0f)), owning_building_guid = 17, terminal_guid = 2505)
    ...
    def Building13(): Unit = { // Name: Kisin Type: comm_station GUID: 20, MapID: 13
      ...
      LocalObject(1542, VehicleSpawnPad.Constructor(Vector3(3334.833f, 5480.62f, 29.77243f), Vector3(0f, 0f, 0f)), owning_building_guid = 20, terminal_guid = 2507)
    ...
    def Building5(): Unit = { // Name: Voltan Type: comm_station GUID: 23, MapID: 5
      ...
      LocalObject(1549, VehicleSpawnPad.Constructor(Vector3(4522.833f, 3536.62f, 27.04407f), Vector3(0f, 0f, 0f)), owning_building_guid = 23, terminal_guid = 2512)
    ...
    def Building6(): Unit = { // Name: Naum Type: comm_station_dsp GUID: 26, MapID: 6
      ...
      LocalObject(235, VehicleSpawnPad.Constructor(Vector3(5544.602f, 3575.971f, 27.74491f), Vector3(0f, 0f, 0f)), owning_building_guid = 26, terminal_guid = 236)
      ...
      LocalObject(1550, VehicleSpawnPad.Constructor(Vector3(5487.335f, 3590.182f, 26.34591f), Vector3(0f, 0f, 0f)), owning_building_guid = 26, terminal_guid = 2513)
    ...
    def Building8(): Unit = { // Name: Acan Type: cryo_facility GUID: 29, MapID: 8
      ...
      LocalObject(1544, VehicleSpawnPad.Constructor(Vector3(3414.315f, 4033.119f, 27.96969f), Vector3(0f, 0f, 0f)), owning_building_guid = 29, terminal_guid = 2508)
    ...
    def Building9(): Unit = { // Name: Bitol Type: cryo_facility GUID: 32, MapID: 9
      ...
      LocalObject(1548, VehicleSpawnPad.Constructor(Vector3(4503.989f, 2506.724f, 28.58006f), Vector3(0f, 0f, 0f)), owning_building_guid = 32, terminal_guid = 2511)
    ...
    def Building7(): Unit = { // Name: Zotz Type: cryo_facility GUID: 35, MapID: 7
      ...
      LocalObject(1554, VehicleSpawnPad.Constructor(Vector3(6793.276f, 2315.989f, 127.3563f), Vector3(0f, 0f, 0f)), owning_building_guid = 35, terminal_guid = 2515)
    ...
    def Building11(): Unit = { // Name: Ghanon Type: tech_plant GUID: 42, MapID: 11
      ...
      LocalObject(1540, VehicleSpawnPad.Constructor(Vector3(2482.07f, 3757.835f, 53.78409f), Vector3(0f, 0f, 0f)), owning_building_guid = 42, terminal_guid = 142)
      LocalObject(143, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 42)
      LocalObject(1541, VehicleSpawnPad.Constructor(Vector3(2503.088f, 3757.835f, 53.78409f), Vector3(0f, 0f, 0f)), owning_building_guid = 42, terminal_guid = 143)
      ...
      LocalObject(1539, VehicleSpawnPad.Constructor(Vector3(2433.945f, 3732.339f, 18.74309f), Vector3(0f, 0f, 0f)), owning_building_guid = 42, terminal_guid = 2506)
    ...
    def Building10(): Unit = { // Name: Chac Type: tech_plant GUID: 45, MapID: 10
      ...
      LocalObject(1546, VehicleSpawnPad.Constructor(Vector3(4020.07f, 6007.835f, 51.86753f), Vector3(0f, 0f, 0f)), owning_building_guid = 45, terminal_guid = 144)
      LocalObject(145, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 45)
      LocalObject(1547, VehicleSpawnPad.Constructor(Vector3(4041.088f, 6007.835f, 51.86753f), Vector3(0f, 0f, 0f)), owning_building_guid = 45, terminal_guid = 145)
      ...
      LocalObject(1545, VehicleSpawnPad.Constructor(Vector3(3971.945f, 5982.339f, 16.82653f), Vector3(0f, 0f, 0f)), owning_building_guid = 45, terminal_guid = 2510)
    ...
    def Building14(): Unit = { // Name: Mulac Type: tech_plant GUID: 48, MapID: 14
      ...
      LocalObject(1552, VehicleSpawnPad.Constructor(Vector3(5663.102f, 2803.07f, 49.55423f), Vector3(0f, 0f, 0f)), owning_building_guid = 48, terminal_guid = 146)
      LocalObject(147, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 48)
      LocalObject(1553, VehicleSpawnPad.Constructor(Vector3(5663.835f, 2824.075f, 49.55423f), Vector3(0f, 0f, 0f)), owning_building_guid = 48, terminal_guid = 147)
      ...
      LocalObject(1551, VehicleSpawnPad.Constructor(Vector3(5640.034f, 2873.061f, 14.51323f), Vector3(0f, 0f, 0f)), owning_building_guid = 48, terminal_guid = 2514)
