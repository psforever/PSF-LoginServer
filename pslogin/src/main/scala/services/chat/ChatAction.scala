...
object ChatAction {
  ...
  final case class Tell(player_guid : PlanetSideGUID, continent : Zone, msg : ChatMsg) extends Action
  final case class Broadcast(player_guid : PlanetSideGUID, continent : Zone, msg : ChatMsg) extends Action
  final case class Voice(player_guid : PlanetSideGUID, continent : Zone, msg : ChatMsg) extends Action
}
